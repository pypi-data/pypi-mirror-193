...
from deutschland.DashboardDeutschland import rest
...
from deutschland.DashboardDeutschland.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GeoApi()
        api_instance.geo  # this is an instance of the class Endpoint
        api_instance.geo()  # this invokes api_instance.geo.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.geo.callable or self.callable in this class
