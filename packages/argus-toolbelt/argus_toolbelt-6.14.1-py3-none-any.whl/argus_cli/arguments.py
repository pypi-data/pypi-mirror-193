...
class Module(MutableMapping):
    ...
    def __init__(self, name=None, module=None, providers=None):
        ...
        if module:
            ...
            # If there are no parents, then this is the root module
        ...
        # Make sure that sub-modules automatically get a parent
...
class Provider(object):
    ...
    def __call__(self, *args, **kwargs):
        # Make sure that the provider is only called once.
