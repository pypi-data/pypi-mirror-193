...
def saveandquit(input_loc, output_loc, cdata):
    # Function to save to output location and close the tool
    os.rename(input_loc, "backup_" + os.path.basname(input_loc)) # Keep a backup of the previous version incase of user error
