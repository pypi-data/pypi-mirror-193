...
def get(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.get(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}"),
        )
...
def product_description(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/description"),
            json={
...
def product_tag(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/tag"),
            json={
                "tag": tag.lower(),
            },
        )
...
def remove_product_tag(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            url=_metadata_url(ctx, f"/product/{product_name}/tag"),
            json={
                "tag": tag.lower(),
            },
        )
...
def product_field_tag(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/{field}/tag"),
            json={
                "tag": tag.lower(),
            },
        )
...
def remove_product_field_tag(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            url=_metadata_url(ctx, f"/product/{product_name}/{field}/tag"),
            json={
                "tag": tag.lower(),
            },
        )
...
def product_field_description(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/{field}/description"),
            json={
                "description": description,
            },
        )
...
def product_quality_expectations(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.get(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/quality/expectations"),
        )
...
def product_quality_profiling(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.get(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/quality/profiling"),
        )
...
def product_quality_validations(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.get(
            ctx,
            _metadata_url(ctx, f"/product/{product_name}/quality/validations"),
        )
