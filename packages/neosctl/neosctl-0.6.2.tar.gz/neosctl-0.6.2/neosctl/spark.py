...
def add(
    ctx: typer.Context,
    product_identifier: str = typer.Argument(..., help="Data Product identifier"),
    ...
    def _request(ctx: typer.Context, payload: typing.Dict) -> httpx.Response:
        return util.post(
            ctx,
            _secret_url(product_identifier, ctx.obj.gateway_api_url),
            json=payload,
        )
...
def remove_key(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            f"{_secret_url(product_identifier, ctx.obj.gateway_api_url)}/key",
            json={"keys": keys},
        )
