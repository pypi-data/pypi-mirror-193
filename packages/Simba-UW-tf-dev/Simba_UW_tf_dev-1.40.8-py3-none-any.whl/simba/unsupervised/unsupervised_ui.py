...
class UnsupervisedGUI(object):
    def __init__(self,
        ...
        self.extract_single_metrics_btn = Button(self.metrics_frm, text='EXTRACT UNSUPERVISED RESULTS (MULTIPLE MODELS)', fg='blue', command=lambda: BatchDataExtractorPopUp())
