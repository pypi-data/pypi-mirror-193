...
from psql_optimizer.commands.query.analyze_model import analyze_model
from psql_optimizer.commands.query.find_table import find_tables
from psql_optimizer.commands.query.set_stats import set_statistics
