...
from psql_optimizer.command.query.analyze_model import analyze_model
from psql_optimizer.command.query.find_table import find_tables
from psql_optimizer.command.query.set_stats import set_statistics
