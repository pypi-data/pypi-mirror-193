...
class GtjaVintexQyt:
    ...
    def qc0020(
            pooltype: str,
            virtual_custid: int = 2933102,
            virtual_fundid: int = 1689971,
            page: int = 1,
            rownum: int = 10000
    ) -> VintexData:
        logger.debug(
            f"Calling qc0020. custid: {virtual_custid}, fundid: {virtual_fundid}, page: {page}, rownum: {rownum}, pooltype: {pooltype}.")
    ...
    def qc0021(
        ...
        logger.debug(
            f"Calling qc0021. page: {page}, rownum: {rownum}, custid: {virtual_custid}, fundid: {virtual_fundid}, pooltype: {pooltype}.")

        path = "/api/v1/qyt/QC/QC0021"

        payload = {"custid": virtual_custid}
