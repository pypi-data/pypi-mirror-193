...
.. hint::
    depending on the used gui framework there can be more app start events. e.g. the :mod:`ae.kivy.apps` module fires
    the events :meth:`~ae.kivy.apps.KivyMainApp.on_app_built` and :meth:`~ae.kivy.apps.KivyMainApp.on_app_started` (all
    of them fired after :meth:`~ae.kivy.apps.KivyMainApp.on_app_run` and
    :meth:`~ae.kivy.apps.KivyMainApp.on_app_build`). see also :ref:`kivy application events`.
...
.. hint::
    depending on the used gui framework there can be more events. e.g. the :mod:`~ae.kivy.apps` module fires the event
    :meth:`~ae.kivy.apps.KivyMainApp.on_app_stopped` (before :meth:`~ae.kivy.apps.KivyMainApp.on_app_stop`
    respectively :meth:`~ae.kivy.apps.KivyMainApp.on_app_quit`).
