...
class CaptureClient:
    ...
    def log(self,
        ...
        if input is not None and self.input_enable:
        ...
        if image is not None and self._is_data_capture_enable():
        ...
        print(self.input_enable)
        print(self.prediction_enable)
        print(self.ground_truth_enable)
