...
class Selenium(Scraper):
    ...
    def on_exists(self, path, element, timeout=0, is_error: bool=True):
    ...
    def on_hover(self, path: str, element: any, is_error: bool=True) -> None:
        element = self.xPath(element=element, path=path, is_error=is_error)
