...
@LastEditTime: 2023-02-22 16:35:11
...
class PropLogHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        condition = "act_id=%s"
        params = [act_id]
        field = "open_id,user_nick,change_type,operate_type,prop_type,machine_name,specs_type,operate_value,history_value,title,create_date"
        ...
        for page in page_list:
            page["operate_value"] = str(page["operate_value"]) if int(page["operate_value"]) < 0 else "+" + str(page["operate_value"])
        page_info = PageInfo(page_index, page_size, total, page_list)
