...
#    fluxwallet Test Network for Unit Tests
...
class BitcoinlibTestClient(BaseClient):
    ...
    def getbalance(self, addresslist):
        """
        Dummy getbalance method for fluxwallet testnet
    ...
    def sendrawtransaction(self, rawtx):
        """
        Dummy method to send transactions on the fluxwallet testnet. The fluxwallet testnet does not exists,
    ...
    def estimatefee(self, blocks):
        """
        Dummy estimate fee method for the fluxwallet testnet.
