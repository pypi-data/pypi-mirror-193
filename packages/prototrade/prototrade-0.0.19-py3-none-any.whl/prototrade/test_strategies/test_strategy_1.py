...
def test_strategy(exchange, lower_volume, upper_volume):
    ...
    while exchange.is_running():
        ...
        exchange.create_order("AAPL", OrderSide.BID, "market", random.randrange(lower_volume, upper_volume)) # Example of placing an order with random volume within the limits
