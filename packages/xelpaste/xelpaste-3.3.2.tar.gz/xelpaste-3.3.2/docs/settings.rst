...
.. glossary::
    ...
    ``DPASTE_EXPIRE_CHOICES``
        ...
        expiration dropdown. Example::
            ...
            gettext = lambda s: s
            DPASTE_EXPIRE_CHOICES = (
                (3600, gettext('In one hour')),
                (3600 * 24 * 7, gettext('In one week')),
                (3600 * 24 * 30, gettext('In one month')),
                (3600 * 24 * 30 * 12 * 100, gettext('100 Years')),
            )
        ...
        **One-time snippets** are supported. One time snippets are automatically
        ...
        expire choices::
            ...
            gettext = lambda s: s
            DPASTE_EXPIRE_CHOICES = (
                ('onetime', gettext('One-Time snippet')),
                (3600, gettext('In one hour')),
                (3600 * 24 * 7, gettext('In one week')),
                (3600 * 24 * 30, gettext('In one month')),
            )
