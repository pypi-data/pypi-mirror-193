...
def main():
    ...
    group_launch.add_argument("-a", "--addenzyme", action="store_true",
                              ...
                              "ation")
    group_launch.add_argument("-b", "--delenzyme", metavar="",
    ...
    parser.add_argument("-n", "--noninteractive", action='store_true',
                        ...
                        "overwritten.")
    parser.add_argument("-x", "--cleave", type=str, metavar="", default=[],
                        nargs='+',
                        help="Cleavage site(s) when adding enzyme in non-inte"\
                        "ractive (e.g. -x \"(D or E,)\" or -x \"(D,)\" \"(E,)\"")

    parser.add_argument("-z", "--exception", type=str, metavar="", default=[],
                        nargs='+',
                        help="Exception(s) when adding enzyme in non-interact"\
                        "ive (e.g. -z \"(D,)(W)\" \"(D,)(A)\"")

    parser.add_argument("-y", "--enzname", type=str, metavar="", default="",
    ...
    parser.add_argument("-w", "--mass", metavar="", choices=['avg', 'mono'],
