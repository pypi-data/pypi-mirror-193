...
class Connectors(object):
    ...
    def __init__(self, config, inputs=None, sample_mode=False, master_transaction_id=None,channel_id=None):
        if inputs is None:
            inputs = {}
        self.C = config
    ...
    def fetch(self, provider_names, inputs=None, sample_mode=False, config={}, encoding_mode="utf-8"):
        ...
        resp = requests.post(url, data=simplejson.dumps(params, ignore_nan=True), verify=self.C.get_verify())
