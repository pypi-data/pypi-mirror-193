...
class CalcInternalShading(VirtualSensorCalculation):
    ...
    def _core(self):
        ...
        internal_shading_ratio : pd.Series
            Float between 0 and 1. Degree of shading of the collectors, from not shaded (0) to completely shaded (1).
        ...
        References
        ----------
        .. [1] Bany, J. and Appelbaum, J. (1987): "The effects of shading on the design of a field of solar collectors",
