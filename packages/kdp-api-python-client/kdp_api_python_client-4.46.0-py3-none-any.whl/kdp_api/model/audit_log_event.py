...
class AuditLogEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, user_id, timestamp, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            type (str):
            user_id (str): user ID
            timestamp (bool, date, datetime, dict, float, int, list, str, none_type): event timestamp - UTC - Required. Number of milliseconds since the Unix epoch (January 1, 1970, 00:00:00 UTC).
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, user_id, timestamp, *args, **kwargs):  # noqa: E501
        """AuditLogEvent - a model defined in OpenAPI
