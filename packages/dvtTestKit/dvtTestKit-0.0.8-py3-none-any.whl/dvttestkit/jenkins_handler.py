...
def generate_jenkins_url():
    jenkins_url_base = os.getenv('JENKINS_URL', "http://192.168.1.140:8080")
    jenkins_url = f"{jenkins_url_base}/generic-webhook-trigger/invoke')"
    jenkins_api_token = os.getenv('JENKINS_API_TOKEN')
    testkit_debug = os.getenv('testkit_debug', 'true')
    cdrouter_restart = os.getenv('cdrouter_restart', 'false')
    cdrouter_skipUpload = os.getenv('cdrouter_skipUpload', 'false')
    TicketKey = os.getenv('TicketKey')
    cdrouter_device = os.getenv('cdrouter_device')
    cdrouter_config = os.getenv('cdrouter_config')
    cdrouter_package = os.getenv('cdrouter_package')
    cdrouter_tests = os.getenv('cdrouter_tests', 'full')
    cdrouter_test = os.getenv('cdrouter_test', 'Get from List')
    cdrouter_message = os.getenv('cdrouter_message', '')
    tags = os.getenv('tags', 'cdrouter7')
    ...
    return f"{jenkins_url}?{encoded_params}"
