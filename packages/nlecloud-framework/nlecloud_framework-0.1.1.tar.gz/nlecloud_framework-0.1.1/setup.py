...
from nlecloud_framework.utils.common import stringTextLine_to_list
from nlecloud_framework.utils.common import utf16leToUtf8
...
with open("requirement.txt","r",encoding="utf8") as f :
    install_requires_list = stringTextLine_to_list(f.read(),is_print=False)
