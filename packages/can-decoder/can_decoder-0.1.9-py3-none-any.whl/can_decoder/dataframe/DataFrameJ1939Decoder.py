...
class DataFrameJ1939Decoder(DataFrameDecoder):
    ...
    def _decode_frame_with_well_formed_data(self, reduced_df, frame, raw_ids, id_indices, *args, **kwargs):
        ...
        timestamps = reduced_df["TimeStamp"].values
    ...
    def _decode(
        ...
        # Add custom fields.
        result["TimeStamp"] = timestamps[valid_indices]
        ...
        result = result.set_index("TimeStamp").tz_localize("UTC")
    ...
    def _decode_frame(self, df: pd.DataFrame, *args, **kwargs):
        ...
        for pgn in unique_pgns:
            ...
            try:
                self._decode_frame_with_well_formed_data(reduced_df, frame, raw_ids, id_indices, ignore_invalid_signals=ignore_invalid)
            except ValueError:
