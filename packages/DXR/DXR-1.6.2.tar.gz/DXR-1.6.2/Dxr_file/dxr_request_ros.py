...
if __name__ == '__main__':
    # res = ssh_download_file('/root/nav_ws/src/lidar_localization/Localization/data/latest/finalCloud.pcd', './', '10.10.8.156', 'root', '123456', 5000, callback)
    threading.Thread(target=ssh_download_file, args=('/root/nav_ws/src/lidar_localization/Localization/data/latest/finalCloud.pcd', './', '10.10.8.156', 'root', '123456', 5000, callback,)).start()