...
def route_exercise(
    ...
    # Grab latest-outcomes info for the exercise in question
    outcomes = fetch_all_best_outcomes(
        course,
        semester,
        effective_user,
    ...
    # Grab all exercises by category for the target exercise
    all_submissions = []
    ...
    legacy = storage.fetch_old_oucomes(course, semester, effective_user, eid)
    ...
    # Sort by submission time, with a few fallbacks
