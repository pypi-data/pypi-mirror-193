...
class AddonsLoader:
    ...
    async def find_addon_by_target_with_ctx(self, target: str, ctx) -> List[ApiAddon]:
        """
        Find plugins by target and IncomingContext
        Func for overload
        """
        return await self.find_addon_by_target(target)
