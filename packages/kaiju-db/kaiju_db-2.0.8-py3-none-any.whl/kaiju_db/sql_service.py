...
class SQLService(Service, abc.ABC):
    ...
    async def m_exists(self, id: list):
    ...
    async def get(self, id, columns='*', connection=None):
    ...
    async def m_get(self, id: list, columns='*'):
    ...
    async def delete(self, id, columns=None, connection=None):
    ...
    def _create_m_delete_query(self, _id, columns, table=None):
        if table is None:
            table = self.table
        columns = self._sql_get_columns(columns, table=table)
        sql = table.delete()
    ...
    async def m_delete(self, id: list, columns=None):
        ...
        """
        sql = self._create_m_delete_query(id, columns)
        if columns:
    ...
    async def update(self, id, data: dict, columns='*', connection=None) -> dict:
    ...
    def _create_m_update_query(self, _id: list, data: dict, columns, table=None):
        if table is None:
            table = self.table
        columns = self._sql_get_columns(columns, table=table)
        self._validate_row(data, whitelist=self.update_columns)
    ...
    async def m_update(self, id: list, data: dict, columns='*'):
        ...
        """
        sql = self._create_m_update_query(id, data, columns)
        if columns:
