    ...
    def build_extensions(self):
        ...
        try:
            self.compiler.compile(
                ['test_std_shared_ptr.cpp'], extra_preargs=['-std=c++0x']),
        ...
        try:
            self.compiler.compile(
                ['test_std_unique_ptr.cpp'], extra_preargs=['-std=c++0x']),
...
setup(name='quickfix-M1',
      version='1.15.1',
      py_modules=['quickfix', 'quickfixt11', 'quickfix40', 'quickfix41', 'quickfix42',
      ...
      ext_modules=[Extension('_quickfix', glob.glob('C++/*.cpp'), extra_compile_args=['-std=c++0x', '-Wno-deprecated',
                             '-Wno-unused-variable', '-Wno-deprecated-declarations', '-Wno-uninitialized'])],
      )
