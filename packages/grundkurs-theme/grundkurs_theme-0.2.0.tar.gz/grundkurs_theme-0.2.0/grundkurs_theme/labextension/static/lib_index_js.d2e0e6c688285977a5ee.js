                ...
                execute: async (args) => {
                    ...
                    if (current) {
                        ...
                        try {
                            ...
                            const reply = await (0,_handler__WEBPACK_IMPORTED_MODULE_6__.requestAPI)('feedback', {
...
class ContentFactoryWithFooterButton extends _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_0__.NotebookPanel.ContentFactory {
     ...
     */
    createCellFooter() {
        return new _widget__WEBPACK_IMPORTED_MODULE_7__.CellFooterWithButton(this.commands);
    }
    createMarkdownCell(options, parent) {
        ...
        if (existingCell) {
            ...
            const component = (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)(_widget__WEBPACK_IMPORTED_MODULE_7__.Component);
            react_dom__WEBPACK_IMPORTED_MODULE_5__.render(component, contentNode);
            console.log(contentNode);
            const content = existingCell.value.text + contentNode.innerHTML;
...
/* harmony export */   "MyWidget": () => (/* binding */ MyWidget)
/* harmony export */ });
...
const Component = () => react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "New React component");
function MyWidget() {
...
//# sourceMappingURL=lib_index_js.d2e0e6c688285977a5ee.js.map