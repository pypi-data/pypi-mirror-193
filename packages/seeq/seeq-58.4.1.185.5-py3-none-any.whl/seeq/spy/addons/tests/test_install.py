...
def test_install_one_tool():
    ...
    try:
        with pytest.raises(Exception, match='Only administrators may create add-on tools'):
        ...
        with pytest.raises(Exception, match='Only administrators may delete add-on tools'):
