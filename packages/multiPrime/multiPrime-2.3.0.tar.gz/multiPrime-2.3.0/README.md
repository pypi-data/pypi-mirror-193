...
`multiPrime is an error-tolerant primer design tool for broad-spectrum pathogen detection. 
It propose a solution for the minimum degeneracy degenerate primer design with error (MD-EDPD).` 
