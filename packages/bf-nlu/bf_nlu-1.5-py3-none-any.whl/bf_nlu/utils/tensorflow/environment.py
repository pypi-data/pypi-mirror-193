...
from bf_nlu.utils.tensorflow.constants import TF_DETERMINISTIC_OPS
from bf_nlu.shared.utils import io as shared_io_utils
...
def _parse_gpu_config(gpu_memory_config: Text) -> Dict[int, int]:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"'{ENV_GPU_CONFIG}' at https://bf_nlu.com/docs/bf_nlu/tuning-your-model"
