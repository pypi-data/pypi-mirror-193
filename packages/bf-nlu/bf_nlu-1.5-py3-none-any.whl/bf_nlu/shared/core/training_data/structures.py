...
class EventTypeError(bf_nluCoreException, ValueError):
    """Represents an error caused by a bf_nlu Core event not being of the expected
    type.
...
class StoryGraph:
    ...
    def fingerprint(self) -> Text:
        ...
        return bf_nlu.shared.utils.io.deep_container_fingerprint(stories_as_yaml)
