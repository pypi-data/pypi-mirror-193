...
from bf_nlu.shared.core.conversation import Dialogue
...
from bf_nlu.shared.core.slots import AnySlot, Slot

if TYPE_CHECKING:
    from bf_nlu.shared.core.events import NLUPredictionData
    from bf_nlu.shared.core.training_data.structures import Story
    from bf_nlu.shared.core.training_data.story_writer.story_writer import StoryWriter
...
class DialogueStateTracker:
    ...
    def as_story(self, include_source: bool = False) -> "Story":
        """Dump the tracker as a story in the bf_nlu Core story format.
    ...
    def fingerprint(self) -> Text:
        ...
        return bf_nlu.shared.utils.io.get_dictionary_fingerprint(data)
