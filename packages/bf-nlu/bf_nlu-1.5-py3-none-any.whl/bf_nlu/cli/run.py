...
from bf_nlu.cli.arguments import run as arguments
import bf_nlu.cli.utils
import bf_nlu.shared.utils.cli  # noqa: F401
...
def add_subparser(
    ...
    run_parser = subparsers.add_parser(
        ...
        help="Starts a bf_nlu server with your trained model.",
    )
...
def run(args: argparse.Namespace) -> None:
    ...
    args.credentials = bf_nlu.cli.utils.get_validated_path(
    ...
    try:
        bf_nlu.model.get_local_model(args.model)
    ...
    bf_nlu.shared.utils.cli.print_error(
        ...
        f"from.\n"
        f"3. Train a model before running the server using `bf_nlu train` and "
