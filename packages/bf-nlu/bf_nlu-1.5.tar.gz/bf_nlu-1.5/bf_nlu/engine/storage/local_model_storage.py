...
from bf_nlu.engine.storage.storage import ModelMetadata, ModelStorage
from bf_nlu.engine.graph import GraphModelConfiguration
from bf_nlu.engine.storage.resource import Resource
from bf_nlu.exceptions import UnsupportedModelVersionError
...
class LocalModelStorage(ModelStorage):
    ...
    def _extract_archive_to_directory(
        ...
        LocalModelStorage._assert_not_bf_nlu2_archive(temporary_directory)

    @staticmethod
    def _assert_not_bf_nlu2_archive(temporary_directory: Union[Text, Path]) -> None:
        fingerprint_file = Path(temporary_directory) / "fingerprint.json"
        if fingerprint_file.is_file():
            serialized_fingerprint = bf_nlu.shared.utils.io.read_json_file(
                fingerprint_file
            )
    ...
    def _load_metadata(directory: Path) -> ModelMetadata:
        serialized_metadata = bf_nlu.shared.utils.io.read_json_file(
    ...
    def _create_model_metadata(
        ...
        return ModelMetadata(
            ...
            bf_nlu_open_source_version=bf_nlu.__version__,
            ...
            project_fingerprint=bf_nlu.model.project_fingerprint(),
