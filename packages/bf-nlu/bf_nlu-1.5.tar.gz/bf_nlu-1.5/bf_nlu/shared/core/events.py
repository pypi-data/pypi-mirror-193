...
from bf_nlu.shared.constants import DOCS_URL_TRAINING_DATA
...
from bf_nlu.shared.exceptions import UnsupportedFeatureException
...
class Event(ABC):
    ...
    user with the assistant. Tells the `bf_nlu.shared.core.trackers.DialogueStateTracker`
    ...
    def resolve_by_type(
        ...
        for cls in bf_nlu.shared.utils.common.all_subclasses(Event):
...
class LegacyForm(ActiveLoop):
    ...
    def fingerprint(self) -> Text:
        ...
        del d["timestamp"]
        return bf_nlu.shared.utils.io.get_dictionary_fingerprint(d)
