...
from bf_nlu.cli.shell import shell
from bf_nlu.shared.utils.cli import print_success, print_error_and_exit
...
def print_train_or_instructions(args: argparse.Namespace) -> None:
    ...
    if should_train:
        ...
        print_success(
            ...
            "to the project directory and running 'bf_nlu train'."
        )
    ...
    if should_run:
        ...
        if args.no_prompt:
            print(
                ...
                "run 'bf_nlu shell' at any time inside "
...
def print_cancel() -> None:
    print_success("Ok. You can continue setting up by running 'bf_nlu init' 🙋🏽‍♀️")
    sys.exit(0)
...
def run(args: argparse.Namespace) -> None:
    ...
    print_success("Welcome to bf_nlu! 🤖\n")
    if args.no_prompt:
        print(
