...
from bf_nlu.nlu.tokenizers.spacy_tokenizer import POS_TAG_KEY, SpacyTokenizer
from bf_nlu.nlu.tokenizers.tokenizer import Token, Tokenizer
        ...
        **kwargs: Any,
        ...
        try:
            with model_storage.read_from(resource) as model_path:
                feature_to_idx_dict = bf_nlu.utils.io.json_unpickle(
