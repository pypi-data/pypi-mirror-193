...
from bf_nlu.shared.core.events import ActionExecuted, Event
    ...
    def _summarize_conflicting_actions(action: Text, stories: List[Text]) -> Text:
        ...
        if len(stories) > 3:
            ...
            raise ValueError(
                ...
                "https://github.com/bf_nluHQ/bf_nlu."
            )
...
def _get_previous_event(
    ...
    if not isinstance(previous_event_name, (str, type(None))):
        ...
        raise TypeError(
            ...
            f"None, not {type(previous_event_name)}. Did you modify bf_nlu source code?"
        )
