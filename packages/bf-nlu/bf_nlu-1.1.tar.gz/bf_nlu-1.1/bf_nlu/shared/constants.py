...
DOCS_BASE_URL = "https://bf_nlu.com/docs/bf_nlu"
LEGACY_DOCS_BASE_URL = "https://legacy-docs-v1.bf_nlu.com"
...
DOCS_URL_MIGRATION_GUIDE_MD_DEPRECATION = (
    f"{DOCS_URL_MIGRATION_GUIDE}#bf_nlu-21-to-bf_nlu-22"
)
DOCS_URL_TELEMETRY = DOCS_BASE_URL + "/telemetry/telemetry"
DOCS_BASE_URL_bf_nlu_X = "https://bf_nlu.com/docs/bf_nlu-x"
DOCS_BASE_URL_ACTION_SERVER = "https://bf_nlu.com/docs/action-server"
...
# Constants for default bf_nlu Open Source project layout
