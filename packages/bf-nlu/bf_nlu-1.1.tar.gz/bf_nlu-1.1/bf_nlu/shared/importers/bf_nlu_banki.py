...
class bf_nluFileImporter(TrainingDataImporter):
    ...
    def __init__(
        ...
        self._nlu_files = bf_nlu.shared.data.get_data_files(
            training_data_paths, bf_nlu.shared.data.is_nlu_file
        )
        self._story_files = bf_nlu.shared.data.get_data_files(
            training_data_paths, YAMLStoryReader.is_stories_file
        )
        self._conversation_test_files = bf_nlu.shared.data.get_data_files(
    ...
    def get_config(self) -> Dict:
        ...
        if not self.config_file or not os.path.exists(self.config_file):
            logger.debug("No configuration file was provided to the bf_nluFileImporter.")
            return {}

        config = bf_nlu.shared.utils.io.read_model_configuration(self.config_file)
        return config
