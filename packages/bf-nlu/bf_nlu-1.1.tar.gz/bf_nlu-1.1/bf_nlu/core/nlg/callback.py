...
from bf_nlu.core.nlg.generator import NaturalLanguageGenerator
    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        if isinstance(response, dict) and self.validate_response(response):
            ...
            raise bf_nluException("NLG web endpoint returned an invalid response.")
    ...
    def validate_response(content: Optional[Dict[Text, Any]]) -> bool:
        ...
        try:
            ...
            raise bf_nluException(
                ...
                f"https://github.com/bf_nluHQ/bf_nlu/blob/main/bf_nlu/core/nlg/callback.py"
            )
