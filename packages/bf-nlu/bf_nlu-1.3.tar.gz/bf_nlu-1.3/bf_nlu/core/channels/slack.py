...
from bf_nlu.core.channels.channel import InputChannel, OutputChannel, UserMessage
from bf_nlu.shared.constants import DOCS_URL_CONNECTORS_SLACK
...
class SlackInput(InputChannel):
    ...
    def _sanitize_user_message(
        ...
        # <mailto:xyz@bf_nlu.com|xyz@bf_nlu.com> or
