...
from bf_nlu.core.channels.channel import OutputChannel, UserMessage
from bf_nlu.core.constants import DEFAULT_REQUEST_TIMEOUT
from bf_nlu.core.http_interpreter import bf_nluNLUHttpInterpreter
from bf_nlu.shared.core.domain import Domain
from bf_nlu.core.exceptions import AgentNotReady
from bf_nlu.shared.constants import DEFAULT_SENDER_ID
from bf_nlu.core.lock_store import InMemoryLockStore, LockStore
from bf_nlu.core.nlg import NaturalLanguageGenerator, TemplatedNaturalLanguageGenerator
from bf_nlu.core.policies.policy import PolicyPrediction
from bf_nlu.core.processor import MessageProcessor
from bf_nlu.core.tracker_store import FailSafeTrackerStore, InMemoryTrackerStore
from bf_nlu.shared.core.trackers import DialogueStateTracker, EventVerbosity
from bf_nlu.exceptions import ModelNotFound
from bf_nlu.nlu.utils import is_url
...
def _load_and_set_updated_model(
    ...
    Args:
        ...
        model_directory: bf_nlu model directory.
...
async def _update_model_from_server(model_server: EndpointConfig, agent: Agent) -> None:
    """Load a zipped bf_nlu Core model from a URL and update the passed agent."""
...
async def load_agent(
    ...
    if endpoints:
        ...
        if endpoints.nlu:
            http_interpreter = bf_nluNLUHttpInterpreter(endpoints.nlu)
...
class Agent:
    """The Agent class provides an interface for the most important bf_nlu functionality.
