...
from bf_nlu.shared.exceptions import bf_nluException, ConnectionException
import bf_nlu.shared.utils.common
from bf_nlu.core.constants import DEFAULT_LOCK_LIFETIME
from bf_nlu.core.lock import TicketLock
...
class LockError(bf_nluException):
...
class RedisLockStore(LockStore):
    ...
    def __init__(
        ...
        Args:
            ...
            db: The name of the database within Redis which should be used by bf_nlu
                Open Source.
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        lock_store_class = bf_nlu.shared.utils.common.class_from_module_path(
