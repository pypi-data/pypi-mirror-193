...
from bf_nlu.nlu.featurizers.dense_featurizer.dense_featurizer import DenseFeaturizer
...
from bf_nlu.shared.nlu.constants import TEXT, ACTION_TEXT
from bf_nlu.exceptions import bf_nluException
import bf_nlu.nlu.utils
import bf_nlu.utils.train_utils as train_utils
...
class ConveRTFeaturizer(DenseFeaturizer, GraphComponent):
    ...
    def __init__(self, name: Text, config: Dict[Text, Any]) -> None:
        ...
        self.model_url = (
            model_url
            if bf_nlu.nlu.utils.is_url(model_url)
    ...
    def _validate_model_url(cls, config: Dict[Text, Any]) -> None:
        ...
        if model_url == RESTRICTED_ACCESS_URL:
            ...
            raise bf_nluException(
                ...
                f"bf_nlu Open Source only. Due to licensing issues you are "
        ...
        if not bf_nlu.nlu.utils.is_url(model_url) and not os.path.isdir(model_url):
            raise bf_nluException(
