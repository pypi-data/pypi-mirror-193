...
class FeatureArray(np.ndarray):
    """Stores any kind of features ready to be used by a bf_nluModel.
...
class bf_nluModelData:
    """Data object used for all bf_nluModels.
    ...
    def __init__(
        ...
        """
        Initializes the bf_nluModelData object.
    ...
    def split(
        ...
        Returns:
            A tuple of train and test bf_nluModelData.
        """
    ...
    def get_signature(
        ...
        """Get signature of bf_nluModelData.
    ...
    def _check_label_key(self) -> None:
        ...
        if (
            ...
            raise ValueError(
                f"Key '{self.label_key}.{self.label_sub_key}' not in bf_nluModelData."
            )
    ...
    def _convert_train_test_split(
        ...
        Returns:
            The test and train bf_nluModelData
        """
        ...
        return (
            bf_nluModelData(self.label_key, self.label_sub_key, data_train),
            bf_nluModelData(self.label_key, self.label_sub_key, data_val),
        )
