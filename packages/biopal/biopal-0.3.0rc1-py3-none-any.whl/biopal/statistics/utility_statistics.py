...
def main_covariance_estimation_SSF_SR(
    data_stack,
    cov_est_window_size,
    pixel_spacing_slant_rg,
    pixel_spacing_az,
...
def main_covariance_estimation_SSF_GR(
    data_stack,
    cov_est_window_size,
    pixel_spacing_grd_x,
    pixel_spacing_grd_y,
...
def main_correlation_estimation_SSF_SR(
    data_stack,
    cov_est_window_size,
    pixel_spacing_slant_rg,
    pixel_spacing_az,
            ...
            for az_idx in np.arange(Naz):
                matrix_out[:, :, rg_idx, az_idx] = [
                    ...
                    [
                        ...
                        vector_in[4, rg_idx, az_idx],
                    ],
                    [
                        np.conj(vector_in[2, rg_idx, az_idx]),
                        np.conj(vector_in[4, rg_idx, az_idx]),
                        vector_in[5, rg_idx, az_idx],
                    ],
                ]
    elif L == 1:
