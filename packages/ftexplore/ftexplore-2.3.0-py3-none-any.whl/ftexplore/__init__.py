...
def main():
    ...
    if remote_address is not None:
        ...
        if hwname == 'demo':
            ...
            from .hardware import didacta
            hwlist.append(didacta.HardwareDidacta())
    ...
    eventloop.run()
    if gui:
        mod_user.stop_code() # make sure that thread running code gets stopped
