...
class SnapshotManager:
	...
	def __init__(A,service_manager,data_dir):B=data_dir;A.data_dir=B;A.service_manager=service_manager;A.tracker=FileMappedDocument(os.path.join(B,'api_states.json'));A.persistence_plugin_manager=PluginManager(SnapshotPersistencePlugin.namespace)
