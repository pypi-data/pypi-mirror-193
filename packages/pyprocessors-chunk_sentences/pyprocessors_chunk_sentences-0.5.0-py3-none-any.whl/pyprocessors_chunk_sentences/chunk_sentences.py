...
class ChunkSentencesParameters(ProcessorParameters):
    unit: ChunkingUnit = Field(
        ...
        description="""Which chunking unit to use to compute boundaries, can be one of:<br/>
                            <li>`character`: group together consecutive sentences until their size is just below `chunk_char_max_length` characters.
                            <li>`token`: group together consecutive sentences until their size is just below `chunk_token_max_length` tokens.""")
