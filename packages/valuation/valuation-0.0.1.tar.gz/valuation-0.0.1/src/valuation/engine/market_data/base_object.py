...
from valuations.engine.check import BothNoneOrGiven, Length, ObjectType, Range
from valuations.engine.exceptions import QLInputError, ql_require
from valuations.engine.utils import date2year_fraction, qldate2date
...
if __type_checking__:
    ...
    from valuations.engine.check import Check
