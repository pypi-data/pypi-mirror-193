...
from valuations.engine.instrument.coupons.base_object import preload_fixing
...
from valuations.utils.other import is_ql_null_value

if __type_checking__:
    # pylint: disable=ungrouped-imports
    from valuations.engine.instrument import QLFlexibleSwap, QLFlexibleBond
    from valuations.engine.market_data import QLInterestRateSwapIndex, QLInterestRateSpreadIndex
