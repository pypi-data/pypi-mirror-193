...
from valuations.olympia.input.market_data_connection.exception import ExcelFileParsingError
from valuations.olympia.input.market_data_connection.source import EXCEL

if __type_checking__:
    # pylint: disable=ungrouped-imports
    from daa_utils.excel_io import TableData
    from valuations.olympia.input.market_data_connection.source import LocalSource
