...
from valuations.olympia.input.data_base import RequestDataBase
from valuations.olympia.input.request import ExcelRequest, OlympiaRequest
from valuations.olympia.output.result import convert_result_db, result_to_writer
...
if __type_checking__:
    ...
    from valuations.universal_output import ResultDB
