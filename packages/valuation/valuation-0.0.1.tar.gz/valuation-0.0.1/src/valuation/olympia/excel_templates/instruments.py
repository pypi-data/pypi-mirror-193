...
from valuations.olympia.excel_templates.template_generation_base import ExcelField, QLObjectDocumentationExcel, data_standard2table, get_objects, set_field_style
...
from valuations.engine.market_data.yield_curve.spread_curve import QLConstantSpreadCurve
from valuations.universal_transfer import TypeKey

if __type_checking__:
    # pylint: disable=ungrouped-imports
    from valuations.universal_transfer import Signature
    from valuations.olympia.excel_templates.template_generation_base import ExcelFieldSubStorage
