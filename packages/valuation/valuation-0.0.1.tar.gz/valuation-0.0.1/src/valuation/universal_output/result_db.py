...
from valuations.consts import result
from valuations.global_settings import __type_checking__
from valuations.universal_output import ResultLineAmount
from valuations.utils.input_output import JSONType, to_json

if __type_checking__:
    # pylint: disable=ungrouped-imports
    from valuations.universal_output import ResultLine, SafeAny
