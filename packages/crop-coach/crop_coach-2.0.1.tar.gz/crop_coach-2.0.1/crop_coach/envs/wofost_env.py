...
class WofostEnv(gym.Env):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.tot_days = Agromanager_dict["max_duration"]
    ...
    def step(self, action):
        ...
        self.tot_days =  calculate_days(self.Agromanager_dict["campaign_start_date"], self.Agromanager_dict["harvest_date"], self.year)
        ...
        irrigation_freq = denormalize_frequencies_action(action[4], self.tot_days)
        fertilization_freq = denormalize_frequencies_action(action[5], self.tot_days)
        ...
        # site_dict = sample_site_dict()
        # soil_dict = sample_soil_dict()
        ...
        params, wdp, config, site_soil_params = Wofost.init_wofost(
        ...
        #  concatinate the state with site_soil_params into state
        self.state = np.concatenate((self.state, site_soil_params), axis=None)
