...
class MergeDebt:
    ...
    def validate_match(self, match: MatchResult):
        ...
        if match.head.sorted_numstat != match.base.sorted_numstat:
            if match.confidence in self.prunable_confidences:
                ...
                self._report.append_alert(MergeDebtAlert.info(
                    match,
                    "Files changes / numstats do not match!",
                ))
    ...
    def execute_matcher(self, matcher: Matcher, prune=True):
        ...
        for match in sub_matches:
            ...
            self._report.append_match(match)
    ...
    def execute_pruner(self, pruner: Pruner):
        ...
        for entry in head_prunes:
            ...
            self._report.append_head_prune(entry)
        for entry in base_prunes:
            self.prune_base_sha(entry.sha)
            self._report.append_base_prune(entry)
    ...
    def from_tree(  # pylint: disable=too-many-arguments
        ...
        head_ref: str,
        base_ref: str,
        prunable_confidences: MatchConfidence = None,
    ):
        ...
        Args:
            ...
            prunable_confidences (MatchConfidence, optional): The match confidences
                that can be pruned. Defaults to None.
        ...
        return MergeDebt(
            ...
            prunable_confidences=prunable_confidences,
        )
