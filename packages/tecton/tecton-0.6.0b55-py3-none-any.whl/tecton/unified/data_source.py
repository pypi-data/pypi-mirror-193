...
from tecton.unified import data_frame
...
class DataSource(unified_common.BaseTectonObject, internal_fco.Fco):
    ...
    def data_delay(self) -> Optional[datetime.timedelta]:
        """The Data Source's batch data delay, if set."""
        if self._spec is not None:
...
class PushSource(DataSource):
    """A Tecton PushSource, used to configure the Tecton online ingest API use in a StreamFeatureView.
    ...
    def __init__(
        ...
        *,
        ...
        :param tags: Tags associated with this Tecton Object (key-value pairs of arbitrary metadata).
        :param owner: Owner name (typically the email of the primary maintainer).
        :param batch_config: An optional BatchConfig object containing the configuration of the batch data source that is to be included
            in this DataSource. If present, it must contain at least all the columns defined in the schema.
        """
        from tecton.cli import common as cli_common
