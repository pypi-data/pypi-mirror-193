...
from tecton.unified.dataset import Dataset
...
class Workspace:
    ...
    @sdk_public_method
    def get_feature_view(self, name: str) -> unified_feature_view.FeatureView:
        ...
        if feature_view_spec is None:
            raise errors.TectonValidationError(
                f"Feature View '{name}' not found. Try running `workspace.list_feature_view()` to view all registered Feature Views."
            )
        ...
        return unified_feature_view.feature_view_from_spec(feature_view_spec, fco_container)

    @sdk_public_method
    def get_feature_table(self, name: str) -> unified_feature_view.FeatureTable:
    ...
    @sdk_public_method
    def get_feature_service(self, name: str) -> unified_feature_service.FeatureService:
    ...
    def get_data_source(
        self, name: str
    ) -> Union[unified_data_source.PushSource, unified_data_source.BatchSource, unified_data_source.StreamSource,]:
    ...
    @sdk_public_method
    def get_entity(self, name: str) -> unified_entity.Entity:
    ...
    @sdk_public_method
    def get_transformation(self, name: str) -> unified_transformation.Transformation:
