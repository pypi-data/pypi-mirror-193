...
pub const COMPILATION_DATE: &str = "Feb 22 2023";
pub const COMPILATION_TIME: &str = "16:15:38";
...
pub const COMPILER_VERSION: &str = "1.61.0";
pub const LIBPNG_VERSION: &str = "image-0.24";
...
pub const COMPRESSION_TYPES: [image::codecs::png::CompressionType; 3] = [image::codecs::png::CompressionType::Default,image::codecs::png::CompressionType::Best,image::codecs::png::CompressionType::Fast];
