...
_RESULT_OBSERVATION = _RESULT.nested_types_by_name['Observation']
_RESULT_OBSERVATION_MEASUREMENT = _RESULT_OBSERVATION.nested_types_by_name['Measurement']
_RESULTGETREQUEST = DESCRIPTOR.message_types_by_name['ResultGetRequest']
_RESULTGETRESPONSE = DESCRIPTOR.message_types_by_name['ResultGetResponse']
_RESULTEXPORTREQUEST = DESCRIPTOR.message_types_by_name['ResultExportRequest']
_RESULTEXPORTRESPONSE = DESCRIPTOR.message_types_by_name['ResultExportResponse']
_RESULT_OBSERVATION_STATUS = _RESULT_OBSERVATION.enum_types_by_name['Status']
_RESULTEXPORTREQUEST_EXPORTTYPE = _RESULTEXPORTREQUEST.enum_types_by_name['ExportType']
_RESULTEXPORTREQUEST_FILETYPE = _RESULTEXPORTREQUEST.enum_types_by_name['FileType']
...
_RESULTAPI = DESCRIPTOR.services_by_name['ResultApi']
