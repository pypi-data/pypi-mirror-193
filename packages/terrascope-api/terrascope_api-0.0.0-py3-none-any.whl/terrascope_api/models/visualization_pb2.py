...
_VISUALIZATION_ACCESSINFO = _VISUALIZATION.nested_types_by_name['AccessInfo']
_VISUALIZATIONGETREQUEST = DESCRIPTOR.message_types_by_name['VisualizationGetRequest']
_VISUALIZATIONGETRESPONSE = DESCRIPTOR.message_types_by_name['VisualizationGetResponse']
_VISUALIZER = DESCRIPTOR.message_types_by_name['Visualizer']
_VISUALIZERCONFIG = DESCRIPTOR.message_types_by_name['VisualizerConfig']
_VISUALIZERCONFIGALGO = DESCRIPTOR.message_types_by_name['VisualizerConfigAlgo']
_VISUALIZERCONFIGALGOGETREQUEST = DESCRIPTOR.message_types_by_name['VisualizerConfigAlgoGetRequest']
_VISUALIZERCONFIGALGOGETRESPONSE = DESCRIPTOR.message_types_by_name['VisualizerConfigAlgoGetResponse']
_VISUALIZATION_TYPE = _VISUALIZATION.enum_types_by_name['Type']
_VISUALIZATION_STATE = _VISUALIZATION.enum_types_by_name['State']
_VISUALIZER_VISUALIZERTYPE = _VISUALIZER.enum_types_by_name['VisualizerType']
...
Visualizer = _reflection.GeneratedProtocolMessageType('Visualizer', (_message.Message,), {
  'DESCRIPTOR' : _VISUALIZER,
  '__module__' : 'visualization_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.visualization.Visualizer)
  })
_sym_db.RegisterMessage(Visualizer)

VisualizerConfig = _reflection.GeneratedProtocolMessageType('VisualizerConfig', (_message.Message,), {
  'DESCRIPTOR' : _VISUALIZERCONFIG,
  '__module__' : 'visualization_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.visualization.VisualizerConfig)
  })
_sym_db.RegisterMessage(VisualizerConfig)

VisualizerConfigAlgo = _reflection.GeneratedProtocolMessageType('VisualizerConfigAlgo', (_message.Message,), {
  'DESCRIPTOR' : _VISUALIZERCONFIGALGO,
  '__module__' : 'visualization_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.visualization.VisualizerConfigAlgo)
  })
_sym_db.RegisterMessage(VisualizerConfigAlgo)

VisualizerConfigAlgoGetRequest = _reflection.GeneratedProtocolMessageType('VisualizerConfigAlgoGetRequest', (_message.Message,), {
  'DESCRIPTOR' : _VISUALIZERCONFIGALGOGETREQUEST,
  '__module__' : 'visualization_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.visualization.VisualizerConfigAlgoGetRequest)
  })
_sym_db.RegisterMessage(VisualizerConfigAlgoGetRequest)

VisualizerConfigAlgoGetResponse = _reflection.GeneratedProtocolMessageType('VisualizerConfigAlgoGetResponse', (_message.Message,), {
  'DESCRIPTOR' : _VISUALIZERCONFIGALGOGETRESPONSE,
  '__module__' : 'visualization_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.visualization.VisualizerConfigAlgoGetResponse)
  })
_sym_db.RegisterMessage(VisualizerConfigAlgoGetResponse)

_VISUALIZATIONAPI = DESCRIPTOR.services_by_name['VisualizationApi']
