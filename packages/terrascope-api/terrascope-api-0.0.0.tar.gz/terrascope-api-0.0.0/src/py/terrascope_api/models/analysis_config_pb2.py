...
_ANALYSISCONFIG = DESCRIPTOR.message_types_by_name['AnalysisConfig']
_ANALYSISCONFIGCREATEREQUEST = DESCRIPTOR.message_types_by_name['AnalysisConfigCreateRequest']
_ANALYSISCONFIGCREATERESPONSE = DESCRIPTOR.message_types_by_name['AnalysisConfigCreateResponse']
_ANALYSISCONFIGUPDATEREQUEST = DESCRIPTOR.message_types_by_name['AnalysisConfigUpdateRequest']
_ANALYSISCONFIGUPDATERESPONSE = DESCRIPTOR.message_types_by_name['AnalysisConfigUpdateResponse']
_ANALYSISCONFIGGETREQUEST = DESCRIPTOR.message_types_by_name['AnalysisConfigGetRequest']
_ANALYSISCONFIGGETRESPONSE = DESCRIPTOR.message_types_by_name['AnalysisConfigGetResponse']
_ANALYSISCONFIGLISTREQUEST = DESCRIPTOR.message_types_by_name['AnalysisConfigListRequest']
_ANALYSISCONFIGLISTRESPONSE = DESCRIPTOR.message_types_by_name['AnalysisConfigListResponse']
_ANALYSISCONFIGDEACTIVATEREQUEST = DESCRIPTOR.message_types_by_name['AnalysisConfigDeactivateRequest']
_ANALYSISCONFIGDEACTIVATERESPONSE = DESCRIPTOR.message_types_by_name['AnalysisConfigDeactivateResponse']
...
AnalysisConfigUpdateRequest = _reflection.GeneratedProtocolMessageType('AnalysisConfigUpdateRequest', (_message.Message,), {
  'DESCRIPTOR' : _ANALYSISCONFIGUPDATEREQUEST,
  '__module__' : 'analysis_config_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.AnalysisConfigUpdateRequest)
  })
_sym_db.RegisterMessage(AnalysisConfigUpdateRequest)

AnalysisConfigUpdateResponse = _reflection.GeneratedProtocolMessageType('AnalysisConfigUpdateResponse', (_message.Message,), {
  'DESCRIPTOR' : _ANALYSISCONFIGUPDATERESPONSE,
  '__module__' : 'analysis_config_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.AnalysisConfigUpdateResponse)
  })
_sym_db.RegisterMessage(AnalysisConfigUpdateResponse)
...
AnalysisConfigDeactivateRequest = _reflection.GeneratedProtocolMessageType('AnalysisConfigDeactivateRequest', (_message.Message,), {
  'DESCRIPTOR' : _ANALYSISCONFIGDEACTIVATEREQUEST,
  '__module__' : 'analysis_config_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.AnalysisConfigDeactivateRequest)
  })
_sym_db.RegisterMessage(AnalysisConfigDeactivateRequest)

AnalysisConfigDeactivateResponse = _reflection.GeneratedProtocolMessageType('AnalysisConfigDeactivateResponse', (_message.Message,), {
  'DESCRIPTOR' : _ANALYSISCONFIGDEACTIVATERESPONSE,
  '__module__' : 'analysis_config_pb2'
  # @@protoc_insertion_point(class_scope:oi.papi.AnalysisConfigDeactivateResponse)
  })
_sym_db.RegisterMessage(AnalysisConfigDeactivateResponse)

_ANALYSISCONFIGAPI = DESCRIPTOR.services_by_name['AnalysisConfigApi']
