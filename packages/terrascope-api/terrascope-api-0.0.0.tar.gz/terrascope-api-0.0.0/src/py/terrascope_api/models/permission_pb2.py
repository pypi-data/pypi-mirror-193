...
_PERMISSIONCREATEREQUEST = DESCRIPTOR.message_types_by_name['PermissionCreateRequest']
_PERMISSIONCREATERESPONSE = DESCRIPTOR.message_types_by_name['PermissionCreateResponse']
_PERMISSIONDELETEREQUEST = DESCRIPTOR.message_types_by_name['PermissionDeleteRequest']
_PERMISSIONDELETERESPONSE = DESCRIPTOR.message_types_by_name['PermissionDeleteResponse']
_PERMISSION_RESOURCETYPE = _PERMISSION.enum_types_by_name['ResourceType']
_PERMISSION_PERMISSIONTYPE = _PERMISSION.enum_types_by_name['PermissionType']
_PERMISSION_COLLECTIONTYPE = _PERMISSION.enum_types_by_name['CollectionType']
...
_PERMISSIONAPI = DESCRIPTOR.services_by_name['PermissionApi']
