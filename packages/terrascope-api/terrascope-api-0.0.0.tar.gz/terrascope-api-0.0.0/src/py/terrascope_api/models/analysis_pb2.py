...
_ANALYSISALGORITHMNODE = DESCRIPTOR.message_types_by_name['AnalysisAlgorithmNode']
_ANALYSISCREATEREQUEST = DESCRIPTOR.message_types_by_name['AnalysisCreateRequest']
_ANALYSISCREATERESPONSE = DESCRIPTOR.message_types_by_name['AnalysisCreateResponse']
_ANALYSISALGORITHMCONFIGNODE = DESCRIPTOR.message_types_by_name['AnalysisAlgorithmConfigNode']
_ANALYSISGETREQUEST = DESCRIPTOR.message_types_by_name['AnalysisGetRequest']
_ANALYSIS = DESCRIPTOR.message_types_by_name['Analysis']
_ANALYSISGETRESPONSE = DESCRIPTOR.message_types_by_name['AnalysisGetResponse']
_ANALYSISLISTREQUEST = DESCRIPTOR.message_types_by_name['AnalysisListRequest']
_ANALYSISLISTRESPONSE = DESCRIPTOR.message_types_by_name['AnalysisListResponse']
...
_ANALYSISAPI = DESCRIPTOR.services_by_name['AnalysisApi']
