...
def parse_args():
    ...
    parser.add_argument(
        "input",
        type=str,
        help="Input is raw count data in TSV/CSV "
    ...
    parser.add_argument(
        "outputdir", type=str, help="The path of the output directory"
    )
    ...
    parser.add_argument(
        ...
        dest="testsplit",
        action="store_true",
        help="Use one fold as a test set (default: False)",
    )
    ...
    parser.add_argument(
        ...
        dest="sizefactors",
        action="store_true",
        help="Normalize means by library size (default: True)",
    )
    parser.add_argument(
        "--nosizefactors",
        dest="sizefactors",
        action="store_false",
        help="Do not normalize means by library size",
    )
    parser.add_argument(
        "--norminput",
        dest="norminput",
        action="store_true",
        help="Zero-mean normalize input (default: True)",
    )
    parser.add_argument(
        "--nonorminput",
        dest="norminput",
        action="store_false",
        help="Do not zero-mean normalize inputs",
    )
    parser.add_argument(
        "--loginput",
        dest="loginput",
        action="store_true",
        help="Log-transform input (default: True)",
    )
    parser.add_argument(
        "--nologinput",
        dest="loginput",
        action="store_false",
        help="Do not log-transform inputs",
    )
    parser.add_argument(
        "-d",
        "--dropoutrate",
    ...
    parser.add_argument(
        ...
        dest="saveweights",
        action="store_true",
        help="Save weights (default: False)",
    )
    parser.add_argument(
        "--no-saveweights",
        dest="saveweights",
        action="store_false",
        help="Do not save weights",
    )
    parser.add_argument(
        "--hyper",
        dest="hyper",
        action="store_true",
        help="Optimizer hyperparameters (default: False)",
    )
    parser.add_argument(
        "--hypern",
        dest="hypern",
    ...
    parser.add_argument(
        ...
        dest="debug",
        action="store_true",
        help="Enable debugging. Checks whether every term in "
    ...
    parser.add_argument(
        ...
        dest="tensorboard",
        action="store_true",
        help="Use tensorboard for saving weight distributions and "
