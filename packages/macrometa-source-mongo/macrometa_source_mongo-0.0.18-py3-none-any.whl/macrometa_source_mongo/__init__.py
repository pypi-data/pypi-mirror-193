...
from macrometa_source_mongo.config_utils import validate_config, create_certficate_files, delete_certficate_files
...
def main_impl():
    ...
    config = delete_certficate_files(config)
    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty('tls_ca_file', 'SSL/TLS CA Certificate', ConfigAttributeType.STRING, False, False,
                           description='Specifies the path to use a specific set of CA certificates. This is most often the case '
                                       'when using “self-signed”server certificates. The ssl_ca_certs option takes a path to a CA file.',
            ...
            ConfigProperty('tls_certificate_key_file', 'SSL/TLS Client Certificate', ConfigAttributeType.STRING, False, False,
                           description='Specifies the path to use a specific client certificate. If the private key for the client '
