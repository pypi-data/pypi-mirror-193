...
@LastEditTime: 2023-02-20 15:10:50
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_client_task_list_v2(self, app_id, act_id, module_id, user_id, task_types="", app_key="", app_secret="", is_log=False, daily_repeat_browse=False, mix_nick=""):
        """
        :description: 获取任务列表
        :param app_id:应用标识
        :param act_id:活动标识
        ...
        for task_info_dict in task_info_list:
            ...
            #邀请新用户
                ...
                invite_log_list = invite_log_model.get_cache_dict_list("act_id=%s and user_id=%s and create_day=%s", "", order_by="id desc", field="invite_avatar", params=[act_id, user_id, SevenHelper.get_now_day_int()], dependency_key=f"invite_log_list:actid_{act_id}_userid_{user_id}")
            ...
            #邀请加入会员
                ...
                invite_log_list = invite_log_model.get_cache_dict_list("act_id=%s and user_id=%s and create_day=%s", "", order_by="id desc", field="invite_avatar", params=[act_id, user_id, SevenHelper.get_now_day_int()], dependency_key=f"invite_log_member_list:actid_{act_id}_userid_{user_id}")
                result["data"] = invite_log_list if len(invite_log_list) > 0 else []
    ...
    def process_join_member(self,app_id,act_id,module_id,user_id,login_token,handler_name,access_token,app_key,app_secret,request_code,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,mix_nick=''):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                elif top_base_model.check_is_member(mix_nick,'',access_token,app_key, app_secret) == False:
                    invoke_result_data.success = False
                    invoke_result_data.error_code = "error"
                    invoke_result_data.error_message = "用户还不是会员"
                else:
