...
class Position(_message.Message):
    __slots__ = ["editable", "employer_key", "key"]
    EDITABLE_FIELD_NUMBER: _ClassVar[int]
    EMPLOYER_KEY_FIELD_NUMBER: _ClassVar[int]
    KEY_FIELD_NUMBER: _ClassVar[int]
    editable: PositionsEditable
    employer_key: ProfileKey
    key: PositionKey
    def __init__(self, key: _Optional[_Union[PositionKey, _Mapping]] = ..., employer_key: _Optional[_Union[ProfileKey, _Mapping]] = ..., editable: _Optional[_Union[PositionsEditable, _Mapping]] = ...) -> None: ...
...
class UpdatePositionRequest(_message.Message):
    __slots__ = ["editable", "key"]
    EDITABLE_FIELD_NUMBER: _ClassVar[int]
    KEY_FIELD_NUMBER: _ClassVar[int]
    editable: PositionsEditable
