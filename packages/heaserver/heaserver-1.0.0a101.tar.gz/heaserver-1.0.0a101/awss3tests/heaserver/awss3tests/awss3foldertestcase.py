...
db_values = {CollectionKey(name='folders_items', db_manager_cls=MockS3ManagerWithMockMongo): [
    ...
    CollectionKey(name='components', db_manager_cls=MockS3ManagerWithMockMongo): [
        {
    ...
    CollectionKey(name='filesystems', db_manager_cls=MockS3ManagerWithMockMongo): [{
        'id': '666f6f2d6261722d71757578',
        'created': None,
        'derived_by': None,
        'derived_from': [],
    ...
    CollectionKey(name='volumes', db_manager_cls=MockS3ManagerWithMockMongo): [{
        ...
        'credential_id': "0123456789ab0123456789ab"  # Let boto3 try to find the user's credentials.
    }],
    ...
    CollectionKey(name='awsaccounts', db_manager_cls=MockS3ManagerWithMockMongo): [
        {
    ...
    CollectionKey(name='awss3folders', db_manager_cls=MockS3ManagerWithMockMongo): [{
        'created': '2022-05-17T00:00:00+00:00',
        'derived_by': None,
        'derived_from': [],
        'description': None,
    ...
    CollectionKey(name='properties', db_manager_cls=MockS3ManagerWithMockMongo): [{
        ...
        "created": "2022-05-17T00:00:00+00:00",
        "owner": "1439c98f-0405-4cb9-b33b-dcefc95e9e28",
        "shares": [
            {
    ...
    CollectionKey(name='credentials', db_manager_cls=MockS3ManagerWithMockMongo): [
        {
...
class AWSS3ItemTestCase(
    microservicetestcase.get_test_case_cls_default(
        ...
        duplicate_action_actions=[
            expectedvalues.Action(
                name='heaserver-awss3folders-item-get-item',
                url='http://localhost:8080/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/{id}',
                rel=['headata-destination'])
        ],
        exclude=['body_put'])
):
