...
class ChineseDailyNerCorpus:
    ...
    Example:
        >>> from kolibri.backend.tensorflow.corpus import ChineseDailyNerCorpus
    ...
    __zip_file__name = 'http://s3.bmio.net/kolibri/china-people-daily-ner-corpus.tar.gz'
...
class SMP2018ECDTCorpus:
    ...
    Example:
        >>> from kolibri.backend.tensorflow.corpus import SMP2018ECDTCorpus
    ...
    __zip_file__name = 'http://s3.bmio.net/kolibri/SMP2018ECDTCorpus.tar.gz'
...
class JigsawToxicCommentCorpus:
    ...
    Examples:
        ...
        >>> from kolibri.backend.tensorflow.corpus import JigsawToxicCommentCorpus
