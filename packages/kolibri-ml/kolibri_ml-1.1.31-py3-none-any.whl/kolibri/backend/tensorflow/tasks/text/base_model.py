...
class TextBaseModel(TaskBaseModel):
    ...
    def fit(self, x_train, y_train, x_validate=None, y_validate=None,
        ...
        train_gen = DataGenerator(x_train, y_train, max_position=self.embedding.max_position, segment=self.embedding.segment)
        if x_validate is not None:
            valid_gen = DataGenerator(x_validate, y_validate, max_position=self.embedding.max_position, segment=self.embedding.segment)
        else:
            valid_gen = None
