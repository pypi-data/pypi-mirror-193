...
from kolibri.backend.tensorflow.layers.layer import Layer
from kolibri.backend.tensorflow.layers.bert_embeddings import BertEmbeddingsLayer
from kolibri.backend.tensorflow.transformer import TransformerEncoderLayer
...
class BertModelLayer(Layer):
    ...
    def _construct(self, **kwargs):
        ...
        # create all transformer encoders sub-layers
