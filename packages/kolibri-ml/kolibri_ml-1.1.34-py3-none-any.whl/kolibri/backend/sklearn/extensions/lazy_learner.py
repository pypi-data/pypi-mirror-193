...
#            y_pred=estimator.predict([X[0][self._feature_importance[:self.nb_features_to_keep]]])
    ...
    def _fit_local_model(self, X_train, y_train, estimator, get_feature_importance=False, important_features=None):
        ...
        categorical_features=[c for c in self. categorical_features if c in X_train_df.columns]
    ...
    def _predict_local_model(self, X_test, estimator, important_features=None):
        ...
        categorical_features=[c for c in self. categorical_features if c in X_test_df.columns]
        for col in categorical_features:
