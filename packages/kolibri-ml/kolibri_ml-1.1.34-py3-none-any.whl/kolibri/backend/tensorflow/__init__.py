...
def dependency_check() -> None:
    ...
    try:
        ...
        raise ImportError(
            "Kolibri request tensorflow_addons, please install via the "
...
from kolibri.backend.tensorflow import layers
# from kolibri.backend.tensorflow.__version__ import __version__
# from kolibri.backend.tensorflow.macros import config
