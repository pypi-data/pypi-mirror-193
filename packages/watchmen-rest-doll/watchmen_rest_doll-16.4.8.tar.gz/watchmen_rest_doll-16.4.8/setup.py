...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-lineage==16.4.8',
 'watchmen-pipeline-surface==16.4.8']

extras_require = \
{'boto3': ['boto3>=1.24.20,<2.0.0'],
 'collector': ['watchmen-collector-surface==16.4.8'],
 ...
 'mysql': ['watchmen-storage-mysql==16.4.8', 'cryptography>=36.0.2,<37.0.0'],
