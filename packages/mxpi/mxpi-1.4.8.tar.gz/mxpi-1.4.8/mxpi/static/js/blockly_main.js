...
resizeOpacity: 1,
  ...
  $("#sshmodel").on("click", function(event){
    var sshaddr=window.location.origin
    document.getElementById('ssh_').innerHTML='<iframe src="'+sshaddr+':8888" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>'
