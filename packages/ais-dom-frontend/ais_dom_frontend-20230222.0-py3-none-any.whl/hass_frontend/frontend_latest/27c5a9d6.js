"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[70115],{73139:(e,t,r)=>{var i=r(50856),o=r(28426);r(29925),r(46998);class s extends o.H3{static get template(){return i.d`
    ...
    `}},{kind:"method",key:"_updateSliderValues",value:function(){const e=this.stateObj;if("on"===(null==e?void 0:e.state)){if(this._brightnessAdjusted=void 0,e.attributes.color_mode===c.ZE.RGB&&!(0,c.Fe)(e,c.ZE.RGBWW)&&!(0,c.Fe)(e,c.ZE.RGBW)){const t=Math.max(...e.attributes.rgb_color);t<255&&(this._brightnessAdjusted=t)}this._ctSliderValue=e.attributes.color_temp_kelvin,this._wvSliderValue=e.attributes.color_mode===c.ZE.RGBW?Math.round(100*e.attributes.rgbw_color[3]/255):void 0,this._cwSliderValue=e.attributes.color_mode===c.ZE.RGBWW?Math.round(100*e.attributes.rgbww_color[3]/255):void 0,this._wwSliderValue=e.attributes.color_mode===c.ZE.RGBWW?Math.round(100*e.attributes.rgbww_color[4]/255):void 0;const t=(0,c.cE)(e);this._colorBrightnessSliderValue=t?Math.round(100*Math.max(...t.slice(0,3))/255):void 0,this._colorPickerColor=null==t?void 0:t.slice(0,3)}else this._colorPickerColor=[0,0,0],this._ctSliderValue=void 0,this._wvSliderValue=void 0,this._cwSliderValue=void 0,this._wwSliderValue=void 0}},{kind:"method",key:"willUpdate",value:function(e){if(w(k(r.prototype),"willUpdate",this).call(this,e),e.has("params")&&e.has("hass")){if(e.has("params")){const e=(0,c.Fe)(this.stateObj,c.ZE.COLOR_TEMP),t=[];(0,c.Yk)(this.stateObj)&&t.push("color"),e&&t.push("color_temp"),this._modes=t,this._mode=this.stateObj.attributes.color_mode===c.ZE.COLOR_TEMP?c.ZE.COLOR_TEMP:"color"}this._updateSliderValues()}}},{kind:"method",key:"_handleTabChanged",value:function(e){const t=this._modes[e.detail.index];t!==this._mode&&(this._mode=t)}},{kind:"method",key:"_ctSliderChanged",value:function(e){const t=e.detail.value;isNaN(t)||(this._ctSliderValue=t,this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,color_temp_kelvin:t}))}},{kind:"method",key:"_wvSliderChanged",value:function(e){const t=e.target;let r=Number(t.value);const i=t.name;if(isNaN(r))return;"wv"===i?this._wvSliderValue=r:"cw"===i?this._cwSliderValue=r:"ww"===i&&(this._wwSliderValue=r),r=Math.min(255,Math.round(255*r/100));const o=(0,c.cE)(this.stateObj);if("wv"===i){const e=o||[0,0,0,0];return e[3]=r,void this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,rgbw_color:e})}const s=o||[0,0,0,0,0];for(;s.length<5;)s.push(0);s["cw"===i?3:4]=r,this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,rgbww_color:s})}},{kind:"method",key:"_colorBrightnessSliderChanged",value:function(e){var t;const r=e.target;let i=Number(r.value);if(isNaN(i))return;const o=this._colorBrightnessSliderValue;this._colorBrightnessSliderValue=i,i=255*i/100;const s=(null===(t=(0,c.cE)(this.stateObj))||void 0===t?void 0:t.slice(0,3))||[255,255,255];this._setRgbWColor(this._adjustColorBrightness(o?this._adjustColorBrightness(s,255*o/100,!0):s,i))}},{kind:"method",key:"_segmentClick",value:function(){24===this._hueSegments&&8===this._saturationSegments?(this._hueSegments=0,this._saturationSegments=0):(this._hueSegments=24,this._saturationSegments=8)}},{kind:"method",key:"_adjustColorBrightness",value:function(e,t,r=!1){if(void 0!==t&&255!==t){let i=t/255;r&&(i=1/i),e[0]=Math.min(255,Math.round(e[0]*i)),e[1]=Math.min(255,Math.round(e[1]*i)),e[2]=Math.min(255,Math.round(e[2]*i))}return e}},{kind:"method",key:"_setRgbWColor",value:function(e){if((0,c.Fe)(this.stateObj,c.ZE.RGBWW)){const t=this.stateObj.attributes.rgbww_color?[...this.stateObj.attributes.rgbww_color]:[0,0,0,0,0];this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,rgbww_color:e.concat(t.slice(3))})}else if((0,c.Fe)(this.stateObj,c.ZE.RGBW)){const t=this.stateObj.attributes.rgbw_color?[...this.stateObj.attributes.rgbw_color]:[0,0,0,0];this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,rgbw_color:e.concat(t.slice(3))})}}},{kind:"method",key:"_colorPicked",value:function(e){if(this._colorPickerColor=[e.detail.rgb.r,e.detail.rgb.g,e.detail.rgb.b],(0,c.Fe)(this.stateObj,c.ZE.RGBWW)||(0,c.Fe)(this.stateObj,c.ZE.RGBW))this._setRgbWColor(this._colorBrightnessSliderValue?this._adjustColorBrightness([e.detail.rgb.r,e.detail.rgb.g,e.detail.rgb.b],255*this._colorBrightnessSliderValue/100):[e.detail.rgb.r,e.detail.rgb.g,e.detail.rgb.b]);else if((0,c.Fe)(this.stateObj,c.ZE.RGB)){const t=[e.detail.rgb.r,e.detail.rgb.g,e.detail.rgb.b];if(this._brightnessAdjusted){const e=this._brightnessAdjusted/255*100,r=Math.round((this.stateObj.attributes.brightness||0)*e/255);this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,brightness_pct:r,rgb_color:this._adjustColorBrightness(t,this._brightnessAdjusted,!0)})}else this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,rgb_color:t})}else this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,hs_color:[e.detail.hs.h,100*e.detail.hs.s]})}},{kind:"get",static:!0,key:"styles",value:function(){return[d.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=27c5a9d6.js.map