...
class TestAssist(object):
    ...
    def TA_WaitForTextEvent(self, text: 'str', time_out_ms: 'int') -> 'int':
        ...
        :return: int\n
            ...
            - 2 线程拿不到 Event 对象\n
        '''
        if (text not in TestAssist.TA_TEXT_EVENT_DICT.keys()):
            TestAssist.TA_TEXT_EVENT_DICT[text] = threading.Event()
        event_ = TestAssist.TA_TEXT_EVENT_DICT[text]
