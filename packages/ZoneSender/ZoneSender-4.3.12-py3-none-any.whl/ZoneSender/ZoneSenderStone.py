...
class ZoneSenderStone(ZoneSenderFramework):
    ...
    def Subscribe(self, obj) -> None:
        ...
        if (isinstance(obj_, CanMessage)):
            ...
            print("DiagnosticEcuInfo_DoIP unsubscribe")
    ...
    def OnSomeipCalling(self, timestamp, someip_in: SomeipPackage, someip_out: SomeipPackage, is_response:bool = True) -> None:
        ''' [需要用户重写实现定制功能]\n
