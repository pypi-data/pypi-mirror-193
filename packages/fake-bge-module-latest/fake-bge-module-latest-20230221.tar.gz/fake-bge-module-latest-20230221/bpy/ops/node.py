...
def collapse_hide_unused_toggle():
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py\:165 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/node.py$165> _
...
def gltf_settings_node_operator():
    ''' Add a node to the active tree for glTF export :file: addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py\:29 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py$29> _
...
def new_geometry_node_group_assign():
    ''' Create a new geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:229 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/geometry_nodes.py$229> _
...
def new_geometry_nodes_modifier():
    ''' Create a new modifier with a new geometry node group :file: startup/bl_operators/geometry_nodes.py\:207 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/geometry_nodes.py$207> _
...
def tree_path_parent():
    ''' Go to parent node tree :file: startup/bl_operators/node.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/node.py$195> _
