...
def play_rendered_anim():
    ''' Play back rendered frames/movies using an external player :file: startup/bl_operators/screen_play_rendered_anim.py\:64 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/screen_play_rendered_anim.py$64> _
