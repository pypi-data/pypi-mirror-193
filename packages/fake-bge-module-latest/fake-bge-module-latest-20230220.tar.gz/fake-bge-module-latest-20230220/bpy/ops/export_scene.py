...
def gltf(filepath: str = "",
         ...
         export_animation_mode: typing.Union[int, str] = 'ACTIONS',
         ...
         export_negative_frame: typing.Union[int, str] = 'SLIDE',
    ...
    :type export_animation_mode: typing.Union[int, str]
    ...
    :type export_negative_frame: typing.Union[int, str]
