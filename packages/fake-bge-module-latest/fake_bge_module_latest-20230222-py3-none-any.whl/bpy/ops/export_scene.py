...
def gltf(filepath: str = "",
         ...
         export_animation_mode: typing.Union[str, int] = 'ACTIONS',
         ...
         export_negative_frame: typing.Union[str, int] = 'SLIDE',
    ...
    :type export_animation_mode: typing.Union[str, int]
    ...
    :type export_negative_frame: typing.Union[str, int]
