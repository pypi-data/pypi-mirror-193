...
def select_next_item():
    ''' Select the next element (using selection order) :file: startup/bl_operators/mesh.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/mesh.py$195> _
...
def select_prev_item():
    ''' Select the previous element (using selection order) :file: startup/bl_operators/mesh.py\:220 <https://projects.blender.org/blender/blender/src/branch/main/release/scripts/startup/bl_operators/mesh.py$220> _
