...
class RatioSpreadSeries(OneAssetOptionBase):
    ...
    def __calculate_present_value__(self) -> float:
        ...
        for obs in self.param.obs_date:
            ...
            param['bid_volatility'] = self.param.bid_volatility
            param['ofr_volatility'] = self.param.ofr_volatility
            ...
            rst = rst + ratio_spread.present_value() / float(len(self.param.obs_date))
        return rst
