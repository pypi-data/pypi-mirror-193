...
from .muti_asset_pricing_module import *
...
class SimplePricerEngine:
    ...
    def ratio_spread(
            ...
            expiry_date:                Union[int, float],
            current_date:               Union[int, float],
            bid_volatility:             Union[int, float],
            ofr_volatility:             Union[int, float],
            riskfree_rate:              Union[int, float],
            dividend:                   Union[int, float],
            year_base:                  int,
            exercise_type:              int = ExerciseType.EUROPEAN,
        ...
        :param expiry_date: 到期日
        :param current_date: 当前日
        :param bid_volatility: bid波动率
        :param ofr_volatility: ofr波动率
        :param riskfree_rate: 无风险利率
        :param dividend: 分红率
        :param year_base: 年化天数
        :return: 价差比率期权定价引擎
        ...
        param['expiry_date'] = expiry_date
        param['current_date'] = current_date
        param['bid_volatility'] = bid_volatility
        param['ofr_volatility'] = ofr_volatility
        param['riskfree_rate'] = riskfree_rate
        param['dividend'] = dividend
        param['year_base'] = year_base
    ...
    def barrier(
        ...
        :param obs_date: 离散障碍MC观测日，dict， Dataframe类型
               或RepeatedStrust返回结果: [Struct(), ...], Struct().obs_index离散观测日
        ...
        # DiscreteBarrierMc
            ...
            param['obs_date'] = Struct.RepeatedStrust(obs_date)
    ...
    def asian(
        ...
        :param obs_date: 离散亚式MC观测日，dict， Dataframe类型
               或RepeatedStrust返回结果: [Struct(), ...], Struct().obs_index离散观测日，Struct().obs_price为已实现价格日
        :return: 亚式期权定价引擎
        """
    ...
    def snowball(
        ...
        :param knock_in_obs_date: 雪球MC敲入观测日，dict， Dataframe类型
               或RepeatedStrust返回结果: [Struct(), ...], Struct(obs_index, adjust_rate)
        :param knock_out_obs_date: 雪球MC敲出观测日，dict， Dataframe类型
               或RepeatedStrust返回结果: [Struct(), ...], Struct(obs_index, adjust_rate, coupon_rate)
        :param is_knock_in: 1为已敲入0为未敲入
        ...
        param['expiry_date'] = expiry_date
        param['year_base'] = year_base
        param['knock_in_obs_date'] = Struct.RepeatedStrust(knock_in_obs_date)
        param['knock_out_obs_date'] = Struct.RepeatedStrust(knock_out_obs_date)
    ...
    def accumulator(
        ...
        :param leverage: 杠杆倍数
        :param year_base: 年化天数
        :param barrier_price: "LinearAcc，FixedAccBarrier必填参数" 障碍价格
        :param payoff: "FixedAcc，FixedAccBarrier必填参数" rebate
        ...
        # FixedAccEnhanced
            ...
            assert barrier_price is not None, "payoff & barrier is required for FixedAccEnhanced"
            param['payoff'] = payoff
            param['barrier_price'] = barrier_price
