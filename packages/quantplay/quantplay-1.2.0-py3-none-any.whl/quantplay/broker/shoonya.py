...
class FinvAsia(Broker):
    ...
    def initialize_symbol_data(self):
        ...
        PickleUtils.save_data(self.symbol_data, "shoonya_instruments")
    ...
    def load_instrument(self):
        try:
            ...
            self.instrument_data = self.instrument_data[['Token', 'TradingSymbol', 'strike_price', 'exchange',
        ...
        for a in self.symbol_data:
            self.fno_symbol_map[self.symbol_data[a]['TradingSymbol']] = self.symbol_data[a]['tradingsymbol']
