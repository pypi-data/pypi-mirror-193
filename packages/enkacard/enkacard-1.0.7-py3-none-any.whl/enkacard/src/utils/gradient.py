...
def userAdaptGrandient(userImg, size = (1502, 787), left = False):
    ...
    color_palette = (rgb[30],rgb[int(len(rgb)/2)],rgb[len(rgb)-100])
    color_palette = list(color_palette)
    if color_palette[0][0] > 210 and color_palette[0][1] > 210 and color_palette[0][2] >  210:
        color_palette[0] = (210,210,210)
    if color_palette[1][0] > 210 and color_palette[1][1] > 210 and color_palette[1][2] >  210:
        color_palette[1] = (210,210,210)
    if color_palette[2][0] > 210 and color_palette[2][1] > 210 and color_palette[2][2] >  210:
        color_palette[2] = (210,210,210)
