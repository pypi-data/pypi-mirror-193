...
class ThinksDashSelectableBox(Component):
    """A ThinksDashSelectableBox component.
...
- value (string | number; optional)"""
    ...
    _namespace = 'thinks_dash_selectable_box'
    _type = 'ThinksDashSelectableBox'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, optionChildren=Component.REQUIRED, optionValues=Component.REQUIRED, value=Component.UNDEFINED, className=Component.UNDEFINED, **kwargs):
        ...
        super(ThinksDashSelectableBox, self).__init__(**args)
