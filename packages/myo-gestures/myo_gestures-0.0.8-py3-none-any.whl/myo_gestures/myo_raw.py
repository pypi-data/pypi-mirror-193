...
from myo_gestures.common import *
...
if __name__ == '__main__':
    ...
    with open('rec_data2/raw_emg_data_8.csv', mode='w') as emg_file, open('rec_data2/gesture_8.csv',mode='w') as gesture_file: ### MESSED UP rec_data/gesture_1.csv
