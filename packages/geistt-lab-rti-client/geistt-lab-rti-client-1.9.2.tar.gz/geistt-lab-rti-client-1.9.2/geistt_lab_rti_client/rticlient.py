...
class RTIClient(Emitter):
    ...
    def __init__(self, application: str = "Python",
                 ...
                 incognito: bool = False, passive: bool = False, inactive: bool = False, connect: bool = True, wait: bool = False):
        super().__init__()
    ...
    def _publish_client(self):
        ...
        message.client.inactive = self._inactive
