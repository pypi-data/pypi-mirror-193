...
inputdir=os.environ["HOME"]+"/papers/srg_evolution_in_4n/data/he3-h3-srg-jube/000065/"
...
def get_wffile(OUT):
   ...
   for line in open(OUT):
     if "WAVEOUT:" in line:  
       ...
       exit
   if waveout==None:
      pattern=re.compile(r"work/(.*).out")
      regexpr=pattern.search(OUT)
      waveout=os.environ["SCRATCH"]+"/3n-wf/"+regexpr.group(1)+".wave.h5"
   return waveout
