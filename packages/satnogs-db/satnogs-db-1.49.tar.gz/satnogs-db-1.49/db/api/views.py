...
from db.api.renderers import BrowserableJSONLDRenderer, JSONLDRenderer, TLERenderer
...
from db.base.models import SATELLITE_STATUS, SERVICE_TYPE, TRANSMITTER_STATUS, TRANSMITTER_TYPE, \
    ...
    SatelliteIdentifier, Transmitter, TransmitterEntry
...
class LatestTleSetViewSet(  # pylint: disable=R0901
    ...
    database
    """
    renderer_classes = [JSONRenderer, BrowsableAPIRenderer, TLERenderer]
