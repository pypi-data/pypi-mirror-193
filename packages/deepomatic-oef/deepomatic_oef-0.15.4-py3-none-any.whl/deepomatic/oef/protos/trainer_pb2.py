...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[deepomatic_dot_oef_dot_protos_dot_hyperparameter__pb2.DESCRIPTOR,deepomatic_dot_oef_dot_protos_dot_optimizer__pb2.DESCRIPTOR,deepomatic_dot_oef_dot_protos_dot_models_dot_image_dot_classification__pb2.DESCRIPTOR,deepomatic_dot_oef_dot_protos_dot_models_dot_image_dot_detection__pb2.DESCRIPTOR,deepomatic_dot_oef_dot_protos_dot_models_dot_image_dot_ocr__pb2.DESCRIPTOR,deepomatic_dot_oef_dot_protos_dot_models_dot_image_dot_segmentation__pb2.DESCRIPTOR,])
...
_TRAINER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_segmentation', full_name='deepomatic.oef.trainer.Trainer.image_segmentation', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='deepomatic.oef.trainer.Trainer.batch_size', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_batch_size', full_name='deepomatic.oef.trainer.Trainer.eval_batch_size', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_train_steps', full_name='deepomatic.oef.trainer.Trainer.num_train_steps', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_eval_steps', full_name='deepomatic.oef.trainer.Trainer.num_eval_steps', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='add_regularization_loss', full_name='deepomatic.oef.trainer.Trainer.add_regularization_loss', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='freeze_variables', full_name='deepomatic.oef.trainer.Trainer.freeze_variables', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='update_trainable_variables', full_name='deepomatic.oef.trainer.Trainer.update_trainable_variables', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pretrained_parameters', full_name='deepomatic.oef.trainer.Trainer.pretrained_parameters', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='keep_checkpoint_every_n_hours', full_name='deepomatic.oef.trainer.Trainer.keep_checkpoint_every_n_hours', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resume_training', full_name='deepomatic.oef.trainer.Trainer.resume_training', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='do_not_restore_variables', full_name='deepomatic.oef.trainer.Trainer.do_not_restore_variables', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='deepomatic.oef.trainer.Trainer.initial_learning_rate', index=15,
    ...
    _descriptor.FieldDescriptor(
      name='learning_rate_policy', full_name='deepomatic.oef.trainer.Trainer.learning_rate_policy', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='optimizer', full_name='deepomatic.oef.trainer.Trainer.optimizer', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gradient_clipping_by_norm', full_name='deepomatic.oef.trainer.Trainer.gradient_clipping_by_norm', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_float16', full_name='deepomatic.oef.trainer.Trainer.use_float16', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quantization', full_name='deepomatic.oef.trainer.Trainer.quantization', index=20,
...
_TRAINER.fields_by_name['image_segmentation'].message_type = deepomatic_dot_oef_dot_protos_dot_models_dot_image_dot_segmentation__pb2._SEGMENTATION
...
_TRAINER.oneofs_by_name['model_type'].fields.append(
  _TRAINER.fields_by_name['image_segmentation'])
_TRAINER.fields_by_name['image_segmentation'].containing_oneof = _TRAINER.oneofs_by_name['model_type']
