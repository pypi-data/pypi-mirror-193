...
class BaseAPI:
    ...
    def groups_id(self) -> list:
        ...
        return [i["group_id"] for i in self._get_groups().get("groups", [])]
    ...
    def _get_content(self, group_id: str = None, payload: dict = None):
        # TODO:不是 payload
        return self._get(f"/app/api/v1/group/{group_id}/content", payload)

    def _get_appconfig_keylist(self, group_id: str = None):
        # TODO:api quorum 中搜不到。没有注释？
