...
from quorum_fullnode_py.exceptions import (
    ParamOverflowError,
    ParamValueError,
    RumChainException,
)
...
class FullNodeAPI(BaseAPI):
    ...
    def _check_group_joined_as_required(self, group_id: str = None):
        ...
        if group_id not in super().groups_id:  # TODO: 不是 base 方法，需要重构
    ...
    def _check_group_owner_as_required(self, group_id: str = None):
        ...
        info = self.group_info(group_id)  # TODO: 不是 base 方法，需要重构
    ...
    def ask_for_relay(self, peers: list):
        ...
        "/ip4/10x.xx.xxx.xxx/tcp/31124/p2p/16Uiu2H...uisLB"
        """
        # TODO: 需要和 relay 参数结合？quorum 的参数命名可优化？
        return super()._ask_for_relay(peers)

    def groups(self) -> list:
        resp = super()._get_groups()
    ...
    def get_content(
        ...
        """
        # TODO：params 的用法和检查，要和 url 的生成一起处理。
        group_id = self._check_group_id_as_required(group_id)
        ...
        rlt = super()._get_content(group_id, params)
        return rlt
    ...
    def trx(self, trx_id: str, group_id: str = None):
        ...
        if len(trxs) == 1:
            ...
            data = super()._get_trx(trx_id=trx_id, group_id=group_id)
        return data
    ...
    def get_trx_auth(self, trx_type: str = "POST", group_id: str = None):
        ...
        """
        group_id = self._check_group_id_as_required(group_id)
        trx_type = _check_trx_type(trx_type)  # TODO: 代码待处理
    ...
    def set_trx_auth(
        ...
        """
        group_id = self._check_group_owner_as_required(group_id)
        mode = _check_trx_mode(mode)  # TODO: 代码待处理
        trx_type = _check_trx_type(trx_type)  # TODO: 代码待处理
        payload = {
            "group_id": group_id,
