...
class LBServices:
    ...
    def choice_nodes(self, nodes_assigned_to_lb, node_list_dict):
        ...
        if table.rowcount == 0:
            return "/"
        print(table)
        node_choice = int(Py_version_manager.py_input("Enter the Node ID: "))
        return node_choice
    ...
    def add_lb(self):
        ...
        if api_key_credentials_object["message"] == "Invalid alias provided":
            ...
            print(table)
            plan_choice = int(Py_version_manager.py_input(": "))
    ...
    def change_lb_name(self):
        lb_name = Py_version_manager.py_input("\nEnter Load-Balancer Name: ")
    ...
    def change_port_node(self, appliances):
        ...
        node_port = Py_version_manager.py_input("\nNode Port: ")
