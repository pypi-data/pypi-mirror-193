...
class Backend(BackendBase):
    def __init__(
        self,
        backend_registration: Optional[List[Dict[str, Any]]] = None,
        tags: Optional[List[str]] = None,
        **kwargs,
    ):
        super().__init__(**kwargs)

        self.backend_registration: Optional[List[BackendRegistration]] = (
            [map(lambda x: BackendRegistration.from_dict(x), backend_registration)]
