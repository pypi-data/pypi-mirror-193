...
.. autohastraits:: Picker(controlling=None, )
    ...
    .. py:attribute:: lineThreshold

        The threshold value for line picking

        .. sourcecode:: python

            IEEEFloat(1, allow_none=False).tag(sync=True)

    .. py:attribute:: pointThreshold

        The threshold value for point picking
    ...
    .. py:attribute:: distance
        ...
        .. sourcecode:: python
            ...
            IEEEFloat(None, allow_none=True).tag(sync=True)
    ...
    .. py:attribute:: instanceId
        ...
        The InstanceID if picking a multi-instanced object
    ...
    .. py:attribute:: index
        ...
        The index of a picked Points instance
