...
var DirectionalLightModel = require('../lights/DirectionalLight.autogen.js').DirectionalLightModel;

class DirectionalLightHelperModel extends Object3DModel {
    ...
    constructThreeObject() {
        ...
        var result = new THREE.DirectionalLightHelper(
...
DirectionalLightHelperModel.model_name = 'DirectionalLightHelperModel';
DirectionalLightHelperModel.serializers = {
