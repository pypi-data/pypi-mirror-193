...
class BoxLineGeometryModel extends BaseBufferGeometryModel {
    ...
    constructThreeObject() {
        ...
        var result = new THREE.BoxLineGeometry(
...
BoxLineGeometryModel.model_name = 'BoxLineGeometryModel';
BoxLineGeometryModel.serializers = {
    ...BaseBufferGeometryModel.serializers,
};

module.exports = {
    BoxLineGeometryModel: BoxLineGeometryModel,
};
