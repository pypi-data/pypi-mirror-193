...
class StringKeyframeTrackModel extends KeyframeTrackModel {
    ...
    constructThreeObject() {
        ...
        var result = new THREE.StringKeyframeTrack(
            this.get('name'),
...
StringKeyframeTrackModel.model_name = 'StringKeyframeTrackModel';
StringKeyframeTrackModel.serializers = {
