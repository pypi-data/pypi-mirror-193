...
# windows 
WINDOW_NAME = 'MLOps-Dataset-Detection'
        ...
        with open(label_path) as f:
            for idx, line in enumerate(f):
                ...
                if not hide_label:
                    ...
                    cv2.putText(img, class_name, (xmin, ymin - 2 if outside else ymin + text_h + 3), 
                                font, fontScale, color, thickness=line_thickness, lineType=cv2.LINE_AA)
