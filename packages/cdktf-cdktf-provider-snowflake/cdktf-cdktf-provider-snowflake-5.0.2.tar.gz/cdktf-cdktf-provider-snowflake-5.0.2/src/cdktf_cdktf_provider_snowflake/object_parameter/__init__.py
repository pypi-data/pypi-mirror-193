...
class ObjectParameter(
    ...
    def __init__(
        ...
        *,
        key: builtins.str,
        object_identifier: typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["ObjectParameterObjectIdentifier", typing.Dict[builtins.str, typing.Any]]]],
...
class ObjectParameterConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def object_identifier(
        self,
    ) -> typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["ObjectParameterObjectIdentifier"]]:
        ...
        return typing.cast(typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["ObjectParameterObjectIdentifier"]], result)

    @builtins.property
    def object_type(self) -> builtins.str:
        '''Type of object to which the parameter applies. Valid values are those in `object types <https://docs.snowflake.com/en/sql-reference/parameters.html#object-types>`_.
