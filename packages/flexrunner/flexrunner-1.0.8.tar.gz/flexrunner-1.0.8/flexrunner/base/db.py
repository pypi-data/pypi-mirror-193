...
from flexrunner.config import REPORT_DIR, DB_INFO
from flexrunner.base.models import ReportSummary
from flexrunner.libs.sqlite_opt import Sqlite3Operation
from flexrunner.libs.mysql_opt import MysqlOperation
...
class TestDB(object):
    ...
    def connect(self):
        ...
        if DB_INFO.get('ENGINE') == 'django.db.backends.sqlite3':
            db_path = os.path.join(REPORT_DIR, DB_INFO.get('NAME'))
