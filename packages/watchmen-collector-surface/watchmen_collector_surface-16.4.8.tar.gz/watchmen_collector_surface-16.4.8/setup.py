...
packages = \
['watchmen_collector_surface',
 'watchmen_collector_surface.cdc',
 'watchmen_collector_surface.connects',
 'watchmen_collector_surface.data',
 'watchmen_collector_surface.task']

package_data = \
{'': ['*']}

install_requires = \
['watchmen-collector-kernel==16.4.8',
 'watchmen-pipeline-kernel==16.4.8',
 'watchmen-rest==16.4.8']
