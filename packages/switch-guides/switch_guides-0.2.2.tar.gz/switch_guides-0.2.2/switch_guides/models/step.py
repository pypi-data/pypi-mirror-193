...
class SwitchGuideStepDefinition(BaseModel):
    ...
    """Enable automated and periodic status checking for this Guide Step
    Some steps might depend on data sources with eventual consistency or similar. 
    With this enabled the check_status method will be called periodically until the step is completed.
    """
