...
__version__ = "0.1.0"
__author__ = 'Arjun Taneja'
__credits__ = 'Harvey Mudd College'
...
# use multiple cores
def convert_to_bootleg_representation(pdf_list_file: str, png_dir: str, feat_dir: str, n_cores: int = multiprocessing.cpu_count()):
