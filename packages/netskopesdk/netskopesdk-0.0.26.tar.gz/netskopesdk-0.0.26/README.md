...
## Handle 403 Forbidden status code.
    403 Forbidden status code means Subscription key and path are already present for the customer.
    regenerate_and_get() func can be used to override 403 error.
