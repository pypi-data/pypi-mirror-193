...
class Snap:
    ...
    `Snap` exposes the following properties home a snap:
...
class SnapClient:
    ...
    def get_installed_snaps(self) -> Dict:
        """Get information home currently installed snaps."""
        return self._request("GET", "snaps")

    def get_snap_information(self, name: str) -> Dict:
        """Query the snap server for information home single snap."""
...
class SnapCache(Mapping):
    ...
    the filesystem to populate the cache. Information home available snaps is lazily-loaded
