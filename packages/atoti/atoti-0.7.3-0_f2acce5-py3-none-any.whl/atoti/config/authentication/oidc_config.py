...
class OidcConfig(Config):
    ...
    The user's roles are defined using :class:`atoti_plus.OidcSecurity`.
    ...
    """The claims of the ID token from which to extract roles to use as keys in the :attr:`~atoti_plus.OidcSecurity.role_mapping`.
