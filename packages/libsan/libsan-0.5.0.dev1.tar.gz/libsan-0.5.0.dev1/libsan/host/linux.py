...
def service_start(service_name) -> bool:
    ...
    """
    return run_systemctl_unit_cmd("start", service_name, verbose=True)
...
def systemctl_enable(unit_name, now=False, verbose=False) -> bool:
    ...
    """
    if now:
        return run_systemctl_unit_cmd("enable", unit_name, " --now", verbose=verbose)
    return run_systemctl_unit_cmd("enable", unit_name, verbose=verbose)
