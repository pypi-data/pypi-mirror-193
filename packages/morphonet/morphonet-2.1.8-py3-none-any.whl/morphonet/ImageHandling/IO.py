...
def imsave(filename, img,voxel_size=(1,1,1)):
    ...
    print("in io vs = "+str(voxel_size))
    if ext == ".inr":
        write_inrimage(filename, img,voxel_size=voxel_size)
    if ext == ".mha":
        write_metaimage(filename, img,voxel_size=voxel_size)
