...
class Cas5a(KaitaiStruct):
    ...
    :field function_code_hm: ax25_frame.payload.function_code_hm
    :field function_code_l: ax25_frame.payload.function_code_l
    :field function_trailer: ax25_frame.payload.function_trailer
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.function_code_hm = self._io.read_u4be()
            if not  ((self.function_code_hm == 16777472) or (self.function_code_hm == 33554944)) :
                raise kaitaistruct.ValidationNotAnyOfError(self.function_code_hm, self._io, u"/types/ui_frame/seq/1")
            self.function_code_l = self._io.read_u2be()
            if not  ((self.function_code_l == 256) or (self.function_code_l == 512)) :
                raise kaitaistruct.ValidationNotAnyOfError(self.function_code_l, self._io, u"/types/ui_frame/seq/2")
            self.function_trailer = self._io.read_u1()
            _on = self.function_code_hm
            if _on == 16777472:
    ...
    class PhotoCatT(KaitaiStruct):
        ...
        def _read(self):
            _on = self._parent.function_code_l
            if _on == 256:
