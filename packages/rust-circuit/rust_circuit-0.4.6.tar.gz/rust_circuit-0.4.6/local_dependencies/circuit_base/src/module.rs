...
use crate::{
    ...
    circuit_info::CachedCircuitInfo,
    ...
    constant::Symbol,
    expand_node::{replace_expand_map, ExpandError},
    named_axes::{deep_strip_axis_names, get_axis_leaves, propagate_named_axes},
    new_rc_unwrap,
    prelude::*,
    PyCircuitBase, Rearrange, TensorEvalError,
};
...
impl Module {
    ...
    fn child_axis_map_inputs_uncached(&self) -> Result<Vec<Vec<Option<usize>>>> {
        ...
        let spec_circuit_resized = substitute_all_modules(spec_resized.circuit.clone());
