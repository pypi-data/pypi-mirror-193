...
class AllProperties(BoatReservationInheritedProperties , BoatReservationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[BoatReservationProperties, BoatReservationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_boatreservation_model(model: AllProperties):
