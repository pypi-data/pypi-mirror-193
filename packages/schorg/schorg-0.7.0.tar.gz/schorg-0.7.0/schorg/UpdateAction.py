...
class AllProperties(UpdateActionInheritedProperties , UpdateActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[UpdateActionProperties, UpdateActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_updateaction_model(model: AllProperties):
