...
class AllProperties(BakeryInheritedProperties , BakeryProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[BakeryProperties, BakeryInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_bakery_model(model: AllProperties):
