...
class ExercisePlanProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        additionalVariable: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
        activityFrequency: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): How often one should engage in the activity.
        repetitions: (Optional[Union[List[Union[SchemaOrgObj, str, StrictInt, StrictFloat]], SchemaOrgObj, str, StrictInt, StrictFloat]]): Number of times one should repeat the activity.
        intensity: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
        activityDuration: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Length of time to engage in the activity.
        ...
        workload: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
        restPeriods: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): How often one should break from the activity.
    """

    additionalVariable: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    activityFrequency: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    repetitions: NotRequired[Union[List[Union[SchemaOrgObj, str, StrictInt, StrictFloat]], SchemaOrgObj, str, StrictInt, StrictFloat]]
    intensity: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    activityDuration: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    exerciseType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    workload: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    restPeriods: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
