...
class ClaimProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        claimInterpreter: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): For a [[Claim]] interpreted from [[MediaObject]] content    sed to indicate a claim contained, implied or refined from the content of a [[MediaObject]].
        appearance: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].
        firstAppearance: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates the first known occurrence of a [[Claim]] in some [[CreativeWork]].
    """

    claimInterpreter: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    appearance: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    firstAppearance: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
