...
class AllProperties(ItemPageInheritedProperties , ItemPageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ItemPageProperties, ItemPageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_itempage_model(model: AllProperties):
