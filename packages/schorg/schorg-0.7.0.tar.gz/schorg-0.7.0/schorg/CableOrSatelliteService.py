...
class AllProperties(CableOrSatelliteServiceInheritedProperties , CableOrSatelliteServiceProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[CableOrSatelliteServiceProperties, CableOrSatelliteServiceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_cableorsatelliteservice_model(model: AllProperties):
