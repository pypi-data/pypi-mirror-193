...
class AllProperties(SubwayStationInheritedProperties , SubwayStationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SubwayStationProperties, SubwayStationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_subwaystation_model(model: AllProperties):
