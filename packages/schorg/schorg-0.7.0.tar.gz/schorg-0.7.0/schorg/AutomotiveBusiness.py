...
class AllProperties(AutomotiveBusinessInheritedProperties , AutomotiveBusinessProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AutomotiveBusinessProperties, AutomotiveBusinessInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_automotivebusiness_model(model: AllProperties):
