...
class AllProperties(ViewActionInheritedProperties , ViewActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ViewActionProperties, ViewActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_viewaction_model(model: AllProperties):
