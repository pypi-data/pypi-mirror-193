...
class ReservationPackageProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        subReservation: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The individual reservations included in the package. Typically a repeated property.
    """

    subReservation: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(ReservationPackageInheritedProperties , ReservationPackageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ReservationPackageProperties, ReservationPackageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_reservationpackage_model(model: AllProperties):
