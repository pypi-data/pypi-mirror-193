...
class AdministrativeAreaInheritedProperties(TypedDict):
    """A geographical region, typically under the jurisdiction of a particular government.
...
class AdministrativeAreaProperties(TypedDict):
    """A geographical region, typically under the jurisdiction of a particular government.
...
class AllProperties(AdministrativeAreaInheritedProperties , AdministrativeAreaProperties, TypedDict):
    pass


class AdministrativeAreaBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="AdministrativeArea",alias='@id')
...
def create_schema_org_model(type_: Union[AdministrativeAreaProperties, AdministrativeAreaInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "AdministrativeArea"
    return model
    

AdministrativeArea = create_schema_org_model()


def create_administrativearea_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_administrativearea_model(model=model)
