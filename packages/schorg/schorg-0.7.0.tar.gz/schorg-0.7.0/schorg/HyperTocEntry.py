...
class HyperTocEntryProperties(TypedDict):
    ...
    Attributes:
        associatedMedia: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A media object that encodes this CreativeWork. This property is a synonym for encoding.
        utterances: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Text of an utterances (spoken words, lyrics etc.) that occurs at a certain section of a media object, represented as a [[HyperTocEntry]].
        tocContinuation: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A [[HyperTocEntry]] can have a [[tocContinuation]] indicated, which is another [[HyperTocEntry]] that would be the default next item to play or render.
    """

    associatedMedia: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    utterances: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    tocContinuation: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
