...
class AllProperties(InternetCafeInheritedProperties , InternetCafeProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[InternetCafeProperties, InternetCafeInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_internetcafe_model(model: AllProperties):
