...
class AllProperties(TipActionInheritedProperties , TipActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TipActionProperties, TipActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_tipaction_model(model: AllProperties):
