...
class AllProperties(ChildCareInheritedProperties , ChildCareProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ChildCareProperties, ChildCareInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_childcare_model(model: AllProperties):
