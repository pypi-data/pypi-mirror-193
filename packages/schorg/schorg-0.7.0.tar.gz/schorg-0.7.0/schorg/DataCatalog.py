...
class DataCatalogProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        dataset: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A dataset contained in this catalog.
    ...
    dataset: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
