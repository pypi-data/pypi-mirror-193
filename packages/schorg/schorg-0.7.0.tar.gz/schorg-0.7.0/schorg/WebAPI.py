...
class WebAPIInheritedProperties(TypedDict):
    """An application programming interface accessible over Web/Internet technologies.
...
class WebAPIProperties(TypedDict):
    """An application programming interface accessible over Web/Internet technologies.
    ...
    Note:
        Model Depth 4
    Attributes:
        documentation: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): Further documentation describing the Web API in more detail.
    """

    documentation: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    


class AllProperties(WebAPIInheritedProperties , WebAPIProperties, TypedDict):
    pass


class WebAPIBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="WebAPI",alias='@id')
    ...
    class Config:
        ...
        fields = {'documentation': {'exclude': True}}
        


def create_schema_org_model(type_: Union[WebAPIProperties, WebAPIInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "WebAPI"
    return model
    

WebAPI = create_schema_org_model()


def create_webapi_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_webapi_model(model=model)
