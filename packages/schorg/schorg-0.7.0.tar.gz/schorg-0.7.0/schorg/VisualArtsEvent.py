...
class VisualArtsEventInheritedProperties(TypedDict):
    """Event type: Visual arts event.
...
class VisualArtsEventProperties(TypedDict):
    """Event type: Visual arts event.
...
class AllProperties(VisualArtsEventInheritedProperties , VisualArtsEventProperties, TypedDict):
    pass


class VisualArtsEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="VisualArtsEvent",alias='@id')
...
def create_schema_org_model(type_: Union[VisualArtsEventProperties, VisualArtsEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "VisualArtsEvent"
    return model
    

VisualArtsEvent = create_schema_org_model()


def create_visualartsevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_visualartsevent_model(model=model)
