...
class TouristDestinationProperties(TypedDict):
    ...
    includesAttraction: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    touristType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(TouristDestinationInheritedProperties , TouristDestinationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TouristDestinationProperties, TouristDestinationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_touristdestination_model(model: AllProperties):
