...
class ComedyEventInheritedProperties(TypedDict):
    """Event type: Comedy event.
...
class ComedyEventProperties(TypedDict):
    """Event type: Comedy event.
...
class AllProperties(ComedyEventInheritedProperties , ComedyEventProperties, TypedDict):
    pass


class ComedyEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="ComedyEvent",alias='@id')
...
def create_schema_org_model(type_: Union[ComedyEventProperties, ComedyEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "ComedyEvent"
    return model
    

ComedyEvent = create_schema_org_model()


def create_comedyevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_comedyevent_model(model=model)
