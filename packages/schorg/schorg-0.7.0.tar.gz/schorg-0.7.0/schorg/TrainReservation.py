...
class AllProperties(TrainReservationInheritedProperties , TrainReservationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TrainReservationProperties, TrainReservationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_trainreservation_model(model: AllProperties):
