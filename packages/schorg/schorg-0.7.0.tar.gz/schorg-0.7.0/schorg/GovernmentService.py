...
class GovernmentServiceInheritedProperties(TypedDict):
    """A service provided by a government organization, e.g. food stamps, veterans benefits, etc.
...
class GovernmentServiceProperties(TypedDict):
    """A service provided by a government organization, e.g. food stamps, veterans benefits, etc.
    ...
    Note:
        Model Depth 4
    Attributes:
        serviceOperator: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
    ...
    serviceOperator: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    jurisdiction: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(GovernmentServiceInheritedProperties , GovernmentServiceProperties, TypedDict):
    pass


class GovernmentServiceBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="GovernmentService",alias='@id')
    ...
    class Config:
        ...
        fields = {'serviceOperator': {'exclude': True}}
        fields = {'jurisdiction': {'exclude': True}}
        


def create_schema_org_model(type_: Union[GovernmentServiceProperties, GovernmentServiceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "GovernmentService"
    return model
    

GovernmentService = create_schema_org_model()


def create_governmentservice_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_governmentservice_model(model=model)
