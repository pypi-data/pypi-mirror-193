...
class AllProperties(LocksmithInheritedProperties , LocksmithProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[LocksmithProperties, LocksmithInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_locksmith_model(model: AllProperties):
