...
class MusicRecordingProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        recordingOf: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The composition this track is a recording of.
        byArtist: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The artist that performed this album or recording.
        inPlaylist: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The playlist to which this recording belongs.
        ...
        isrcCode: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The International Standard Recording Code for the recording.
        inAlbum: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The album to which this recording belongs.
    """

    recordingOf: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    byArtist: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    inPlaylist: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    duration: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    isrcCode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    inAlbum: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
