...
class FlightReservationProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        securityScreening: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The type of security screening the passenger is subject to.
        passengerSequenceNumber: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The passenger's sequence number as assigned by the airline.
        passengerPriorityStatus: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
        boardingGroup: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The airline-specific indicator of boarding order / preference.
    """

    securityScreening: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    passengerSequenceNumber: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    passengerPriorityStatus: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    boardingGroup: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(FlightReservationInheritedProperties , FlightReservationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FlightReservationProperties, FlightReservationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_flightreservation_model(model: AllProperties):
