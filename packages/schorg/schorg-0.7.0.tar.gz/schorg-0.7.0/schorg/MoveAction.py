...
class AllProperties(MoveActionInheritedProperties , MoveActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MoveActionProperties, MoveActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_moveaction_model(model: AllProperties):
