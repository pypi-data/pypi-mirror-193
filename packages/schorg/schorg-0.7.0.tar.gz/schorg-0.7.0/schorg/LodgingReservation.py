...
class LodgingReservationProperties(TypedDict):
    ...
    Attributes:
        ...
        lodgingUnitType: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Textual description of the unit type (including suite vs. room, size of bed, etc.).
        numChildren: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The number of children staying in the unit.
        numAdults: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The number of adults staying in the unit.
        ...
        lodgingUnitDescription: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A full description of the lodging unit.
    """

    checkoutTime: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    lodgingUnitType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    numChildren: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
    numAdults: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
    checkinTime: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    lodgingUnitDescription: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
