...
class DeliveryEventInheritedProperties(TypedDict):
    """An event involving the delivery of an item.
...
class DeliveryEventProperties(TypedDict):
    """An event involving the delivery of an item.
    ...
    Note:
        Model Depth 3
    Attributes:
        availableThrough: (Optional[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]): After this date, the item will no longer be available for pickup.
        accessCode: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Password, PIN, or access code needed for delivery (e.g. from a locker).
        hasDeliveryMethod: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Method used for delivery or shipping.
        availableFrom: (Optional[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]): When the item is available for pickup from the store, locker, etc.
    """

    availableThrough: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    accessCode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    hasDeliveryMethod: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    availableFrom: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    


class AllProperties(DeliveryEventInheritedProperties , DeliveryEventProperties, TypedDict):
    pass


class DeliveryEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="DeliveryEvent",alias='@id')
    ...
    class Config:
        ...
        fields = {'availableThrough': {'exclude': True}}
        fields = {'accessCode': {'exclude': True}}
        fields = {'hasDeliveryMethod': {'exclude': True}}
        fields = {'availableFrom': {'exclude': True}}
        


def create_schema_org_model(type_: Union[DeliveryEventProperties, DeliveryEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "DeliveryEvent"
    return model
    

DeliveryEvent = create_schema_org_model()


def create_deliveryevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_deliveryevent_model(model=model)
