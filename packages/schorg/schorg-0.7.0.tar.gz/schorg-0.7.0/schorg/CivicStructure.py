...
class CivicStructureInheritedProperties(TypedDict):
    """A public structure, such as a town hall or concert hall.
...
class CivicStructureProperties(TypedDict):
    """A public structure, such as a town hall or concert hall.
...
class AllProperties(CivicStructureInheritedProperties , CivicStructureProperties, TypedDict):
    pass


class CivicStructureBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="CivicStructure",alias='@id')
...
def create_schema_org_model(type_: Union[CivicStructureProperties, CivicStructureInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "CivicStructure"
    return model
    

CivicStructure = create_schema_org_model()


def create_civicstructure_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_civicstructure_model(model=model)
