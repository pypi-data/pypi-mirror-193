...
class AllProperties(EntertainmentBusinessInheritedProperties , EntertainmentBusinessProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[EntertainmentBusinessProperties, EntertainmentBusinessInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_entertainmentbusiness_model(model: AllProperties):
