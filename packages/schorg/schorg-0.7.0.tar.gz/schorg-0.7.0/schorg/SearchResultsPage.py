...
class AllProperties(SearchResultsPageInheritedProperties , SearchResultsPageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SearchResultsPageProperties, SearchResultsPageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_searchresultspage_model(model: AllProperties):
