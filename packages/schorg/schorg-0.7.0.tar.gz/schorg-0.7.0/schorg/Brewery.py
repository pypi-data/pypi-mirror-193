...
class AllProperties(BreweryInheritedProperties , BreweryProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[BreweryProperties, BreweryInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_brewery_model(model: AllProperties):
