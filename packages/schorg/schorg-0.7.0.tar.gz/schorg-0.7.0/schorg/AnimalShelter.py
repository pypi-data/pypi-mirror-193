...
class AllProperties(AnimalShelterInheritedProperties , AnimalShelterProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AnimalShelterProperties, AnimalShelterInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_animalshelter_model(model: AllProperties):
