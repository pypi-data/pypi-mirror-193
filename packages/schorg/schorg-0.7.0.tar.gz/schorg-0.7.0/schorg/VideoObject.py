...
class VideoObjectProperties(TypedDict):
    ...
    videoFrameSize: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
class AllProperties(VideoObjectInheritedProperties , VideoObjectProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[VideoObjectProperties, VideoObjectInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_videoobject_model(model: AllProperties):
