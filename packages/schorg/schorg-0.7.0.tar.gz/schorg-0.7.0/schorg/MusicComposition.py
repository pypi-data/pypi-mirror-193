...
class MusicCompositionProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        iswcCode: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The International Standard Musical Work Code for the composition.
        lyrics: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The words in the song.
        musicalKey: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The key, mode, or scale this composition uses.
        includedComposition: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Smaller compositions included in this work (e.g. a movement in a symphony).
        recordedAs: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): An audio recording of the work.
        ...
        musicCompositionForm: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The type of composition (e.g. overture, sonata, symphony, etc.).
        firstPerformance: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The date and place the work was first performed.
        lyricist: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The person who wrote the words.
        musicArrangement: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): An arrangement derived from the composition.
    """

    iswcCode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    lyrics: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    musicalKey: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    includedComposition: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    recordedAs: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    composer: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    musicCompositionForm: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    firstPerformance: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    lyricist: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    musicArrangement: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
