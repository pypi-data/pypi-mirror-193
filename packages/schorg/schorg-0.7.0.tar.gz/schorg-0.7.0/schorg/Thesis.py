...
class ThesisProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        inSupportOf: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Qualification, candidature, degree, application that Thesis supports.
    """

    inSupportOf: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
