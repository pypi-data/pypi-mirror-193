...
class AllProperties(LigamentInheritedProperties , LigamentProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[LigamentProperties, LigamentInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_ligament_model(model: AllProperties):
