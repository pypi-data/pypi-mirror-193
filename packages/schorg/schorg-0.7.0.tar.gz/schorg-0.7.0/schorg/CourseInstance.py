...
class CourseInstanceInheritedProperties(TypedDict):
    """An instance of a [[Course]] which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students.
    ...
    Attributes:
        ...
        remainingAttendeeCapacity: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The number of attendee places for an event that remain unallocated.
        ...
        previousStartDate: (Optional[Union[List[Union[SchemaOrgObj, str, date]], SchemaOrgObj, str, date]]): Used in conjunction with eventStatus for rescheduled or cancelled events. This property contains the previously scheduled start date. For rescheduled events, the startDate property should be used for the newly scheduled start date. In the (rare) case of an event that has been postponed and rescheduled multiple times, this field may be repeated.
        ...
        maximumVirtualAttendeeCapacity: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The maximum physical attendee capacity of an [[Event]] whose [[eventAttendanceMode]] is [[OnlineEventAttendanceMode]] (or the online aspects, in the case of a [[MixedEventAttendanceMode]]). 
        ...
        maximumAttendeeCapacity: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The total number of individuals that may attend an event or venue.
        ...
        maximumPhysicalAttendeeCapacity: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The maximum physical attendee capacity of an [[Event]] whose [[eventAttendanceMode]] is [[OfflineEventAttendanceMode]] (or the offline aspects, in the case of a [[MixedEventAttendanceMode]]). 
    ...
    eventAttendanceMode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    workFeatured: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    remainingAttendeeCapacity: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
    actor: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    doorTime: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    previousStartDate: NotRequired[Union[List[Union[SchemaOrgObj, str, date]], SchemaOrgObj, str, date]]
    ...
    maximumVirtualAttendeeCapacity: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
    ...
    maximumAttendeeCapacity: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
    ...
    maximumPhysicalAttendeeCapacity: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
...
class CourseInstanceProperties(TypedDict):
    """An instance of a [[Course]] which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students.
    ...
    Note:
        Model Depth 3
    Attributes:
        courseWorkload: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
        courseMode: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous).
        instructor: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
    """

    courseWorkload: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    courseMode: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    instructor: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(CourseInstanceInheritedProperties , CourseInstanceProperties, TypedDict):
    pass


class CourseInstanceBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="CourseInstance",alias='@id')
    ...
    class Config:
        ...
        fields = {'courseWorkload': {'exclude': True}}
        fields = {'courseMode': {'exclude': True}}
        fields = {'instructor': {'exclude': True}}
        


def create_schema_org_model(type_: Union[CourseInstanceProperties, CourseInstanceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "CourseInstance"
    return model
    

CourseInstance = create_schema_org_model()


def create_courseinstance_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_courseinstance_model(model=model)
