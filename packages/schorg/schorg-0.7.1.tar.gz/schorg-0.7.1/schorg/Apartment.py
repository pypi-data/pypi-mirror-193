...
class AllProperties(ApartmentInheritedProperties , ApartmentProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ApartmentProperties, ApartmentInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_apartment_model(model: AllProperties):
