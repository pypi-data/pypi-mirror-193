...
class AllProperties(RecyclingCenterInheritedProperties , RecyclingCenterProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[RecyclingCenterProperties, RecyclingCenterInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_recyclingcenter_model(model: AllProperties):
