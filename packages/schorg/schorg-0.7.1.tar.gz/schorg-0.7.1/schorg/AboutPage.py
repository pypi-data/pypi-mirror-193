...
class AllProperties(AboutPageInheritedProperties , AboutPageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AboutPageProperties, AboutPageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_aboutpage_model(model: AllProperties):
