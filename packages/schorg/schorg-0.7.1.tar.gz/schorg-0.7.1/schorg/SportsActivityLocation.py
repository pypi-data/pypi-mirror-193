...
class AllProperties(SportsActivityLocationInheritedProperties , SportsActivityLocationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SportsActivityLocationProperties, SportsActivityLocationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_sportsactivitylocation_model(model: AllProperties):
