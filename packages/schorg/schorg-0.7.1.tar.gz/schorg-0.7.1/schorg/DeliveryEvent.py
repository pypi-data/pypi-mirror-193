...
class DeliveryEventProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        availableThrough: (Optional[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]): After this date, the item will no longer be available for pickup.
        accessCode: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Password, PIN, or access code needed for delivery (e.g. from a locker).
        hasDeliveryMethod: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Method used for delivery or shipping.
        availableFrom: (Optional[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]): When the item is available for pickup from the store, locker, etc.
    """

    availableThrough: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]
    accessCode: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    hasDeliveryMethod: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    availableFrom: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]
