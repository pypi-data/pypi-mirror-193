...
class AllProperties(LibraryInheritedProperties , LibraryProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[LibraryProperties, LibraryInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_library_model(model: AllProperties):
