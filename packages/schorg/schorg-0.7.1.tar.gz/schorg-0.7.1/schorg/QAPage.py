...
class AllProperties(QAPageInheritedProperties , QAPageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[QAPageProperties, QAPageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_qapage_model(model: AllProperties):
