...
class MedicalTrialProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        trialDesign: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Specifics about the trial design (enumerated).
    """

    trialDesign: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(MedicalTrialInheritedProperties , MedicalTrialProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalTrialProperties, MedicalTrialInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicaltrial_model(model: AllProperties):
