...
class VehicleProperties(TypedDict):
    ...
    vehicleSpecialUsage: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    steeringPosition: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    fuelConsumption: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    modelDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    vehicleTransmission: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    emissionsCO2: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    meetsEmissionStandard: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    vehicleIdentificationNumber: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    vehicleInteriorType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    vehicleEngine: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    numberOfDoors: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    vehicleInteriorColor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    driveWheelConfiguration: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    numberOfAxles: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    vehicleSeatingCapacity: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    numberOfPreviousOwners: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    purchaseDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    bodyType: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    fuelType: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    speed: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    mileageFromOdometer: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    productionDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    knownVehicleDamages: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    dateVehicleFirstRegistered: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    weightTotal: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    numberOfAirbags: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    fuelEfficiency: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    vehicleModelDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    numberOfForwardGears: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    callSign: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    vehicleConfiguration: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    tongueWeight: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    accelerationTime: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    seatingCapacity: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    


class AllProperties(VehicleInheritedProperties , VehicleProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[VehicleProperties, VehicleInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_vehicle_model(model: AllProperties):
