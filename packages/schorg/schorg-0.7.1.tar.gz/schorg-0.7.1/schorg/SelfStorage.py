...
class AllProperties(SelfStorageInheritedProperties , SelfStorageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SelfStorageProperties, SelfStorageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_selfstorage_model(model: AllProperties):
