...
class TicketProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        ticketNumber: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The unique identifier for the ticket.
        issuedBy: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The organization issuing the ticket or permit.
        ticketToken: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): Reference to an asset (e.g., Barcode, QR code image or PDF) usable for entrance.
        ...
        ticketedSeat: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The seat associated with the ticket.
        ...
        dateIssued: (Optional[Union[List[Union[datetime, str, SchemaOrgObj, date]], datetime, str, SchemaOrgObj, date]]): The date the ticket was issued.
    """

    ticketNumber: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    issuedBy: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ticketToken: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    ticketedSeat: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    priceCurrency: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    dateIssued: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj, date]], datetime, str, SchemaOrgObj, date]]
    


class AllProperties(TicketInheritedProperties , TicketProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TicketProperties, TicketInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_ticket_model(model: AllProperties):
