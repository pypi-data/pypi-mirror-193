...
class AllProperties(GovernmentOrganizationInheritedProperties , GovernmentOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[GovernmentOrganizationProperties, GovernmentOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_governmentorganization_model(model: AllProperties):
