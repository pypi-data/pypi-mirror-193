...
class HealthPlanFormularyProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        healthPlanCostSharing: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): The costs to the patient for services under this network or formulary.
        offersPrescriptionByMail: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Whether prescriptions can be delivered by mail.
    ...
    healthPlanCostSharing: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    offersPrescriptionByMail: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
