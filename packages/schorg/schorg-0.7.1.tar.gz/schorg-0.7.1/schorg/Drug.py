...
class DrugInheritedProperties(TypedDict):
    """A chemical or biologic substance, used as a medical therapy, that has a physiological effect on an organism. Here the term drug is used interchangeably with the term medicine although clinical knowledge makes a clear difference between them.
    ...
    countryOfAssembly: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    width: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    isAccessoryOrSparePartFor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    isConsumableFor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    hasEnergyConsumptionDetails: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    weight: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    hasMerchantReturnPolicy: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    hasAdultConsideration: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    purchaseDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    ...
    countryOfLastProcessing: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    releaseDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    brand: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    productionDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    inProductGroupWithID: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
...
class DrugProperties(TypedDict):
    """A chemical or biologic substance, used as a medical therapy, that has a physiological effect on an organism. Here the term drug is used interchangeably with the term medicine although clinical knowledge makes a clear difference between them.
    ...
    Note:
        Model Depth 3
    Attributes:
        includedInHealthInsurancePlan: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The insurance plans that cover this drug.
        clincalPharmacology: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Description of the absorption and elimination of drugs, including their concentration (pharmacokinetics, pK) and biological effects (pharmacodynamics, pD).
        warning: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): Any FDA or other warnings about the drug (text or URL).
        activeIngredient: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): An active ingredient, typically chemical compounds and/or biologic substances.
        nonProprietaryName: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The generic name of this drug or supplement.
        foodWarning: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any precaution, guidance, contraindication, etc. related to consumption of specific foods while taking this drug.
        availableStrength: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): An available dosage strength for the drug.
        breastfeedingWarning: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any precaution, guidance, contraindication, etc. related to this drug's use by breastfeeding mothers.
        dosageForm: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A dosage form in which this drug/supplement is available, e.g. 'tablet', 'suspension', 'injection'.
        isAvailableGenerically: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): True if the drug is available in a generic form (regardless of name).
        relatedDrug: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any other drug related to this one, for example commonly-prescribed alternatives.
        labelDetails: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): Link to the drug's label details.
        ...
        administrationRoute: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A route by which this drug may be administered, e.g. 'oral'.
        proprietaryName: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Proprietary name given to the diet plan, typically by its originator or creator.
        clinicalPharmacology: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Description of the absorption and elimination of drugs, including their concentration (pharmacokinetics, pK) and biological effects (pharmacodynamics, pD).
        prescriptionStatus: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Indicates the status of drug prescription, e.g. local catalogs classifications or whether the drug is available by prescription or over-the-counter, etc.
        prescribingInfo: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): Link to prescribing information for the drug.
        pregnancyWarning: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any precaution, guidance, contraindication, etc. related to this drug's use during pregnancy.
        ...
        overdosage: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any information related to overdose on a drug, including signs or symptoms, treatments, contact information for emergency response.
        isProprietary: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): True if this item's name is a proprietary/brand name (vs. generic name).
        rxcui: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The RxCUI drug identifier from RXNORM.
        alcoholWarning: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any precaution, guidance, contraindication, etc. related to consumption of alcohol while taking this drug.
        drugClass: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The class of drug this belongs to (e.g., statins).
        interactingDrug: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Another drug that is known to interact with this drug in a way that impacts the effect of this drug or causes a risk to the patient. Note: disease interactions are typically captured as contraindications.
        pregnancyCategory: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Pregnancy category of this drug.
        maximumIntake: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Recommended intake of this supplement for a given population as defined by a specific recommending authority.
        mechanismOfAction: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The specific biochemical interaction through which this drug or supplement produces its pharmacological effect.
    """

    includedInHealthInsurancePlan: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    clincalPharmacology: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    warning: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    activeIngredient: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    nonProprietaryName: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    foodWarning: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    availableStrength: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    breastfeedingWarning: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    dosageForm: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    isAvailableGenerically: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    relatedDrug: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    labelDetails: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    administrationRoute: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    proprietaryName: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    clinicalPharmacology: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    prescriptionStatus: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    prescribingInfo: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    pregnancyWarning: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    legalStatus: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    overdosage: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    isProprietary: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    rxcui: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    alcoholWarning: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    drugClass: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    interactingDrug: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    pregnancyCategory: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    maximumIntake: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    mechanismOfAction: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(DrugInheritedProperties , DrugProperties, TypedDict):
    pass


class DrugBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="Drug",alias='@id')
    ...
    class Config:
        ...
        fields = {'includedInHealthInsurancePlan': {'exclude': True}}
        fields = {'clincalPharmacology': {'exclude': True}}
        fields = {'warning': {'exclude': True}}
        fields = {'activeIngredient': {'exclude': True}}
        fields = {'nonProprietaryName': {'exclude': True}}
        fields = {'foodWarning': {'exclude': True}}
        fields = {'availableStrength': {'exclude': True}}
        fields = {'breastfeedingWarning': {'exclude': True}}
        fields = {'dosageForm': {'exclude': True}}
        fields = {'isAvailableGenerically': {'exclude': True}}
        fields = {'relatedDrug': {'exclude': True}}
        fields = {'labelDetails': {'exclude': True}}
        fields = {'doseSchedule': {'exclude': True}}
        fields = {'drugUnit': {'exclude': True}}
        fields = {'administrationRoute': {'exclude': True}}
        fields = {'proprietaryName': {'exclude': True}}
        fields = {'clinicalPharmacology': {'exclude': True}}
        fields = {'prescriptionStatus': {'exclude': True}}
        fields = {'prescribingInfo': {'exclude': True}}
        fields = {'pregnancyWarning': {'exclude': True}}
        fields = {'legalStatus': {'exclude': True}}
        fields = {'overdosage': {'exclude': True}}
        fields = {'isProprietary': {'exclude': True}}
        fields = {'rxcui': {'exclude': True}}
        fields = {'alcoholWarning': {'exclude': True}}
        fields = {'drugClass': {'exclude': True}}
        fields = {'interactingDrug': {'exclude': True}}
        fields = {'pregnancyCategory': {'exclude': True}}
        fields = {'maximumIntake': {'exclude': True}}
        fields = {'mechanismOfAction': {'exclude': True}}
        


def create_schema_org_model(type_: Union[DrugProperties, DrugInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "Drug"
    return model
    

Drug = create_schema_org_model()


def create_drug_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_drug_model(model=model)
