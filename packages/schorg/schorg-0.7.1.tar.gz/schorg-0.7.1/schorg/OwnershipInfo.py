...
class OwnershipInfoProperties(TypedDict):
    ...
    ownedThrough: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]
    ownedFrom: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]
...
def create_ownershipinfo_model(model: AllProperties):
