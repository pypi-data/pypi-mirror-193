...
class BroadcastFrequencySpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        broadcastFrequencyValue: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): The frequency in MHz for a particular broadcast.
    """
    ...
    broadcastFrequencyValue: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
