...
class MusicGroupProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        album: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A music album.
        ...
        albums: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A collection of music albums.
        ...
        musicGroupMember: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A member of a music group&#x2014;for example, John, Paul, George, or Ringo.
    """

    album: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    albums: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    genre: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    musicGroupMember: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
