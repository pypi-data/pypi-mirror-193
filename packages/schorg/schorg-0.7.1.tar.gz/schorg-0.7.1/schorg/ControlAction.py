...
class AllProperties(ControlActionInheritedProperties , ControlActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ControlActionProperties, ControlActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_controlaction_model(model: AllProperties):
