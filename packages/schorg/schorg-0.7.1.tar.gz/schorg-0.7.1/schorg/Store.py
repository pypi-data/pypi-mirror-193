...
class AllProperties(StoreInheritedProperties , StoreProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[StoreProperties, StoreInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_store_model(model: AllProperties):
