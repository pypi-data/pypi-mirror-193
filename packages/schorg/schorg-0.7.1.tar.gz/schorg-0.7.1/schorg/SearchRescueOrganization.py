...
class AllProperties(SearchRescueOrganizationInheritedProperties , SearchRescueOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SearchRescueOrganizationProperties, SearchRescueOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_searchrescueorganization_model(model: AllProperties):
