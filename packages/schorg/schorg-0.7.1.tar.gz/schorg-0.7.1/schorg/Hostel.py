...
class AllProperties(HostelInheritedProperties , HostelProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[HostelProperties, HostelInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_hostel_model(model: AllProperties):
