...
class AllProperties(PerformingArtsTheaterInheritedProperties , PerformingArtsTheaterProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[PerformingArtsTheaterProperties, PerformingArtsTheaterInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_performingartstheater_model(model: AllProperties):
