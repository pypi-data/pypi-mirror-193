...
class AllProperties(MedicalSignOrSymptomInheritedProperties , MedicalSignOrSymptomProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalSignOrSymptomProperties, MedicalSignOrSymptomInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicalsignorsymptom_model(model: AllProperties):
