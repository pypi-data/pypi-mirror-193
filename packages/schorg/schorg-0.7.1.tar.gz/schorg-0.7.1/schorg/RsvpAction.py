...
class RsvpActionProperties(TypedDict):
    ...
    Note:
        Model Depth 6
    Attributes:
        additionalNumberOfGuests: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): If responding yes, the number of guests who will attend in addition to the invitee.
    ...
    additionalNumberOfGuests: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
