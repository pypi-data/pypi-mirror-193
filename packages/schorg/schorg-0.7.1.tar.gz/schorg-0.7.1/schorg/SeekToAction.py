...
class AllProperties(SeekToActionInheritedProperties , SeekToActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SeekToActionProperties, SeekToActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_seektoaction_model(model: AllProperties):
