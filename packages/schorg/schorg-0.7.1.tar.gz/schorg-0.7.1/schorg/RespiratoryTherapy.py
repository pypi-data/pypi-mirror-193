...
class RespiratoryTherapyInheritedProperties(TypedDict):
    ...
    duplicateTherapy: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
...
class AllProperties(RespiratoryTherapyInheritedProperties , RespiratoryTherapyProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[RespiratoryTherapyProperties, RespiratoryTherapyInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_respiratorytherapy_model(model: AllProperties):
