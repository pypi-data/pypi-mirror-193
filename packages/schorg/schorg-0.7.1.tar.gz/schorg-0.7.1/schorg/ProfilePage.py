...
class AllProperties(ProfilePageInheritedProperties , ProfilePageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ProfilePageProperties, ProfilePageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_profilepage_model(model: AllProperties):
