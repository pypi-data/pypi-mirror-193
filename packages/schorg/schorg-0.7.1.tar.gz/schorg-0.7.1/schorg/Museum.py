...
class AllProperties(MuseumInheritedProperties , MuseumProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MuseumProperties, MuseumInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_museum_model(model: AllProperties):
