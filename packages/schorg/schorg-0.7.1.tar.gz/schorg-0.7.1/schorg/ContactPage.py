...
class AllProperties(ContactPageInheritedProperties , ContactPageProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ContactPageProperties, ContactPageInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_contactpage_model(model: AllProperties):
