...
class AllProperties(HotelInheritedProperties , HotelProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[HotelProperties, HotelInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_hotel_model(model: AllProperties):
