...
class BuyActionProperties(TypedDict):
    ...
    warrantyPromise: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    vendor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(BuyActionInheritedProperties , BuyActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[BuyActionProperties, BuyActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_buyaction_model(model: AllProperties):
