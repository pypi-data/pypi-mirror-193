...
class ProductGroupProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        variesBy: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. "color"; terms defined elsewhere can be referenced with their URIs.
        hasVariant: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).
        productGroupID: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Indicates a textual identifier for a ProductGroup.
    """

    variesBy: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    hasVariant: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    productGroupID: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(ProductGroupInheritedProperties , ProductGroupProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ProductGroupProperties, ProductGroupInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_productgroup_model(model: AllProperties):
