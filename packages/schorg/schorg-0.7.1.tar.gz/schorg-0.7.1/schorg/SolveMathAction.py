...
class AllProperties(SolveMathActionInheritedProperties , SolveMathActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SolveMathActionProperties, SolveMathActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_solvemathaction_model(model: AllProperties):
