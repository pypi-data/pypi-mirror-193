...
class ArteryProperties(TypedDict):
    ...
    Note:
        Model Depth 5
    Attributes:
        arterialBranch: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The branches that comprise the arterial structure.
        supplyTo: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The area to which the artery supplies blood.
    """

    arterialBranch: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    supplyTo: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
