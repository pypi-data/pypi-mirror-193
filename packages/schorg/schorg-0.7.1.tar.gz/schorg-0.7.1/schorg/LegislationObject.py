...
class LegislationObjectProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        legislationLegalValue: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a "stronger" legal value than the HTML file of the same act.
    """

    legislationLegalValue: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
