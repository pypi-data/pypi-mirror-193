...
class DietarySupplementInheritedProperties(TypedDict):
    """A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites.
...
class DietarySupplementProperties(TypedDict):
    """A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites.
    ...
    Attributes:
        ...
        safetyConsideration: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Any potential safety concern associated with the supplement. May include interactions with other drugs and foods, pregnancy, breastfeeding, known adverse reactions, and documented efficacy of the supplement.
        ...
        maximumIntake: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Recommended intake of this supplement for a given population as defined by a specific recommending authority.
        recommendedIntake: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Recommended intake of this supplement for a given population as defined by a specific recommending authority.
    ...
    safetyConsideration: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    maximumIntake: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    recommendedIntake: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    mechanismOfAction: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(DietarySupplementInheritedProperties , DietarySupplementProperties, TypedDict):
    pass


class DietarySupplementBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="DietarySupplement",alias='@id')
    ...
    class Config:
        ...
        fields = {'safetyConsideration': {'exclude': True}}
        ...
        fields = {'maximumIntake': {'exclude': True}}
        fields = {'recommendedIntake': {'exclude': True}}
        fields = {'mechanismOfAction': {'exclude': True}}
        


def create_schema_org_model(type_: Union[DietarySupplementProperties, DietarySupplementInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "DietarySupplement"
    return model
    

DietarySupplement = create_schema_org_model()


def create_dietarysupplement_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_dietarysupplement_model(model=model)
