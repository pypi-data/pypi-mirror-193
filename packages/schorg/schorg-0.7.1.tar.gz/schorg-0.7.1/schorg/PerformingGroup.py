...
class AllProperties(PerformingGroupInheritedProperties , PerformingGroupProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[PerformingGroupProperties, PerformingGroupInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_performinggroup_model(model: AllProperties):
