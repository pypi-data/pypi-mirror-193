...
class AllProperties(FindActionInheritedProperties , FindActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FindActionProperties, FindActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_findaction_model(model: AllProperties):
