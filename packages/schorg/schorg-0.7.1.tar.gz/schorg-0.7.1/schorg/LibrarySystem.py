...
class AllProperties(LibrarySystemInheritedProperties , LibrarySystemProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[LibrarySystemProperties, LibrarySystemInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_librarysystem_model(model: AllProperties):
