...
class AllProperties(GovernmentOfficeInheritedProperties , GovernmentOfficeProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[GovernmentOfficeProperties, GovernmentOfficeInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_governmentoffice_model(model: AllProperties):
