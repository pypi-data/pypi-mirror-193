...
class AllProperties(HealthAndBeautyBusinessInheritedProperties , HealthAndBeautyBusinessProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[HealthAndBeautyBusinessProperties, HealthAndBeautyBusinessInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_healthandbeautybusiness_model(model: AllProperties):
