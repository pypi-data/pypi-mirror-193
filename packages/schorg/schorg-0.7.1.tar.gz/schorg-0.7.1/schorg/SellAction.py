...
class SellActionProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        buyer: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A sub property of participant. The participant/person/organization that bought the object.
        warrantyPromise: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The warranty promise(s) included in the offer.
    """

    buyer: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    warrantyPromise: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(SellActionInheritedProperties , SellActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SellActionProperties, SellActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_sellaction_model(model: AllProperties):
