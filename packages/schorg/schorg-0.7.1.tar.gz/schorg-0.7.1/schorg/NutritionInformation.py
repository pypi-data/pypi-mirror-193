...
class NutritionInformationProperties(TypedDict):
    ...
    carbohydrateContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    fatContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    cholesterolContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    calories: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    unsaturatedFatContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    sugarContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    transFatContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    proteinContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    saturatedFatContent: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
