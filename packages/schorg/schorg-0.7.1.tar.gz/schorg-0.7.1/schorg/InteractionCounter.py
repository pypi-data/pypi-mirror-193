...
class InteractionCounterProperties(TypedDict):
    ...
    interactionType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    interactionService: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    userInteractionCount: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
