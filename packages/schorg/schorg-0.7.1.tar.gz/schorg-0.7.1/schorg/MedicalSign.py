...
class MedicalSignProperties(TypedDict):
    ...
    identifyingExam: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    identifyingTest: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
