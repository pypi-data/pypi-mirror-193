...
class AllProperties(TravelAgencyInheritedProperties , TravelAgencyProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TravelAgencyProperties, TravelAgencyInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_travelagency_model(model: AllProperties):
