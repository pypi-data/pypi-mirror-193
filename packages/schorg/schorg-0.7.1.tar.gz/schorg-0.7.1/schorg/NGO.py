...
class AllProperties(NGOInheritedProperties , NGOProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[NGOProperties, NGOInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_ngo_model(model: AllProperties):
