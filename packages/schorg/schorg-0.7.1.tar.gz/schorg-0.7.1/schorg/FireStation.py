...
class AllProperties(FireStationInheritedProperties , FireStationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FireStationProperties, FireStationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_firestation_model(model: AllProperties):
