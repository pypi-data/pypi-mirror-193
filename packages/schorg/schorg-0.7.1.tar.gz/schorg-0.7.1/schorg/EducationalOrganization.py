...
class AllProperties(EducationalOrganizationInheritedProperties , EducationalOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[EducationalOrganizationProperties, EducationalOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_educationalorganization_model(model: AllProperties):
