...
class GeoCircleInheritedProperties(TypedDict):
    ...
    elevation: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
...
class GeoCircleProperties(TypedDict):
    ...
    geoRadius: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
