...
class HealthPlanCostSharingSpecificationProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        healthPlanCoinsuranceRate: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): The rate of coinsurance expressed as a number between 0.0 and 1.0.
    ...
    healthPlanCoinsuranceRate: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    ...
    healthPlanCopay: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
