...
class AllProperties(FundingSchemeInheritedProperties , FundingSchemeProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FundingSchemeProperties, FundingSchemeInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_fundingscheme_model(model: AllProperties):
