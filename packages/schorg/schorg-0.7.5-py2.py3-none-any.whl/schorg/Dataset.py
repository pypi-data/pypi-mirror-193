...
class DatasetProperties(TypedDict):
    ...
    Attributes:
        ...
        datasetTimeInterval: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
...
def create_dataset_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Dataset. Please see: https://schema.org/Dataset"
            )
    # delete_keys = []
