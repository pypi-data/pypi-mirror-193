...
class HomeAndConstructionBusinessAllProperties(
...
def create_homeandconstructionbusiness_model(
    model: Union[
        HomeAndConstructionBusinessProperties,
        HomeAndConstructionBusinessInheritedProperties,
        HomeAndConstructionBusinessAllProperties,
    ...
    _type = deepcopy(HomeAndConstructionBusinessAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of HomeAndConstructionBusiness. Please see: https://schema.org/HomeAndConstructionBusiness"
            )
    # delete_keys = []
...
def schema_json(model: HomeAndConstructionBusinessAllProperties):
