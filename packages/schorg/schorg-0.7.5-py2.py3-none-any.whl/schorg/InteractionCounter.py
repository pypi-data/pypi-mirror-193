...
class InteractionCounterProperties(TypedDict):
    ...
    Attributes:
        ...
        interactionType: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The Action representing the type of interaction. For up votes, +1s, etc. use [[LikeAction]]. For down votes use [[DislikeAction]]. Otherwise, use the most specific Action.
        interactionService: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The WebSite or SoftwareApplication where the interactions took place.
        userInteractionCount: (Optional[Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]]): The number of interactions for the CreativeWork using the WebSite or SoftwareApplication.
    ...
    interactionType: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    interactionService: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    userInteractionCount: NotRequired[
...
class InteractionCounterAllProperties(
    InteractionCounterInheritedProperties, InteractionCounterProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        InteractionCounterProperties,
        InteractionCounterInheritedProperties,
        InteractionCounterAllProperties,
    ] = InteractionCounterAllProperties
) -> Type[SchemaOrgBase]:
...
def create_interactioncounter_model(
    model: Union[
        InteractionCounterProperties,
        InteractionCounterInheritedProperties,
        InteractionCounterAllProperties,
    ...
    _type = deepcopy(InteractionCounterAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of InteractionCounter. Please see: https://schema.org/InteractionCounter"
            )
    # delete_keys = []
...
def schema_json(model: InteractionCounterAllProperties):
