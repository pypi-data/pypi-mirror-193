...
class Nonprofit501c8AllProperties(
    Nonprofit501c8InheritedProperties, Nonprofit501c8Properties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        Nonprofit501c8Properties,
        Nonprofit501c8InheritedProperties,
        Nonprofit501c8AllProperties,
    ] = Nonprofit501c8AllProperties
) -> Type[SchemaOrgBase]:
...
def create_nonprofit501c8_model(
    model: Union[
        Nonprofit501c8Properties,
        Nonprofit501c8InheritedProperties,
        Nonprofit501c8AllProperties,
    ...
    _type = deepcopy(Nonprofit501c8AllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Nonprofit501c8. Please see: https://schema.org/Nonprofit501c8"
            )
    # delete_keys = []
...
def schema_json(model: Nonprofit501c8AllProperties):
