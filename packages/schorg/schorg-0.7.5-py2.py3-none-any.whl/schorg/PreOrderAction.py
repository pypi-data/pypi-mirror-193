...
class PreOrderActionAllProperties(
    PreOrderActionInheritedProperties, PreOrderActionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        PreOrderActionProperties,
        PreOrderActionInheritedProperties,
        PreOrderActionAllProperties,
    ] = PreOrderActionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_preorderaction_model(
    model: Union[
        PreOrderActionProperties,
        PreOrderActionInheritedProperties,
        PreOrderActionAllProperties,
    ...
    _type = deepcopy(PreOrderActionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PreOrderAction. Please see: https://schema.org/PreOrderAction"
            )
    # delete_keys = []
...
def schema_json(model: PreOrderActionAllProperties):
