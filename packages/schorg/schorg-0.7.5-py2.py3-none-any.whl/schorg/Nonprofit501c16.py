...
class Nonprofit501c16AllProperties(
    Nonprofit501c16InheritedProperties, Nonprofit501c16Properties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        Nonprofit501c16Properties,
        Nonprofit501c16InheritedProperties,
        Nonprofit501c16AllProperties,
    ] = Nonprofit501c16AllProperties
) -> Type[SchemaOrgBase]:
...
def create_nonprofit501c16_model(
    model: Union[
        Nonprofit501c16Properties,
        Nonprofit501c16InheritedProperties,
        Nonprofit501c16AllProperties,
    ...
    _type = deepcopy(Nonprofit501c16AllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Nonprofit501c16. Please see: https://schema.org/Nonprofit501c16"
            )
    # delete_keys = []
...
def schema_json(model: Nonprofit501c16AllProperties):
