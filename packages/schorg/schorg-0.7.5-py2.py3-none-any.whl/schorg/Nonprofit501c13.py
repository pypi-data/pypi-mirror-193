...
class Nonprofit501c13AllProperties(
    Nonprofit501c13InheritedProperties, Nonprofit501c13Properties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        Nonprofit501c13Properties,
        Nonprofit501c13InheritedProperties,
        Nonprofit501c13AllProperties,
    ] = Nonprofit501c13AllProperties
) -> Type[SchemaOrgBase]:
...
def create_nonprofit501c13_model(
    model: Union[
        Nonprofit501c13Properties,
        Nonprofit501c13InheritedProperties,
        Nonprofit501c13AllProperties,
    ...
    _type = deepcopy(Nonprofit501c13AllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Nonprofit501c13. Please see: https://schema.org/Nonprofit501c13"
            )
    # delete_keys = []
...
def schema_json(model: Nonprofit501c13AllProperties):
