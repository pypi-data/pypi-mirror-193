...
class TouristAttractionAllProperties(
    TouristAttractionInheritedProperties, TouristAttractionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        TouristAttractionProperties,
        TouristAttractionInheritedProperties,
        TouristAttractionAllProperties,
    ] = TouristAttractionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_touristattraction_model(
    model: Union[
        TouristAttractionProperties,
        TouristAttractionInheritedProperties,
        TouristAttractionAllProperties,
    ...
    _type = deepcopy(TouristAttractionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of TouristAttraction. Please see: https://schema.org/TouristAttraction"
            )
    # delete_keys = []
...
def schema_json(model: TouristAttractionAllProperties):
