...
class ArchiveOrganizationProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        archiveHeld: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]].
    """

    archiveHeld: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class ArchiveOrganizationAllProperties(
    ArchiveOrganizationInheritedProperties, ArchiveOrganizationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ArchiveOrganizationProperties,
        ArchiveOrganizationInheritedProperties,
        ArchiveOrganizationAllProperties,
    ] = ArchiveOrganizationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_archiveorganization_model(
    model: Union[
        ArchiveOrganizationProperties,
        ArchiveOrganizationInheritedProperties,
        ArchiveOrganizationAllProperties,
    ...
    _type = deepcopy(ArchiveOrganizationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of ArchiveOrganization. Please see: https://schema.org/ArchiveOrganization"
            )
    # delete_keys = []
...
def schema_json(model: ArchiveOrganizationAllProperties):
