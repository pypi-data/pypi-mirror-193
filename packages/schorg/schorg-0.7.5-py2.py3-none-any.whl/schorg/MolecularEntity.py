...
class MolecularEntityProperties(TypedDict):
    ...
    monoisotopicMolecularWeight: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    molecularWeight: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    ...
    molecularFormula: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    inChI: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class MolecularEntityAllProperties(
    MolecularEntityInheritedProperties, MolecularEntityProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MolecularEntityProperties,
        MolecularEntityInheritedProperties,
        MolecularEntityAllProperties,
    ] = MolecularEntityAllProperties
) -> Type[SchemaOrgBase]:
...
def create_molecularentity_model(
    model: Union[
        MolecularEntityProperties,
        MolecularEntityInheritedProperties,
        MolecularEntityAllProperties,
    ...
    _type = deepcopy(MolecularEntityAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of MolecularEntity. Please see: https://schema.org/MolecularEntity"
            )
    # delete_keys = []
...
def schema_json(model: MolecularEntityAllProperties):
