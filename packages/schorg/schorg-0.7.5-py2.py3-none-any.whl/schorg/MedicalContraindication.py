...
class MedicalContraindicationAllProperties(
    MedicalContraindicationInheritedProperties,
    MedicalContraindicationProperties,
    TypedDict,
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MedicalContraindicationProperties,
        MedicalContraindicationInheritedProperties,
        MedicalContraindicationAllProperties,
    ] = MedicalContraindicationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_medicalcontraindication_model(
    model: Union[
        MedicalContraindicationProperties,
        MedicalContraindicationInheritedProperties,
        MedicalContraindicationAllProperties,
    ...
    _type = deepcopy(MedicalContraindicationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of MedicalContraindication. Please see: https://schema.org/MedicalContraindication"
            )
    # delete_keys = []
...
def schema_json(model: MedicalContraindicationAllProperties):
