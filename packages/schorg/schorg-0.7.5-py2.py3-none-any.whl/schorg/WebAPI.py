...
class WebAPIProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        documentation: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): Further documentation describing the Web API in more detail.
    """
...
def create_webapi_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of WebAPI. Please see: https://schema.org/WebAPI"
            )
    # delete_keys = []
