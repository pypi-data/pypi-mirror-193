...
class LodgingBusinessAllProperties(
    LodgingBusinessInheritedProperties, LodgingBusinessProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        LodgingBusinessProperties,
        LodgingBusinessInheritedProperties,
        LodgingBusinessAllProperties,
    ] = LodgingBusinessAllProperties
) -> Type[SchemaOrgBase]:
...
def create_lodgingbusiness_model(
    model: Union[
        LodgingBusinessProperties,
        LodgingBusinessInheritedProperties,
        LodgingBusinessAllProperties,
    ...
    _type = deepcopy(LodgingBusinessAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of LodgingBusiness. Please see: https://schema.org/LodgingBusiness"
            )
    # delete_keys = []
...
def schema_json(model: LodgingBusinessAllProperties):
