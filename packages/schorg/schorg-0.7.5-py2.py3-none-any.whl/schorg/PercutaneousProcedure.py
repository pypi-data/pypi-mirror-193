...
class PercutaneousProcedureAllProperties(
    PercutaneousProcedureInheritedProperties, PercutaneousProcedureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        PercutaneousProcedureProperties,
        PercutaneousProcedureInheritedProperties,
        PercutaneousProcedureAllProperties,
    ] = PercutaneousProcedureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_percutaneousprocedure_model(
    model: Union[
        PercutaneousProcedureProperties,
        PercutaneousProcedureInheritedProperties,
        PercutaneousProcedureAllProperties,
    ...
    _type = deepcopy(PercutaneousProcedureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PercutaneousProcedure. Please see: https://schema.org/PercutaneousProcedure"
            )
    # delete_keys = []
...
def schema_json(model: PercutaneousProcedureAllProperties):
