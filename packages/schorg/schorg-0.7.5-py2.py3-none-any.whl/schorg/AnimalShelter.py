...
class AnimalShelterInheritedProperties(TypedDict):
    """Animal shelter.
...
class AnimalShelterProperties(TypedDict):
    """Animal shelter.
...
class AnimalShelterAllProperties(
    AnimalShelterInheritedProperties, AnimalShelterProperties, TypedDict
):
    pass


class AnimalShelterBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="AnimalShelter", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        AnimalShelterProperties,
        AnimalShelterInheritedProperties,
        AnimalShelterAllProperties,
    ] = AnimalShelterAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "AnimalShelter"
    return model


AnimalShelter = create_schema_org_model()


def create_animalshelter_model(
    model: Union[
        AnimalShelterProperties,
        AnimalShelterInheritedProperties,
        AnimalShelterAllProperties,
    ...
    _type = deepcopy(AnimalShelterAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of AnimalShelter. Please see: https://schema.org/AnimalShelter"
            )
    # delete_keys = []
...
def schema_json(model: AnimalShelterAllProperties):
    pydantic_type = create_animalshelter_model(model=model)
