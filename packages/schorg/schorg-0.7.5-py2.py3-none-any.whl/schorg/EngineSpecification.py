...
class EngineSpecificationProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        enginePower: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The power of the vehicle's engine.    Typical unit code(s): KWT for kilowatt, BHP for brake horsepower, N12 for metric horsepower (PS, with 1 PS = 735,49875 W)* Note 1: There are many different ways of measuring an engine's power. For an overview, see  [http://en.wikipedia.org/wiki/Horsepower#Engine\_power\_test\_codes](http://en.wikipedia.org/wiki/Horsepower#Engine_power_test_codes).* Note 2: You can link to information about how the given value has been determined using the [[valueReference]] property.* Note 3: You can use [[minValue]] and [[maxValue]] to indicate ranges.
        torque: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The torque (turning force) of the vehicle's engine.Typical unit code(s): NU for newton metre (N m), F17 for pound-force per foot, or F48 for pound-force per inch* Note 1: You can link to information about how the given value has been determined (e.g. reference RPM) using the [[valueReference]] property.* Note 2: You can use [[minValue]] and [[maxValue]] to indicate ranges.
        engineType: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): The type of engine or engines powering the vehicle.
        ...
        engineDisplacement: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The volume swept by all of the pistons inside the cylinders of an internal combustion engine in a single movement. Typical unit code(s): CMQ for cubic centimeter, LTR for liters, INQ for cubic inches* Note 1: You can link to information about how the given value has been determined using the [[valueReference]] property.* Note 2: You can use [[minValue]] and [[maxValue]] to indicate ranges.
    """

    enginePower: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    torque: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    engineType: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    fuelType: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    engineDisplacement: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class EngineSpecificationAllProperties(
    EngineSpecificationInheritedProperties, EngineSpecificationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        EngineSpecificationProperties,
        EngineSpecificationInheritedProperties,
        EngineSpecificationAllProperties,
    ] = EngineSpecificationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_enginespecification_model(
    model: Union[
        EngineSpecificationProperties,
        EngineSpecificationInheritedProperties,
        EngineSpecificationAllProperties,
    ...
    _type = deepcopy(EngineSpecificationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of EngineSpecification. Please see: https://schema.org/EngineSpecification"
            )
    # delete_keys = []
...
def schema_json(model: EngineSpecificationAllProperties):
