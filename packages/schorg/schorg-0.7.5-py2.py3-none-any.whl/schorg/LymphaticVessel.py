...
class LymphaticVesselProperties(TypedDict):
    ...
    originatesFrom: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    runsTo: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class LymphaticVesselAllProperties(
    LymphaticVesselInheritedProperties, LymphaticVesselProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        LymphaticVesselProperties,
        LymphaticVesselInheritedProperties,
        LymphaticVesselAllProperties,
    ] = LymphaticVesselAllProperties
) -> Type[SchemaOrgBase]:
...
def create_lymphaticvessel_model(
    model: Union[
        LymphaticVesselProperties,
        LymphaticVesselInheritedProperties,
        LymphaticVesselAllProperties,
    ...
    _type = deepcopy(LymphaticVesselAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of LymphaticVessel. Please see: https://schema.org/LymphaticVessel"
            )
    # delete_keys = []
...
def schema_json(model: LymphaticVesselAllProperties):
