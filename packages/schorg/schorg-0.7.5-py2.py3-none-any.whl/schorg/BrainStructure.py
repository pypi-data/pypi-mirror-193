...
class BrainStructureAllProperties(
    BrainStructureInheritedProperties, BrainStructureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        BrainStructureProperties,
        BrainStructureInheritedProperties,
        BrainStructureAllProperties,
    ] = BrainStructureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_brainstructure_model(
    model: Union[
        BrainStructureProperties,
        BrainStructureInheritedProperties,
        BrainStructureAllProperties,
    ...
    _type = deepcopy(BrainStructureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BrainStructure. Please see: https://schema.org/BrainStructure"
            )
    # delete_keys = []
...
def schema_json(model: BrainStructureAllProperties):
