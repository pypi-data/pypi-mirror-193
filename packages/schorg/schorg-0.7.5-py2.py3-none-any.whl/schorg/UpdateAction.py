...
class UpdateActionInheritedProperties(TypedDict):
    """The act of managing by changing/editing the state of the object.
...
class UpdateActionProperties(TypedDict):
    """The act of managing by changing/editing the state of the object.
...
class UpdateActionAllProperties(
    UpdateActionInheritedProperties, UpdateActionProperties, TypedDict
):
    pass


class UpdateActionBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="UpdateAction", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        ...
        UpdateActionInheritedProperties,
        UpdateActionAllProperties,
    ] = UpdateActionAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "UpdateAction"
    return model


UpdateAction = create_schema_org_model()


def create_updateaction_model(
    model: Union[
        UpdateActionProperties,
        UpdateActionInheritedProperties,
        UpdateActionAllProperties,
    ...
    _type = deepcopy(UpdateActionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of UpdateAction. Please see: https://schema.org/UpdateAction"
            )
    # delete_keys = []
...
def schema_json(model: UpdateActionAllProperties):
    pydantic_type = create_updateaction_model(model=model)
