...
class GeneProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        expressedIn: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Tissue, organ, biological sample, etc in which activity of this gene has been observed experimentally. For example brain, digestive system.
        ...
        encodesBioChemEntity: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Another BioChemEntity encoded by this one.
        alternativeOf: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Another gene which is a variation of this one.
    """

    expressedIn: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    hasBioPolymerSequence: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    encodesBioChemEntity: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    alternativeOf: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class GeneAllProperties(GeneInheritedProperties, GeneProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        GeneProperties, GeneInheritedProperties, GeneAllProperties
    ] = GeneAllProperties
) -> Type[SchemaOrgBase]:
...
def create_gene_model(
    model: Union[GeneProperties, GeneInheritedProperties, GeneAllProperties]
):
    _type = deepcopy(GeneAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Gene. Please see: https://schema.org/Gene"
            )
    # delete_keys = []
...
def schema_json(model: GeneAllProperties):
