...
class TouristInformationCenterAllProperties(
    TouristInformationCenterInheritedProperties,
    TouristInformationCenterProperties,
    TypedDict,
):
    pass
...
def create_touristinformationcenter_model(
    model: Union[
        TouristInformationCenterProperties,
        TouristInformationCenterInheritedProperties,
        TouristInformationCenterAllProperties,
    ...
    _type = deepcopy(TouristInformationCenterAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of TouristInformationCenter. Please see: https://schema.org/TouristInformationCenter"
            )
    # delete_keys = []
...
def schema_json(model: TouristInformationCenterAllProperties):
