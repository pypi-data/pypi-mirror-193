...
class GovernmentServiceProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        serviceOperator: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
...
def create_governmentservice_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of GovernmentService. Please see: https://schema.org/GovernmentService"
            )
    # delete_keys = []
