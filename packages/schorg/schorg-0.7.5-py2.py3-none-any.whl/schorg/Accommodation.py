...
class AccommodationAllProperties(
    AccommodationInheritedProperties, AccommodationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        AccommodationInheritedProperties,
        AccommodationAllProperties,
    ] = AccommodationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_accommodation_model(
    model: Union[
        AccommodationProperties,
        AccommodationInheritedProperties,
        AccommodationAllProperties,
    ...
    _type = deepcopy(AccommodationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Accommodation. Please see: https://schema.org/Accommodation"
            )
    # delete_keys = []
...
def schema_json(model: AccommodationAllProperties):
