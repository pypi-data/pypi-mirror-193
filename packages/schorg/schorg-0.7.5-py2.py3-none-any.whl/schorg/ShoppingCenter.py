...
class ShoppingCenterAllProperties(
    ShoppingCenterInheritedProperties, ShoppingCenterProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ShoppingCenterProperties,
        ShoppingCenterInheritedProperties,
        ShoppingCenterAllProperties,
    ] = ShoppingCenterAllProperties
) -> Type[SchemaOrgBase]:
...
def create_shoppingcenter_model(
    model: Union[
        ShoppingCenterProperties,
        ShoppingCenterInheritedProperties,
        ShoppingCenterAllProperties,
    ...
    _type = deepcopy(ShoppingCenterAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of ShoppingCenter. Please see: https://schema.org/ShoppingCenter"
            )
    # delete_keys = []
...
def schema_json(model: ShoppingCenterAllProperties):
