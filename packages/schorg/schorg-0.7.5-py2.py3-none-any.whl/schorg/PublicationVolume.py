...
class PublicationVolumeProperties(TypedDict):
    ...
    Attributes:
        ...
        volumeNumber: (Optional[Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]]): Identifies the volume of publication or multi-part work; for example, "iii" or "2".
...
def create_publicationvolume_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PublicationVolume. Please see: https://schema.org/PublicationVolume"
            )
    # delete_keys = []
