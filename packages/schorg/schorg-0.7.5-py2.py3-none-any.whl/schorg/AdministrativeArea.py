...
class AdministrativeAreaAllProperties(
    AdministrativeAreaInheritedProperties, AdministrativeAreaProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        AdministrativeAreaInheritedProperties,
        AdministrativeAreaAllProperties,
    ] = AdministrativeAreaAllProperties
) -> Type[SchemaOrgBase]:
...
def create_administrativearea_model(
    model: Union[
        AdministrativeAreaProperties,
        AdministrativeAreaInheritedProperties,
        AdministrativeAreaAllProperties,
    ...
    _type = deepcopy(AdministrativeAreaAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of AdministrativeArea. Please see: https://schema.org/AdministrativeArea"
            )
    # delete_keys = []
...
def schema_json(model: AdministrativeAreaAllProperties):
