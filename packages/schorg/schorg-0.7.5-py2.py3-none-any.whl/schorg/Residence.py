...
class ResidenceAllProperties(
    ResidenceInheritedProperties, ResidenceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ResidenceProperties, ResidenceInheritedProperties, ResidenceAllProperties
    ] = ResidenceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_residence_model(
    model: Union[
        ResidenceProperties, ResidenceInheritedProperties, ResidenceAllProperties
    ]
):
    _type = deepcopy(ResidenceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Residence. Please see: https://schema.org/Residence"
            )
    # delete_keys = []
...
def schema_json(model: ResidenceAllProperties):
