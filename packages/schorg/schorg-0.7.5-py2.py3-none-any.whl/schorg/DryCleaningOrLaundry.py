...
class DryCleaningOrLaundryAllProperties(
    DryCleaningOrLaundryInheritedProperties, DryCleaningOrLaundryProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        DryCleaningOrLaundryProperties,
        DryCleaningOrLaundryInheritedProperties,
        DryCleaningOrLaundryAllProperties,
    ] = DryCleaningOrLaundryAllProperties
) -> Type[SchemaOrgBase]:
...
def create_drycleaningorlaundry_model(
    model: Union[
        DryCleaningOrLaundryProperties,
        DryCleaningOrLaundryInheritedProperties,
        DryCleaningOrLaundryAllProperties,
    ...
    _type = deepcopy(DryCleaningOrLaundryAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DryCleaningOrLaundry. Please see: https://schema.org/DryCleaningOrLaundry"
            )
    # delete_keys = []
...
def schema_json(model: DryCleaningOrLaundryAllProperties):
