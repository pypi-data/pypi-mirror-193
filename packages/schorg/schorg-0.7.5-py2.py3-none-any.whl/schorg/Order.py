...
class OrderProperties(TypedDict):
    ...
    Attributes:
        ...
        discount: (Optional[Union[List[Union[str, SchemaOrgObj, StrictInt, StrictFloat]], str, SchemaOrgObj, StrictInt, StrictFloat]]): Any discount applied (to an Order).
        ...
        paymentDue: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The date that payment is due.
...
def create_order_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Order. Please see: https://schema.org/Order"
            )
    # delete_keys = []
