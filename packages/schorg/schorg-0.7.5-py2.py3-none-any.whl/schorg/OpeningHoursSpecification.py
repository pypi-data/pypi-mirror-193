...
class OpeningHoursSpecificationProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        closes: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The closing hour of the place or service on the given day(s) of the week.
        ...
        opens: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The opening hour of the place or service on the given day(s) of the week.
...
def create_openinghoursspecification_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of OpeningHoursSpecification. Please see: https://schema.org/OpeningHoursSpecification"
            )
    # delete_keys = []
