...
class LodgingReservationProperties(TypedDict):
    ...
    Attributes:
        ...
        numChildren: (Optional[Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]]): The number of children staying in the unit.
        numAdults: (Optional[Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]]): The number of adults staying in the unit.
    ...
    lodgingUnitType: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    numChildren: NotRequired[
        Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]
    ]
    numAdults: NotRequired[
        Union[List[Union[str, SchemaOrgObj, int]], str, SchemaOrgObj, int]
    ]
    checkinTime: NotRequired[
        Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]
    ]
    lodgingUnitDescription: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class LodgingReservationAllProperties(
    LodgingReservationInheritedProperties, LodgingReservationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        LodgingReservationProperties,
        LodgingReservationInheritedProperties,
        LodgingReservationAllProperties,
    ] = LodgingReservationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_lodgingreservation_model(
    model: Union[
        LodgingReservationProperties,
        LodgingReservationInheritedProperties,
        LodgingReservationAllProperties,
    ...
    _type = deepcopy(LodgingReservationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of LodgingReservation. Please see: https://schema.org/LodgingReservation"
            )
    # delete_keys = []
...
def schema_json(model: LodgingReservationAllProperties):
