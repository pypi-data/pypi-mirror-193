...
class ConsumeActionAllProperties(
    ConsumeActionInheritedProperties, ConsumeActionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        ConsumeActionInheritedProperties,
        ConsumeActionAllProperties,
    ] = ConsumeActionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_consumeaction_model(
    model: Union[
        ConsumeActionProperties,
        ConsumeActionInheritedProperties,
        ConsumeActionAllProperties,
    ...
    _type = deepcopy(ConsumeActionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of ConsumeAction. Please see: https://schema.org/ConsumeAction"
            )
    # delete_keys = []
...
def schema_json(model: ConsumeActionAllProperties):
