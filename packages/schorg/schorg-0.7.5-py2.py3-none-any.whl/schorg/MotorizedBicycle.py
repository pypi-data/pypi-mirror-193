...
class MotorizedBicycleAllProperties(
    MotorizedBicycleInheritedProperties, MotorizedBicycleProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MotorizedBicycleProperties,
        MotorizedBicycleInheritedProperties,
        MotorizedBicycleAllProperties,
    ] = MotorizedBicycleAllProperties
) -> Type[SchemaOrgBase]:
...
def create_motorizedbicycle_model(
    model: Union[
        MotorizedBicycleProperties,
        MotorizedBicycleInheritedProperties,
        MotorizedBicycleAllProperties,
    ...
    _type = deepcopy(MotorizedBicycleAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of MotorizedBicycle. Please see: https://schema.org/MotorizedBicycle"
            )
    # delete_keys = []
...
def schema_json(model: MotorizedBicycleAllProperties):
