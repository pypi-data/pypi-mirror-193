...
class DriveWheelConfigurationValueAllProperties(
...
def create_drivewheelconfigurationvalue_model(
    model: Union[
        DriveWheelConfigurationValueProperties,
        DriveWheelConfigurationValueInheritedProperties,
        DriveWheelConfigurationValueAllProperties,
    ...
    _type = deepcopy(DriveWheelConfigurationValueAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DriveWheelConfigurationValue. Please see: https://schema.org/DriveWheelConfigurationValue"
            )
    # delete_keys = []
...
def schema_json(model: DriveWheelConfigurationValueAllProperties):
