...
class CivicStructureAllProperties(
    CivicStructureInheritedProperties, CivicStructureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CivicStructureProperties,
        CivicStructureInheritedProperties,
        CivicStructureAllProperties,
    ] = CivicStructureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_civicstructure_model(
    model: Union[
        CivicStructureProperties,
        CivicStructureInheritedProperties,
        CivicStructureAllProperties,
    ...
    _type = deepcopy(CivicStructureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of CivicStructure. Please see: https://schema.org/CivicStructure"
            )
    # delete_keys = []
...
def schema_json(model: CivicStructureAllProperties):
