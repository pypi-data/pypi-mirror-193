...
class DeliveryChargeSpecificationAllProperties(
...
def create_deliverychargespecification_model(
    model: Union[
        DeliveryChargeSpecificationProperties,
        DeliveryChargeSpecificationInheritedProperties,
        DeliveryChargeSpecificationAllProperties,
    ...
    _type = deepcopy(DeliveryChargeSpecificationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DeliveryChargeSpecification. Please see: https://schema.org/DeliveryChargeSpecification"
            )
    # delete_keys = []
...
def schema_json(model: DeliveryChargeSpecificationAllProperties):
