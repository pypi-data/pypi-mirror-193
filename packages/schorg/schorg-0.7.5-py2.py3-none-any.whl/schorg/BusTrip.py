...
class BusTripProperties(TypedDict):
    ...
    departureBusStop: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    arrivalBusStop: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class BusTripAllProperties(BusTripInheritedProperties, BusTripProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        BusTripProperties, BusTripInheritedProperties, BusTripAllProperties
    ] = BusTripAllProperties
) -> Type[SchemaOrgBase]:
...
def create_bustrip_model(
    model: Union[BusTripProperties, BusTripInheritedProperties, BusTripAllProperties]
):
    _type = deepcopy(BusTripAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BusTrip. Please see: https://schema.org/BusTrip"
            )
    # delete_keys = []
...
def schema_json(model: BusTripAllProperties):
