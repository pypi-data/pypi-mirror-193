...
class MaximumDoseScheduleInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        doseValue: (Optional[Union[List[Union[str, SchemaOrgObj, StrictInt, StrictFloat]], str, SchemaOrgObj, StrictInt, StrictFloat]]): The value of the dose, e.g. 500.
...
class MaximumDoseScheduleAllProperties(
    MaximumDoseScheduleInheritedProperties, MaximumDoseScheduleProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MaximumDoseScheduleProperties,
        MaximumDoseScheduleInheritedProperties,
        MaximumDoseScheduleAllProperties,
    ] = MaximumDoseScheduleAllProperties
) -> Type[SchemaOrgBase]:
...
def create_maximumdoseschedule_model(
    model: Union[
        MaximumDoseScheduleProperties,
        MaximumDoseScheduleInheritedProperties,
        MaximumDoseScheduleAllProperties,
    ...
    _type = deepcopy(MaximumDoseScheduleAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of MaximumDoseSchedule. Please see: https://schema.org/MaximumDoseSchedule"
            )
    # delete_keys = []
...
def schema_json(model: MaximumDoseScheduleAllProperties):
