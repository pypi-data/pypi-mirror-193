...
class EmergencyServiceInheritedProperties(TypedDict):
    """An emergency service, such as a fire station or ER.
...
class EmergencyServiceProperties(TypedDict):
    """An emergency service, such as a fire station or ER.
...
class EmergencyServiceAllProperties(
    EmergencyServiceInheritedProperties, EmergencyServiceProperties, TypedDict
):
    pass


class EmergencyServiceBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="EmergencyService", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        EmergencyServiceProperties,
        EmergencyServiceInheritedProperties,
        EmergencyServiceAllProperties,
    ] = EmergencyServiceAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "EmergencyService"
    return model


EmergencyService = create_schema_org_model()


def create_emergencyservice_model(
    model: Union[
        EmergencyServiceProperties,
        EmergencyServiceInheritedProperties,
        EmergencyServiceAllProperties,
    ...
    _type = deepcopy(EmergencyServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of EmergencyService. Please see: https://schema.org/EmergencyService"
            )
    # delete_keys = []
...
def schema_json(model: EmergencyServiceAllProperties):
    pydantic_type = create_emergencyservice_model(model=model)
