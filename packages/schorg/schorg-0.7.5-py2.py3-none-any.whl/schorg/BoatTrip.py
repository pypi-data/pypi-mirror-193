...
class BoatTripProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        departureBoatTerminal: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The terminal or port from which the boat departs.
        arrivalBoatTerminal: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The terminal or port from which the boat arrives.
    """

    departureBoatTerminal: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    arrivalBoatTerminal: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class BoatTripAllProperties(BoatTripInheritedProperties, BoatTripProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        BoatTripProperties, BoatTripInheritedProperties, BoatTripAllProperties
    ] = BoatTripAllProperties
) -> Type[SchemaOrgBase]:
...
def create_boattrip_model(
    model: Union[BoatTripProperties, BoatTripInheritedProperties, BoatTripAllProperties]
):
    _type = deepcopy(BoatTripAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BoatTrip. Please see: https://schema.org/BoatTrip"
            )
    # delete_keys = []
...
def schema_json(model: BoatTripAllProperties):
