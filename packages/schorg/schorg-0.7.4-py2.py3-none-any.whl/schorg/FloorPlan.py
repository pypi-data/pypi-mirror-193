...
class FloorPlanProperties(TypedDict):
    ...
    Attributes:
        ...
        layoutImage: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): A schematic image showing the floorplan layout.
...
def create_floorplan_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of FloorPlanAllProperties")
    delete_keys = []
