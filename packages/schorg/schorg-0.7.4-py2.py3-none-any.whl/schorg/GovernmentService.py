...
class GovernmentServiceProperties(TypedDict):
    ...
    serviceOperator: NotRequired[
        Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]
    ]
    jurisdiction: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]


class GovernmentServiceAllProperties(
    GovernmentServiceInheritedProperties, GovernmentServiceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        GovernmentServiceProperties,
        GovernmentServiceInheritedProperties,
        GovernmentServiceAllProperties,
    ] = GovernmentServiceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_governmentservice_model(
    model: Union[
        GovernmentServiceProperties,
        GovernmentServiceInheritedProperties,
        GovernmentServiceAllProperties,
    ...
    _type = deepcopy(GovernmentServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of GovernmentServiceAllProperties")
    delete_keys = []
...
def schema_json(model: GovernmentServiceAllProperties):
