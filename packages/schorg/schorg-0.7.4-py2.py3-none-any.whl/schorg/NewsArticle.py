...
class NewsArticleProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        printColumn: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The number of the column in which the NewsArticle appears in the print edition.
        printEdition: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The edition of the print product in which the NewsArticle appears.
        printSection: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
        printPage: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
        dateline: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A [dateline](https://en.wikipedia.org/wiki/Dateline) is a brief piece of text included in news articles that describes where and when the story was written or filed though the date is often omitted. Sometimes only a placename is provided.Structured representations of dateline-related information can also be expressed more explicitly using [[locationCreated]] (which represents where a work was created, e.g. where a news report was written).  For location depicted or described in the content, use [[contentLocation]].Dateline summaries are oriented more towards human readers than towards automated processing, and can vary substantially. Some examples: "BEIRUT, Lebanon, June 2.", "Paris, France", "December 19, 2017 11:43AM Reporting from Washington", "Beijing/Moscow", "QUEZON CITY, Philippines".
    """

    printColumn: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    printEdition: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    printSection: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    printPage: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    dateline: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_newsarticle_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of NewsArticleAllProperties")
    delete_keys = []
