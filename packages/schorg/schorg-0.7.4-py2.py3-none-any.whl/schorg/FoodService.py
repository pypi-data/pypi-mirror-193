...
class FoodServiceAllProperties(
    FoodServiceInheritedProperties, FoodServiceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        FoodServiceProperties, FoodServiceInheritedProperties, FoodServiceAllProperties
    ] = FoodServiceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_foodservice_model(
    model: Union[
        FoodServiceProperties, FoodServiceInheritedProperties, FoodServiceAllProperties
    ]
):
    _type = deepcopy(FoodServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of FoodServiceAllProperties")
    delete_keys = []
...
def schema_json(model: FoodServiceAllProperties):
