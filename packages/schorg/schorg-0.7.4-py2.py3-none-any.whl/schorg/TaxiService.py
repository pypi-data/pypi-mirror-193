...
class TaxiServiceAllProperties(
    TaxiServiceInheritedProperties, TaxiServiceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        TaxiServiceProperties, TaxiServiceInheritedProperties, TaxiServiceAllProperties
    ] = TaxiServiceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_taxiservice_model(
    model: Union[
        TaxiServiceProperties, TaxiServiceInheritedProperties, TaxiServiceAllProperties
    ]
):
    _type = deepcopy(TaxiServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of TaxiServiceAllProperties")
    delete_keys = []
...
def schema_json(model: TaxiServiceAllProperties):
