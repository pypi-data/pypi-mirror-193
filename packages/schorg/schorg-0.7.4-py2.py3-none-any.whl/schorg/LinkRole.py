...
class LinkRoleProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        linkRelationship: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates the relationship type of a Web link.
...
def create_linkrole_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of LinkRoleAllProperties")
    delete_keys = []
