...
class ResearchOrganizationInheritedProperties(TypedDict):
    """A Research Organization (e.g. scientific institute, research company).
...
class ResearchOrganizationProperties(TypedDict):
    """A Research Organization (e.g. scientific institute, research company).
...
class ResearchOrganizationAllProperties(
    ResearchOrganizationInheritedProperties, ResearchOrganizationProperties, TypedDict
):
    pass


class ResearchOrganizationBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="ResearchOrganization", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        ResearchOrganizationProperties,
        ResearchOrganizationInheritedProperties,
        ResearchOrganizationAllProperties,
    ] = ResearchOrganizationAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "ResearchOrganization"
    return model


ResearchOrganization = create_schema_org_model()


def create_researchorganization_model(
    model: Union[
        ResearchOrganizationProperties,
        ResearchOrganizationInheritedProperties,
        ResearchOrganizationAllProperties,
    ...
    _type = deepcopy(ResearchOrganizationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of ResearchOrganizationAllProperties")
    delete_keys = []
...
def schema_json(model: ResearchOrganizationAllProperties):
    pydantic_type = create_researchorganization_model(model=model)
