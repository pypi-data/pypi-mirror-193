...
class SearchRescueOrganizationInheritedProperties(TypedDict):
    """A Search and Rescue organization of some kind.
...
class SearchRescueOrganizationProperties(TypedDict):
    """A Search and Rescue organization of some kind.
...
class SearchRescueOrganizationAllProperties(
    SearchRescueOrganizationInheritedProperties,
    SearchRescueOrganizationProperties,
    TypedDict,
):
    pass


class SearchRescueOrganizationBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="SearchRescueOrganization", alias="@id")
...
def create_schema_org_model(
    ...
    model.__name__ = "SearchRescueOrganization"
    return model


SearchRescueOrganization = create_schema_org_model()


def create_searchrescueorganization_model(
    model: Union[
        SearchRescueOrganizationProperties,
        SearchRescueOrganizationInheritedProperties,
        SearchRescueOrganizationAllProperties,
    ...
    _type = deepcopy(SearchRescueOrganizationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of SearchRescueOrganizationAllProperties")
    delete_keys = []
...
def schema_json(model: SearchRescueOrganizationAllProperties):
    pydantic_type = create_searchrescueorganization_model(model=model)
