...
class ServiceAllProperties(ServiceInheritedProperties, ServiceProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        ServiceProperties, ServiceInheritedProperties, ServiceAllProperties
    ] = ServiceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_service_model(
    model: Union[ServiceProperties, ServiceInheritedProperties, ServiceAllProperties]
):
    _type = deepcopy(ServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of ServiceAllProperties")
    delete_keys = []
...
def schema_json(model: ServiceAllProperties):
