...
class SizeSpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        sizeSystem: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The size system used to identify a product's size. Typically either a standard (for example, "GS1" or "ISO-EN13402"), country code (for example "US" or "JP"), or a measuring system (for example "Metric" or "Imperial").
        sizeGroup: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The size group (also known as "size type") for a product's size. Size groups are common in the fashion industry to define size segments and suggested audiences for wearable products. Multiple values can be combined, for example "men's big and tall", "petite maternity" or "regular"
    ...
    sizeSystem: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    sizeGroup: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
class SizeSpecificationAllProperties(
    SizeSpecificationInheritedProperties, SizeSpecificationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        SizeSpecificationProperties,
        SizeSpecificationInheritedProperties,
        SizeSpecificationAllProperties,
    ] = SizeSpecificationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_sizespecification_model(
    model: Union[
        SizeSpecificationProperties,
        SizeSpecificationInheritedProperties,
        SizeSpecificationAllProperties,
    ...
    _type = deepcopy(SizeSpecificationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of SizeSpecificationAllProperties")
    delete_keys = []
...
def schema_json(model: SizeSpecificationAllProperties):
