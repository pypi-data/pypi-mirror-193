...
class MusicReleaseProperties(TypedDict):
    ...
    Attributes:
        ...
        catalogNumber: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The catalog number for the release.
    ...
    musicReleaseFormat: NotRequired[
    ...
    catalogNumber: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    creditedTo: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]


class MusicReleaseAllProperties(
    MusicReleaseInheritedProperties, MusicReleaseProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MusicReleaseProperties,
        MusicReleaseInheritedProperties,
        MusicReleaseAllProperties,
    ] = MusicReleaseAllProperties
) -> Type[SchemaOrgBase]:
...
def create_musicrelease_model(
    ...
    _type = deepcopy(MusicReleaseAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MusicReleaseAllProperties")
    delete_keys = []
...
def schema_json(model: MusicReleaseAllProperties):
