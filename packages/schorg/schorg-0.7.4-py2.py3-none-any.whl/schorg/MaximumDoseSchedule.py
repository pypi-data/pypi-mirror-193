...
class MaximumDoseScheduleInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        doseValue: (Optional[Union[List[Union[StrictInt, StrictFloat, SchemaOrgObj, str]], StrictInt, StrictFloat, SchemaOrgObj, str]]): The value of the dose, e.g. 500.
...
def create_maximumdoseschedule_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MaximumDoseScheduleAllProperties")
    delete_keys = []
