...
class MedicalRiskFactorProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        increasesRiskOf: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The condition, complication, etc. influenced by this factor.
    """
...
def create_medicalriskfactor_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MedicalRiskFactorAllProperties")
    delete_keys = []
