...
class MedicalOrganizationInheritedProperties(TypedDict):
    """A medical organization (physical or not), such as hospital, institution or clinic.
...
class MedicalOrganizationProperties(TypedDict):
    """A medical organization (physical or not), such as hospital, institution or clinic.
...
class MedicalOrganizationAllProperties(
    MedicalOrganizationInheritedProperties, MedicalOrganizationProperties, TypedDict
):
    pass


class MedicalOrganizationBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="MedicalOrganization", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        MedicalOrganizationProperties,
        MedicalOrganizationInheritedProperties,
        MedicalOrganizationAllProperties,
    ] = MedicalOrganizationAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "MedicalOrganization"
    return model


MedicalOrganization = create_schema_org_model()


def create_medicalorganization_model(
    model: Union[
        MedicalOrganizationProperties,
        MedicalOrganizationInheritedProperties,
        MedicalOrganizationAllProperties,
    ...
    _type = deepcopy(MedicalOrganizationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MedicalOrganizationAllProperties")
    delete_keys = []
...
def schema_json(model: MedicalOrganizationAllProperties):
    pydantic_type = create_medicalorganization_model(model=model)
