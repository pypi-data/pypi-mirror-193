...
class DataFeedItemProperties(TypedDict):
    ...
    Attributes:
        ...
        dateDeleted: (Optional[Union[List[Union[date, datetime, SchemaOrgObj, str]], date, datetime, SchemaOrgObj, str]]): The datetime the item was removed from the DataFeed.
...
def create_datafeeditem_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of DataFeedItemAllProperties")
    delete_keys = []
