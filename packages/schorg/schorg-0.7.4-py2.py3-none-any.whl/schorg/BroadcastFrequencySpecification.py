...
class BroadcastFrequencySpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        broadcastFrequencyValue: (Optional[Union[List[Union[StrictInt, StrictFloat, SchemaOrgObj, str]], StrictInt, StrictFloat, SchemaOrgObj, str]]): The frequency in MHz for a particular broadcast.
    """
...
def create_broadcastfrequencyspecification_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BroadcastFrequencySpecificationAllProperties"
            )
    delete_keys = []
