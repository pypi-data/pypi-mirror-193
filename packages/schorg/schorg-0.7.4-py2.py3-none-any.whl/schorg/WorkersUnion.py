...
class WorkersUnionAllProperties(
    WorkersUnionInheritedProperties, WorkersUnionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        WorkersUnionProperties,
        WorkersUnionInheritedProperties,
        WorkersUnionAllProperties,
    ] = WorkersUnionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_workersunion_model(
    ...
    _type = deepcopy(WorkersUnionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of WorkersUnionAllProperties")
    delete_keys = []
...
def schema_json(model: WorkersUnionAllProperties):
