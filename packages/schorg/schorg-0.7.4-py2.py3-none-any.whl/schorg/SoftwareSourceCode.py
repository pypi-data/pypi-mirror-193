...
class SoftwareSourceCodeProperties(TypedDict):
    ...
    Attributes:
        ...
        codeRepository: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Link to the repository where the un-compiled, human readable code and related code is located (SVN, GitHub, CodePlex).
    """
...
def create_softwaresourcecode_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of SoftwareSourceCodeAllProperties")
    delete_keys = []
