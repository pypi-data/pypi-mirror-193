...
class PatientInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        colleague: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): A colleague of the person.
        ...
        birthDate: (Optional[Union[List[Union[date, SchemaOrgObj, str]], date, SchemaOrgObj, str]]): Date of birth.
        deathDate: (Optional[Union[List[Union[date, SchemaOrgObj, str]], date, SchemaOrgObj, str]]): Date of death.
...
class PatientAllProperties(PatientInheritedProperties, PatientProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        PatientProperties, PatientInheritedProperties, PatientAllProperties
    ] = PatientAllProperties
) -> Type[SchemaOrgBase]:
...
def create_patient_model(
    model: Union[PatientProperties, PatientInheritedProperties, PatientAllProperties]
):
    _type = deepcopy(PatientAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of PatientAllProperties")
    delete_keys = []
...
def schema_json(model: PatientAllProperties):
