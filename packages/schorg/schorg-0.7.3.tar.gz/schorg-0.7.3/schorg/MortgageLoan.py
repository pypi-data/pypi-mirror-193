...
class MortgageLoanProperties(TypedDict):
    ...
    Attributes:
        ...
        domiciledMortgage: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether borrower is a resident of the jurisdiction where the property is located.
    """
