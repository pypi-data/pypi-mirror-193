...
class BusinessEventAllProperties(
    BusinessEventInheritedProperties, BusinessEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        BusinessEventInheritedProperties,
        BusinessEventAllProperties,
    ] = BusinessEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_businessevent_model(
    model: Union[
        BusinessEventProperties,
        BusinessEventInheritedProperties,
        BusinessEventAllProperties,
    ...
    _type = deepcopy(BusinessEventAllProperties)
...
def schema_json(model: BusinessEventAllProperties):
