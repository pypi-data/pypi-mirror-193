...
class CreativeWorkSeasonAllProperties(
    CreativeWorkSeasonInheritedProperties, CreativeWorkSeasonProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CreativeWorkSeasonProperties,
        CreativeWorkSeasonInheritedProperties,
        CreativeWorkSeasonAllProperties,
    ] = CreativeWorkSeasonAllProperties
) -> Type[SchemaOrgBase]:
...
def create_creativeworkseason_model(
    model: Union[
        CreativeWorkSeasonProperties,
        CreativeWorkSeasonInheritedProperties,
        CreativeWorkSeasonAllProperties,
    ...
    _type = deepcopy(CreativeWorkSeasonAllProperties)
...
def schema_json(model: CreativeWorkSeasonAllProperties):
