...
class HowToSectionAllProperties(
    HowToSectionInheritedProperties, HowToSectionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        HowToSectionProperties,
        HowToSectionInheritedProperties,
        HowToSectionAllProperties,
    ] = HowToSectionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_howtosection_model(
    ...
    _type = deepcopy(HowToSectionAllProperties)
...
def schema_json(model: HowToSectionAllProperties):
