...
class CreativeWorkAllProperties(
    CreativeWorkInheritedProperties, CreativeWorkProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        CreativeWorkInheritedProperties,
        CreativeWorkAllProperties,
    ] = CreativeWorkAllProperties
) -> Type[SchemaOrgBase]:
...
def create_creativework_model(
    ...
    _type = deepcopy(CreativeWorkAllProperties)
...
def schema_json(model: CreativeWorkAllProperties):
