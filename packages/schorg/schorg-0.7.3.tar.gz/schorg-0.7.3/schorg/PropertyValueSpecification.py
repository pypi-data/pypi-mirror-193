...
class PropertyValueSpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        readonlyValue: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether or not a property is mutable.  Default is false. Specifying this for a property that also has a value makes it act similar to a "hidden" input in an HTML form.
        ...
        valueRequired: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether the property must be filled in to complete the action.  Default is false.
        ...
        multipleValues: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether multiple values are allowed for the property.  Default is false.
