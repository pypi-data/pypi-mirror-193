...
class TVSeriesAllProperties(TVSeriesInheritedProperties, TVSeriesProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        TVSeriesProperties, TVSeriesInheritedProperties, TVSeriesAllProperties
    ] = TVSeriesAllProperties
) -> Type[SchemaOrgBase]:
...
def create_tvseries_model(
    model: Union[TVSeriesProperties, TVSeriesInheritedProperties, TVSeriesAllProperties]
):
    _type = deepcopy(TVSeriesAllProperties)
...
def schema_json(model: TVSeriesAllProperties):
