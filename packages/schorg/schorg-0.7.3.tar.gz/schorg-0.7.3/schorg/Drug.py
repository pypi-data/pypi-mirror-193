...
class DrugInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        releaseDate: (Optional[Union[List[Union[str, date, SchemaOrgObj]], str, date, SchemaOrgObj]]): The release date of a product or product model. This can be used to distinguish the exact variant of a product.
...
class DrugProperties(TypedDict):
    ...
    Attributes:
        ...
        isAvailableGenerically: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): True if the drug is available in a generic form (regardless of name).
        ...
        isProprietary: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): True if this item's name is a proprietary/brand name (vs. generic name).
