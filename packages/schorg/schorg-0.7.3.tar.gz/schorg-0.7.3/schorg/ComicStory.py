...
class ComicStoryAllProperties(
    ComicStoryInheritedProperties, ComicStoryProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ComicStoryProperties, ComicStoryInheritedProperties, ComicStoryAllProperties
    ] = ComicStoryAllProperties
) -> Type[SchemaOrgBase]:
...
def create_comicstory_model(
    model: Union[
        ComicStoryProperties, ComicStoryInheritedProperties, ComicStoryAllProperties
    ]
):
    _type = deepcopy(ComicStoryAllProperties)
...
def schema_json(model: ComicStoryAllProperties):
