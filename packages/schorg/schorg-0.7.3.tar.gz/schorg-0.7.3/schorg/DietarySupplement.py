...
class DietarySupplementProperties(TypedDict):
    ...
    safetyConsideration: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
...
class DietarySupplementAllProperties(
    DietarySupplementInheritedProperties, DietarySupplementProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        DietarySupplementProperties,
        DietarySupplementInheritedProperties,
        DietarySupplementAllProperties,
    ] = DietarySupplementAllProperties
) -> Type[SchemaOrgBase]:
...
def create_dietarysupplement_model(
    model: Union[
        DietarySupplementProperties,
        DietarySupplementInheritedProperties,
        DietarySupplementAllProperties,
    ...
    _type = deepcopy(DietarySupplementAllProperties)
...
def schema_json(model: DietarySupplementAllProperties):
