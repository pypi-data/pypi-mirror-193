...
class EpisodeAllProperties(EpisodeInheritedProperties, EpisodeProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        EpisodeProperties, EpisodeInheritedProperties, EpisodeAllProperties
    ] = EpisodeAllProperties
) -> Type[SchemaOrgBase]:
...
def create_episode_model(
    model: Union[EpisodeProperties, EpisodeInheritedProperties, EpisodeAllProperties]
):
    _type = deepcopy(EpisodeAllProperties)
...
def schema_json(model: EpisodeAllProperties):
