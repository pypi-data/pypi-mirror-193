...
class DiagnosticLabProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        availableTest: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A diagnostic test or procedure offered by this lab.
    """

    availableTest: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
