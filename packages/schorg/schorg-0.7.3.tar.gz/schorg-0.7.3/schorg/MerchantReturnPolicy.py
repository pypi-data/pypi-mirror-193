...
class MerchantReturnPolicyProperties(TypedDict):
    ...
    Attributes:
        ...
        inStoreReturnsOffered: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Are in-store returns offered? (For more advanced return methods use the [[returnMethod]] property.)
