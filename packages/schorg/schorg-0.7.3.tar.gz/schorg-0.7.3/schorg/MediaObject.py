...
class MediaObjectAllProperties(
    MediaObjectInheritedProperties, MediaObjectProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MediaObjectProperties, MediaObjectInheritedProperties, MediaObjectAllProperties
    ] = MediaObjectAllProperties
) -> Type[SchemaOrgBase]:
...
def create_mediaobject_model(
    model: Union[
        MediaObjectProperties, MediaObjectInheritedProperties, MediaObjectAllProperties
    ]
):
    _type = deepcopy(MediaObjectAllProperties)
...
def schema_json(model: MediaObjectAllProperties):
