...
class LegislationObjectProperties(TypedDict):
    ...
    legislationLegalValue: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class LegislationObjectAllProperties(
    LegislationObjectInheritedProperties, LegislationObjectProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        LegislationObjectProperties,
        LegislationObjectInheritedProperties,
        LegislationObjectAllProperties,
    ] = LegislationObjectAllProperties
) -> Type[SchemaOrgBase]:
...
def create_legislationobject_model(
    model: Union[
        LegislationObjectProperties,
        LegislationObjectInheritedProperties,
        LegislationObjectAllProperties,
    ...
    _type = deepcopy(LegislationObjectAllProperties)
...
def schema_json(model: LegislationObjectAllProperties):
