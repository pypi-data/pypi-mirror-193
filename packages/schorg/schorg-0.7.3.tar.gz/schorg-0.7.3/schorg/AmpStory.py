...
class AmpStoryInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        uploadDate: (Optional[Union[List[Union[str, date, SchemaOrgObj]], str, date, SchemaOrgObj]]): Date when this media object was uploaded to this site.
    ...
    regionsAllowed: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    contentUrl: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    productionCompany: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    encodesCreativeWork: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    uploadDate: NotRequired[
...
class AmpStoryAllProperties(AmpStoryInheritedProperties, AmpStoryProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        AmpStoryProperties, AmpStoryInheritedProperties, AmpStoryAllProperties
    ] = AmpStoryAllProperties
) -> Type[SchemaOrgBase]:
...
def create_ampstory_model(
    model: Union[AmpStoryProperties, AmpStoryInheritedProperties, AmpStoryAllProperties]
):
    _type = deepcopy(AmpStoryAllProperties)
...
def schema_json(model: AmpStoryAllProperties):
