...
class CreditCardInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        cashBack: (Optional[Union[List[Union[str, StrictBool, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictBool, StrictInt, StrictFloat, SchemaOrgObj]]): A cardholder benefit that pays the cardholder a small percentage of their net expenditures.
        contactlessPayment: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): A secure method for consumers to purchase products or services via debit, credit or smartcards by using RFID or NFC technology.
        ...
        renegotiableLoan: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether the terms for payment of interest can be renegotiated during the life of the loan.
        ...
        recourseLoan: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): The only way you get the money back in the event of default is the security. Recourse is where you still have the opportunity to go back to the borrower for the rest of the money.
    """

    floorLimit: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    cashBack: NotRequired[
        Union[
            List[Union[str, StrictBool, StrictInt, StrictFloat, SchemaOrgObj]],
            str,
            StrictBool,
            StrictInt,
            StrictFloat,
...
class CreditCardAllProperties(
    CreditCardInheritedProperties, CreditCardProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CreditCardProperties, CreditCardInheritedProperties, CreditCardAllProperties
    ] = CreditCardAllProperties
) -> Type[SchemaOrgBase]:
...
def create_creditcard_model(
    model: Union[
        CreditCardProperties, CreditCardInheritedProperties, CreditCardAllProperties
    ]
):
    _type = deepcopy(CreditCardAllProperties)
...
def schema_json(model: CreditCardAllProperties):
