...
class EducationEventAllProperties(
    EducationEventInheritedProperties, EducationEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        EducationEventProperties,
        EducationEventInheritedProperties,
        EducationEventAllProperties,
    ] = EducationEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_educationevent_model(
    model: Union[
        EducationEventProperties,
        EducationEventInheritedProperties,
        EducationEventAllProperties,
    ...
    _type = deepcopy(EducationEventAllProperties)
...
def schema_json(model: EducationEventAllProperties):
