...
class MusicEventAllProperties(
    MusicEventInheritedProperties, MusicEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MusicEventProperties, MusicEventInheritedProperties, MusicEventAllProperties
    ] = MusicEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_musicevent_model(
    model: Union[
        MusicEventProperties, MusicEventInheritedProperties, MusicEventAllProperties
    ]
):
    _type = deepcopy(MusicEventAllProperties)
...
def schema_json(model: MusicEventAllProperties):
