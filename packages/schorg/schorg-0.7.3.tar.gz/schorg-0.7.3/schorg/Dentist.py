...
class DentistAllProperties(DentistInheritedProperties, DentistProperties, TypedDict):
    pass


class DentistBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="Dentist", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        DentistProperties, DentistInheritedProperties, DentistAllProperties
    ] = DentistAllProperties
) -> Type[SchemaOrgBase]:
...
def create_dentist_model(
    model: Union[DentistProperties, DentistInheritedProperties, DentistAllProperties]
):
    _type = deepcopy(DentistAllProperties)
...
def schema_json(model: DentistAllProperties):
    pydantic_type = create_dentist_model(model=model)
