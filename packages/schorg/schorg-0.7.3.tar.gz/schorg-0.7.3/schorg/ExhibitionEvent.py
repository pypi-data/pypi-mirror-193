...
class ExhibitionEventAllProperties(
    ExhibitionEventInheritedProperties, ExhibitionEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ExhibitionEventProperties,
        ExhibitionEventInheritedProperties,
        ExhibitionEventAllProperties,
    ] = ExhibitionEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_exhibitionevent_model(
    model: Union[
        ExhibitionEventProperties,
        ExhibitionEventInheritedProperties,
        ExhibitionEventAllProperties,
    ...
    _type = deepcopy(ExhibitionEventAllProperties)
...
def schema_json(model: ExhibitionEventAllProperties):
