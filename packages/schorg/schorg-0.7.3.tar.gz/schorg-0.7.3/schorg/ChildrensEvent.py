...
class ChildrensEventAllProperties(
    ChildrensEventInheritedProperties, ChildrensEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ChildrensEventProperties,
        ChildrensEventInheritedProperties,
        ChildrensEventAllProperties,
    ] = ChildrensEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_childrensevent_model(
    model: Union[
        ChildrensEventProperties,
        ChildrensEventInheritedProperties,
        ChildrensEventAllProperties,
    ...
    _type = deepcopy(ChildrensEventAllProperties)
...
def schema_json(model: ChildrensEventAllProperties):
