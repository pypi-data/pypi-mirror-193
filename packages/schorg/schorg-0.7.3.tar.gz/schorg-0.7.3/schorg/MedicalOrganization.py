...
class MedicalOrganizationProperties(TypedDict):
    ...
    Attributes:
        ...
        isAcceptingNewPatients: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Whether the provider is accepting new patients.
    """
