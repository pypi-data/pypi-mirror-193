...
class HowToDirectionProperties(TypedDict):
    ...
    afterMedia: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    beforeMedia: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    tool: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    duringMedia: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
...
class HowToDirectionAllProperties(
    HowToDirectionInheritedProperties, HowToDirectionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        HowToDirectionProperties,
        HowToDirectionInheritedProperties,
        HowToDirectionAllProperties,
    ] = HowToDirectionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_howtodirection_model(
    model: Union[
        HowToDirectionProperties,
        HowToDirectionInheritedProperties,
        HowToDirectionAllProperties,
    ...
    _type = deepcopy(HowToDirectionAllProperties)
...
def schema_json(model: HowToDirectionAllProperties):
