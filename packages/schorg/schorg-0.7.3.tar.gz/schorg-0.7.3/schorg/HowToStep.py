...
class HowToStepAllProperties(
    HowToStepInheritedProperties, HowToStepProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        HowToStepProperties, HowToStepInheritedProperties, HowToStepAllProperties
    ] = HowToStepAllProperties
) -> Type[SchemaOrgBase]:
...
def create_howtostep_model(
    model: Union[
        HowToStepProperties, HowToStepInheritedProperties, HowToStepAllProperties
    ]
):
    _type = deepcopy(HowToStepAllProperties)
...
def schema_json(model: HowToStepAllProperties):
