...
class LiteraryEventAllProperties(
    LiteraryEventInheritedProperties, LiteraryEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        LiteraryEventProperties,
        LiteraryEventInheritedProperties,
        LiteraryEventAllProperties,
    ] = LiteraryEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_literaryevent_model(
    model: Union[
        LiteraryEventProperties,
        LiteraryEventInheritedProperties,
        LiteraryEventAllProperties,
    ...
    _type = deepcopy(LiteraryEventAllProperties)
...
def schema_json(model: LiteraryEventAllProperties):
