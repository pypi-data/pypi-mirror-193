...
class EUEnergyEfficiencyCategoryA2PlusAllProperties(
...
def create_euenergyefficiencycategorya2plus_model(
    model: Union[
        EUEnergyEfficiencyCategoryA2PlusProperties,
        EUEnergyEfficiencyCategoryA2PlusInheritedProperties,
        EUEnergyEfficiencyCategoryA2PlusAllProperties,
    ...
    _type = deepcopy(EUEnergyEfficiencyCategoryA2PlusAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of EUEnergyEfficiencyCategoryA2Plus. Please see: https://schema.org/EUEnergyEfficiencyCategoryA2Plus"
            )
    # delete_keys = []
...
def schema_json(model: EUEnergyEfficiencyCategoryA2PlusAllProperties):
