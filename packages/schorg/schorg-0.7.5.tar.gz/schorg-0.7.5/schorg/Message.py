...
class MessageProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        dateReceived: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The date/time the message was received if a single recipient exists.
        ...
        dateSent: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The date/time at which the message was sent.
...
def create_message_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Message. Please see: https://schema.org/Message"
            )
    # delete_keys = []
