...
class DeliveryMethodAllProperties(
    DeliveryMethodInheritedProperties, DeliveryMethodProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        DeliveryMethodInheritedProperties,
        DeliveryMethodAllProperties,
    ] = DeliveryMethodAllProperties
) -> Type[SchemaOrgBase]:
...
def create_deliverymethod_model(
    model: Union[
        DeliveryMethodProperties,
        DeliveryMethodInheritedProperties,
        DeliveryMethodAllProperties,
    ...
    _type = deepcopy(DeliveryMethodAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DeliveryMethod. Please see: https://schema.org/DeliveryMethod"
            )
    # delete_keys = []
...
def schema_json(model: DeliveryMethodAllProperties):
