...
class HealthAndBeautyBusinessInheritedProperties(TypedDict):
    """Health and beauty.
...
class HealthAndBeautyBusinessProperties(TypedDict):
    """Health and beauty.
...
class HealthAndBeautyBusinessAllProperties(
    HealthAndBeautyBusinessInheritedProperties,
    HealthAndBeautyBusinessProperties,
    TypedDict,
):
    pass


class HealthAndBeautyBusinessBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="HealthAndBeautyBusiness", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        HealthAndBeautyBusinessProperties,
        HealthAndBeautyBusinessInheritedProperties,
        HealthAndBeautyBusinessAllProperties,
    ] = HealthAndBeautyBusinessAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "HealthAndBeautyBusiness"
    return model


HealthAndBeautyBusiness = create_schema_org_model()


def create_healthandbeautybusiness_model(
    model: Union[
        HealthAndBeautyBusinessProperties,
        HealthAndBeautyBusinessInheritedProperties,
        HealthAndBeautyBusinessAllProperties,
    ...
    _type = deepcopy(HealthAndBeautyBusinessAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of HealthAndBeautyBusiness. Please see: https://schema.org/HealthAndBeautyBusiness"
            )
    # delete_keys = []
...
def schema_json(model: HealthAndBeautyBusinessAllProperties):
    pydantic_type = create_healthandbeautybusiness_model(model=model)
