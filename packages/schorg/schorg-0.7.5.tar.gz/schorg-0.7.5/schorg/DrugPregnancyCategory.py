...
class DrugPregnancyCategoryAllProperties(
    DrugPregnancyCategoryInheritedProperties, DrugPregnancyCategoryProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        DrugPregnancyCategoryProperties,
        DrugPregnancyCategoryInheritedProperties,
        DrugPregnancyCategoryAllProperties,
    ] = DrugPregnancyCategoryAllProperties
) -> Type[SchemaOrgBase]:
...
def create_drugpregnancycategory_model(
    model: Union[
        DrugPregnancyCategoryProperties,
        DrugPregnancyCategoryInheritedProperties,
        DrugPregnancyCategoryAllProperties,
    ...
    _type = deepcopy(DrugPregnancyCategoryAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DrugPregnancyCategory. Please see: https://schema.org/DrugPregnancyCategory"
            )
    # delete_keys = []
...
def schema_json(model: DrugPregnancyCategoryAllProperties):
