...
class OfferForLeaseAllProperties(
    OfferForLeaseInheritedProperties, OfferForLeaseProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        OfferForLeaseProperties,
        OfferForLeaseInheritedProperties,
        OfferForLeaseAllProperties,
    ] = OfferForLeaseAllProperties
) -> Type[SchemaOrgBase]:
...
def create_offerforlease_model(
    model: Union[
        OfferForLeaseProperties,
        OfferForLeaseInheritedProperties,
        OfferForLeaseAllProperties,
    ...
    _type = deepcopy(OfferForLeaseAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of OfferForLease. Please see: https://schema.org/OfferForLease"
            )
    # delete_keys = []
...
def schema_json(model: OfferForLeaseAllProperties):
