...
class DeliveryTimeSettingsAllProperties(
    DeliveryTimeSettingsInheritedProperties, DeliveryTimeSettingsProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        DeliveryTimeSettingsProperties,
        DeliveryTimeSettingsInheritedProperties,
        DeliveryTimeSettingsAllProperties,
    ] = DeliveryTimeSettingsAllProperties
) -> Type[SchemaOrgBase]:
...
def create_deliverytimesettings_model(
    model: Union[
        DeliveryTimeSettingsProperties,
        DeliveryTimeSettingsInheritedProperties,
        DeliveryTimeSettingsAllProperties,
    ...
    _type = deepcopy(DeliveryTimeSettingsAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of DeliveryTimeSettings. Please see: https://schema.org/DeliveryTimeSettings"
            )
    # delete_keys = []
...
def schema_json(model: DeliveryTimeSettingsAllProperties):
