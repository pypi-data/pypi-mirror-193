...
class SportsActivityLocationInheritedProperties(TypedDict):
    """A sports location, such as a playing field.
...
class SportsActivityLocationProperties(TypedDict):
    """A sports location, such as a playing field.
...
class SportsActivityLocationAllProperties(
    SportsActivityLocationInheritedProperties,
    SportsActivityLocationProperties,
    TypedDict,
):
    pass


class SportsActivityLocationBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="SportsActivityLocation", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        SportsActivityLocationProperties,
        SportsActivityLocationInheritedProperties,
        SportsActivityLocationAllProperties,
    ] = SportsActivityLocationAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "SportsActivityLocation"
    return model


SportsActivityLocation = create_schema_org_model()


def create_sportsactivitylocation_model(
    model: Union[
        SportsActivityLocationProperties,
        SportsActivityLocationInheritedProperties,
        SportsActivityLocationAllProperties,
    ...
    _type = deepcopy(SportsActivityLocationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of SportsActivityLocation. Please see: https://schema.org/SportsActivityLocation"
            )
    # delete_keys = []
...
def schema_json(model: SportsActivityLocationAllProperties):
    pydantic_type = create_sportsactivitylocation_model(model=model)
