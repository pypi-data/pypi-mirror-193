...
class OfferForPurchaseAllProperties(
    OfferForPurchaseInheritedProperties, OfferForPurchaseProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        OfferForPurchaseProperties,
        OfferForPurchaseInheritedProperties,
        OfferForPurchaseAllProperties,
    ] = OfferForPurchaseAllProperties
) -> Type[SchemaOrgBase]:
...
def create_offerforpurchase_model(
    model: Union[
        OfferForPurchaseProperties,
        OfferForPurchaseInheritedProperties,
        OfferForPurchaseAllProperties,
    ...
    _type = deepcopy(OfferForPurchaseAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of OfferForPurchase. Please see: https://schema.org/OfferForPurchase"
            )
    # delete_keys = []
...
def schema_json(model: OfferForPurchaseAllProperties):
