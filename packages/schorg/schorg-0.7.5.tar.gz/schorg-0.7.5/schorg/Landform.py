...
class LandformAllProperties(LandformInheritedProperties, LandformProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        LandformProperties, LandformInheritedProperties, LandformAllProperties
    ] = LandformAllProperties
) -> Type[SchemaOrgBase]:
...
def create_landform_model(
    model: Union[LandformProperties, LandformInheritedProperties, LandformAllProperties]
):
    _type = deepcopy(LandformAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Landform. Please see: https://schema.org/Landform"
            )
    # delete_keys = []
...
def schema_json(model: LandformAllProperties):
