...
class ObservationProperties(TypedDict):
    ...
    Attributes:
        ...
        observationDate: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The observationDate of an [[Observation]].
...
def create_observation_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Observation. Please see: https://schema.org/Observation"
            )
    # delete_keys = []
