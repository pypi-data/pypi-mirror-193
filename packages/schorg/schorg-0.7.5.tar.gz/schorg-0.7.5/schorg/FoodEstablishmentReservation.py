...
class FoodEstablishmentReservationAllProperties(
...
def create_foodestablishmentreservation_model(
    model: Union[
        FoodEstablishmentReservationProperties,
        FoodEstablishmentReservationInheritedProperties,
        FoodEstablishmentReservationAllProperties,
    ...
    _type = deepcopy(FoodEstablishmentReservationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of FoodEstablishmentReservation. Please see: https://schema.org/FoodEstablishmentReservation"
            )
    # delete_keys = []
...
def schema_json(model: FoodEstablishmentReservationAllProperties):
