...
class UnRegisterActionAllProperties(
    UnRegisterActionInheritedProperties, UnRegisterActionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        UnRegisterActionProperties,
        UnRegisterActionInheritedProperties,
        UnRegisterActionAllProperties,
    ] = UnRegisterActionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_unregisteraction_model(
    model: Union[
        UnRegisterActionProperties,
        UnRegisterActionInheritedProperties,
        UnRegisterActionAllProperties,
    ...
    _type = deepcopy(UnRegisterActionAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of UnRegisterAction. Please see: https://schema.org/UnRegisterAction"
            )
    # delete_keys = []
...
def schema_json(model: UnRegisterActionAllProperties):
