...
class SpecialAnnouncementInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        version: (Optional[Union[List[Union[str, SchemaOrgObj, StrictInt, StrictFloat]], str, SchemaOrgObj, StrictInt, StrictFloat]]): The version of the CreativeWork embodied by a specified resource.
        ...
        contentReferenceTime: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The specific time described by a creative work, for works (e.g. articles, video objects etc.) that emphasise a particular moment within an Event.
        ...
        copyrightYear: (Optional[Union[List[Union[str, SchemaOrgObj, StrictInt, StrictFloat]], str, SchemaOrgObj, StrictInt, StrictFloat]]): The year during which the claimed copyright for the CreativeWork was first asserted.
        ...
        temporal: (Optional[Union[List[Union[str, SchemaOrgObj, datetime]], str, SchemaOrgObj, datetime]]): The "temporal" property can be used in cases where more specific properties(e.g. [[temporalCoverage]], [[dateCreated]], [[dateModified]], [[datePublished]]) are not known to be appropriate.
...
def create_specialannouncement_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of SpecialAnnouncement. Please see: https://schema.org/SpecialAnnouncement"
            )
    # delete_keys = []
