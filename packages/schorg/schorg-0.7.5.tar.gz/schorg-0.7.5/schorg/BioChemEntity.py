...
class BioChemEntityAllProperties(
    BioChemEntityInheritedProperties, BioChemEntityProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        BioChemEntityInheritedProperties,
        BioChemEntityAllProperties,
    ] = BioChemEntityAllProperties
) -> Type[SchemaOrgBase]:
...
def create_biochementity_model(
    model: Union[
        BioChemEntityProperties,
        BioChemEntityInheritedProperties,
        BioChemEntityAllProperties,
    ...
    _type = deepcopy(BioChemEntityAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BioChemEntity. Please see: https://schema.org/BioChemEntity"
            )
    # delete_keys = []
...
def schema_json(model: BioChemEntityAllProperties):
