...
class PalliativeProcedureAllProperties(
    PalliativeProcedureInheritedProperties, PalliativeProcedureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        PalliativeProcedureProperties,
        PalliativeProcedureInheritedProperties,
        PalliativeProcedureAllProperties,
    ] = PalliativeProcedureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_palliativeprocedure_model(
    model: Union[
        PalliativeProcedureProperties,
        PalliativeProcedureInheritedProperties,
        PalliativeProcedureAllProperties,
    ...
    _type = deepcopy(PalliativeProcedureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PalliativeProcedure. Please see: https://schema.org/PalliativeProcedure"
            )
    # delete_keys = []
...
def schema_json(model: PalliativeProcedureAllProperties):
