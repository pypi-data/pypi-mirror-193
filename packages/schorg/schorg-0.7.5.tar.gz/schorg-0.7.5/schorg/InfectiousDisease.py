...
class InfectiousDiseaseProperties(TypedDict):
    ...
    infectiousAgent: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    infectiousAgentClass: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    transmissionMethod: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class InfectiousDiseaseAllProperties(
    InfectiousDiseaseInheritedProperties, InfectiousDiseaseProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        InfectiousDiseaseProperties,
        InfectiousDiseaseInheritedProperties,
        InfectiousDiseaseAllProperties,
    ] = InfectiousDiseaseAllProperties
) -> Type[SchemaOrgBase]:
...
def create_infectiousdisease_model(
    model: Union[
        InfectiousDiseaseProperties,
        InfectiousDiseaseInheritedProperties,
        InfectiousDiseaseAllProperties,
    ...
    _type = deepcopy(InfectiousDiseaseAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of InfectiousDisease. Please see: https://schema.org/InfectiousDisease"
            )
    # delete_keys = []
...
def schema_json(model: InfectiousDiseaseAllProperties):
