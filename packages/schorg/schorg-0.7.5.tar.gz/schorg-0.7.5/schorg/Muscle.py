...
class MuscleProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        nerve: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The underlying innervation associated with the muscle.
        muscleAction: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The movement the muscle generates.
        bloodSupply: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The blood vessel that carries blood from the heart to the muscle.
        antagonist: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The muscle whose action counteracts the specified muscle.
        insertion: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The place of attachment of a muscle, or what the muscle moves.
    """

    nerve: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    muscleAction: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    bloodSupply: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    antagonist: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    insertion: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class MuscleAllProperties(MuscleInheritedProperties, MuscleProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        MuscleProperties, MuscleInheritedProperties, MuscleAllProperties
    ] = MuscleAllProperties
) -> Type[SchemaOrgBase]:
...
def create_muscle_model(
    model: Union[MuscleProperties, MuscleInheritedProperties, MuscleAllProperties]
):
    _type = deepcopy(MuscleAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Muscle. Please see: https://schema.org/Muscle"
            )
    # delete_keys = []
...
def schema_json(model: MuscleAllProperties):
