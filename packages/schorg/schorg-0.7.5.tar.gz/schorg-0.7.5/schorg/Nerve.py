...
class NerveProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        nerveMotor: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The neurological pathway extension that involves muscle control.
        branch: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The branches that delineate from the nerve bundle. Not to be confused with [[branchOf]].
        sourcedFrom: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The neurological pathway that originates the neurons.
        sensoryUnit: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The neurological pathway extension that inputs and sends information to the brain or spinal cord.
    """

    nerveMotor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    branch: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    sourcedFrom: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    sensoryUnit: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class NerveAllProperties(NerveInheritedProperties, NerveProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        NerveProperties, NerveInheritedProperties, NerveAllProperties
    ] = NerveAllProperties
) -> Type[SchemaOrgBase]:
...
def create_nerve_model(
    model: Union[NerveProperties, NerveInheritedProperties, NerveAllProperties]
):
    _type = deepcopy(NerveAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of Nerve. Please see: https://schema.org/Nerve"
            )
    # delete_keys = []
...
def schema_json(model: NerveAllProperties):
