...
class PaymentChargeSpecificationProperties(TypedDict):
    ...
    Note:
        Model Depth 5
    Attributes:
        appliesToPaymentMethod: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The payment method(s) to which the payment charge specification applies.
    ...
    appliesToPaymentMethod: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    appliesToDeliveryMethod: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]


class PaymentChargeSpecificationAllProperties(
...
def create_paymentchargespecification_model(
    model: Union[
        PaymentChargeSpecificationProperties,
        PaymentChargeSpecificationInheritedProperties,
        PaymentChargeSpecificationAllProperties,
    ...
    _type = deepcopy(PaymentChargeSpecificationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PaymentChargeSpecification. Please see: https://schema.org/PaymentChargeSpecification"
            )
    # delete_keys = []
...
def schema_json(model: PaymentChargeSpecificationAllProperties):
