...
class BedAndBreakfastAllProperties(
    BedAndBreakfastInheritedProperties, BedAndBreakfastProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        BedAndBreakfastProperties,
        BedAndBreakfastInheritedProperties,
        BedAndBreakfastAllProperties,
    ] = BedAndBreakfastAllProperties
) -> Type[SchemaOrgBase]:
...
def create_bedandbreakfast_model(
    model: Union[
        BedAndBreakfastProperties,
        BedAndBreakfastInheritedProperties,
        BedAndBreakfastAllProperties,
    ...
    _type = deepcopy(BedAndBreakfastAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of BedAndBreakfast. Please see: https://schema.org/BedAndBreakfast"
            )
    # delete_keys = []
...
def schema_json(model: BedAndBreakfastAllProperties):
