...
class PodcastEpisodeAllProperties(
    PodcastEpisodeInheritedProperties, PodcastEpisodeProperties, TypedDict
):
    pass


class PodcastEpisodeBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="PodcastEpisode", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        ...
        PodcastEpisodeInheritedProperties,
        PodcastEpisodeAllProperties,
    ] = PodcastEpisodeAllProperties
) -> Type[SchemaOrgBase]:
...
def create_podcastepisode_model(
    model: Union[
        PodcastEpisodeProperties,
        PodcastEpisodeInheritedProperties,
        PodcastEpisodeAllProperties,
    ...
    _type = deepcopy(PodcastEpisodeAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of PodcastEpisode. Please see: https://schema.org/PodcastEpisode"
            )
    # delete_keys = []
...
def schema_json(model: PodcastEpisodeAllProperties):
    pydantic_type = create_podcastepisode_model(model=model)
