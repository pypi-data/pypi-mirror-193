...
class MedicalProcedureAllProperties(
    MedicalProcedureInheritedProperties, MedicalProcedureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MedicalProcedureProperties,
        MedicalProcedureInheritedProperties,
        MedicalProcedureAllProperties,
    ] = MedicalProcedureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_medicalprocedure_model(
    model: Union[
        MedicalProcedureProperties,
        MedicalProcedureInheritedProperties,
        MedicalProcedureAllProperties,
    ...
    _type = deepcopy(MedicalProcedureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of MedicalProcedure. Please see: https://schema.org/MedicalProcedure"
            )
    # delete_keys = []
...
def schema_json(model: MedicalProcedureAllProperties):
