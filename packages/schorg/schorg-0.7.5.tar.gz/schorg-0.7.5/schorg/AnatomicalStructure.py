...
class AnatomicalStructureAllProperties(
    AnatomicalStructureInheritedProperties, AnatomicalStructureProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        AnatomicalStructureProperties,
        AnatomicalStructureInheritedProperties,
        AnatomicalStructureAllProperties,
    ] = AnatomicalStructureAllProperties
) -> Type[SchemaOrgBase]:
...
def create_anatomicalstructure_model(
    model: Union[
        AnatomicalStructureProperties,
        AnatomicalStructureInheritedProperties,
        AnatomicalStructureAllProperties,
    ...
    _type = deepcopy(AnatomicalStructureAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of AnatomicalStructure. Please see: https://schema.org/AnatomicalStructure"
            )
    # delete_keys = []
...
def schema_json(model: AnatomicalStructureAllProperties):
