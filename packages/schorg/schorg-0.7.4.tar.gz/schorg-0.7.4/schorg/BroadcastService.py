...
class BroadcastServiceAllProperties(
    BroadcastServiceInheritedProperties, BroadcastServiceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        BroadcastServiceInheritedProperties,
        BroadcastServiceAllProperties,
    ] = BroadcastServiceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_broadcastservice_model(
    model: Union[
        BroadcastServiceProperties,
        BroadcastServiceInheritedProperties,
        BroadcastServiceAllProperties,
    ...
    _type = deepcopy(BroadcastServiceAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of BroadcastServiceAllProperties")
    delete_keys = []
...
def schema_json(model: BroadcastServiceAllProperties):
