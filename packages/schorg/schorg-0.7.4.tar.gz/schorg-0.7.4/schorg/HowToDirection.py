...
class HowToDirectionProperties(TypedDict):
    ...
    Attributes:
        ...
        afterMedia: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): A media object representing the circumstances after performing this direction.
        beforeMedia: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): A media object representing the circumstances before performing this direction.
        ...
        duringMedia: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): A media object representing the circumstances while performing this direction.
...
def create_howtodirection_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of HowToDirectionAllProperties")
    delete_keys = []
