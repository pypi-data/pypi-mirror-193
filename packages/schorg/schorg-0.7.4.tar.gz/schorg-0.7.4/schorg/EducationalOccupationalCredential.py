...
class EducationalOccupationalCredentialProperties(TypedDict):
    ...
    Attributes:
        ...
        credentialCategory: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): The category or type of credential being described, for example "degree”, “certificate”, “badge”, or more specific term.
    """
...
def create_educationaloccupationalcredential_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(
                f"{k} not part of EducationalOccupationalCredentialAllProperties"
            )
    delete_keys = []
