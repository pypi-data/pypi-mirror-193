...
class TechArticleAllProperties(
    TechArticleInheritedProperties, TechArticleProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        TechArticleProperties, TechArticleInheritedProperties, TechArticleAllProperties
    ] = TechArticleAllProperties
) -> Type[SchemaOrgBase]:
...
def create_techarticle_model(
    model: Union[
        TechArticleProperties, TechArticleInheritedProperties, TechArticleAllProperties
    ]
):
    _type = deepcopy(TechArticleAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of TechArticleAllProperties")
    delete_keys = []
...
def schema_json(model: TechArticleAllProperties):
