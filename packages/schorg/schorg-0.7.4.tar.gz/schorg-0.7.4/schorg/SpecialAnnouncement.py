...
class SpecialAnnouncementProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        diseaseSpreadStatistics: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Statistical information about the spread of a disease, either as [[WebContent]], or  described directly as a [[Dataset]], or the specific [[Observation]]s in the dataset. When a [[WebContent]] URL is  provided, the page indicated might also contain more such markup.
        publicTransportClosuresInfo: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Information about public transport closures.
        ...
        quarantineGuidelines: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Guidelines about quarantine rules, e.g. in the context of a pandemic.
        travelBans: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Information about travel bans, e.g. in the context of a pandemic.
        webFeed: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom.
        diseasePreventionInfo: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Information about disease prevention.
        datePosted: (Optional[Union[List[Union[date, datetime, SchemaOrgObj, str]], date, datetime, SchemaOrgObj, str]]): Publication date of an online listing.
        ...
        schoolClosuresInfo: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Information about school closures.
        newsUpdatesAndGuidelines: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Indicates a page with news updates and guidelines. This could often be (but is not required to be) the main page containing [[SpecialAnnouncement]] markup on a site.
        gettingTestedInfo: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Information about getting tested (for a [[MedicalCondition]]), e.g. in the context of a pandemic.
    """
...
def create_specialannouncement_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of SpecialAnnouncementAllProperties")
    delete_keys = []
