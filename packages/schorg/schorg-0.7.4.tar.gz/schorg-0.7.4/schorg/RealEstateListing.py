...
class RealEstateListingAllProperties(
    RealEstateListingInheritedProperties, RealEstateListingProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        RealEstateListingProperties,
        RealEstateListingInheritedProperties,
        RealEstateListingAllProperties,
    ] = RealEstateListingAllProperties
) -> Type[SchemaOrgBase]:
...
def create_realestatelisting_model(
    model: Union[
        RealEstateListingProperties,
        RealEstateListingInheritedProperties,
        RealEstateListingAllProperties,
    ...
    _type = deepcopy(RealEstateListingAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of RealEstateListingAllProperties")
    delete_keys = []
...
def schema_json(model: RealEstateListingAllProperties):
