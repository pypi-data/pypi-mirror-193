...
class MusicVideoObjectAllProperties(
    MusicVideoObjectInheritedProperties, MusicVideoObjectProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MusicVideoObjectProperties,
        MusicVideoObjectInheritedProperties,
        MusicVideoObjectAllProperties,
    ] = MusicVideoObjectAllProperties
) -> Type[SchemaOrgBase]:
...
def create_musicvideoobject_model(
    model: Union[
        MusicVideoObjectProperties,
        MusicVideoObjectInheritedProperties,
        MusicVideoObjectAllProperties,
    ...
    _type = deepcopy(MusicVideoObjectAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MusicVideoObjectAllProperties")
    delete_keys = []
...
def schema_json(model: MusicVideoObjectAllProperties):
