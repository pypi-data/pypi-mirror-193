...
class ExercisePlanProperties(TypedDict):
    ...
    Attributes:
        ...
        repetitions: (Optional[Union[List[Union[StrictInt, StrictFloat, SchemaOrgObj, str]], StrictInt, StrictFloat, SchemaOrgObj, str]]): Number of times one should repeat the activity.
...
def create_exerciseplan_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of ExercisePlanAllProperties")
    delete_keys = []
