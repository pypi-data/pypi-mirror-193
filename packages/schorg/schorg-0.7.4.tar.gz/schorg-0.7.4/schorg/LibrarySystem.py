...
class LibrarySystemInheritedProperties(TypedDict):
    """A [[LibrarySystem]] is a collaborative system amongst several libraries.
...
class LibrarySystemProperties(TypedDict):
    """A [[LibrarySystem]] is a collaborative system amongst several libraries.
...
class LibrarySystemAllProperties(
    LibrarySystemInheritedProperties, LibrarySystemProperties, TypedDict
):
    pass


class LibrarySystemBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="LibrarySystem", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        LibrarySystemProperties,
        LibrarySystemInheritedProperties,
        LibrarySystemAllProperties,
    ] = LibrarySystemAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "LibrarySystem"
    return model


LibrarySystem = create_schema_org_model()


def create_librarysystem_model(
    model: Union[
        LibrarySystemProperties,
        LibrarySystemInheritedProperties,
        LibrarySystemAllProperties,
    ...
    _type = deepcopy(LibrarySystemAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of LibrarySystemAllProperties")
    delete_keys = []
...
def schema_json(model: LibrarySystemAllProperties):
    pydantic_type = create_librarysystem_model(model=model)
