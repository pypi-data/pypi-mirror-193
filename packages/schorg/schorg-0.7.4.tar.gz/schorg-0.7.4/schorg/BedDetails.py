...
class BedDetailsProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        typeOfBed: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The type of bed to which the BedDetail refers, i.e. the type of bed available in the quantity indicated by quantity.
        numberOfBeds: (Optional[Union[List[Union[StrictInt, StrictFloat, SchemaOrgObj, str]], StrictInt, StrictFloat, SchemaOrgObj, str]]): The quantity of the given bed type available in the HotelRoom, Suite, House, or Apartment.
    """

    typeOfBed: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_beddetails_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of BedDetailsAllProperties")
    delete_keys = []
