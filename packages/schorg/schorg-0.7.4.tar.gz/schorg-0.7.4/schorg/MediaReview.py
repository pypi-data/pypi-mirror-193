...
class MediaReviewProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        originalMediaLink: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
        originalMediaContextDescription: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Describes, in a [[MediaReview]] when dealing with [[DecontextualizedContent]], background information that can contribute to better interpretation of the [[MediaObject]].
        mediaAuthenticityCategory: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates a MediaManipulationRatingEnumeration classification of a media object (in the context of how it was published or shared).
    """

    originalMediaLink: NotRequired[
        Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]
    ]
    originalMediaContextDescription: NotRequired[
        Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]
    ]
    mediaAuthenticityCategory: NotRequired[
        Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]
    ]


class MediaReviewAllProperties(
    MediaReviewInheritedProperties, MediaReviewProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MediaReviewProperties, MediaReviewInheritedProperties, MediaReviewAllProperties
    ] = MediaReviewAllProperties
) -> Type[SchemaOrgBase]:
...
def create_mediareview_model(
    model: Union[
        MediaReviewProperties, MediaReviewInheritedProperties, MediaReviewAllProperties
    ]
):
    _type = deepcopy(MediaReviewAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MediaReviewAllProperties")
    delete_keys = []
...
def schema_json(model: MediaReviewAllProperties):
