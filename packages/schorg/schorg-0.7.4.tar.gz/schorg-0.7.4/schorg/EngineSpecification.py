...
class EngineSpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        engineType: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): The type of engine or engines powering the vehicle.
...
def create_enginespecification_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of EngineSpecificationAllProperties")
    delete_keys = []
