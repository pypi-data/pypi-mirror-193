...
class CheckoutPageAllProperties(
    CheckoutPageInheritedProperties, CheckoutPageProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CheckoutPageProperties,
        CheckoutPageInheritedProperties,
        CheckoutPageAllProperties,
    ] = CheckoutPageAllProperties
) -> Type[SchemaOrgBase]:
...
def create_checkoutpage_model(
    ...
    _type = deepcopy(CheckoutPageAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of CheckoutPageAllProperties")
    delete_keys = []
...
def schema_json(model: CheckoutPageAllProperties):
