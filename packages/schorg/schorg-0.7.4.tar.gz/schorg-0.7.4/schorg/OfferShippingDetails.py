...
class OfferShippingDetailsProperties(TypedDict):
    ...
    Attributes:
        ...
        shippingSettingsLink: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Link to a page containing [[ShippingRateSettings]] and [[DeliveryTimeSettings]] details.
...
def create_offershippingdetails_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of OfferShippingDetailsAllProperties")
    delete_keys = []
