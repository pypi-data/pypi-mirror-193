...
class FAQPageAllProperties(FAQPageInheritedProperties, FAQPageProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        FAQPageProperties, FAQPageInheritedProperties, FAQPageAllProperties
    ] = FAQPageAllProperties
) -> Type[SchemaOrgBase]:
...
def create_faqpage_model(
    model: Union[FAQPageProperties, FAQPageInheritedProperties, FAQPageAllProperties]
):
    _type = deepcopy(FAQPageAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of FAQPageAllProperties")
    delete_keys = []
...
def schema_json(model: FAQPageAllProperties):
