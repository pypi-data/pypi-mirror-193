...
class EducationalOrganizationInheritedProperties(TypedDict):
    """An educational organization.
...
class EducationalOrganizationProperties(TypedDict):
    """An educational organization.
...
class EducationalOrganizationAllProperties(
    EducationalOrganizationInheritedProperties,
    EducationalOrganizationProperties,
    TypedDict,
):
    pass


class EducationalOrganizationBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="EducationalOrganization", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        EducationalOrganizationProperties,
        EducationalOrganizationInheritedProperties,
        EducationalOrganizationAllProperties,
    ] = EducationalOrganizationAllProperties
) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "EducationalOrganization"
    return model


EducationalOrganization = create_schema_org_model()


def create_educationalorganization_model(
    model: Union[
        EducationalOrganizationProperties,
        EducationalOrganizationInheritedProperties,
        EducationalOrganizationAllProperties,
    ...
    _type = deepcopy(EducationalOrganizationAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of EducationalOrganizationAllProperties")
    delete_keys = []
...
def schema_json(model: EducationalOrganizationAllProperties):
    pydantic_type = create_educationalorganization_model(model=model)
