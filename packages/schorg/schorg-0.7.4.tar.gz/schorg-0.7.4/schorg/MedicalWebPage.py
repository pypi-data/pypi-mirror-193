...
class MedicalWebPageProperties(TypedDict):
    ...
    medicalAudience: NotRequired[
        Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]
    ]
    aspect: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]


class MedicalWebPageAllProperties(
    MedicalWebPageInheritedProperties, MedicalWebPageProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        MedicalWebPageProperties,
        MedicalWebPageInheritedProperties,
        MedicalWebPageAllProperties,
    ] = MedicalWebPageAllProperties
) -> Type[SchemaOrgBase]:
...
def create_medicalwebpage_model(
    model: Union[
        MedicalWebPageProperties,
        MedicalWebPageInheritedProperties,
        MedicalWebPageAllProperties,
    ...
    _type = deepcopy(MedicalWebPageAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of MedicalWebPageAllProperties")
    delete_keys = []
...
def schema_json(model: MedicalWebPageAllProperties):
