...
class BuyActionProperties(TypedDict):
    ...
    Attributes:
        ...
        vendor: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): 'vendor' is an earlier term for 'seller'.
    """
    ...
    vendor: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_buyaction_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of BuyActionAllProperties")
    delete_keys = []
