...
class DrugCostProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        costPerUnit: (Optional[Union[List[Union[StrictInt, StrictFloat, SchemaOrgObj, str]], StrictInt, StrictFloat, SchemaOrgObj, str]]): The cost per unit of the drug.
        ...
        costOrigin: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Additional details to capture the origin of the cost data. For example, 'Medicare Part B'.
        ...
        costCurrency: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The currency (in 3-letter) of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217.
    """
    ...
    costOrigin: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    costCategory: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    costCurrency: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_drugcost_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of DrugCostAllProperties")
    delete_keys = []
