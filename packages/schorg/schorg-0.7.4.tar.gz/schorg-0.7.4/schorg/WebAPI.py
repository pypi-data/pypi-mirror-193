...
class WebAPIProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        documentation: (Optional[Union[List[Union[AnyUrl, SchemaOrgObj, str]], AnyUrl, SchemaOrgObj, str]]): Further documentation describing the Web API in more detail.
    """
...
class WebAPIAllProperties(WebAPIInheritedProperties, WebAPIProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        WebAPIProperties, WebAPIInheritedProperties, WebAPIAllProperties
    ] = WebAPIAllProperties
) -> Type[SchemaOrgBase]:
...
def create_webapi_model(
    model: Union[WebAPIProperties, WebAPIInheritedProperties, WebAPIAllProperties]
):
    _type = deepcopy(WebAPIAllProperties)
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of WebAPIAllProperties")
    delete_keys = []
...
def schema_json(model: WebAPIAllProperties):
