...
class AirportProperties(TypedDict):
    ...
    Attributes:
        ...
        icaoCode: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): ICAO identifier for an airport.
    """

    iataCode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    icaoCode: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_airport_model(
    ...
    for k in model.__annotations__.keys():
        if k not in _type.__annotations__:
            raise TypeError(f"{k} not part of AirportAllProperties")
    delete_keys = []
