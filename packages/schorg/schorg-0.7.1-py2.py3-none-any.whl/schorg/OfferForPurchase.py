...
class OfferForPurchaseInheritedProperties(TypedDict):
    """An [[OfferForPurchase]] in Schema.org represents an [[Offer]] to sell something, i.e. an [[Offer]] whose  [[businessFunction]] is [sell](http://purl.org/goodrelations/v1#Sell.). See [Good Relations](https://en.wikipedia.org/wiki/GoodRelations) for  background on the underlying concepts.  
...
class OfferForPurchaseProperties(TypedDict):
    """An [[OfferForPurchase]] in Schema.org represents an [[Offer]] to sell something, i.e. an [[Offer]] whose  [[businessFunction]] is [sell](http://purl.org/goodrelations/v1#Sell.). See [Good Relations](https://en.wikipedia.org/wiki/GoodRelations) for  background on the underlying concepts.  
...
class AllProperties(OfferForPurchaseInheritedProperties , OfferForPurchaseProperties, TypedDict):
    pass


class OfferForPurchaseBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="OfferForPurchase",alias='@id')
...
def create_schema_org_model(type_: Union[OfferForPurchaseProperties, OfferForPurchaseInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "OfferForPurchase"
    return model
    

OfferForPurchase = create_schema_org_model()


def create_offerforpurchase_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_offerforpurchase_model(model=model)
