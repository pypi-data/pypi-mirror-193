...
class UnitPriceSpecificationProperties(TypedDict):
    ...
    Attributes:
        ...
        priceComponentType: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): Identifies a price component (for example, a line item on an invoice), part of the total price for an offer.
        billingStart: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): Specifies after how much time this price (or price component) becomes valid and billing starts. Can be used, for example, to model a price increase after the first year of a subscription. The unit of measurement is specified by the unitCode property.
        ...
        billingDuration: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): Specifies for how long this price (or price component) will be billed. Can be used, for example, to model the contractual duration of a subscription or payment plan. Type can be either a Duration or a Number (in which case the unit of measurement, for example month, is specified by the unitCode property).
        ...
        referenceQuantity: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The reference quantity for which a certain price applies, e.g. 1 EUR per 4 kWh of electricity. This property is a replacement for unitOfMeasurement for the advanced cases where the price does not relate to a standard unit.
        billingIncrement: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): This property specifies the minimal quantity and rounding increment that will be the basis for the billing. The unit of measurement is specified by the unitCode property.
    """

    priceType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    priceComponentType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    billingStart: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    unitCode: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    billingDuration: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    unitText: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    referenceQuantity: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    billingIncrement: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    


class AllProperties(UnitPriceSpecificationInheritedProperties , UnitPriceSpecificationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[UnitPriceSpecificationProperties, UnitPriceSpecificationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_unitpricespecification_model(model: AllProperties):
