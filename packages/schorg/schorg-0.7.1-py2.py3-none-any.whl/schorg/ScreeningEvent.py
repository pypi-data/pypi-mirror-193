...
class ScreeningEventProperties(TypedDict):
    ...
    Attributes:
        ...
        workPresented: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The movie presented during this event.
    """
    ...
    workPresented: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
