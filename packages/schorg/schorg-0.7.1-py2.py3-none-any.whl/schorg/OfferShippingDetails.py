...
class OfferShippingDetailsProperties(TypedDict):
    ...
    Attributes:
        ...
        doesNotShip: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Indicates when shipping to a particular [[shippingDestination]] is not available.
    ...
    shippingSettingsLink: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    doesNotShip: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    ...
    shippingOrigin: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
