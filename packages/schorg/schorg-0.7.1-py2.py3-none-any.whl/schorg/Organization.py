...
class AllProperties(OrganizationInheritedProperties , OrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[OrganizationProperties, OrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_organization_model(model: AllProperties):
