...
class MerchantReturnPolicyProperties(TypedDict):
    ...
    Attributes:
        ...
        inStoreReturnsOffered: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Are in-store returns offered? (For more advanced return methods use the [[returnMethod]] property.)
        ...
        restockingFee: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): Use [[MonetaryAmount]] to specify a fixed restocking fee for product returns, or use [[Number]] to specify a percentage of the product price paid by the customer.
    ...
    customerRemorseReturnFees: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    additionalProperty: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    itemDefectReturnLabelSource: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    inStoreReturnsOffered: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    itemCondition: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    restockingFee: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    returnPolicyCategory: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    returnLabelSource: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    applicableCountry: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    returnMethod: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    returnShippingFeesAmount: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    itemDefectReturnShippingFeesAmount: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    returnPolicySeasonalOverride: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    customerRemorseReturnShippingFeesAmount: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    returnFees: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    customerRemorseReturnLabelSource: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    merchantReturnLink: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    itemDefectReturnFees: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    merchantReturnDays: NotRequired[Union[List[Union[datetime, int, SchemaOrgObj, str, date]], datetime, int, SchemaOrgObj, str, date]]
    returnPolicyCountry: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
