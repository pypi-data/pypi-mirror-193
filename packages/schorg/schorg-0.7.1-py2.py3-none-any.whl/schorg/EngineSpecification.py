...
class EngineSpecificationProperties(TypedDict):
    ...
    engineType: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    fuelType: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    engineDisplacement: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
