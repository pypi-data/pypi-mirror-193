...
class AllProperties(MedicalStudyInheritedProperties , MedicalStudyProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalStudyProperties, MedicalStudyInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicalstudy_model(model: AllProperties):
