...
class AllProperties(SportsOrganizationInheritedProperties , SportsOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SportsOrganizationProperties, SportsOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_sportsorganization_model(model: AllProperties):
