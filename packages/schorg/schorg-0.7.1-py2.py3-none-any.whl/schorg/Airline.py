...
class AllProperties(AirlineInheritedProperties , AirlineProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AirlineProperties, AirlineInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_airline_model(model: AllProperties):
