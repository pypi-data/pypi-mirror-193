...
class AllProperties(EmploymentAgencyInheritedProperties , EmploymentAgencyProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[EmploymentAgencyProperties, EmploymentAgencyInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_employmentagency_model(model: AllProperties):
