...
class AllProperties(OnlineBusinessInheritedProperties , OnlineBusinessProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[OnlineBusinessProperties, OnlineBusinessInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_onlinebusiness_model(model: AllProperties):
