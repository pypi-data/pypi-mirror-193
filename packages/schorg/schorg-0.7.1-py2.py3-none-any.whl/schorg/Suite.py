...
class AllProperties(SuiteInheritedProperties , SuiteProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SuiteProperties, SuiteInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_suite_model(model: AllProperties):
