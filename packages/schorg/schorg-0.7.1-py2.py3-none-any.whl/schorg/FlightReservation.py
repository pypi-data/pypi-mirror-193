...
class FlightReservationProperties(TypedDict):
    ...
    securityScreening: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    passengerSequenceNumber: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    passengerPriorityStatus: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
