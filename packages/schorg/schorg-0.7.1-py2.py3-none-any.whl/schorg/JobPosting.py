...
class JobPostingProperties(TypedDict):
    ...
    Attributes:
        ...
        jobImmediateStart: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): An indicator as to whether a position is available for an immediate start.
        ...
        totalJobOpenings: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The number of positions open for this job posting. Use a positive integer. Do not use if the number of positions is unclear or not known.
        ...
        experienceInPlaceOfEducation: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Indicates whether a [[JobPosting]] will accept experience (as indicated by [[OccupationalExperienceRequirements]]) in place of its formal educational qualifications (as indicated by [[educationRequirements]]). If true, indicates that satisfying one of these requirements is sufficient.
        ...
        directApply: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Indicates whether an [[url]] that is associated with a [[JobPosting]] enables direct application for the job, via the posting website. A job posting is considered to have directApply of [[True]] if an application process for the specified job can be directly initiated via the url(s) given (noting that e.g. multiple internet domains might nevertheless be involved at an implementation level). A value of [[False]] is appropriate if there is no clear path to applying directly online for the specified job, navigating directly from the JobPosting url(s) supplied.
    ...
    incentiveCompensation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    securityClearanceRequirement: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    hiringOrganization: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    baseSalary: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    workHours: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    jobImmediateStart: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    employerOverview: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    skills: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    physicalRequirement: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    specialCommitments: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    jobStartDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    title: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    relevantOccupation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    eligibilityToWorkRequirement: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    sensoryRequirement: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    employmentType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    totalJobOpenings: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
    salaryCurrency: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    applicationContact: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    experienceInPlaceOfEducation: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    ...
    applicantLocationRequirements: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    employmentUnit: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    benefits: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    jobLocationType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    responsibilities: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    directApply: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
