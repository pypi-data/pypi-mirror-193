...
class CourseInstanceInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        remainingAttendeeCapacity: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The number of attendee places for an event that remain unallocated.
        ...
        doorTime: (Optional[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]): The time admission will commence.
        ...
        maximumVirtualAttendeeCapacity: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The maximum physical attendee capacity of an [[Event]] whose [[eventAttendanceMode]] is [[OnlineEventAttendanceMode]] (or the online aspects, in the case of a [[MixedEventAttendanceMode]]). 
        ...
        maximumPhysicalAttendeeCapacity: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The maximum physical attendee capacity of an [[Event]] whose [[eventAttendanceMode]] is [[OfflineEventAttendanceMode]] (or the offline aspects, in the case of a [[MixedEventAttendanceMode]]). 
    ...
    eventAttendanceMode: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    workFeatured: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    remainingAttendeeCapacity: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
    actor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    doorTime: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]]
    previousStartDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    ...
    maximumVirtualAttendeeCapacity: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
    ...
    maximumPhysicalAttendeeCapacity: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
...
class CourseInstanceProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        courseWorkload: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
        courseMode: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous).
        instructor: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
    """

    courseWorkload: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    courseMode: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    instructor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
