...
class AllProperties(TVClipInheritedProperties , TVClipProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TVClipProperties, TVClipInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_tvclip_model(model: AllProperties):
