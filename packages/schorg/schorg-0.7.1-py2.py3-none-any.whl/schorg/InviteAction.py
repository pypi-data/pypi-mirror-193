...
class AllProperties(InviteActionInheritedProperties , InviteActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[InviteActionProperties, InviteActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_inviteaction_model(model: AllProperties):
