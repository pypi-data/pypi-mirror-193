...
class AllProperties(ResearchOrganizationInheritedProperties , ResearchOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ResearchOrganizationProperties, ResearchOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_researchorganization_model(model: AllProperties):
