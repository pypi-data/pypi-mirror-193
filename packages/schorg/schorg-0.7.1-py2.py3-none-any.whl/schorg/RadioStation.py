...
class AllProperties(RadioStationInheritedProperties , RadioStationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[RadioStationProperties, RadioStationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_radiostation_model(model: AllProperties):
