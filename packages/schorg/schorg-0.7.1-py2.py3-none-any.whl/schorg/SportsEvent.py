...
class SportsEventProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        competitor: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): A competitor in a sports event.
        awayTeam: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The away team in a sports event.
        sport: (Optional[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]): A type of sport (e.g. Baseball).
        homeTeam: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The home team in a sports event.
    """

    competitor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    awayTeam: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    sport: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    homeTeam: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
