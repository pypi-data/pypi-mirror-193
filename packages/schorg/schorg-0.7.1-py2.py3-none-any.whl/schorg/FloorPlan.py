...
class FloorPlanProperties(TypedDict):
    ...
    layoutImage: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    numberOfAvailableAccommodationUnits: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    numberOfAccommodationUnits: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    petsAllowed: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    isPlanForApartment: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
