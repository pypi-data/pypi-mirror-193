...
class AllProperties(ScholarlyArticleInheritedProperties , ScholarlyArticleProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ScholarlyArticleProperties, ScholarlyArticleInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_scholarlyarticle_model(model: AllProperties):
