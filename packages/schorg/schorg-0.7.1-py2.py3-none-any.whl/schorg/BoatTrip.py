...
class BoatTripProperties(TypedDict):
    ...
    departureBoatTerminal: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    arrivalBoatTerminal: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
