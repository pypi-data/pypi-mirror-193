...
class AllProperties(ProjectInheritedProperties , ProjectProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ProjectProperties, ProjectInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_project_model(model: AllProperties):
