...
class CorporationProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        tickerSymbol: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO 15022.
    """

    tickerSymbol: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(CorporationInheritedProperties , CorporationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[CorporationProperties, CorporationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_corporation_model(model: AllProperties):
