...
class HealthInsurancePlanProperties(TypedDict):
    ...
    benefitsSummaryUrl: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    healthPlanId: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    healthPlanMarketingUrl: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    includesHealthPlanFormulary: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    healthPlanDrugOption: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    includesHealthPlanNetwork: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    usesHealthPlanIdStandard: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
