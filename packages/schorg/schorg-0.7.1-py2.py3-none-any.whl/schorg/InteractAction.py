...
class AllProperties(InteractActionInheritedProperties , InteractActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[InteractActionProperties, InteractActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_interactaction_model(model: AllProperties):
