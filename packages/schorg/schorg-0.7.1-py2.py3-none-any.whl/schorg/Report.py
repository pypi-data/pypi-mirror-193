...
class ReportProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        reportNumber: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The number or other unique designator assigned to a Report by the publishing organization.
    """

    reportNumber: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(ReportInheritedProperties , ReportProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ReportProperties, ReportInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_report_model(model: AllProperties):
