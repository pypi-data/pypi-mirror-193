...
class BankAccountInheritedProperties(TypedDict):
    ...
    annualPercentageRate: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    interestRate: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
...
class BankAccountProperties(TypedDict):
    ...
    accountMinimumInflow: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    accountOverdraftLimit: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    bankAccountType: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
...
def create_bankaccount_model(model: AllProperties):
