...
class MortgageLoanProperties(TypedDict):
    ...
    Attributes:
        ...
        domiciledMortgage: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Whether borrower is a resident of the jurisdiction where the property is located.
    """

    loanMortgageMandateAmount: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    domiciledMortgage: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
