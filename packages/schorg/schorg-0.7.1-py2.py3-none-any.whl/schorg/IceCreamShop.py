...
class AllProperties(IceCreamShopInheritedProperties , IceCreamShopProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[IceCreamShopProperties, IceCreamShopInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_icecreamshop_model(model: AllProperties):
