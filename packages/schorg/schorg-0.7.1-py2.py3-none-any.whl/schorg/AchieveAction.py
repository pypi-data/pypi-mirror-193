...
class AllProperties(AchieveActionInheritedProperties , AchieveActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AchieveActionProperties, AchieveActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_achieveaction_model(model: AllProperties):
