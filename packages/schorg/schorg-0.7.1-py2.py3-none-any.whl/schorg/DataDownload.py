...
class AllProperties(DataDownloadInheritedProperties , DataDownloadProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[DataDownloadProperties, DataDownloadInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_datadownload_model(model: AllProperties):
