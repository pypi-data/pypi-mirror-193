...
class AllProperties(QuoteActionInheritedProperties , QuoteActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[QuoteActionProperties, QuoteActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_quoteaction_model(model: AllProperties):
