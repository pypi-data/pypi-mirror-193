...
class AllProperties(FinancialServiceInheritedProperties , FinancialServiceProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FinancialServiceProperties, FinancialServiceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_financialservice_model(model: AllProperties):
