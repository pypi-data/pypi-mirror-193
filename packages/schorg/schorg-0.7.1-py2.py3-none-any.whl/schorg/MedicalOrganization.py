...
class AllProperties(MedicalOrganizationInheritedProperties , MedicalOrganizationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalOrganizationProperties, MedicalOrganizationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicalorganization_model(model: AllProperties):
