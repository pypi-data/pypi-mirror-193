...
class PostalAddressProperties(TypedDict):
    ...
    addressLocality: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    postOfficeBoxNumber: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
