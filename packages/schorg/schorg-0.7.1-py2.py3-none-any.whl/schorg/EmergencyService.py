...
class AllProperties(EmergencyServiceInheritedProperties , EmergencyServiceProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[EmergencyServiceProperties, EmergencyServiceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_emergencyservice_model(model: AllProperties):
