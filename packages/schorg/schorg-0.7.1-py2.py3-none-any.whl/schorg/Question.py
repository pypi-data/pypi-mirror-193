...
class QuestionProperties(TypedDict):
    ...
    Attributes:
        ...
        answerCount: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The number of answers this question has received.
    ...
    acceptedAnswer: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    suggestedAnswer: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    answerCount: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
