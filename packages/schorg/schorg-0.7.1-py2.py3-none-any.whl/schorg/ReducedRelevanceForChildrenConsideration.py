...
class ReducedRelevanceForChildrenConsiderationBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="ReducedRelevanceForChildrenConsideration",alias='@id')
...
def create_reducedrelevanceforchildrenconsideration_model(model: AllProperties):
