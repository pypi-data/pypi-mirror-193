...
class AllProperties(AssessActionInheritedProperties , AssessActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AssessActionProperties, AssessActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_assessaction_model(model: AllProperties):
