...
class ExerciseActionProperties(TypedDict):
    ...
    exerciseRelatedDiet: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    exerciseCourse: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    sportsActivityLocation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
...
def create_exerciseaction_model(model: AllProperties):
