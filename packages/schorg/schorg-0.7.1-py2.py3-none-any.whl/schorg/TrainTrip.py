...
class TrainTripProperties(TypedDict):
    ...
    arrivalStation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    departureStation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
