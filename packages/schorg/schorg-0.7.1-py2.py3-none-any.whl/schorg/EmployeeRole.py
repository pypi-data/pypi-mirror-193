...
class EmployeeRoleInheritedProperties(TypedDict):
    ...
    numberedPosition: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
...
def create_employeerole_model(model: AllProperties):
