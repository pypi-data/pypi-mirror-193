...
class MedicalRiskFactorProperties(TypedDict):
    ...
    increasesRiskOf: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    


class AllProperties(MedicalRiskFactorInheritedProperties , MedicalRiskFactorProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalRiskFactorProperties, MedicalRiskFactorInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicalriskfactor_model(model: AllProperties):
