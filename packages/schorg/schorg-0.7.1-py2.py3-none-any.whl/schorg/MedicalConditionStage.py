...
class MedicalConditionStageProperties(TypedDict):
    ...
    Attributes:
        ...
        stageAsNumber: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): The stage represented as a number, e.g. 3.
    """

    subStageSuffix: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    stageAsNumber: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
