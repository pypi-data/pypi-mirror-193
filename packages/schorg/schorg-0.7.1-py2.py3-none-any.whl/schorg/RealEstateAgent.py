...
class AllProperties(RealEstateAgentInheritedProperties , RealEstateAgentProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[RealEstateAgentProperties, RealEstateAgentInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_realestateagent_model(model: AllProperties):
