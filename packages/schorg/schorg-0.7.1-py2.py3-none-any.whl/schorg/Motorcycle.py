...
class AllProperties(MotorcycleInheritedProperties , MotorcycleProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MotorcycleProperties, MotorcycleInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_motorcycle_model(model: AllProperties):
