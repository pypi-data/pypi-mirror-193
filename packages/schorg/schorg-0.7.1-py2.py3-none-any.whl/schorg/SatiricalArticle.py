...
class AllProperties(SatiricalArticleInheritedProperties , SatiricalArticleProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SatiricalArticleProperties, SatiricalArticleInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_satiricalarticle_model(model: AllProperties):
