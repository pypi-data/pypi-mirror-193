...
class ImageObjectProperties(TypedDict):
    ...
    Attributes:
        ...
        representativeOfPage: (Optional[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]): Indicates whether this image is representative of the content of the page.
    """
    ...
    representativeOfPage: NotRequired[Union[List[Union[str, SchemaOrgObj, StrictBool]], str, SchemaOrgObj, StrictBool]]
    


class AllProperties(ImageObjectInheritedProperties , ImageObjectProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ImageObjectProperties, ImageObjectInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_imageobject_model(model: AllProperties):
