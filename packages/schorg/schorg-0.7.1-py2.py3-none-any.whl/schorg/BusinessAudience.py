...
class BusinessAudienceProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        yearlyRevenue: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The size of the business in annual revenue.
        ...
        yearsInOperation: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The age of the business.
    """

    yearlyRevenue: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    numberOfEmployees: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    yearsInOperation: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
