...
class WarrantyPromiseProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        warrantyScope: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The scope of the warranty promise.
        durationOfWarranty: (Optional[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]): The duration of the warranty promise. Common unitCode values are ANN for year, MON for months, or DAY for days.
    """

    warrantyScope: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    durationOfWarranty: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
