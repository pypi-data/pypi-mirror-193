...
class MovieTheaterProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        screenCount: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): The number of screens in the movie theater.
    """

    screenCount: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
