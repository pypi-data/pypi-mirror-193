...
class EducationalOccupationalProgramProperties(TypedDict):
    ...
    Attributes:
        ...
        termsPerYear: (Optional[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]): The number of times terms of study are offered per year. Semesters and quarters are common units for term. For example, if the student can only take 2 semesters for the program in one year, then termsPerYear should be 2.
        ...
        typicalCreditsPerTerm: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The number of credits or units a full-time student would be expected to take in 1 term however 'term' is defined by the institution.
        maximumEnrollment: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The maximum number of students who may be enrolled in the program.
    ...
    applicationDeadline: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
    timeToComplete: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    termsPerYear: NotRequired[Union[List[Union[str, StrictInt, StrictFloat, SchemaOrgObj]], str, StrictInt, StrictFloat, SchemaOrgObj]]
    ...
    financialAidEligible: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    salaryUponCompletion: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    ...
    typicalCreditsPerTerm: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
    maximumEnrollment: NotRequired[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]
    programType: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    programPrerequisites: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    educationalProgramMode: NotRequired[Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]]
    ...
    trainingSalary: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]
    endDate: NotRequired[Union[List[Union[datetime, str, SchemaOrgObj, date]], datetime, str, SchemaOrgObj, date]]
    applicationStartDate: NotRequired[Union[List[Union[str, SchemaOrgObj, date]], str, SchemaOrgObj, date]]
