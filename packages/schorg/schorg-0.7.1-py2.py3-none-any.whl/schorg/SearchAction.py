...
class AllProperties(SearchActionInheritedProperties , SearchActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SearchActionProperties, SearchActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_searchaction_model(model: AllProperties):
