...
class LiteraryEventInheritedProperties(TypedDict):
    """Event type: Literary event.
...
class LiteraryEventProperties(TypedDict):
    """Event type: Literary event.
...
class AllProperties(LiteraryEventInheritedProperties , LiteraryEventProperties, TypedDict):
    pass


class LiteraryEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="LiteraryEvent",alias='@id')
...
def create_schema_org_model(type_: Union[LiteraryEventProperties, LiteraryEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "LiteraryEvent"
    return model
    

LiteraryEvent = create_schema_org_model()


def create_literaryevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_literaryevent_model(model=model)
