...
class DietProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        endorsers: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): People or organizations that endorse the plan.
        dietFeatures: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Nutritional information specific to the dietary plan. May include dietary recommendations on what foods to avoid, what foods to consume, and specific alterations/deviations from the USDA or other regulatory body's approved dietary guidelines.
        physiologicalBenefits: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Specific physiologic benefits associated to the plan.
        expertConsiderations: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Medical expert advice related to the plan.
        risks: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Specific physiologic risks associated to the diet plan.
    """

    endorsers: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    dietFeatures: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    physiologicalBenefits: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    expertConsiderations: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    risks: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
