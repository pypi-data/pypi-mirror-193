...
class DataFeedProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        dataFeedElement: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): An item within a data feed. Data feeds may have many elements.
    """

    dataFeedElement: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
def create_datafeed_model(model: AllProperties):
