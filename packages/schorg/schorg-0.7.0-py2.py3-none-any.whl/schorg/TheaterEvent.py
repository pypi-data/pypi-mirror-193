...
class TheaterEventInheritedProperties(TypedDict):
    """Event type: Theater performance.
...
class TheaterEventProperties(TypedDict):
    """Event type: Theater performance.
...
class AllProperties(TheaterEventInheritedProperties , TheaterEventProperties, TypedDict):
    pass


class TheaterEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="TheaterEvent",alias='@id')
...
def create_schema_org_model(type_: Union[TheaterEventProperties, TheaterEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "TheaterEvent"
    return model
    

TheaterEvent = create_schema_org_model()


def create_theaterevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_theaterevent_model(model=model)
