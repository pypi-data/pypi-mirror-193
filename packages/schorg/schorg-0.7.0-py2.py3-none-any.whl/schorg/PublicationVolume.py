...
class PublicationVolumeProperties(TypedDict):
    ...
    Attributes:
        ...
        volumeNumber: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): Identifies the volume of publication or multi-part work; for example, "iii" or "2".
    ...
    volumeNumber: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
