...
class AllProperties(TelevisionStationInheritedProperties , TelevisionStationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TelevisionStationProperties, TelevisionStationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_televisionstation_model(model: AllProperties):
