...
class HowToDirectionProperties(TypedDict):
    ...
    Attributes:
        ...
        afterMedia: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A media object representing the circumstances after performing this direction.
        beforeMedia: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A media object representing the circumstances before performing this direction.
        ...
        duringMedia: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A media object representing the circumstances while performing this direction.
    ...
    afterMedia: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    beforeMedia: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    tool: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    duringMedia: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
