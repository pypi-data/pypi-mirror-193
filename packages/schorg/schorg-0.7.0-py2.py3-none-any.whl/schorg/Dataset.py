...
class DatasetProperties(TypedDict):
    ...
    Attributes:
        ...
        variableMeasured: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
    ...
    variableMeasured: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
