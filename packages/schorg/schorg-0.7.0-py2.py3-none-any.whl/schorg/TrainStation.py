...
class AllProperties(TrainStationInheritedProperties , TrainStationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TrainStationProperties, TrainStationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_trainstation_model(model: AllProperties):
