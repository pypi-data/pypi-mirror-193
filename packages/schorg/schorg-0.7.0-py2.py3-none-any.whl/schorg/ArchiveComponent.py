...
class ArchiveComponentProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        holdingArchive: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): [[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].
        itemLocation: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Current location of the item.
    """

    holdingArchive: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    itemLocation: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
