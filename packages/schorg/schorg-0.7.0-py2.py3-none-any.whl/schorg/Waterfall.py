...
class AllProperties(WaterfallInheritedProperties , WaterfallProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[WaterfallProperties, WaterfallInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_waterfall_model(model: AllProperties):
