...
class FlightProperties(TypedDict):
    ...
    webCheckinTime: NotRequired[Union[List[Union[datetime, SchemaOrgObj, str]], datetime, SchemaOrgObj, str]]
    arrivalAirport: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    estimatedFlightDuration: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    carrier: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    departureAirport: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    mealService: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    flightDistance: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    departureGate: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    departureTerminal: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    arrivalTerminal: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
