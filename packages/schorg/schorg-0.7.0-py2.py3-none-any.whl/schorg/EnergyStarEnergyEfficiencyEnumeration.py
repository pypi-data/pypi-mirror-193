...
class EnergyStarEnergyEfficiencyEnumerationBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="EnergyStarEnergyEfficiencyEnumeration",alias='@id')
...
def create_energystarenergyefficiencyenumeration_model(model: AllProperties):
