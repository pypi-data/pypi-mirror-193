...
class WebApplicationProperties(TypedDict):
    ...
    browserRequirements: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(WebApplicationInheritedProperties , WebApplicationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[WebApplicationProperties, WebApplicationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_webapplication_model(model: AllProperties):
