...
class PostalAddressProperties(TypedDict):
    ...
    Note:
        Model Depth 5
    Attributes:
        addressLocality: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The locality in which the street address is, and which is in the region. For example, Mountain View.
        postOfficeBoxNumber: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The post office box number for PO box addresses.
        streetAddress: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The street address. For example, 1600 Amphitheatre Pkwy.
    ...
    addressLocality: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    postOfficeBoxNumber: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    streetAddress: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
...
class AllProperties(PostalAddressInheritedProperties , PostalAddressProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[PostalAddressProperties, PostalAddressInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_postaladdress_model(model: AllProperties):
