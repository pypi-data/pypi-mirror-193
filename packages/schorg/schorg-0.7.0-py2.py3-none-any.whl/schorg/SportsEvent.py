...
class SportsEventInheritedProperties(TypedDict):
    """Event type: Sports event.
...
class SportsEventProperties(TypedDict):
    """Event type: Sports event.
    ...
    Note:
        Model Depth 3
    Attributes:
        competitor: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A competitor in a sports event.
        awayTeam: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The away team in a sports event.
        sport: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A type of sport (e.g. Baseball).
        homeTeam: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The home team in a sports event.
    """

    competitor: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    awayTeam: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    sport: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    homeTeam: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(SportsEventInheritedProperties , SportsEventProperties, TypedDict):
    pass


class SportsEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="SportsEvent",alias='@id')
    ...
    class Config:
        ...
        fields = {'competitor': {'exclude': True}}
        fields = {'awayTeam': {'exclude': True}}
        fields = {'sport': {'exclude': True}}
        fields = {'homeTeam': {'exclude': True}}
        


def create_schema_org_model(type_: Union[SportsEventProperties, SportsEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "SportsEvent"
    return model
    

SportsEvent = create_schema_org_model()


def create_sportsevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_sportsevent_model(model=model)
