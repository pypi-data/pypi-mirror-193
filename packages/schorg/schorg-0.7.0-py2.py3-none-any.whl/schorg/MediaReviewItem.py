...
class MediaReviewItemProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        mediaItemAppearance: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): In the context of a [[MediaReview]], indicates specific media item(s) that are grouped using a [[MediaReviewItem]].
    """

    mediaItemAppearance: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
