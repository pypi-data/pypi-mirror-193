...
class AllProperties(FinancialProductInheritedProperties , FinancialProductProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[FinancialProductProperties, FinancialProductInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_financialproduct_model(model: AllProperties):
