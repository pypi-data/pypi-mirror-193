...
class OrderProperties(TypedDict):
    ...
    isGift: NotRequired[Union[List[Union[SchemaOrgObj, str, StrictBool]], SchemaOrgObj, str, StrictBool]]
    confirmationNumber: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    ...
    discountCurrency: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    ...
    paymentMethodId: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
