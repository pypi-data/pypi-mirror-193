...
class CollectionProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        collectionSize: (Optional[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]): The number of items in the [[Collection]].
    """

    collectionSize: NotRequired[Union[List[Union[SchemaOrgObj, str, int]], SchemaOrgObj, str, int]]
