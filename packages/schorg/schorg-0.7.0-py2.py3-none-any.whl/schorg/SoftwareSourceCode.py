...
class SoftwareSourceCodeProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        targetProduct: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
        runtimePlatform: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0).
        codeSampleType: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
        runtime: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0).
        programmingLanguage: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The computer programming language.
        sampleType: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
        codeRepository: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): Link to the repository where the un-compiled, human readable code and related code is located (SVN, GitHub, CodePlex).
    """

    targetProduct: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    runtimePlatform: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    codeSampleType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    runtime: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    programmingLanguage: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    sampleType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    codeRepository: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
