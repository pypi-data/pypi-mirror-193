...
class AllProperties(MedicalTestInheritedProperties , MedicalTestProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[MedicalTestProperties, MedicalTestInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_medicaltest_model(model: AllProperties):
