...
class BlogProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        blogPosts: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates a post that is part of a [[Blog]]. Note that historically, what we term a "Blog" was once known as a "weblog", and that what we term a "BlogPosting" is now often colloquially referred to as a "blog".
        blogPost: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A posting that is part of this blog.
    ...
    blogPosts: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    blogPost: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
