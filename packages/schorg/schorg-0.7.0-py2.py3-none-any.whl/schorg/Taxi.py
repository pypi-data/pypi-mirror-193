...
class TaxiInheritedProperties(TypedDict):
    """A taxi.
...
class TaxiProperties(TypedDict):
    """A taxi.
...
class AllProperties(TaxiInheritedProperties , TaxiProperties, TypedDict):
    pass


class TaxiBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="Taxi",alias='@id')
...
def create_schema_org_model(type_: Union[TaxiProperties, TaxiInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "Taxi"
    return model
    

Taxi = create_schema_org_model()


def create_taxi_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_taxi_model(model=model)
