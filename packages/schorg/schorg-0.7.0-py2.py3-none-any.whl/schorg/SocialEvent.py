...
class AllProperties(SocialEventInheritedProperties , SocialEventProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[SocialEventProperties, SocialEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_socialevent_model(model: AllProperties):
