...
class AllProperties(BusReservationInheritedProperties , BusReservationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[BusReservationProperties, BusReservationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_busreservation_model(model: AllProperties):
