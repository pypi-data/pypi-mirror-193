...
class AllProperties(TransferActionInheritedProperties , TransferActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[TransferActionProperties, TransferActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_transferaction_model(model: AllProperties):
