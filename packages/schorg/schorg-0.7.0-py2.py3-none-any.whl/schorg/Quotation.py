...
class QuotationProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        spokenByCharacter: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
    """

    spokenByCharacter: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
