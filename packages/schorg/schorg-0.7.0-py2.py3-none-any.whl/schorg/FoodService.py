...
class FoodServiceInheritedProperties(TypedDict):
    """A food service, like breakfast, lunch, or dinner.
...
class FoodServiceProperties(TypedDict):
    """A food service, like breakfast, lunch, or dinner.
...
class AllProperties(FoodServiceInheritedProperties , FoodServiceProperties, TypedDict):
    pass


class FoodServiceBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="FoodService",alias='@id')
...
def create_schema_org_model(type_: Union[FoodServiceProperties, FoodServiceInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "FoodService"
    return model
    

FoodService = create_schema_org_model()


def create_foodservice_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_foodservice_model(model=model)
