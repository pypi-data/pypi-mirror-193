...
class AllProperties(CrematoriumInheritedProperties , CrematoriumProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[CrematoriumProperties, CrematoriumInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_crematorium_model(model: AllProperties):
