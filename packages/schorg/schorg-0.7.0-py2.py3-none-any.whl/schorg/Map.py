...
class MapProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        mapType: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): Indicates the kind of Map, from the MapCategoryType Enumeration.
    """

    mapType: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
