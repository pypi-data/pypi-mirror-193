...
class AllProperties(DanceEventInheritedProperties , DanceEventProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[DanceEventProperties, DanceEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_danceevent_model(model: AllProperties):
