...
class ClaimReviewProperties(TypedDict):
    ...
    Note:
        Model Depth 4
    Attributes:
        claimReviewed: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A short summary of the specific claims reviewed in a ClaimReview.
    """

    claimReviewed: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(ClaimReviewInheritedProperties , ClaimReviewProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ClaimReviewProperties, ClaimReviewInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_claimreview_model(model: AllProperties):
