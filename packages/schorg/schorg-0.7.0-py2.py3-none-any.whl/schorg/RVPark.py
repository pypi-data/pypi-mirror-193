...
class AllProperties(RVParkInheritedProperties , RVParkProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[RVParkProperties, RVParkInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_rvpark_model(model: AllProperties):
