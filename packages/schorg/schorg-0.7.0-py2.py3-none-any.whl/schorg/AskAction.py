...
class AskActionProperties(TypedDict):
    ...
    Note:
        Model Depth 5
    Attributes:
        question: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): A sub property of object. A question.
    """

    question: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(AskActionInheritedProperties , AskActionProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[AskActionProperties, AskActionInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_askaction_model(model: AllProperties):
