...
class ScreeningEventInheritedProperties(TypedDict):
    """A screening of a movie or other video.
...
class ScreeningEventProperties(TypedDict):
    """A screening of a movie or other video.
    ...
    Attributes:
        ...
        workPresented: (Optional[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]): The movie presented during this event.
    """
    ...
    workPresented: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class AllProperties(ScreeningEventInheritedProperties , ScreeningEventProperties, TypedDict):
    pass


class ScreeningEventBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="ScreeningEvent",alias='@id')
    ...
    class Config:
        ...
        fields = {'workPresented': {'exclude': True}}
        


def create_schema_org_model(type_: Union[ScreeningEventProperties, ScreeningEventInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "ScreeningEvent"
    return model
    

ScreeningEvent = create_schema_org_model()


def create_screeningevent_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_screeningevent_model(model=model)
