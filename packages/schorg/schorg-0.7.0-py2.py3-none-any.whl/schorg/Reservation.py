...
class AllProperties(ReservationInheritedProperties , ReservationProperties, TypedDict):
    pass
...
def create_schema_org_model(type_: Union[ReservationProperties, ReservationInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
...
def create_reservation_model(model: AllProperties):
