...
class LandmarksOrHistoricalBuildingsInheritedProperties(TypedDict):
    """An historical landmark or building.
    ...
    Attributes:
        ...
        hasMap: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A URL to a map of the place.
        ...
        maps: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A URL to a map of the place.
        ...
        map: (Optional[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]): A URL to a map of the place.
    ...
    smokingAllowed: NotRequired[Union[List[Union[SchemaOrgObj, str, StrictBool]], SchemaOrgObj, str, StrictBool]]
    ...
    hasMap: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    ...
    maps: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    ...
    containedInPlace: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    ...
    openingHoursSpecification: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    ...
    map: NotRequired[Union[List[Union[SchemaOrgObj, str, AnyUrl]], SchemaOrgObj, str, AnyUrl]]
    ...
    publicAccess: NotRequired[Union[List[Union[SchemaOrgObj, str, StrictBool]], SchemaOrgObj, str, StrictBool]]
    ...
    hasDriveThroughService: NotRequired[Union[List[Union[SchemaOrgObj, str, StrictBool]], SchemaOrgObj, str, StrictBool]]
    specialOpeningHoursSpecification: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    geoContains: NotRequired[Union[List[Union[SchemaOrgObj, str]], SchemaOrgObj, str]]
    


class LandmarksOrHistoricalBuildingsProperties(TypedDict):
    """An historical landmark or building.
...
class AllProperties(LandmarksOrHistoricalBuildingsInheritedProperties , LandmarksOrHistoricalBuildingsProperties, TypedDict):
    pass


class LandmarksOrHistoricalBuildingsBaseModel(SchemaOrgBase):
    id_ : Optional[Any] = Field(default="LandmarksOrHistoricalBuildings",alias='@id')
...
def create_schema_org_model(type_: Union[LandmarksOrHistoricalBuildingsProperties, LandmarksOrHistoricalBuildingsInheritedProperties, AllProperties] = AllProperties) -> Type[SchemaOrgBase]:
    model = create_model_from_typeddict(type_, __base__=SchemaOrgBase)
    model.__name__ = "LandmarksOrHistoricalBuildings"
    return model
    

LandmarksOrHistoricalBuildings = create_schema_org_model()


def create_landmarksorhistoricalbuildings_model(model: AllProperties):
...
def schema_json(model: AllProperties):
    pydantic_type =  create_landmarksorhistoricalbuildings_model(model=model)
