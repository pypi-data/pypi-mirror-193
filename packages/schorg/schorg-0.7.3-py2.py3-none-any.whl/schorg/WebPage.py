...
class WebPageAllProperties(WebPageInheritedProperties, WebPageProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        WebPageProperties, WebPageInheritedProperties, WebPageAllProperties
    ] = WebPageAllProperties
) -> Type[SchemaOrgBase]:
...
def create_webpage_model(
    model: Union[WebPageProperties, WebPageInheritedProperties, WebPageAllProperties]
):
    _type = deepcopy(WebPageAllProperties)
...
def schema_json(model: WebPageAllProperties):
