...
class ScreeningEventAllProperties(
    ScreeningEventInheritedProperties, ScreeningEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ScreeningEventProperties,
        ScreeningEventInheritedProperties,
        ScreeningEventAllProperties,
    ] = ScreeningEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_screeningevent_model(
    model: Union[
        ScreeningEventProperties,
        ScreeningEventInheritedProperties,
        ScreeningEventAllProperties,
    ...
    _type = deepcopy(ScreeningEventAllProperties)
...
def schema_json(model: ScreeningEventAllProperties):
