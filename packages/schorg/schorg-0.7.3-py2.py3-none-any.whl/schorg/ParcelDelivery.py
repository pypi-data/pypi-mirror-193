...
class ParcelDeliveryProperties(TypedDict):
    ...
    Attributes:
        ...
        expectedArrivalUntil: (Optional[Union[List[Union[datetime, str, date, SchemaOrgObj]], datetime, str, date, SchemaOrgObj]]): The latest date the package may arrive.
        ...
        expectedArrivalFrom: (Optional[Union[List[Union[datetime, str, date, SchemaOrgObj]], datetime, str, date, SchemaOrgObj]]): The earliest date the package may arrive.
