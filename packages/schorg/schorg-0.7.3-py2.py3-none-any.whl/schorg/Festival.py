...
class FestivalAllProperties(FestivalInheritedProperties, FestivalProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        FestivalProperties, FestivalInheritedProperties, FestivalAllProperties
    ] = FestivalAllProperties
) -> Type[SchemaOrgBase]:
...
def create_festival_model(
    model: Union[FestivalProperties, FestivalInheritedProperties, FestivalAllProperties]
):
    _type = deepcopy(FestivalAllProperties)
...
def schema_json(model: FestivalAllProperties):
