...
class EducationalOccupationalProgramProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        applicationDeadline: (Optional[Union[List[Union[str, date, SchemaOrgObj]], str, date, SchemaOrgObj]]): The date at which the program stops collecting applications for the next enrollment cycle.
        ...
        applicationStartDate: (Optional[Union[List[Union[str, date, SchemaOrgObj]], str, date, SchemaOrgObj]]): The date at which the program begins collecting applications for the next enrollment cycle.
    """
