...
class HowToAllProperties(HowToInheritedProperties, HowToProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        HowToProperties, HowToInheritedProperties, HowToAllProperties
    ] = HowToAllProperties
) -> Type[SchemaOrgBase]:
...
def create_howto_model(
    model: Union[HowToProperties, HowToInheritedProperties, HowToAllProperties]
):
    _type = deepcopy(HowToAllProperties)
...
def schema_json(model: HowToAllProperties):
