...
class ReviewAllProperties(ReviewInheritedProperties, ReviewProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        ReviewProperties, ReviewInheritedProperties, ReviewAllProperties
    ] = ReviewAllProperties
) -> Type[SchemaOrgBase]:
...
def create_review_model(
    model: Union[ReviewProperties, ReviewInheritedProperties, ReviewAllProperties]
):
    _type = deepcopy(ReviewAllProperties)
...
def schema_json(model: ReviewAllProperties):
