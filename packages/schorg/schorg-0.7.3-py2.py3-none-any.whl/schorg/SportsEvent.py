...
class SportsEventAllProperties(
    SportsEventInheritedProperties, SportsEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        SportsEventProperties, SportsEventInheritedProperties, SportsEventAllProperties
    ] = SportsEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_sportsevent_model(
    model: Union[
        SportsEventProperties, SportsEventInheritedProperties, SportsEventAllProperties
    ]
):
    _type = deepcopy(SportsEventAllProperties)
...
def schema_json(model: SportsEventAllProperties):
