...
class SoftwareApplicationAllProperties(
    SoftwareApplicationInheritedProperties, SoftwareApplicationProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        SoftwareApplicationInheritedProperties,
        SoftwareApplicationAllProperties,
    ] = SoftwareApplicationAllProperties
) -> Type[SchemaOrgBase]:
...
def create_softwareapplication_model(
    model: Union[
        SoftwareApplicationProperties,
        SoftwareApplicationInheritedProperties,
        SoftwareApplicationAllProperties,
    ...
    _type = deepcopy(SoftwareApplicationAllProperties)
...
def schema_json(model: SoftwareApplicationAllProperties):
