...
class CourseInstanceInheritedProperties(TypedDict):
    ...
    Attributes:
        ...
        previousStartDate: (Optional[Union[List[Union[str, date, SchemaOrgObj]], str, date, SchemaOrgObj]]): Used in conjunction with eventStatus for rescheduled or cancelled events. This property contains the previously scheduled start date. For rescheduled events, the startDate property should be used for the newly scheduled start date. In the (rare) case of an event that has been postponed and rescheduled multiple times, this field may be repeated.
...
class CourseInstanceProperties(TypedDict):
    ...
    courseWorkload: NotRequired[
        Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]
    ]
    courseMode: NotRequired[
        Union[List[Union[AnyUrl, str, SchemaOrgObj]], AnyUrl, str, SchemaOrgObj]
    ]
    instructor: NotRequired[Union[List[Union[str, SchemaOrgObj]], str, SchemaOrgObj]]


class CourseInstanceAllProperties(
    CourseInstanceInheritedProperties, CourseInstanceProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CourseInstanceProperties,
        CourseInstanceInheritedProperties,
        CourseInstanceAllProperties,
    ] = CourseInstanceAllProperties
) -> Type[SchemaOrgBase]:
...
def create_courseinstance_model(
    model: Union[
        CourseInstanceProperties,
        CourseInstanceInheritedProperties,
        CourseInstanceAllProperties,
    ...
    _type = deepcopy(CourseInstanceAllProperties)
...
def schema_json(model: CourseInstanceAllProperties):
