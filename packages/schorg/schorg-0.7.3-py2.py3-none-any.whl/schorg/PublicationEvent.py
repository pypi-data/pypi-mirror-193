...
class PublicationEventProperties(TypedDict):
    ...
    Attributes:
        ...
        free: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): A flag to signal that the item, event, or place is accessible for free.
...
class PublicationEventAllProperties(
    PublicationEventInheritedProperties, PublicationEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        PublicationEventProperties,
        PublicationEventInheritedProperties,
        PublicationEventAllProperties,
    ] = PublicationEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_publicationevent_model(
    model: Union[
        PublicationEventProperties,
        PublicationEventInheritedProperties,
        PublicationEventAllProperties,
    ...
    _type = deepcopy(PublicationEventAllProperties)
...
def schema_json(model: PublicationEventAllProperties):
