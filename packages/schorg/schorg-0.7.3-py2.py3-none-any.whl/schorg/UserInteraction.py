...
class UserInteractionAllProperties(
    UserInteractionInheritedProperties, UserInteractionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        UserInteractionInheritedProperties,
        UserInteractionAllProperties,
    ] = UserInteractionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_userinteraction_model(
    model: Union[
        UserInteractionProperties,
        UserInteractionInheritedProperties,
        UserInteractionAllProperties,
    ...
    _type = deepcopy(UserInteractionAllProperties)
...
def schema_json(model: UserInteractionAllProperties):
