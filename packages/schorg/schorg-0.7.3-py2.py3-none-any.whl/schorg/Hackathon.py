...
class HackathonAllProperties(
    HackathonInheritedProperties, HackathonProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        HackathonProperties, HackathonInheritedProperties, HackathonAllProperties
    ] = HackathonAllProperties
) -> Type[SchemaOrgBase]:
...
def create_hackathon_model(
    model: Union[
        HackathonProperties, HackathonInheritedProperties, HackathonAllProperties
    ]
):
    _type = deepcopy(HackathonAllProperties)
...
def schema_json(model: HackathonAllProperties):
