...
class DatasetAllProperties(DatasetInheritedProperties, DatasetProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        DatasetProperties, DatasetInheritedProperties, DatasetAllProperties
    ] = DatasetAllProperties
) -> Type[SchemaOrgBase]:
...
def create_dataset_model(
    model: Union[DatasetProperties, DatasetInheritedProperties, DatasetAllProperties]
):
    _type = deepcopy(DatasetAllProperties)
...
def schema_json(model: DatasetAllProperties):
