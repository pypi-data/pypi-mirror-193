...
class ImageObjectProperties(TypedDict):
    ...
    Attributes:
        ...
        representativeOfPage: (Optional[Union[List[Union[str, StrictBool, SchemaOrgObj]], str, StrictBool, SchemaOrgObj]]): Indicates whether this image is representative of the content of the page.
    """
