...
class InteractionCounterProperties(TypedDict):
    ...
    Attributes:
        ...
        userInteractionCount: (Optional[Union[List[Union[str, int, SchemaOrgObj]], str, int, SchemaOrgObj]]): The number of interactions for the CreativeWork using the WebSite or SoftwareApplication.
