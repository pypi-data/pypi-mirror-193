...
class GameAllProperties(GameInheritedProperties, GameProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        GameProperties, GameInheritedProperties, GameAllProperties
    ] = GameAllProperties
) -> Type[SchemaOrgBase]:
...
def create_game_model(
    model: Union[GameProperties, GameInheritedProperties, GameAllProperties]
):
    _type = deepcopy(GameAllProperties)
...
def schema_json(model: GameAllProperties):
