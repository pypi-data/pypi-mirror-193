...
class DeliveryEventProperties(TypedDict):
    ...
    availableFrom: NotRequired[
        Union[List[Union[datetime, str, SchemaOrgObj]], datetime, str, SchemaOrgObj]
    ]


class DeliveryEventAllProperties(
    DeliveryEventInheritedProperties, DeliveryEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        DeliveryEventProperties,
        DeliveryEventInheritedProperties,
        DeliveryEventAllProperties,
    ] = DeliveryEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_deliveryevent_model(
    model: Union[
        DeliveryEventProperties,
        DeliveryEventInheritedProperties,
        DeliveryEventAllProperties,
    ...
    _type = deepcopy(DeliveryEventAllProperties)
...
def schema_json(model: DeliveryEventAllProperties):
