...
class FoodEventAllProperties(
    FoodEventInheritedProperties, FoodEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        FoodEventProperties, FoodEventInheritedProperties, FoodEventAllProperties
    ] = FoodEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_foodevent_model(
    model: Union[
        FoodEventProperties, FoodEventInheritedProperties, FoodEventAllProperties
    ]
):
    _type = deepcopy(FoodEventAllProperties)
...
def schema_json(model: FoodEventAllProperties):
