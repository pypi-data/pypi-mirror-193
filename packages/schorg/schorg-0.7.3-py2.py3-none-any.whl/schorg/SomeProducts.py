...
class SomeProductsAllProperties(
    SomeProductsInheritedProperties, SomeProductsProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        SomeProductsProperties,
        SomeProductsInheritedProperties,
        SomeProductsAllProperties,
    ] = SomeProductsAllProperties
) -> Type[SchemaOrgBase]:
...
def create_someproducts_model(
    ...
    _type = deepcopy(SomeProductsAllProperties)
...
def schema_json(model: SomeProductsAllProperties):
