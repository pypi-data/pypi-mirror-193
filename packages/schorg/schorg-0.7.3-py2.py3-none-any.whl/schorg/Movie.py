...
class MovieAllProperties(MovieInheritedProperties, MovieProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        MovieProperties, MovieInheritedProperties, MovieAllProperties
    ] = MovieAllProperties
) -> Type[SchemaOrgBase]:
...
def create_movie_model(
    model: Union[MovieProperties, MovieInheritedProperties, MovieAllProperties]
):
    _type = deepcopy(MovieAllProperties)
...
def schema_json(model: MovieAllProperties):
