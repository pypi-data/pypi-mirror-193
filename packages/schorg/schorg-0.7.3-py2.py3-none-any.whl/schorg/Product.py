...
class ProductAllProperties(ProductInheritedProperties, ProductProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        ProductProperties, ProductInheritedProperties, ProductAllProperties
...
def create_product_model(
    model: Union[ProductProperties, ProductInheritedProperties, ProductAllProperties]
):
    _type = deepcopy(ProductAllProperties)
...
def schema_json(model: ProductAllProperties):
