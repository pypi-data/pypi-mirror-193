...
class SaleEventAllProperties(
    SaleEventInheritedProperties, SaleEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        SaleEventProperties, SaleEventInheritedProperties, SaleEventAllProperties
    ] = SaleEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_saleevent_model(
    model: Union[
        SaleEventProperties, SaleEventInheritedProperties, SaleEventAllProperties
    ]
):
    _type = deepcopy(SaleEventAllProperties)
...
def schema_json(model: SaleEventAllProperties):
