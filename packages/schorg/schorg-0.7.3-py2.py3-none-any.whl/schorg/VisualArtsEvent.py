...
class VisualArtsEventAllProperties(
    VisualArtsEventInheritedProperties, VisualArtsEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        VisualArtsEventProperties,
        VisualArtsEventInheritedProperties,
        VisualArtsEventAllProperties,
    ] = VisualArtsEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_visualartsevent_model(
    model: Union[
        VisualArtsEventProperties,
        VisualArtsEventInheritedProperties,
        VisualArtsEventAllProperties,
    ...
    _type = deepcopy(VisualArtsEventAllProperties)
...
def schema_json(model: VisualArtsEventAllProperties):
