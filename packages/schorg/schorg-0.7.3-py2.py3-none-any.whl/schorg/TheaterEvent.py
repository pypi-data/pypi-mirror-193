...
class TheaterEventAllProperties(
    TheaterEventInheritedProperties, TheaterEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        TheaterEventProperties,
        TheaterEventInheritedProperties,
        TheaterEventAllProperties,
    ] = TheaterEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_theaterevent_model(
    ...
    _type = deepcopy(TheaterEventAllProperties)
...
def schema_json(model: TheaterEventAllProperties):
