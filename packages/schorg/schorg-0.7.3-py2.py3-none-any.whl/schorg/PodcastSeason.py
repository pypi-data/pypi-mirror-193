...
class PodcastSeasonAllProperties(
    PodcastSeasonInheritedProperties, PodcastSeasonProperties, TypedDict
):
    pass


class PodcastSeasonBaseModel(SchemaOrgBase):
    id_: Optional[Any] = Field(default="PodcastSeason", alias="@id")
...
def create_schema_org_model(
    type_: Union[
        PodcastSeasonProperties,
        PodcastSeasonInheritedProperties,
        PodcastSeasonAllProperties,
    ] = PodcastSeasonAllProperties
) -> Type[SchemaOrgBase]:
...
def create_podcastseason_model(
    model: Union[
        PodcastSeasonProperties,
        PodcastSeasonInheritedProperties,
        PodcastSeasonAllProperties,
    ...
    _type = deepcopy(PodcastSeasonAllProperties)
...
def schema_json(model: PodcastSeasonAllProperties):
    pydantic_type = create_podcastseason_model(model=model)
