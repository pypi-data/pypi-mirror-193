...
class EventSeriesAllProperties(
    EventSeriesInheritedProperties, EventSeriesProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        EventSeriesProperties, EventSeriesInheritedProperties, EventSeriesAllProperties
    ] = EventSeriesAllProperties
) -> Type[SchemaOrgBase]:
...
def create_eventseries_model(
    model: Union[
        EventSeriesProperties, EventSeriesInheritedProperties, EventSeriesAllProperties
    ]
):
    _type = deepcopy(EventSeriesAllProperties)
...
def schema_json(model: EventSeriesAllProperties):
