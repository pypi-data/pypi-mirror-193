...
class MessageProperties(TypedDict):
    ...
    Attributes:
        ...
        dateRead: (Optional[Union[List[Union[datetime, str, date, SchemaOrgObj]], datetime, str, date, SchemaOrgObj]]): The date/time at which the message has been read by the recipient if a single recipient exists.
...
class MessageAllProperties(MessageInheritedProperties, MessageProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        MessageProperties, MessageInheritedProperties, MessageAllProperties
    ] = MessageAllProperties
) -> Type[SchemaOrgBase]:
...
def create_message_model(
    model: Union[MessageProperties, MessageInheritedProperties, MessageAllProperties]
):
    _type = deepcopy(MessageAllProperties)
...
def schema_json(model: MessageAllProperties):
