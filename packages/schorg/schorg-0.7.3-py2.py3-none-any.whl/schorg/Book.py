...
class BookAllProperties(BookInheritedProperties, BookProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        BookProperties, BookInheritedProperties, BookAllProperties
    ] = BookAllProperties
) -> Type[SchemaOrgBase]:
...
def create_book_model(
    model: Union[BookProperties, BookInheritedProperties, BookAllProperties]
):
    _type = deepcopy(BookAllProperties)
...
def schema_json(model: BookAllProperties):
