...
class EventAllProperties(EventInheritedProperties, EventProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        EventProperties, EventInheritedProperties, EventAllProperties
    ] = EventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_event_model(
    model: Union[EventProperties, EventInheritedProperties, EventAllProperties]
):
    _type = deepcopy(EventAllProperties)
...
def schema_json(model: EventAllProperties):
