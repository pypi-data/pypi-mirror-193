...
class ComedyEventAllProperties(
    ComedyEventInheritedProperties, ComedyEventProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ComedyEventProperties, ComedyEventInheritedProperties, ComedyEventAllProperties
    ] = ComedyEventAllProperties
) -> Type[SchemaOrgBase]:
...
def create_comedyevent_model(
    model: Union[
        ComedyEventProperties, ComedyEventInheritedProperties, ComedyEventAllProperties
    ]
):
    _type = deepcopy(ComedyEventAllProperties)
...
def schema_json(model: ComedyEventAllProperties):
