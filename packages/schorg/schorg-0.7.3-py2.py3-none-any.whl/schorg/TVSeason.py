...
class TVSeasonAllProperties(TVSeasonInheritedProperties, TVSeasonProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        TVSeasonProperties, TVSeasonInheritedProperties, TVSeasonAllProperties
    ] = TVSeasonAllProperties
) -> Type[SchemaOrgBase]:
...
def create_tvseason_model(
    model: Union[TVSeasonProperties, TVSeasonInheritedProperties, TVSeasonAllProperties]
):
    _type = deepcopy(TVSeasonAllProperties)
...
def schema_json(model: TVSeasonAllProperties):
