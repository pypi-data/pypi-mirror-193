...
class IndividualProductAllProperties(
    IndividualProductInheritedProperties, IndividualProductProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        IndividualProductProperties,
        IndividualProductInheritedProperties,
        IndividualProductAllProperties,
    ] = IndividualProductAllProperties
) -> Type[SchemaOrgBase]:
...
def create_individualproduct_model(
    model: Union[
        IndividualProductProperties,
        IndividualProductInheritedProperties,
        IndividualProductAllProperties,
    ...
    _type = deepcopy(IndividualProductAllProperties)
...
def schema_json(model: IndividualProductAllProperties):
