...
class VisualArtworkAllProperties(
    VisualArtworkInheritedProperties, VisualArtworkProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        VisualArtworkProperties,
        VisualArtworkInheritedProperties,
        VisualArtworkAllProperties,
    ] = VisualArtworkAllProperties
) -> Type[SchemaOrgBase]:
...
def create_visualartwork_model(
    model: Union[
        VisualArtworkProperties,
        VisualArtworkInheritedProperties,
        VisualArtworkAllProperties,
    ...
    _type = deepcopy(VisualArtworkAllProperties)
...
def schema_json(model: VisualArtworkAllProperties):
