...
class CreativeWorkSeriesAllProperties(
    CreativeWorkSeriesInheritedProperties, CreativeWorkSeriesProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        CreativeWorkSeriesProperties,
        CreativeWorkSeriesInheritedProperties,
        CreativeWorkSeriesAllProperties,
    ] = CreativeWorkSeriesAllProperties
) -> Type[SchemaOrgBase]:
...
def create_creativeworkseries_model(
    model: Union[
        CreativeWorkSeriesProperties,
        CreativeWorkSeriesInheritedProperties,
        CreativeWorkSeriesAllProperties,
    ...
    _type = deepcopy(CreativeWorkSeriesAllProperties)
...
def schema_json(model: CreativeWorkSeriesAllProperties):
