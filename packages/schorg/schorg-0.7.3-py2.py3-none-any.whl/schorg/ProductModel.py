...
class ProductModelAllProperties(
    ProductModelInheritedProperties, ProductModelProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ...
        ProductModelInheritedProperties,
        ProductModelAllProperties,
    ] = ProductModelAllProperties
) -> Type[SchemaOrgBase]:
...
def create_productmodel_model(
    ...
    _type = deepcopy(ProductModelAllProperties)
...
def schema_json(model: ProductModelAllProperties):
