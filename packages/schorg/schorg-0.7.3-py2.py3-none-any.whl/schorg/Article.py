...
class ArticleAllProperties(ArticleInheritedProperties, ArticleProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        ArticleProperties, ArticleInheritedProperties, ArticleAllProperties
    ] = ArticleAllProperties
) -> Type[SchemaOrgBase]:
...
def create_article_model(
    model: Union[ArticleProperties, ArticleInheritedProperties, ArticleAllProperties]
):
    _type = deepcopy(ArticleAllProperties)
...
def schema_json(model: ArticleAllProperties):
