...
class ClipAllProperties(ClipInheritedProperties, ClipProperties, TypedDict):
    pass
...
def create_schema_org_model(
    type_: Union[
        ClipProperties, ClipInheritedProperties, ClipAllProperties
    ] = ClipAllProperties
) -> Type[SchemaOrgBase]:
...
def create_clip_model(
    model: Union[ClipProperties, ClipInheritedProperties, ClipAllProperties]
):
    _type = deepcopy(ClipAllProperties)
...
def schema_json(model: ClipAllProperties):
