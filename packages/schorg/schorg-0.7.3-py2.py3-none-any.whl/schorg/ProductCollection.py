...
class ProductCollectionAllProperties(
    ProductCollectionInheritedProperties, ProductCollectionProperties, TypedDict
):
    pass
...
def create_schema_org_model(
    type_: Union[
        ProductCollectionProperties,
        ProductCollectionInheritedProperties,
        ProductCollectionAllProperties,
    ] = ProductCollectionAllProperties
) -> Type[SchemaOrgBase]:
...
def create_productcollection_model(
    model: Union[
        ProductCollectionProperties,
        ProductCollectionInheritedProperties,
        ProductCollectionAllProperties,
    ...
    _type = deepcopy(ProductCollectionAllProperties)
...
def schema_json(model: ProductCollectionAllProperties):
