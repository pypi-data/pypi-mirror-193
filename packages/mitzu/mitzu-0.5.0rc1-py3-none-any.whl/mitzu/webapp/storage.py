...
class StorageReference(M.Reference[M.ID]):
    ...
    def get_value_unsafe(self) -> M.ID:
        return super().get_value_unsafe()
...
class MitzuStorage:
    ...
    def get_event_data_table_definition(
        ...
        prefix = SEPC_PROJECT_PREFIX + project_id + TABLE_DEFIONITION_PREFIX
        return self.mitzu_cache.get(prefix + edt_full_name)
