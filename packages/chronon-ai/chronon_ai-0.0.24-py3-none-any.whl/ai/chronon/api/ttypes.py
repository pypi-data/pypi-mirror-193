...
class Join(object):
    ...
    def __init__(self, metaData=None, left=None, joinParts=None, skewKeys=None, onlineExternalParts=None, labelPart=None, bootstrapParts=None, rowIds=None,):
        self.metaData = metaData
        self.left = left
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i178 in range(_size174):
                        _elem179 = BootstrapPart()
                        _elem179.read(iprot)
                        self.bootstrapParts.append(_elem179)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.skewKeys is not None:
            ...
            for kiter187, viter188 in self.skewKeys.items():
                oprot.writeString(kiter187.encode('utf-8') if sys.version_info[0] == 2 else kiter187)
                oprot.writeListBegin(TType.STRING, len(viter188))
        ...
        if self.onlineExternalParts is not None:
            ...
            for iter190 in self.onlineExternalParts:
                iter190.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.bootstrapParts is not None:
            ...
            for iter191 in self.bootstrapParts:
                iter191.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
