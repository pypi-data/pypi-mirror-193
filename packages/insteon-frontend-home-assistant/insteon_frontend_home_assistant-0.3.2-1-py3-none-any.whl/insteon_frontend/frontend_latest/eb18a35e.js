...
>
  ...
  <span slot="secondary">${e.area}</span>
    ...
    `}},{kind:"method",key:"_showEditorArea",value:function(e,t){return i.dy`<div slot="introduction">
        ...
        ${t.map((e=>i.dy`
              <ha-card outlined>
                ...
                ${e.entities?e.entities.map((t=>i.dy`
                        ...
                        `)):i.dy` <ha-form .schema=${Q.kT}></ha-form> `};
              </ha-card>
            `))}
      ...
      </ha-config-section>`}},{kind:"method",key:"_setSceneDevices",value:function(){const e=[];if(!this._scene)return[];for(const[t,r]of Object.entries(this._scene.devices)){const i=this._insteonToHaDeviceMap[t]||void 0,n=i.entities||{},o=[];let s;for(const[e,a]of Object.entries(n)){const n=r.find((t=>t.data3==+e)),l=(null==n?void 0:n.data1)||0,d=(null==n?void 0:n.data2)||28,p=(null==n?void 0:n.data3)||e,h=!!n;o.push({entity_id:a.entity_id,name:(0,c.C)(this.hass.states[a.entity_id])||"Device button "+e,is_in_scene:h,data1:l,data2:d,data3:+p}),s={address:t,device_id:i.device.id,name:(0,f.jL)(i.device,this.hass,this._deviceEntityLookup[i.device.id]),entities:o}}s&&e.push(s)}return e}},{kind:"method",key:"firstUpdated",value:function(e){ae(ce(r.prototype),"firstUpdated",this).call(this,e),this.hass&&this.insteon&&(this.hassSubscribe(),!this._scene&&this.sceneId?this._loadScene():this._initNewScene(),this.style.setProperty("--app-header-background-color","var(--sidebar-background-color)"),this.style.setProperty("--app-header-text-color","var(--sidebar-text-color)"),this.style.setProperty("--app-header-border-bottom","1px solid var(--divider-color)"),this.style.setProperty("--ha-card-border-radius","var(--ha-config-card-border-radius, 8px)"))}},{kind:"method",key:"updated",value:function(e){ae(ce(r.prototype),"updated",this).call(this,e),this.hass&&this.insteon&&(e.has("_deviceRegistryEntries")||e.has("_entityRegistryEntries"))&&this._mapDeviceEntities()}},{kind:"method",key:"_initNewScene",value:function(){this._dirty=!1;const e=(()=>{const e=W;return W=void 0,e})();this._scene={name:this.insteon.localize("scenes.scene.default_name"),devices:{},group:-1},this._dirty=void 0!==e&&(void 0!==e.areaId||void 0!==e.config)}},{kind:"method",key:"_mapDeviceEntities",value:function(){this._insteonToHaDeviceMap={},this._haToinsteonDeviceMap={},this._deviceRegistryEntries.map((e=>{const t=e.identifiers[0][1],r={};this._entityRegistryEntries.filter((t=>t.device_id==e.id)).map((e=>{const t=this.hass.states[e.entity_id].attributes.insteon_group;r[t]=e})),this._insteonToHaDeviceMap[t]={device:e,entities:r},this._haToinsteonDeviceMap[e.id]=t}));for(const e of this._entityRegistryEntries)e.device_id&&!R.includes((0,a.M)(e.entity_id))&&(e.device_id in this._deviceEntityLookup||(this._deviceEntityLookup[e.device_id]=[]),this._deviceEntityLookup[e.device_id].includes(e.entity_id)||this._deviceEntityLookup[e.device_id].push(e.entity_id))}},{kind:"method",key:"_handleMenuAction",value:async function(e){if(0===e.detail.index)this._deleteTapped()}},{kind:"method",key:"_showSetOnLevel",value:function(e){e.stopPropagation();const t=e.currentTarget.device_address,r=e.currentTarget.group,i=this._scene.devices[t];let n=i.find((e=>e.data3==+r));n||(this._selectEntity(!0,i,r),n=i.find((e=>e.data3==+r)));const o=(this._insteonToHaDeviceMap[t].entities||{})[+r];de.includes((0,a.M)(o.entity_id))&&this._setOnLevel(t,r,n.data1,0==n.data2?28:n.data2)}},{kind:"method",key:"_setOnLevel",value:async function(e,t,r,i){var n,o;n=this,o={hass:this.hass,insteon:this.insteon,title:this.insteon.localize("device.actions.add"),address:e,group:t,value:r,ramp_rate:i,callback:async(e,t,r,i)=>this._handleSetOnLevel(e,t,r,i)},(0,p.B)(n,"show-dialog",{dialogTag:"dialog-insteon-scene-set-on-level",dialogImport:J,dialogParams:o}),history.back()}},{kind:"method",key:"_handleSetOnLevel",value:function(e,t,r,i){const n=this._scene.devices[e].find((e=>e.data3==+t));n.data1!=r&&(n.data1=r,this._dirty=!0),n.data2!=i&&(n.data2=i,this._dirty=!0),this._dirty&&(this._scene={...this._scene})}},{kind:"method",key:"_loadScene",value:async function(){this._scene=await(0,Q.o5)(this.hass,+this.sceneId);for(const e in Object.keys(this._scene.devices)){const t=this._deviceRegistryEntries.find((t=>t.identifiers[0][1]===e)),r=(null==t?void 0:t.id)||void 0;r&&this._pickDevice(r)}this._dirty=!1}},{kind:"method",key:"_pickDevice",value:function(e){const t=this._deviceRegistryEntries.find((t=>t.id==e)),r=null==t?void 0:t.identifiers[0][1];if(!r)return;if(this._scene.devices.hasOwnProperty(r))return;const i={...this._scene};i.devices[r]=[],this._scene={...i},this._dirty=!0}},{kind:"method",key:"_devicePicked",value:function(e){const t=e.detail.value;e.target.value="",this._pickDevice(t)}},{kind:"method",key:"_deleteDevice",value:function(e){const t=e.target.device_address,r={...this._scene};r.devices.hasOwnProperty(t)&&delete r.devices[t],this._scene={...r},this._dirty=!0}},{kind:"method",key:"_toggleSelection",value:function(e){const t=e.target.device_address,r=e.target.checked,i=e.target.group,n=this._scene.devices[t];this._selectEntity(r,n,i),this._scene={...this._scene},this._dirty=!0}},{kind:"method",key:"_selectEntity",value:function(e,t,r){if(e){const e=t.find((e=>e.data3==+r));if(e)return;const i={data1:0,data2:0,data3:r,has_controller:!1,has_responder:!1};t.push(i)}else{const e=t.findIndex((e=>e.data3==+r));-1!==e&&t.splice(e,1)}this._dirty=!0}},{kind:"method",key:"_toggleOnLevel",value:function(e){const t=e.target.device_address,r=e.target.checked,i=e.target.group,n=this._scene.devices[t];let o=n.find((e=>e.data3==+i));if(o||(this._selectEntity(!0,n,+i),o=n.find((e=>e.data3==+i))),r){o.data1=255;const e=((this._insteonToHaDeviceMap[t]||void 0).entities||{})[+i];de.includes((0,a.M)(e.entity_id))&&(o.data2=28)}else o.data1=0,o.data2=0;this._scene={...this._scene},this._dirty=!0}},{kind:"method",key:"_nameChanged",value:function(e){var t,r;e.stopPropagation();const i=e.target,n=i.name;if(!n)return;let o=null!==(t=null===(r=e.detail)||void 0===r?void 0:r.value)&&void 0!==t?t:i.value;"number"===i.type&&(o=Number(o)),(this._scene[n]||"")!==o&&(o?this._scene={...this._scene,[n]:o}:(delete this._scene[n],this._scene={...this._scene}),this._scene={...this._scene},this._dirty=!0)}},{kind:"field",key:"_backTapped",value(){return async()=>{await this.confirmUnsavedChanged()&&this._goBack()}}},{kind:"method",key:"_goBack",value:function(){(0,s.T)((()=>history.back()))}},{kind:"method",key:"confirmUnsavedChanged",value:async function(){if(this._dirty){const e=(0,B.g7)(this,{title:this.hass.localize("ui.panel.config.scene.editor.unsaved_confirm_title"),text:this.hass.localize("ui.panel.config.scene.editor.unsaved_confirm_text"),confirmText:this.hass.localize("ui.common.leave"),dismissText:this.hass.localize("ui.common.stay"),destructive:!0});return history.back(),e}return!0}},{kind:"method",key:"_deleteTapped",value:function(){(0,B.g7)(this,{text:this.hass.localize("ui.panel.config.scene.picker.delete_confirm"),confirmText:this.hass.localize("ui.common.delete"),dismissText:this.hass.localize("ui.common.cancel"),confirm:()=>this._delete()}),history.back()}},{kind:"method",key:"_delete",value:async function(){this._saving=!0;const e=+this.sceneId,t=await(0,Q.Kw)(this.hass,e);this._saving=!1,t.result||((0,B.Ys)(this,{text:this.insteon.localize("common.error.scene_write"),confirmText:this.hass.localize("ui.common.close")}),history.back()),history.back()}},{kind:"method",key:"_saveScene",value:async function(){if(!this._checkDeviceEntitySelections())return(0,B.Ys)(this,{text:this.insteon.localize("common.error.scene_device_no_entities"),confirmText:this.hass.localize("ui.common.close")}),void history.back();this._saving=!0;const e=[];Object.keys(this._scene.devices).forEach((t=>{this._scene.devices[t].forEach((r=>{const i={address:t,data1:r.data1,data2:r.data2,data3:r.data3};e.push(i)}))}));const t=await(0,Q.tW)(this.hass,this._scene.group,e,this._scene.name);this._saving=!1,this._dirty=!1,t.result?this.sceneId||(0,I.c)(`/insteon/scene/${t.scene_id}`,{replace:!0}):((0,B.Ys)(this,{text:this.insteon.localize("common.error.scene_write"),confirmText:this.hass.localize("ui.common.close")}),history.back())}},{kind:"method",key:"_checkDeviceEntitySelections",value:function(){for(const[e,t]of Object.entries(this._scene.devices))if(0==t.length)return!1;return!0}},{kind:"method",key:"handleKeyboardSave",value:function(){this._saveScene()}},{kind:"get",static:!0,key:"styles",value:function(){return[H.Qx,i.iv`
        ha-card {
          overflow: hidden;
        }
        .errors {
      ...
      `]}}]}}),(0,v.f)((he=i.oi,class extends he{constructor(...e){super(...e),L(this,"_keydownEvent",(e=>{(e.ctrlKey||e.metaKey)&&"s"===e.key&&(e.preventDefault(),this.handleKeyboardSave())}))}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._keydownEvent)}disconnectedCallback(){this.removeEventListener("keydown",this._keydownEvent),super.disconnectedCallback()}handleKeyboardSave(){}})));var he}}]);
//# sourceMappingURL=eb18a35e.js.map