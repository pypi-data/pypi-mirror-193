...
import LWD_utils.global_val as global_val

sys.path.append("../../PaperCrawlerUtil")
from LWD_utils.proxypool.processors.server import app
from LWD_utils.proxypool.processors.getter import Getter
from LWD_utils.proxypool.processors.tester import Tester
from LWD_utils.proxypool.setting import APP_PROD_METHOD_GEVENT, APP_PROD_METHOD_MEINHELD, APP_PROD_METHOD_TORNADO, API_THREADED, \
    IS_PROD, APP_PROD_METHOD, IS_WINDOWS
from loguru import logger
from LWD_utils.constant import *
...
class Scheduler():
    ...
    def run(self):
        ...
        try:
            logger.info('starting LWD_utils.proxypool...')
