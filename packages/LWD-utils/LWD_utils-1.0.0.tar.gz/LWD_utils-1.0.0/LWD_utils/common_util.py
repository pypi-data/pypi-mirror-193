...
from LWD_utils.proxypool.storages.proxy_dict import ProxyDict

sys.path.append("LWD_utils")
sys.path.append("LWD_utils/proxypool")
sys.path.append("LWD_utils/proxypool/*")
...
import time
import requests
from LWD_utils.proxypool.setting import *
