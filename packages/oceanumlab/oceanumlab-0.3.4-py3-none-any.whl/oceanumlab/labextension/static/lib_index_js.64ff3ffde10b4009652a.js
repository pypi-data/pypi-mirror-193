...
const datasourceCode = (datasource, notebook, icell) => {
    ...
    if (datasource.variables ||
        ...
        datasourceStr += `=datamesh.query(${JSON.stringify(datasource).replace(/null/g, 'None')})`;
    }
    else {
    ...
    constructor(props) {
        ...
        this.insertDatameshConnect = async (datasource) => {
            ...
            if (widget instanceof _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2__.NotebookPanel) {
                ...
                if (datameshTokenInject) {
                    _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2__.NotebookActions.setCellCollapse(notebookContent.widgets[0], true);
...
//# sourceMappingURL=lib_index_js.64ff3ffde10b4009652a.js.map