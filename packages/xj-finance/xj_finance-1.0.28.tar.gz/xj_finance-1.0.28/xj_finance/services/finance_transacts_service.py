...
class FinanceTransactsService:
    ...
    def get(params, user_id):
        ...
        if params['transact_time_start'] and params['transact_time_end']:
            transacts = transacts.filter(transact_time__range=(params['transact_time_start'], params['transact_time_end']))
