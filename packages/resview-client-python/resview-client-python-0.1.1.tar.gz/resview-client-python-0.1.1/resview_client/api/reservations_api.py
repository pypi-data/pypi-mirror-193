...
class ReservationsApi(object):
    ...
    def reservation_get_batch_api_reservations_get_batch_post(
        ...
        **kwargs
        ...
        Returns all reservations in the batch request.  # noqa: E501
    ...
    def reservations_list_api_reservations_get(
        ...
        **kwargs
        ...
        Returns a list of reservations.  :param limit: The maximum number of reservations to return. :param start_key: The key to start the scan from. :param status: The status of the reservation to filter by.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
