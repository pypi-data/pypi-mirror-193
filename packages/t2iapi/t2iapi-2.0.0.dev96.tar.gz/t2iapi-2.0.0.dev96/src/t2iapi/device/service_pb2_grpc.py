...
class DeviceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRemovableDescriptors = channel.unary_unary(
                '/t2iapi.device.DeviceService/GetRemovableDescriptors',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
...
class DeviceServiceServicer(object):
    ...
    def GetRemovableDescriptors(self, request, context):
        """
...
def add_DeviceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetRemovableDescriptors': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRemovableDescriptors,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
...
class DeviceService(object):
    ...
    @staticmethod
    def GetRemovableDescriptors(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.device.DeviceService/GetRemovableDescriptors',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
