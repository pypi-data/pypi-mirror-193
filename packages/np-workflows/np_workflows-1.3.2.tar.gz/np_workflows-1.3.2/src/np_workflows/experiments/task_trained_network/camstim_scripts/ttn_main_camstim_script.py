...
old_repeats, reversed_repeats, annotated_repeats = (
    main_params["stim_repeats"][key] for key in ("old", "reversed", "annotated")
)
old_sec, reversed_sec, annotated_sec = (
    main_params["stim_lengths_sec"][key] for key in ("old", "reversed", "annotated")
)
...
for stim_file, duration_sec in segment_stim_secs:
    segment = Stimulus_v2.from_file(stim_file, window)
