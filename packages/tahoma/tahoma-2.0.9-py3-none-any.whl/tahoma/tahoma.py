...
version ='tahoma - Version '+ __version__+' - by @pzim-devdata'
...
def main():
    ...
    def info():
        ...
        print( "------*       "+version+"        *-------" )
        print( "      ***************************************************************        " )
        print( "                python3 -m pip install tahoma-pzim -U" )
    ...
    for arg in sys.argv :
        if arg == '-g' or arg == '--getlist' :
            try :
                import ext_modules.get_devices_url
                exit()
            except Exception as e: 
                print(e)
                exec((open(os.path.dirname(os.path.abspath(__file__))+"/ext_modules/get_devices_url.py")).read())
                exit()
