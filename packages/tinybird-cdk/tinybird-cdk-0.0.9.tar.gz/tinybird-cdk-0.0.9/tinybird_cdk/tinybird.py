...
class Client:
    ...
    def __init__(self):
        self.tb_cdk_token = config.get('TB_CDK_TOKEN')
        self.tb_cdk_tag = config.get('TB_CDK_TAG')
        self.tb_cdk_endpoint = config.get('TB_CDK_ENDPOINT', default='https://api.tinybird.co').rstrip('/')
        headers = {
