...
INSERT INTO analysis_pool VALUES('CMS_13_EEJET','13TeV','e+e- at the Z pole, plus optional jets');
INSERT INTO analysis_pool VALUES('CMS_13_MMJET','13TeV','mu+mu- at the Z pole, plus optional jets');
...
--2.76 TeV hadronic
INSERT INTO analysis VALUES('CMS_2021_I1963239','pb','CMS_2_76_DJET');

-- 7 TeV fully hadronic
INSERT INTO analysis VALUES('ATLAS_2016_I1478355','pb','ATLAS_7_JETS');
...
-- plots in pb
INSERT INTO analysis VALUES('ATLAS_2017_I1627873','pb','ATLAS_13_LLJET');
INSERT INTO analysis VALUES('CMS_2022_I2079374:LMODE=EL','pb','CMS_13_EEJET'); -- These two are CMS Inlusive DY measurements
INSERT INTO analysis VALUES('CMS_2022_I2079374:LMODE=MU','pb','CMS_13_MMJET');
INSERT INTO analysis VALUES('ATLAS_2022_I2077570:LMODE=ELEL','pb','ATLAS_13_EEJET'); -- Z+jets
INSERT INTO analysis VALUES('ATLAS_2022_I2077570:LMODE=MUMU','pb','ATLAS_13_MMJET'); -- Z+jets
...
INSERT INTO analysis VALUES('CMS_2021_I1866118','pb','ATLAS_13_MMJET'); -- DY Z production -> mm 
...
INSERT INTO analysis VALUES('ATLAS_2022_I2077575', 'fb', 'ATLAS_13_TTHAD'); -- Hadronic top pairs (fb) boosted
...
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d22-x01-y01','/REF/ATLAS_2019_I1734263/d24-x01-y01',1);
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d25-x01-y01','/REF/ATLAS_2019_I1734263/d27-x01-y01',1);
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d28-x01-y01','/REF/ATLAS_2019_I1734263/d30-x01-y01',1);
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d31-x01-y01','/REF/ATLAS_2019_I1734263/d33-x01-y01',1);
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d34-x01-y01','/REF/ATLAS_2019_I1734263/d36-x01-y01',1);
INSERT INTO covariances VALUES('/REF/ATLAS_2019_I1734263/d37-x01-y01','/REF/ATLAS_2019_I1734263/d39-x01-y01',1);
...
INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d14[0-2]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d16[7-9]-x01-y01');
INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d170-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d19[5-8]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d22[3-6]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d25[1-4]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d279-x01-y01');
INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d28[0-2]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d30[7-9]-x01-y01');
INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d310-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d33[5-8]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d36[3-6]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d39[1-4]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d40[5-8]-x01-y01');

INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d419-x01-y01');
INSERT INTO blacklist VALUES('ATLAS_2020_I1801434','d42[0-2]-x01-y01');

-- remove the correlations
INSERT INTO blacklist VALUES('ATLAS_2019_I1720442','d1[5-9]');
INSERT INTO blacklist VALUES('ATLAS_2019_I1720442','d2[0-9]');
...
INSERT INTO blacklist VALUES('ATLAS_2019_I1734263','d4[1-3]-x01-y01');
...
INSERT INTO blacklist VALUES('ATLAS_2013_I1217863:LMODE=ZEL','d1[7-8]');
...
INSERT INTO blacklist VALUES('ATLAS_2016_I1426515','d1[0-5]-x01-y02');
...
INSERT INTO blacklist VALUES('CMS_2016_I1491950','d6[0-9]-x02-y01');
INSERT INTO blacklist VALUES('CMS_2016_I1491950','d7[0-9]-x02-y01');
INSERT INTO blacklist VALUES('CMS_2016_I1491950','d8[0-1]-x02-y01');
...
INSERT INTO blacklist VALUES('ATLAS_2016_I1502620:LMODE=WEL','d35-x01-y0[1-2]');
INSERT INTO blacklist VALUES('ATLAS_2016_I1502620:LMODE=WMU','d35-x01-y0[1-2]');

INSERT INTO blacklist VALUES('CMS_2018_I1662081','d0[1-7]');

-- CMS jet mass normalised plots.
INSERT INTO blacklist VALUES('CMS_2018_I1682495','d2[5-9]');
INSERT INTO blacklist VALUES('CMS_2018_I1682495','d3[0-9]');
INSERT INTO blacklist VALUES('CMS_2018_I1682495','d4[0-9]');

-- BG subtracted tt bb
INSERT INTO blacklist VALUES('ATLAS_2018_I1705857','d0[2-4]');
...
INSERT INTO blacklist VALUES('CMS_2021_I1932460','d1[0-4]-x01-y01'); 
...
-- ttbar whitelist only the particle-level absolute xs
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d0[2-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d1[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d2[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d3[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d4[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d5[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d6[0-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2022_I2077575','d7[1-4]-x01-y01');
...
--
INSERT INTO whitelist VALUES('ATLAS_2014_I1279489','d01-x0[1-2]-y01');
INSERT INTO whitelist VALUES('ATLAS_2014_I1279489','d02-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2014_I1279489','d03-x0[1-2]-y01');
INSERT INTO whitelist VALUES('ATLAS_2014_I1279489','d04-x0[1-2]-y01');
INSERT INTO whitelist VALUES('ATLAS_2014_I1279489','d05-x0[3-5]-y01');
--
INSERT INTO whitelist VALUES('ATLAS_2014_I1307243','d1[3-9]');
INSERT INTO whitelist VALUES('ATLAS_2014_I1307243','d2[0-8]');
--
...
--
INSERT INTO whitelist VALUES('ATLAS_2018_I1646686','d0[1-9]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2018_I1646686','d1[0-4]-x01-y01');
--
...
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d17[0-2]-');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d1[8-9]-');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d20-');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d2[2-5]-');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d2[7-9]-');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d30-');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d3[2-5]-');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d3[7-9]');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d40');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d4[2-5]');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d4[7-9]');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d5[0-4]');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d5[6-9]');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d6[0-3]');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d6[5-9]');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d7[0-2]');

INSERT INTO whitelist VALUES('CMS_2018_I1663958','d7[4-9]');
INSERT INTO whitelist VALUES('CMS_2018_I1663958','d8[0-1]');
...
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d6[4-7]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d69');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d7[0-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d8[0-3]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d8[5-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d9[0-1]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d9[3-8]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d11[0-5]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d13[5-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=EL','d14[0-9]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d10');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d6[4-7]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d69');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d7[0-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d8[0-3]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d8[5-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d9[0-8]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d11[0-5]');

INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d13[5-9]');
INSERT INTO whitelist VALUES('ATLAS_2017_I1517194:LMODE=MU','d14[0-9]');
...
INSERT INTO whitelist VALUES('ATLAS_2016_I1458270','d0[4-9]-x01-y01');
...
INSERT INTO whitelist VALUES('ATLAS_2018_I1707015:LMODE=DILEPTON','d0[6-9]');
...
-- gamma ll
INSERT INTO whitelist VALUES('ATLAS_2016_I1448301:LMODE=LL','d0[5-6]-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2016_I1448301:LMODE=LL','d09-x01-y01');
INSERT INTO whitelist VALUES('ATLAS_2016_I1448301:LMODE=LL','d1[0-1]-x01-y01');

-- HMDY ee
INSERT INTO whitelist VALUES('ATLAS_2016_I1467454:LMODE=EL','d1[8-9]');
INSERT INTO whitelist VALUES('ATLAS_2016_I1467454:LMODE=EL','d2[0-8]');

-- HMDY mumu
INSERT INTO whitelist VALUES('ATLAS_2016_I1467454:LMODE=MU','d29');
INSERT INTO whitelist VALUES('ATLAS_2016_I1467454:LMODE=MU','d3[0-9]');
...
INSERT INTO whitelist VALUES('CMS_2019_I1753680:LMODE=EL','d2[6-8]-x01-y02');
-- INSERT INTO whitelist VALUES('CMS_2019_I1753680:LMODE=EL','d29-x01-y02'); these are LL
INSERT INTO whitelist VALUES('CMS_2019_I1753680:LMODE=MU','d2[6-8]-x01-y01');
-- INSERT INTO whitelist VALUES('CMS_2019_I1753680:LMODE=MU','d29-x01-y01'); these are LL
...
-- 13TeV ttbar boosted
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d2[2-5])','y_2');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d2[6-9])','Pt_1');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d3[0-3])','Pt_2');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d3[4-7])','P_tt');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d3[8-9]|d4[0-1])','Pt_1');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d4[2-5])','y_tt/Pt_1');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d4[6-9])','y_tt/y_1');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d5[0-3])','y_t1/m_tt');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d5[4-7])','y_tt/Pt_1');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d5[8-9]|d6[0-1])','P_tt/m_tt');
INSERT INTO subpool VALUES('ATLAS_2022_I2077575','(d6[2-5])','y_tt/P_tt');
...
INSERT INTO theory_predictions VALUES('A', 'ATLAS_2022_I2077575','2077575','REF','y01','y03',
       'ATLAS_2022_I2077575-Theory.yoda',
       'POWHEG+Pythia8',
       'Taken from the HEPData record of the experimental paper. No uncertainties.');
INSERT INTO theory_predictions VALUES('A','ATLAS_2019_I1764342','1764342,1736301','REF','y01','y04',
       'ATLAS_2019_I1764342-Theory.yoda',
       'Sherpa NLO',
       'Taken from the HEPData record of the experimental paper. No uncertainties.');
INSERT INTO theory_predictions VALUES('B','ATLAS_2019_I1764342','1736301','SPECIAL',NULL,NULL,
       'ATLAS_2019_I1764342-Theory_B.yoda',
       'Sherpa NLO (2)',
...
INSERT INTO theory_predictions VALUES('A','ATLAS_2016_I1448301:LMODE=EL','1357993,897881','RAW','d01-x01-y01|d03-x01-y01',NULL,
...
INSERT INTO theory_predictions VALUES('A','ATLAS_2016_I1448301:LMODE=MU','1357993,897881','RAW','d01-x01-y02|d03-x01-y02',NULL,
...
INSERT INTO theory_predictions VALUES('A','ATLAS_2017_I1591327','1664354,939520','SPECIAL','d',NULL,
