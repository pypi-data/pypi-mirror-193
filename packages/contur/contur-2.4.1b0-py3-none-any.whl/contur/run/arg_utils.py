...
#                            type=dict, help="Dict of colours for the 68/95 contours")
    ...
    if "io" in active_groups:
        ...
        io.add_argument("--map", dest="MAPFILE", default=None,
        ...
        io.add_argument("--addtoDB", action="store_true", dest="ADD_DB", default=False,
                             help="add results of an existing DB file")
        io.add_argument("--keep-hepmc", action="store_true", dest="KEEPHEPMC", default=False,
                             help="preserve the HepMC files if they are being generated.")
    ...
    if "batch" in active_groups:
        ...
        parser.add_argument("-o", "--outputdir", dest="OUTPUTDIR", type=str,
                            default=cfg.batch_output_dir, help="Specify the output directory name.")
        ...
        parser.add_argument('-b', '--beams', dest="BEAMS", default="13TeV", type=str,
                            help=f"Generate events using these beams. Known beams are {get_beam_names(allow_all=True)}. NOTE: em_ep_91_2 is currently beta, see https://gitlab.com/hepcedar/rivet/-/issues/293.")
        ...
        parser.add_argument("--main_program", dest="main_program", default="main93",
    ...
    if "xsbf" in active_groups:
        ...
        parser.add_argument("--bsm-br", "--foldBSMBRs", help="Whether or not to fold in the BSM branching ratios ",
