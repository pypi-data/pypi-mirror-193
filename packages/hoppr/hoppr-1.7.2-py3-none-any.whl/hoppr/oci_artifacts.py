...
from oras.provider import Registry  # type: ignore
...
def _create_client_info(artifact: str) -> Tuple[Container, oras.client.OrasClient]:
    ...
    creds = Credentials.find_credentials(container.registry)
    if creds is not None:
        registry.set_basic_auth(creds.username, creds.password)
