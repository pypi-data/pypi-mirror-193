...
class V1LightningworkSpec(object):
    ...
    def __init__(
        self,
        build_spec: 'V1BuildSpec' = None,
        cluster_driver: 'V1LightningworkClusterDriver' = None,
        cluster_id: 'str' = None,
        compute_config: 'V1ComputeConfig' = None,
        desired_state: 'V1LightningworkState' = None,
        drives: 'list[V1LightningworkDrives]' = None,
        env: 'list[V1EnvVar]' = None,
        lightningapp_instance_id: 'str' = None,
        network_config: 'list[V1NetworkConfig]' = None,
        pause_automation: 'bool' = None,
        restart_policy: 'V1LightningappRestartPolicy' = None,
        user_id: 'str' = None,
        user_requested_compute_config: 'V1UserRequestedComputeConfig' = None
    ):  # noqa: E501
    ...
    def user_requested_compute_config(
            self,
            user_requested_compute_config: 'V1UserRequestedComputeConfig'):
