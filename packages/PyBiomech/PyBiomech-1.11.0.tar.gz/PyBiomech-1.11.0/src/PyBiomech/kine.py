...
#        tip2 = P2 + u2 + v
    ...
    # Collect all global marker positions
    mkrsAll = {}
    mkrsAll[nameP1] = P1
    mkrsAll[nameP2] = P2
    mkrsAll[nameP3] = P3
    ...
    # Get wand direction
    mkrDirectionTo = mkrsAll[args['direction']['to']]
    mkrDirectionFrom = mkrsAll[args['direction']['from']] + v
    direction = mkrDirectionTo - mkrDirectionFrom
    direction /= np.linalg.norm(direction, axis=1)
    directionMarkers = args['directionMarkers']
    pathDirection = [None] * 2
    pathDirection[0] = mkrsAll[directionMarkers[0]]
    if (type(directionMarkers[1]) is dict):
        pathDirection[1] = pathDirection[0] + directionMarkers[1]['aheadOf'] * direction
    else:
        pathDirection[1] = mkrsAll[directionMarkers[1]]
    
    infoFitting['pathDirection'] = pathDirection
