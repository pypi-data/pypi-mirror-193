...
<<<<<<< HEAD
> **Alacorder should automatically download and install missing dependencies upon setup, but you can also install them yourself with `pip`: `pandas`, `numpy`, `PyPDF2`, `openpyxl`, `xlrd`, `xlwt`, `xarray`, `numexpr`, `bottleneck`, `tables` (pytables), and `click`. Recommended dependencies: `xlsxwriter`, `jupyter`, `tabulate`, `matplotlib`.**
=======
...
>>>>>>> 3d9f05ca3f6f29d9efd279388c4de3561bddbc5b
