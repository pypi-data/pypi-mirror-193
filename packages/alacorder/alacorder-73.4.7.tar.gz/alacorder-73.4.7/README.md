...
* To install on Windows and Mac, open Command Prompt (Terminal) and enter `pip install alacorder` or `pip3 install alacorder`. 
    * To start the interface, enter `python -m alacorder.guided` or `python3 -m alacorder.guided`.
...
1.  *Import the library from your command line:* Depending on your Python configuration, enter `python -m alacorder.guided` or `python3 -m alacorder.guided` to launch the guided interface in module mode. 
