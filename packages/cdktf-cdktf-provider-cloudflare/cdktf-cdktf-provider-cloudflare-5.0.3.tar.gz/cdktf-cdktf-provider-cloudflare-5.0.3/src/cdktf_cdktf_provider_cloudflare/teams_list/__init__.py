...
class TeamsList(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the teams list. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_list#name TeamsList#name}
        :param type: The teams list type. Available values: ``IP``, ``SERIAL``, ``URL``, ``DOMAIN``, ``EMAIL``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_list#type TeamsList#type}
        :param description: The description of the teams list. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_list#description TeamsList#description}
        ...
        :param items: The items of the teams list. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_list#items TeamsList#items}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
