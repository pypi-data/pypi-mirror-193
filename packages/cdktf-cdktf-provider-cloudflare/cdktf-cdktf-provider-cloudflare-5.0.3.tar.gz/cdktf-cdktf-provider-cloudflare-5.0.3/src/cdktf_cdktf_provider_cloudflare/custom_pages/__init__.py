...
class CustomPages(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: The type of custom page you wish to update. Available values: ``basic_challenge``, ``waf_challenge``, ``waf_block``, ``ratelimit_block``, ``country_challenge``, ``ip_block``, ``under_attack``, ``500_errors``, ``1000_errors``, ``always_online``, ``managed_challenge``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/custom_pages#type CustomPages#type}
        :param url: URL of where the custom page source is located. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/custom_pages#url CustomPages#url}
        ...
        :param state: Managed state of the custom page. Available values: ``default``, ``customized``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/custom_pages#state CustomPages#state}
