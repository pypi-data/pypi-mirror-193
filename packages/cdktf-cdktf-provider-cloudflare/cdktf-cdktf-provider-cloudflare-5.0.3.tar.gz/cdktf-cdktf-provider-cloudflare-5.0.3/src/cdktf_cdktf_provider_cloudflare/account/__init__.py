...
class Account(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: Account type. Available values: ``enterprise``, ``standard``. Defaults to ``standard``. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/account#type Account#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
