...
class DevicePostureIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the device posture integration. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#name DevicePostureIntegration#name}
        :param type: The device posture integration type. Available values: ``workspace_one``, ``uptycs``, ``crowdstrike_s2s``, ``intune``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#type DevicePostureIntegration#type}
        ...
        :param interval: Indicates the frequency with which to poll the third-party API. Must be in the format ``1h`` or ``30m``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#interval DevicePostureIntegration#interval}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DevicePostureIntegrationConfigA:
    def __init__(
        ...
        *,
        ...
        '''
        :param api_url: The third-party API's URL. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#api_url DevicePostureIntegration#api_url}
        :param auth_url: The third-party authorization API URL. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#auth_url DevicePostureIntegration#auth_url}
        :param client_id: The client identifier for authenticating API calls. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#client_id DevicePostureIntegration#client_id}
        :param client_key: The client key for authenticating API calls. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#client_key DevicePostureIntegration#client_key}
        :param client_secret: The client secret for authenticating API calls. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#client_secret DevicePostureIntegration#client_secret}
        :param customer_id: The customer identifier for authenticating API calls. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/device_posture_integration#customer_id DevicePostureIntegration#customer_id}
        '''
        if __debug__:
