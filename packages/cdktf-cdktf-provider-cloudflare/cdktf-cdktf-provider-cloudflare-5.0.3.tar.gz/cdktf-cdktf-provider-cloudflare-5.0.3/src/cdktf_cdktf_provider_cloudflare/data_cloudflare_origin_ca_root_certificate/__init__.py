...
class DataCloudflareOriginCaRootCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        :param algorithm: The name of the algorithm used when creating an Origin CA certificate. Available values: ``rsa``, ``ecc``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/origin_ca_root_certificate#algorithm DataCloudflareOriginCaRootCertificate#algorithm}
