...
class ZoneLockdown(
    ...
    def __init__(
        ...
        *,
        ...
        :param urls: A list of simple wildcard patterns to match requests against. The order of the urls is unimportant. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/zone_lockdown#urls ZoneLockdown#urls}
        ...
        :param description: A description about the lockdown entry. Typically used as a reminder or explanation for the lockdown. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/zone_lockdown#description ZoneLockdown#description}
        ...
        :param paused: Boolean of whether this zone lockdown is currently paused. Defaults to ``false``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/zone_lockdown#paused ZoneLockdown#paused}
...
class ZoneLockdownConfigurations:
    def __init__(self, *, target: builtins.str, value: builtins.str) -> None:
        '''
        :param target: The request property to target. Available values: ``ip``, ``ip_range``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/zone_lockdown#target ZoneLockdown#target}
        :param value: The value to target. Depends on target's type. IP addresses should just be standard IPv4/IPv6 notation i.e. ``192.0.2.1`` or ``2001:db8::/32`` and IP ranges in CIDR format i.e. ``192.0.2.0/24``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/zone_lockdown#value ZoneLockdown#value}
        '''
        if __debug__:
