...
class NotificationPolicyWebhooks(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the webhook destination. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/notification_policy_webhooks#name NotificationPolicyWebhooks#name}
        ...
        :param url: The URL of the webhook destinations. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/notification_policy_webhooks#url NotificationPolicyWebhooks#url}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
