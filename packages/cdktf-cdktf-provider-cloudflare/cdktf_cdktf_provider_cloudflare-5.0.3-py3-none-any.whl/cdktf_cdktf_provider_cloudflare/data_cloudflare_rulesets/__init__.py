...
class DataCloudflareRulesets(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets cloudflare_rulesets} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Must provide only one of ``zone_id``, ``account_id``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#account_id DataCloudflareRulesets#account_id}
        :param filter: filter block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#filter DataCloudflareRulesets#filter}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#id DataCloudflareRulesets#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param include_rules: Include rule data in response. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#include_rules DataCloudflareRulesets#include_rules}
        :param zone_id: The zone identifier to target for the resource. Must provide only one of ``zone_id``, ``account_id``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#zone_id DataCloudflareRulesets#zone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_filter(
        ...
        *,
        ...
        '''
        :param id: The ID of the Ruleset to target. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#id DataCloudflareRulesets#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param kind: Type of Ruleset to create. Available values: ``custom``, ``managed``, ``root``, ``schema``, ``zone``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#kind DataCloudflareRulesets#kind}
        :param name: Name of the ruleset. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#name DataCloudflareRulesets#name}
        :param phase: Point in the request/response lifecycle where the ruleset will be created. Available values: ``ddos_l4``, ``ddos_l7``, ``http_custom_errors``, ``http_log_custom_fields``, ``http_request_cache_settings``, ``http_request_firewall_custom``, ``http_request_firewall_managed``, ``http_request_late_transform``, ``http_request_late_transform_managed``, ``http_request_main``, ``http_request_origin``, ``http_request_dynamic_redirect``, ``http_request_redirect``, ``http_request_sanitize``, ``http_request_transform``, ``http_response_firewall_managed``, ``http_response_headers_transform``, ``http_response_headers_transform_managed``, ``magic_transit``, ``http_ratelimit``, ``http_request_sbfm``, ``http_config_settings``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#phase DataCloudflareRulesets#phase}
        :param version: Version of the ruleset to filter on. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/rulesets#version DataCloudflareRulesets#version}
        '''
