...
class DataCloudflareZone(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the zone. Must provide only one of ``zone_id``, ``name``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/zone#name DataCloudflareZone#name}
