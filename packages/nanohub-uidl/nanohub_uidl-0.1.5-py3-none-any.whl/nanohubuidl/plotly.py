...
class PlotlyBuilder:
    def BasePlotlyComponent(*args, **kwargs):
        ...
        PlotlyPlot.content.attrs["data"] = {
            "type": "dynamic",
            "content": {"referenceType": "prop", "id": "data"},
        }
        PlotlyPlot.content.attrs["layout"] = {
            "type": "dynamic",
            "content": {"referenceType": "prop", "id": "layout"},
        }
        PlotlyPlot.content.attrs["frames"] = {
            "type": "dynamic",
            "content": {"referenceType": "prop", "id": "frames"},
        }
        ...
        BasePlotlyComponent.addPropVariable(
            "data", {"type": "array", "defaultValue": [{"x": [], "y": []}]}
        )
        BasePlotlyComponent.addPropVariable(
            "layout", {"type": "object", "defaultValue": {}}
        )
        BasePlotlyComponent.addPropVariable(
            "frames", {"type": "array", "defaultValue": []}
        )
        BasePlotlyComponent.addPropVariable(
            "config", {"type": "object", "defaultValue": {}}
        )
        BasePlotlyComponent.addPropVariable(
            "handlePurge", {"type": "func", "defaultValue": "(e)=>{console.log(e);}"}
        )
    ...
    def BasePlot(tp, Component, *args, **kwargs):
        ...
        Component.addStateVariable(
            ...
            {
                "type": "object",
                "defaultValue": {"displayModeBar": True, "responsive": True},
            },
        )
        ...
        BasePlot.content.attrs["data"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "data"},
        }
        BasePlot.content.attrs["layout"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "layout"},
        }
        BasePlot.content.attrs["frames"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "frames"},
        }

        BasePlot.content.attrs["config"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "config"},
        }
    ...
    def MoleculeComponent(tp, *args, **kwargs):
        ...
        PlotlyPlot.content.attrs["data"] = {
            "type": "dynamic",
            "content": {"referenceType": "prop", "id": "setData(self)"},
        }
        PlotlyPlot.content.attrs["layout"] = {
            "type": "dynamic",
            "content": {"referenceType": "prop", "id": "setLayout(self)"},
        }
        PlotlyPlot.content.attrs["useResizeHandler"] = True
        PlotlyPlot.content.style = {
            "height": "100%",
        ...
        MoleculeComponent.addPropVariable(
            "onUpdate", {"type": "func", "defaultValue": "(e)=>{}"}
        )
        ...
        handleUpdate += (
            "  if (JSON.stringify(scene) === JSON.stringify(component.state.scene))"
            + eol
        )
        ...
        handleUpdate += "}" + eol
        MoleculeComponent.addPropVariable(
            "handleUpdate", {"type": "func", "defaultValue": handleUpdate}
        )
        setData = ""
        ...
        setData += "      }" + eol
        setData += (
            "      var exPlane = c.props.exposedShowPlanes(c,p.plane,ve,p.center/100,bo,p.color);"
            + eol
        )
        ...
        setData += "}" + eol
        MoleculeComponent.addPropVariable(
            "setData", {"type": "func", "defaultValue": setData}
        )
        eol = "\n"
        setLayout = ""
        ...
        setLayout += "}" + eol
        MoleculeComponent.addPropVariable(
            "setLayout", {"type": "func", "defaultValue": setLayout}
        )
        ...
        MoleculeComponent.addPropVariable(
            "boundary", {"type": "array", "defaultValue": [[0, 0, 0], [1, 1, 1]]}
        )
        MoleculeComponent.addPropVariable(
            "vectors",
            {"type": "array", "defaultValue": [[1, 0, 0], [0, 1, 0], [0, 0, 1]]},
        )
        MoleculeComponent.addPropVariable(
            "atoms", {"type": "array", "defaultValue": []}
        )
        MoleculeComponent.addStateVariable(
            "scene",
            {
                "type": "object",
                "defaultValue": {
        ...
        MoleculeComponent.addPropVariable(
            "planes", {"type": "array", "defaultValue": []}
        )
        MoleculeComponent.addPropVariable(
            "miller", {"type": "array", "defaultValue": []}
        )
        MoleculeComponent.addPropVariable(
            "config", {"type": "object", "defaultValue": {}}
        )
    ...
    def Molecule(tp, Component, *args, **kwargs):
        ...
        BasePlot.content.attrs["boundary"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "boundary"},
        }

        BasePlot.content.attrs["vectors"] = {
            "type": "dynamic",
            "content": {"referenceType": "state", "id": "vectors"},
        }
