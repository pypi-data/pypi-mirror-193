...
class Pipeline(object):
                ...
                while len(outputs) > 0:
                    for orig_ix, correct_ix in track(
                        ...
                        for a in activation:
                            ...
                            if a == "softmax":
                                softmax_val = val[a]
                            classification_distribution[correct_ix][self.cur_loop] = {
    ...
    def __call__(self):
        ...
        if error:
            self.console.error("SOMETHING WENT WRONG WHILE STARTING THE EXPERIMENT !\n PLEASE CONTACT ALECTIO ADMIN")
            return 
