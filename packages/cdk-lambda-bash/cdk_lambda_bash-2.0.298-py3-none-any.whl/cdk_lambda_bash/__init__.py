...
class BashExecFunction(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__634a45e063379d008b93c0445c3baf34458772aa792f9d20f521088626f550c2)
    ...
    def run(
        ...
        *,
        ...
        return typing.cast(_aws_cdk_ceddda9d.CustomResource, jsii.invoke(self, "run", [ops]))
...
class BashExecFunctionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__38ce028794aa7d3deb9edd0d37d99548e962a5625501b9c9827320b5fb87a06f)
...
class RunOps:
    def __init__(self, *, run_on_update: typing.Optional[builtins.bool] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c5eb9ecdcaa8af8fbb8635d7db938fe17a1fcb455a8b83b8ac1865ea151b61f9)
...
def _typecheckingstub__634a45e063379d008b93c0445c3baf34458772aa792f9d20f521088626f550c2(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    script: builtins.str,
...
def _typecheckingstub__38ce028794aa7d3deb9edd0d37d99548e962a5625501b9c9827320b5fb87a06f(
    *,
    script: builtins.str,
    dockerfile: typing.Optional[builtins.str] = None,
    environment: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
...
def _typecheckingstub__c5eb9ecdcaa8af8fbb8635d7db938fe17a1fcb455a8b83b8ac1865ea151b61f9(
    *,
    run_on_update: typing.Optional[builtins.bool] = None,
) -> None:
    """Type checking stubs"""
