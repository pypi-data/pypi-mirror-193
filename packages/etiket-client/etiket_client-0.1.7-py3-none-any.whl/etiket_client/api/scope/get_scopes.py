...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/scopes/".format(client.base_url)
...
) -> Optional[Union[BaseError, HTTPValidationError, List["ScopeOut"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ScopeOut.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseError, HTTPValidationError, List["ScopeOut"]]]:
    return Response(
