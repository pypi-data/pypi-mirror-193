...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[BaseError, UserOut]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[BaseError, UserOut]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
) -> Response[Union[BaseError, UserOut]]:
    """Get Userme
...
def sync(
    *,
    client: AuthenticatedClient,
) -> Optional[Union[BaseError, UserOut]]:
    """Get Userme
