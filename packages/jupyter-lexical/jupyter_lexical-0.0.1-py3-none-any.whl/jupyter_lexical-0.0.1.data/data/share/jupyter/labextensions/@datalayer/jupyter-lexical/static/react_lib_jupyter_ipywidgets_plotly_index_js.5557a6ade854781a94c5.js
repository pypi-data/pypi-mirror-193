"use strict";
(self["webpackChunk_datalayer_jupyter_lexical"] = self["webpackChunk_datalayer_jupyter_lexical"] || []).push([["react_lib_jupyter_ipywidgets_plotly_index_js"],{

/***/ "../react/lib/jupyter/ipywidgets/plotly/Figure.js":
/*!********************************************************!*\
  !*** ../react/lib/jupyter/ipywidgets/plotly/Figure.js ***!
  \********************************************************/
...
/* harmony export */ });
/* harmony import */ var _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @jupyter-widgets/base */ "../../node_modules/@jupyter-widgets/base/lib/index.js");
...
/* harmony import */ var _Version__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Version */ "../react/lib/jupyter/ipywidgets/plotly/Version.js");
...
class FigureModel extends _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.DOMWidgetModel {
    ...
    static model_module = _Version__WEBPACK_IMPORTED_MODULE_3__.MODULE_NAME;
    static model_module_version = semver_range;
    static view_name = "FigureView";
    static view_module = _Version__WEBPACK_IMPORTED_MODULE_3__.MODULE_NAME;
...
class FigureView extends _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.DOMWidgetView {
    ...
    perform_render() {
        ...
        plotly_js__WEBPACK_IMPORTED_MODULE_2___default().newPlot(that.el, initialTraces, initialLayout, config).then(function () {
            // ### Send trace deltas ###
    ...
    processLuminoMessage(msg) {
        ...
        switch (msg.type) {
            case "before-attach":
                ...
                plotly_js__WEBPACK_IMPORTED_MODULE_2___default().newPlot(that.el, [], {
                    xaxis: axisHidden,
                    yaxis: axisHidden,
                });
    ...
    autosizeFigure() {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_1___default().isNil(layout) || lodash__WEBPACK_IMPORTED_MODULE_1___default().isNil(layout.width)) {
            // @ts-ignore
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().Plots.resize(that.el).then(function () {
     ...
     */
    destroy() {
        plotly_js__WEBPACK_IMPORTED_MODULE_2___default().purge(this.el);
    }
    /**
    ...
    do_addTraces() {
        ...
        if (msgData !== null) {
            var that = this;
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().addTraces(this.el, msgData.trace_data).then(function () {
                // ### Send trace deltas ###
    ...
    do_deleteTraces() {
        ...
        if (msgData !== null) {
            var delete_inds = msgData.delete_inds;
            var that = this;
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().deleteTraces(this.el, delete_inds).then(function () {
                // ### Send trace deltas ###
    ...
    do_moveTraces() {
        ...
        if (msgData !== null) {
            ...
            if (!inds_equal) {
                plotly_js__WEBPACK_IMPORTED_MODULE_2___default().moveTraces(this.el, currentInds, newInds);
            }
        }
    }
    /**
    ...
    do_restyle() {
        ...
        if (msgData !== null) {
            ...
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().restyle(this.el, restyleData, traceIndexes);
            // ### Send trace deltas ###
    ...
    do_relayout() {
        ...
        if (msgData !== null) {
            if (msgData.source_view_id !== this.viewID) {
                ...
                plotly_js__WEBPACK_IMPORTED_MODULE_2___default().relayout(this.el, msgData.relayout_data);
            }
            // ### Send layout delta ###
            var layout_edit_id = msgData.layout_edit_id;
            this._sendLayoutDelta(layout_edit_id);
    ...
    do_update() {
        ...
        if (msgData !== null) {
            ...
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().update(this.el, style, layout, traceIndexes);
            // ### Send trace deltas ###
    ...
    do_animate() {
        ...
        if (msgData !== null) {
            ...
            var that = this;
            // @ts-ignore
            plotly_js__WEBPACK_IMPORTED_MODULE_2___default().animate(this.el, animationData, animationOpts).then(function () {
                // ### Send trace deltas ###
...
/***/ "../react/lib/jupyter/ipywidgets/plotly/index.js":
/*!*******************************************************!*\
  !*** ../react/lib/jupyter/ipywidgets/plotly/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Figure__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Figure */ "../react/lib/jupyter/ipywidgets/plotly/Figure.js");
/* harmony import */ var _Version__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Version */ "../react/lib/jupyter/ipywidgets/plotly/Version.js");
...
//# sourceMappingURL=react_lib_jupyter_ipywidgets_plotly_index_js.5557a6ade854781a94c5.js.map