...
NUMBER_OF_CONFIGURATION_PROGRAM_CHANGES = "Number of configuration program changes"
DATE_A_OF_LAST_CONFIGURATION_PROGRAM_CHANGE = "Date a of last configuration program change"
DATE_A_OF_LAST_TIME_SWITCH_PROGRAM_CHANGE = "Date a of last time switch program change"
DATE_A_OF_LAST_RIPPLE_CONTROL_RECEIVER_PROGRAM_CHANGE = "Date a of last ripple control receiver program change"
STATUS_OF_SECURITY_SWITCHES = "Status of security switches"
DATE_A_OF_LAST_CALIBRATION = "Date a of last calibration"
DATE_A_OF_NEXT_CONFIGURATION_PROGRAM_CHANGE = "Date a of next configuration program change"
DATE_A_OF_ACTIVATION_OF_THE_PASSIVE_CALENDAR = "Date a of activation of the passive calendar"
NUMBER_OF_PROTECTED_CONFIGURATION_PROGRAM_CHANGES = "Number of protected configuration program changes"
DATE_A_OF_LAST_PROTECTED_CONFIGURATION_PROGRAM_CHANGE = "Date a of last protected configuration program change"
DATE_A_CORRECTED_OF_LAST_CLOCK_SYNCHRONIZATION_SETTING = "Date a (corrected) of last clock synchronization/setting"
DATE_OF_LAST_FIRMWARE_ACTIVATION = "Date of last firmware activation"
# Internal operating status
INTERNAL_OPERATING_STATUS_GLOBAL = "Internal operating status global"
INTERNAL_OPERATING_STATUS_1 = "Internal operating status (status word 1)"
INTERNAL_OPERATING_STATUS_2 = "Internal operating status (status word 2)"
INTERNAL_OPERATING_STATUS_3 = "Internal operating status (status word 3)"
INTERNAL_OPERATING_STATUS_4 = "Internal operating status (status word 4)"
