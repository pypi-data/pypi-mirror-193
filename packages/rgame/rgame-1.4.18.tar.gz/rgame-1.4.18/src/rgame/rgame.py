...
def TimeInit():
    ...
    global py;
    try:
        tim = cdll.LoadLibrary(".\\RGame\\SDL\\Time.dll")
...
class RG_CppPhysics(RG_Physics):
    ...
    def __init__(self, mainScript:RG_MainScript, interval:float) -> None:
        ...
        self.C_Physics = cdll.LoadLibrary(".\\RGame\\Physics\\Physics.dll");
...
class RG_MainWindow:
    ...
    def __init__(self, mainScr, frameRate = ref(30)):
        ...
        self.Window = Tk(self.WindowTitle)
    ...
    def CreateWindow(self):
        ...
        print("Main\\Start up\\MainWindow\\configuring> Started  | setting  -> Max Size (will be seprate to min in a future update)");
