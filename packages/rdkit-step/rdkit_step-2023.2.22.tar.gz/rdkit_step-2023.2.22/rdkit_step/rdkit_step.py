...
class RdkitStep(object):
    ...
    my_description["description"] : tuple
        A description of the RDKit step. It must be
    ...
    my_description = {
        "description": "An interface for RDKit",
        "group": "Featurizers",
        "name": "RDKit",
    }
    ...
    def description(self):
        ...
        return RdkitStep.my_description
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return rdkit_step.Rdkit(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return rdkit_step.TkRdkit(canvas=canvas, **kwargs)
