...
# body param
SchemaForRequestBodyApplicationJson = InternalAccount


request_body_internal_account = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = InternalAccount
...
class BaseApi(api_client.Api):
    ...
    def _add_internal_accounts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_internal_account.serialize(body, content_type)
