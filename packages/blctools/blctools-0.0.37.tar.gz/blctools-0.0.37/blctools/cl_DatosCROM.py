...
class DatosCROM(TablasVC):
    ...
    def incidencias_resumen_diario(self):
        ...
        # cond1 = self.__incidencias is not None
        # cond2 = self.__rpt_incidencias_resumen_diario is None
        # cond3 = 
        # interpretar_incidencias_bajo_iec61400
        if self.__incidencias is not None and self.__rpt_incidencias_resumen_diario is None:
    ...
    def elaborar_resumen_diario_incidencias(self):
        ...
        self.explotar_incidencias(iec61400=True)
        ...
        df_Hours = pd.merge(
            left= self.incidencias_explotadas
                ...
                .groupby(by=[
                    'Nemo','Equipo_Orig',
                    self.incidencias_explotadas.Start.dt.date,
                    'Origin','Reason'
                ])
                ['Hours']
                .sum()
