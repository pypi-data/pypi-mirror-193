...
FIXED_SAVE_PATH: True # If True, the save path will be from your user's folder / home folder. If False, the save path will be where the program is run from
EDITOR:
