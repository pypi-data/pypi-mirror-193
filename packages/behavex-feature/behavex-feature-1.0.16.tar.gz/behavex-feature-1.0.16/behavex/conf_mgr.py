...
def get_config():
    ...
    customized_json=string(default="")
...
class ConfigRun(metaclass=ExecutionSingleton):
    ...
    def set_args(self, args):
        ...
        if bool(args.customized_json) is True or str(args.customized_json) == 'True':
            self.environ['logs'] = os.path.join(os.environ.get('FEATURES_PATH'), 'merge_report_logs')
        else:
