...
def launch_behavex():
    ...
    try:
        ...
        if bool(customized_json) is True or str(customized_json) == 'True':
            ...
            folderpath = os.path.join(conf_mgr.get_param('output.path', 'output_folder'), 'outputs', 'logs')
            shutil.rmtree(folderpath)
            shutil.copytree(os.path.join(os.environ.get('FEATURES_PATH'), 'merge_report_logs'), folderpath)
