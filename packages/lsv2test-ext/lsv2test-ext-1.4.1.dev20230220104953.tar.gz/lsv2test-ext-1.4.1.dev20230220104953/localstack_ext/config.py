...
# Whether to download external lambda layers from AWS through LS proxy when creating/updating functions. Default: True
...
# timeout seconds to wait before returning from load operations on the CLI
POD_LOAD_CLI_TIMEOUT = 60
