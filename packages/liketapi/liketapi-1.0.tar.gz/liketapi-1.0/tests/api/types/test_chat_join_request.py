...
from liketapi.methods import ApproveChatJoinRequest, DeclineChatJoinRequest
from liketapi.types import Chat, ChatJoinRequest, User


class TestChatJoinRequest:
    def test_approve_alias(self) -> None:
    ...
    def test_decline_alias(self) -> None:
        chat_join_request = ChatJoinRequest(
            chat=Chat(id=-42, type="supergroup"),
            from_user=User(id=42, is_bot=False, first_name="Test"),
            user_chat_id=42,
