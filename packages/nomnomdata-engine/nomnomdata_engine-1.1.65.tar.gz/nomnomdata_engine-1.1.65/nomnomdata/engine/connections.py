...
ShopifyConnection = Connection(
    ...
    description="API token to use to authenticate with Shopify.",
    categories=["Shopify", "API"],
    parameter_groups=[
        ParameterGroup(
            Parameter(type=String(), name="api_key", display_name="API Key", required=True),
            Parameter(type=Password(), name="password", display_name="Password", required=True),
            name="shopify_params",
