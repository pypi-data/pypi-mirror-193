...
from mxpissh import handler
from mxpissh.main import make_app, make_handlers
from mxpissh.settings import (
    get_app_settings, get_server_settings, max_body_size
)
from mxpissh.utils import to_str
from mxpissh.worker import clients
...
class TestAppBasic(TestAppBase):
    ...
    def test_app_with_correct_credentials_user_bar(self):
        ...
        # end - those just for testing mxpissh websocket stablity
