...
from mxpissh.policy import (
    load_host_keys, get_policy_class, check_policy_setting
)
from mxpissh.utils import (
    to_ip_address, parse_origin_from_url, is_valid_encoding
)
from mxpissh._version import __version__
...
font_dirs = ['mxpissh', 'static', 'css', 'fonts']
...
def get_app_settings(options):
    settings = dict(
        template_path=os.path.join(base_dir, 'mxpissh', 'templates'),
        static_path=os.path.join(base_dir, 'mxpissh', 'static'),
