...
class VertexTensorToSegmentation(ProcessObject):
    ...
    @staticmethod
    def create(connections: "fast::Connections", width: "int"=-1, height: "int"=-1) -> "std::shared_ptr< fast::VertexTensorToSegmentation >":
        r"""
        Create instance

        If multiple objects are provided to the connections param, they are drawn in the order the they are specified.
        :type connections: fast::Connections
...
def VertexTensorToSegmentation_create(connections: "fast::Connections", width: "int"=-1, height: "int"=-1) -> "std::shared_ptr< fast::VertexTensorToSegmentation >":
    r"""
    Create instance
