...
class CompositeFormat(System.Object):
    ...
    @property
    def _segments(self) -> typing.List[System.ValueTuple[str, int, int, str]]:
        """The parsed segments that make up the composite format string."""
        ...

    @property
    def _literalLength(self) -> int:
        """The sum of the lengths of all of the literals in _segments."""
        ...

    @property
    def _formattedCount(self) -> int:
        """The number of segments in _segments that represent format holes."""
        ...

    @property
    def _argsRequired(self) -> int:
    ...
    @staticmethod
    def TryParse(format: str, compositeFormat: typing.Optional[System.Text.CompositeFormat]) -> typing.Union[bool, System.Text.CompositeFormat]:
        """
        Try to parse the composite format string .
        
        :param format: The string to parse.
        :param compositeFormat: The parsed CompositeFormat if parsing was successful; otherwise, null.
        :returns: true the  can be parsed successfully; otherwise, false.
        """
        ...
