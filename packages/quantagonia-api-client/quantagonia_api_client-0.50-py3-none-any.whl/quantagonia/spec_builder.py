...
class QUBOSpecBuilder(SpecBuilder):
    ...
    def set_coeff_strengthening(self, coeff_strengthening: bool):
        """
        Enable or disable coefficient strengthening.
        """
        check_type("coeff_strengthening", coeff_strengthening, bool)
