...
def create_qr_code(crypto_currency, crypto_address, amount=None, label=None, message=None, filename="output"):
    """
    ...
    Args:
        ...
        label (str, optional): The label for the payment.
    ...
    """
    data = f"{crypto_currency}:{crypto_address}?amount={amount}&label=CryptoWallet&message={message}"
    try:
