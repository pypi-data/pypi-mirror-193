        ...
        if self.cb_C1.isChecked():
            try:
                ...
                try:
                    ...
                    im1 = (self.ds1[slice_name].sel(
                        channel=self.channels_start).data * self.bscale + self.bzero)
                    im2 = (self.ds2[slice_name].sel(
                        channel=self.channels_start).data * self.bscale + self.bzero)
                    im4 = (self.ds4[slice_name].sel(
                        channel=self.channels_start).data * self.bscale + self.bzero)
        ...
        if self.cb_C2.isChecked():
            try:
                ...
                try:
                    ...
                    im1 = (self.ds1[slice_name].sel(
                        channel=self.channels_start + 1).data * self.bscale + self.bzero)
                    im2 = (self.ds2[slice_name].sel(
                        channel=self.channels_start + 1).data * self.bscale + self.bzero)
                    im4 = (self.ds4[slice_name].sel(
                        channel=self.channels_start + 1).data * self.bscale + self.bzero)
        ...
        if self.cb_C3.isChecked():
            try:
                ...
                try:
                    ...
                    im1 = (self.ds1[slice_name].sel(
                        channel=self.channels_start + 2).data * self.bscale + self.bzero)
                    im2 = (self.ds2[slice_name].sel(
                        channel=self.channels_start + 2).data * self.bscale + self.bzero)
                    im4 = (self.ds4[slice_name].sel(
                        channel=self.channels_start + 2).data * self.bscale + self.bzero)
        ...
        if self.cb_C4.isChecked():
            try:
                ...
                try:
                    ...
                    im1 = (self.ds1[slice_name].sel(
                        channel=self.channels_start + 3).data * self.bscale + self.bzero)
                    im2 = (self.ds2[slice_name].sel(
                        channel=self.channels_start + 3).data * self.bscale + self.bzero)
                    im4 = (self.ds4[slice_name].sel(
                        channel=self.channels_start + 3).data * self.bscale + self.bzero)
