...
class Seq2SeqOutputDecoder(base.BaseOutputDecoder):
    ...
    def decode(
        ...
        if out is not None:
            return self._place_sequences(out, sequences)
        return sequences

    def _place_sequences(self, X: pd.DataFrame, sequences: Dict[str, np.array]):
        ...
        def apply_func(group):
            ...
            group['output'].iloc[-sequence_length:] = group_sequence
            return group
