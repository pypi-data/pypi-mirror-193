...
class PythonExecutor:
    ...
    def run_function(self, request: ExecutionRequest) -> ExecutionResponse:
        ...
        logging.debug("Arguments execution OK")
        ...
        logging.debug("Function execution OK")
        logging.debug(value)
        self.clear_imports()
        self.clear_syspaths()
        logging.debug("Clearing OK")
        return value
...
def run_calculate_function_value(
    ...
    PythonSerializer().clean()
    logging.info(len(PythonSerializer().memory.objects))
