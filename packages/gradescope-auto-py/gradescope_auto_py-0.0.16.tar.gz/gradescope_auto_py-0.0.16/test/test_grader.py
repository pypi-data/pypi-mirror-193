...
file_submit = hw0_folder / 'case_no_error' / 'hw0_stud.py'
file_prep_expect = hw0_folder / 'case_no_error' / 'hw0_prep.py'
...
def test_grade():
    for case in ['case_no_error', 'case_runtime_error']:
        # prep
        grader = gap.Grader(afp_list=grader_config.afp_list)
