...
class GraderConfig:
    ...
    def grade(self, folder_submit='submission', folder_source='source'):
        ...
        # get file to run
        file_run = self.get_file_run(folder_submit, print_fnc=grader.print)
        if file_run is None:
            return grader
        ...
        for file in self.file_supp_tup:
            ...
            file_dst = folder_submit / file

            if file_dst.exists():
                # student submitted file with same name as supplemental file
