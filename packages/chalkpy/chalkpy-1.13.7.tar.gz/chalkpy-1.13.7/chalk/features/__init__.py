...
from chalk.features.resolver import Cron, Resolver, ResolverProtocol, ScheduleOptions, offline, online, sink
...
def owner(f: Any) -> Optional[str]:
    ...
    'Comments above a feature are applied assigned to the features above which they sit.'
