...
def feature(
    ...
    ...     # :tags: fraud, credit
    ...     name: str = feature(max_staleness="10m", etl_offline_to_online=True)
    ...     score = feature(version=2, default_version=2)
    """
    return cast(
        _TRich,
        Feature(
...
def has_one(f: Callable[[], Any]) -> Any:
    ...
    ... class User
    ...     id: str
    ...     card: Card = has_one(lambda: User.id == Card.user_id)
    """
...
def has_many(f: Callable[[], Any]) -> Any:
    ...
    ... class User
    ...     id: str
    ...     cards: DataFrame[Card] = has_many(lambda: User.id == Card.user_id)
    """
    return Feature(join=f)
