...
class ResponsePerson(BaseModel):
    ...
    personal_ids: Optional[List[ResponsePersonalId]] = Field(None, description="> 🚧 Beta > This is an Beta property. Feedback from the community is welcome. We may make breaking changes to this property. Array of personal identifiers ")
