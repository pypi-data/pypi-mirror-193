...
- Composes nicely with native python/pandas types. `Lists`, `pd.Series`, `Tuples`, etc... are converted into filter expressions.
...
countries = wos.get_reference_data(type=wos.WOSRefType.Countries)
