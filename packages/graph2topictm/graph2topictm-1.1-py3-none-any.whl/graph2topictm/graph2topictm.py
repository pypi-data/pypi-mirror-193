...
class Graph2TopicTM(TopicModel):
    def __init__(self, dataset=None, topic_model="g2t", num_topics=10, dim_size=5, word_select_method='tfidf_idfi', graph_method='greedy_modularity',embedding='bert-base-uncased', seed=30):
