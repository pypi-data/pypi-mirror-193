...
import configparser
import pdb
from common_rdm import CommomAutoRDM
from log_checker import Log_Checker
from fuzzywuzzy import fuzz

class ReadCSV():
    def __init__(self, _path = '', _log_num_threshold_second = 60):
        self.path = _path
    ...
    #keywords_list为 ['log_times', 'log_wrong_format', 'boot_error_log']
    ...
    def find_pic(self, log):
        ...
        read_ini.read("../test_conf/logconfig.ini", encoding='utf-8')
    ...
    def do_prepare(self, keywords_list, common_info):
