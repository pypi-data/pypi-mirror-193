/*! For license information please see a6fe4bee.js.LICENSE.txt */
        ...
        <div class="content">
          ...
          ${this._systemStatusData?i.dy`<ha-card outlined>
                  ...
                  <div class="card-content">
                    <ha-chart-base
                      .hass=${this.hass}
                      .data=${{datasets:[{...z,data:this._cpuEntries}]}}
                ...
                <ha-card outlined>
                  ...
                  <div class="card-content">
                    <ha-chart-base
                      .hass=${this.hass}
                      .data=${{datasets:[{...z,data:this._memoryEntries}]}}
                      .options=${this._chartOptions}
                    ></ha-chart-base>
                  </div>
                </ha-card>`:""}
...
//# sourceMappingURL=a6fe4bee.js.map