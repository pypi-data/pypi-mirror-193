...
class Snaplib__222:
    ...
    def __init__(self, start=0):
        self.counter_cross_val = counter.Counter(start)
    ...
    def cleane(df:pd.DataFrame, 
        ...
        return nans.Nans().cleane(df, target=None, verbose=True)
