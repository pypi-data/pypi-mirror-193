...
class Snaplib__222:
    ...
    def cross_val(algorithms : list, 
        ...
        '''
        return cross_validation.cross_val(algorithms, 
                                          k_fold_dict, 
                                          metric, 
                                          task, 
                                          cv, 
    ...
    def recover_data(df_in : pd.DataFrame, 
                     ...
                     discrete_columns : list[str] or str = 'auto', 
                     ) -> pd.DataFrame:
        ''' 
...
class Snaplib:
    ...
    def cross_val(self, algorithms, k_fold_dict, metric, task, cv, verbose=0, early_stopping_rounds=0):
