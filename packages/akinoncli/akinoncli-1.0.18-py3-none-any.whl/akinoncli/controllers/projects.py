...
class ProjectApps(Controller):
    ...
    def attach_certificate(self):
        ...
        url = (url.scheme or 'https://') + url.host
        fqdn = self.app.pargs.fqdn

        data = {'fqdn': fqdn, 'url': url}

        confirm = input('The certificate you specified will be attached to the project app. Are you sure? (Y/N)')
