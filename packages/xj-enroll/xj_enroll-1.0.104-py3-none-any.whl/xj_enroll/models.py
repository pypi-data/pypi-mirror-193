...
class EnrollRecord(models.Model):
    ...
    enroll_auth_status = models.IntegerField(verbose_name='报名权限状态ID', db_column='enroll_auth_status_id', blank=True, null=True, help_text='')
    enroll_pay_status = models.IntegerField(verbose_name='报名支付状态ID', db_column='enroll_pay_status_id', blank=True, null=True, help_text='')
