...
class ScenarioRunner:
    ...
    def run_sync(self) -> dict:
        ...
        while job_status == JobStatus.RUNNING.value:
            ...
            if (curr_time - init_time) > self.__run_timeout_seconds__:
                raise Exception('The job {} did not finish in a reasonable time: {} seconds'.format(job_id, self.__run_timeout_seconds__))
