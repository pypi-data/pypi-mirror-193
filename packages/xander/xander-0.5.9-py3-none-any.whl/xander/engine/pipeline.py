...
class Pipeline(BasePipeline):
    ...
    def set_component(self, name, function, function_params, logger, return_output=False, save_output=True,
                      disabled=False):
        """
        ...
        logging.info('[XANDER] Pipeline {} -> new component added.'.format(self.pipeline_slug))
        return True
