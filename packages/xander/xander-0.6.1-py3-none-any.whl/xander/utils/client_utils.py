...
def post(url, headers, payload):
    try:
        ...
        logging.debug(f'[XANDER] Connection error while calling {url} ({e})', exc_info=e)
        return False, -1
    ...
    if int(res.status_code) == 200:
        ...
        try:
            ...
            logging.debug(str(e), exc_info=e)
            return True, {'message': res.text}
    else:
        logging.warning("[XANDER] Response code: {} while calling {}".format(res.status_code, url))
