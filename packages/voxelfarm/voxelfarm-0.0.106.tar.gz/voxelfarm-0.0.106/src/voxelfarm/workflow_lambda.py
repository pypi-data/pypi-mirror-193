...
class workflow_lambda_host:
    ...
    def is_number(self, element) -> bool:
        try:
            float(element)
            return True
        except:
    ...
    def publish_reports(self, workflow_request: request, report_name:str, report_id: str, constant_spatial_id: str, constant_object_id: str, propertyIds:tuple, timestampID: str = None, spatialId: str = None, objectId: str = None):
        ...
        self.handle_dataframe(workflow_request, result['df'], report_id, f"{iso_time}", timestampID, spatialId, objectId, propertyIds, constant_spatial_id, constant_object_id)
        self.lambda_framework.log(f'End process for report {report_id}')    
        return {'success': True}

    def handle_dataframe(self, workflow_request: request, df_model:pd.DataFrame, report_id: str, timestamp:str, timestampId:str, spatialId: str, objectId: str, propertyIds:tuple, constant_spatial_id:str, constant_object_id:str):
