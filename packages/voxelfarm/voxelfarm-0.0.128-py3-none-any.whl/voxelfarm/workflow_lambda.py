    ...
    def find_product_definition(self, product, workflow):
        if 'id' in workflow:
            ...
            if product_id == product:
                self.lambda_framework.log(f'product_id is equal to searched product: {product}')
                return workflow
            else:
                self.lambda_framework.log(f'product_id is different to searched product: {product}')
