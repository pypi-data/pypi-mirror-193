...
from tator_openapi.model.affiliation import Affiliation
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Affiliation']:
            return Affiliation

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Affiliation'], typing.List['Affiliation']],
    ...
    def __getitem__(self, i: int) -> 'Affiliation':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_affiliation_list_oapg(
        self,
...
class GetAffiliationList(BaseApi):
    ...
    def get_affiliation_list(
        ...
        return self._get_affiliation_list_oapg(
