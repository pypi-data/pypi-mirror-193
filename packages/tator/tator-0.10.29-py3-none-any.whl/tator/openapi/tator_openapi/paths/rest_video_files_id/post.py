...
# body param
SchemaForRequestBodyApplicationJson = VideoDefinition


request_body_video_definition = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_video_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_video_definition.serialize(body, content_type)
...
class CreateVideoFile(BaseApi):
    ...
    def create_video_file(
        ...
        return self._create_video_file_oapg(
            body=body,
