...
from tator_openapi.model.localization_type import LocalizationType
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LocalizationType']:
            return LocalizationType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LocalizationType'], typing.List['LocalizationType']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'LocalizationType':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_localization_type_list_oapg(
        self,
...
class GetLocalizationTypeList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_localization_type_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_localization_type_list(
        ...
        return self._get_localization_type_list_oapg(
