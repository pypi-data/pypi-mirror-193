...
from tator_openapi.model.organization_update import OrganizationUpdate
...
# body param
SchemaForRequestBodyApplicationJson = OrganizationUpdate


request_body_organization_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_organization_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_update.serialize(body, content_type)
