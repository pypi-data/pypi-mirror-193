...
class RoleSchema(
    ...
    @schemas.classproperty
    def THUMBNAIL_GIF(cls):
        return cls("thumbnail_gif")
...
# body param
SchemaForRequestBodyApplicationJson = ImageDefinition


request_body_image_definition = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_image_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_image_definition.serialize(body, content_type)
...
class CreateImageFile(BaseApi):
    ...
    def create_image_file(
        ...
        return self._create_image_file_oapg(
            body=body,
