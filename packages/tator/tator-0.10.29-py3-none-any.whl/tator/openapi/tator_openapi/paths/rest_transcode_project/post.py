...
from tator_openapi.model.transcode_spec import TranscodeSpec
from tator_openapi.model.transcode import Transcode
...
# body param
SchemaForRequestBodyApplicationJson = TranscodeSpec


request_body_transcode_spec = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Transcode
...
class BaseApi(api_client.Api):
    ...
    def _transcode_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transcode_spec.serialize(body, content_type)
