...
from tator_openapi.model.message_response import MessageResponse
from tator_openapi.model.not_found_response import NotFoundResponse
from tator_openapi.model.localization_bulk_update import LocalizationBulkUpdate
...
# body param
SchemaForRequestBodyApplicationJson = LocalizationBulkUpdate


request_body_localization_bulk_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MessageResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_localization_list_oapg(
        self,
    ...
    def _update_localization_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_localization_bulk_update.serialize(body, content_type)
...
class UpdateLocalizationList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_localization_list(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_localization_list(
        ...
        return self._update_localization_list_oapg(
            body=body,
