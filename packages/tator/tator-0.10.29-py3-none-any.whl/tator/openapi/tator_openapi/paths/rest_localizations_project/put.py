...
from tator_openapi.model.localization import Localization
from tator_openapi.model.not_found_response import NotFoundResponse
from tator_openapi.model.localization_id_query import LocalizationIdQuery
...
MediaSearchSchema = schemas.StrSchema


class ExcludeParentsSchema(
    schemas.IntSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'version': typing.Union[VersionSchema, list, tuple, ],
        'after': typing.Union[AfterSchema, decimal.Decimal, int, ],
        'media_search': typing.Union[MediaSearchSchema, str, ],
        'excludeParents': typing.Union[ExcludeParentsSchema, decimal.Decimal, int, ],
        ...
        'frame': typing.Union[FrameSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_media_search = api_client.QueryParameter(
    name="media_search",
    style=api_client.ParameterStyle.FORM,
    schema=MediaSearchSchema,
    explode=True,
)
request_query_exclude_parents = api_client.QueryParameter(
    name="excludeParents",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeParentsSchema,
    explode=True,
)
...
request_query_frame = api_client.QueryParameter(
    name="frame",
    style=api_client.ParameterStyle.FORM,
    schema=FrameSchema,
    explode=True,
...
# body param
SchemaForRequestBodyApplicationJson = LocalizationIdQuery


request_body_localization_id_query = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Localization']:
            return Localization

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Localization'], typing.List['Localization']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'Localization':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_localization_list_by_id_oapg(
        self,
    ...
    def _get_localization_list_by_id_oapg(
        ...
        for parameter in (
            ...
            request_query_after,
            request_query_media_search,
            request_query_exclude_parents,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_localization_id_query.serialize(body, content_type)
...
class GetLocalizationListById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_localization_list_by_id(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_localization_list_by_id(
        ...
        return self._get_localization_list_by_id_oapg(
            body=body,
