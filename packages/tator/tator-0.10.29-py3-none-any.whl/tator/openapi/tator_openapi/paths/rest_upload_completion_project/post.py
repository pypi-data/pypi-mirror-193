...
from tator_openapi.model.upload_completion_spec import UploadCompletionSpec
...
# body param
SchemaForRequestBodyApplicationJson = UploadCompletionSpec


request_body_upload_completion_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _complete_upload_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upload_completion_spec.serialize(body, content_type)
...
class CompleteUpload(BaseApi):
    ...
    def complete_upload(
        ...
        return self._complete_upload_oapg(
            body=body,
