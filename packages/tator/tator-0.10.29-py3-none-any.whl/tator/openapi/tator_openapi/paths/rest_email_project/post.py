...
from tator_openapi.model.email_spec import EmailSpec
...
# body param
SchemaForRequestBodyApplicationJson = EmailSpec


request_body_email_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _send_email_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_spec.serialize(body, content_type)
