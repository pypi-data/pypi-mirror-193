...
from tator_openapi.model.state_bulk_update import StateBulkUpdate
...
# body param
SchemaForRequestBodyApplicationJson = StateBulkUpdate


request_body_state_bulk_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_state_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_state_bulk_update.serialize(body, content_type)
...
class UpdateStateList(BaseApi):
    ...
    def update_state_list(
        ...
        return self._update_state_list_oapg(
            body=body,
