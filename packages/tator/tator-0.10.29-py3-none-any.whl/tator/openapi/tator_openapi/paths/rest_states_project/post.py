...
from tator_openapi.model.state_spec import StateSpec
...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['StateSpec']:
            return StateSpec

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['StateSpec'], typing.List['StateSpec']],
    ...
    def __getitem__(self, i: int) -> 'StateSpec':
        return super().__getitem__(i)


request_body_state_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_state_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_state_spec.serialize(body, content_type)
...
class CreateStateList(BaseApi):
    ...
    def create_state_list(
        ...
        return self._create_state_list_oapg(
            body=body,
