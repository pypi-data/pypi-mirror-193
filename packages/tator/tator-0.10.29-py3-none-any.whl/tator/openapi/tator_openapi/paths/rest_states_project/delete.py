...
from tator_openapi.model.state_id_query import StateIdQuery
...
# body param
SchemaForRequestBodyApplicationJson = StateIdQuery


request_body_state_id_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_state_list_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_state_id_query.serialize(body, content_type)
...
class DeleteStateList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_state_list(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def delete_state_list(
        ...
        return self._delete_state_list_oapg(
            body=body,
