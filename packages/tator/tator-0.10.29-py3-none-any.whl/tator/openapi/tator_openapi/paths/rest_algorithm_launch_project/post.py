...
from tator_openapi.model.algorithm_launch_spec import AlgorithmLaunchSpec
from tator_openapi.model.algorithm_launch import AlgorithmLaunch
...
# body param
SchemaForRequestBodyApplicationJson = AlgorithmLaunchSpec


request_body_algorithm_launch_spec = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AlgorithmLaunch
...
class BaseApi(api_client.Api):
    ...
    def _algorithm_launch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_algorithm_launch_spec.serialize(body, content_type)
...
class AlgorithmLaunch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def algorithm_launch(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def algorithm_launch(
        ...
        return self._algorithm_launch_oapg(
            body=body,
