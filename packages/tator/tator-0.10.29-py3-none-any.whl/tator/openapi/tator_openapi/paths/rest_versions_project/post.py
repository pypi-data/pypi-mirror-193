...
from tator_openapi.model.version_spec import VersionSpec
...
# body param
SchemaForRequestBodyApplicationJson = VersionSpec


request_body_version_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_version_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_version_spec.serialize(body, content_type)
...
class CreateVersion(BaseApi):
    ...
    def create_version(
        ...
        return self._create_version_oapg(
            body=body,
