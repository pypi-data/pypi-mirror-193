...
from tator_openapi.model.state_type_spec import StateTypeSpec
...
# body param
SchemaForRequestBodyApplicationJson = StateTypeSpec


request_body_state_type_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_state_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_state_type_spec.serialize(body, content_type)
...
class CreateStateType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_state_type(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_state_type(
        ...
        return self._create_state_type_oapg(
            body=body,
