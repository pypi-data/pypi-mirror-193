...
from tator_openapi.model.state_type import StateType
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['StateType']:
            return StateType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['StateType'], typing.List['StateType']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'StateType':
        return super().__getitem__(i)
...
class GetStateTypeList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_state_type_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_state_type_list(
        ...
        return self._get_state_type_list_oapg(
