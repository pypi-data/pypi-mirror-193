...
from tator_openapi.model.leaf_bulk_update import LeafBulkUpdate
...
# body param
SchemaForRequestBodyApplicationJson = LeafBulkUpdate


request_body_leaf_bulk_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_leaf_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_leaf_bulk_update.serialize(body, content_type)
...
class UpdateLeafList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_leaf_list(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_leaf_list(
        ...
        return self._update_leaf_list_oapg(
            body=body,
