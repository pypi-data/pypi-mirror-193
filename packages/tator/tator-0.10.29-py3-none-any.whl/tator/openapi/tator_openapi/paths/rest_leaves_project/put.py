...
from tator_openapi.model.leaf_id_query import LeafIdQuery
...
# body param
SchemaForRequestBodyApplicationJson = LeafIdQuery


request_body_leaf_id_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _get_leaf_list_by_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_leaf_id_query.serialize(body, content_type)
...
class GetLeafListById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_leaf_list_by_id(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_leaf_list_by_id(
        ...
        return self._get_leaf_list_by_id_oapg(
            body=body,
