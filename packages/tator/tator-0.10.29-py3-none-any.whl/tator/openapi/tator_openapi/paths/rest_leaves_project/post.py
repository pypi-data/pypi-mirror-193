...
from tator_openapi.model.leaf_spec import LeafSpec
...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LeafSpec']:
            return LeafSpec

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LeafSpec'], typing.List['LeafSpec']],
    ...
    def __getitem__(self, i: int) -> 'LeafSpec':
        return super().__getitem__(i)


request_body_leaf_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_leaf_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_leaf_spec.serialize(body, content_type)
...
class CreateLeafList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_leaf_list(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_leaf_list(
        ...
        return self._create_leaf_list_oapg(
            body=body,
