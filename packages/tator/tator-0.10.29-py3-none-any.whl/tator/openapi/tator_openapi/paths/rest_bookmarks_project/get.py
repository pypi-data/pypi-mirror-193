...
from tator_openapi.model.bookmark import Bookmark
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Bookmark']:
            return Bookmark

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Bookmark'], typing.List['Bookmark']],
    ...
    def __getitem__(self, i: int) -> 'Bookmark':
...
class GetBookmarkList(BaseApi):
    ...
    def get_bookmark_list(
        ...
        return self._get_bookmark_list_oapg(
