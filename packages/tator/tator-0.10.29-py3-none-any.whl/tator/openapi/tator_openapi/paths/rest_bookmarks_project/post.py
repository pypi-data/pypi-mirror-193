...
from tator_openapi.model.bookmark_spec import BookmarkSpec
...
# body param
SchemaForRequestBodyApplicationJson = BookmarkSpec


request_body_bookmark_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_bookmark_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bookmark_spec.serialize(body, content_type)
...
class CreateBookmark(BaseApi):
    ...
    def create_bookmark(
        ...
        return self._create_bookmark_oapg(
            body=body,
