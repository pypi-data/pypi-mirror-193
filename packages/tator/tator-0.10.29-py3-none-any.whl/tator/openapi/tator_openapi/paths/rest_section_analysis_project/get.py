...
from tator_openapi.model.section_analysis import SectionAnalysis
...
SchemaFor200ResponseBodyApplicationJson = SectionAnalysis
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_section_analysis_oapg(
        self,
...
class GetSectionAnalysis(BaseApi):
    ...
    def get_section_analysis(
        ...
        return self._get_section_analysis_oapg(
