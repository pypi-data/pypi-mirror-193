...
from tator_openapi.model.user_spec import UserSpec
from tator_openapi.model.bad_request_response import BadRequestResponse

from . import path

# body param
SchemaForRequestBodyApplicationJson = UserSpec


request_body_user_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_spec.serialize(body, content_type)
