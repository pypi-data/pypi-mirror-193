...
from tator_openapi.model.favorite_spec import FavoriteSpec
...
# body param
SchemaForRequestBodyApplicationJson = FavoriteSpec


request_body_favorite_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_favorite_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_favorite_spec.serialize(body, content_type)
...
class CreateFavorite(BaseApi):
    ...
    def create_favorite(
        ...
        return self._create_favorite_oapg(
            body=body,
