...
from tator_openapi.model.file_update import FileUpdate
...
# body param
SchemaForRequestBodyApplicationJson = FileUpdate


request_body_file_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_file_update.serialize(body, content_type)
