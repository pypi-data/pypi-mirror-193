...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'element': typing.Union[ElementSchema, str, ],
...
request_query_element = api_client.QueryParameter(
    name="element",
...
@dataclass
class ApiResponseFor301(api_client.ApiResponse):
    response: urllib3.HTTPResponse
    body: schemas.Unset = schemas.unset
    headers: schemas.Unset = schemas.unset


_response_for_301 = api_client.OpenApiResponse(
    response_cls=ApiResponseFor301,
)
