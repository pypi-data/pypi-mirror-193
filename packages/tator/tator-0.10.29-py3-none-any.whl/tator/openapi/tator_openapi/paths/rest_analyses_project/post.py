...
from tator_openapi.model.analysis_spec import AnalysisSpec
...
# body param
SchemaForRequestBodyApplicationJson = AnalysisSpec


request_body_analysis_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_analysis_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_analysis_spec.serialize(body, content_type)
...
class CreateAnalysis(BaseApi):
    ...
    def create_analysis(
        ...
        return self._create_analysis_oapg(
            body=body,
