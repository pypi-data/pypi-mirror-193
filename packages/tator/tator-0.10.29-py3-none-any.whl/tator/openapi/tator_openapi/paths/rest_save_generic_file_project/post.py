...
from tator_openapi.model.generic_file_spec import GenericFileSpec
from tator_openapi.model.generic_file import GenericFile
...
# body param
SchemaForRequestBodyApplicationJson = GenericFileSpec


request_body_generic_file_spec = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GenericFile
...
class BaseApi(api_client.Api):
    ...
    def _save_generic_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generic_file_spec.serialize(body, content_type)
...
class SaveGenericFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def save_generic_file(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def save_generic_file(
        ...
        return self._save_generic_file_oapg(
            body=body,
