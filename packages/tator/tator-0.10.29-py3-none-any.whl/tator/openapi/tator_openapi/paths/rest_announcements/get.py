...
from tator_openapi.model.announcement import Announcement
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_announcement_list_oapg(
        self,
...
class GetAnnouncementList(BaseApi):
    ...
    def get_announcement_list(
        ...
        return self._get_announcement_list_oapg(
