...
from tator_openapi.model.get_cloned_media_response import GetClonedMediaResponse
...
SchemaFor200ResponseBodyApplicationJson = GetClonedMediaResponse
...
class GetClonedMedia(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_cloned_media(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_cloned_media(
        ...
        return self._get_cloned_media_oapg(
