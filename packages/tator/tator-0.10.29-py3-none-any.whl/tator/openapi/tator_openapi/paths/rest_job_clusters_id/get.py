...
from tator_openapi.model.job_cluster import JobCluster
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['JobCluster']:
            return JobCluster

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['JobCluster'], typing.List['JobCluster']],
    ...
    def __getitem__(self, i: int) -> 'JobCluster':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_job_cluster_list_oapg(
        self,
...
class GetJobClusterList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_job_cluster_list(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_job_cluster_list(
        ...
        return self._get_job_cluster_list_oapg(
