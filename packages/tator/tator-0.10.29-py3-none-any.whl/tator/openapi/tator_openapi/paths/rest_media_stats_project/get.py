...
from tator_openapi.model.media_stats import MediaStats
...
SchemaFor200ResponseBodyApplicationJson = MediaStats
...
class GetMediaStats(BaseApi):
    ...
    def get_media_stats(
        ...
        return self._get_media_stats_oapg(
