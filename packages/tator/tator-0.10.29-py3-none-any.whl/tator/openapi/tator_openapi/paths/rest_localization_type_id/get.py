...
SchemaFor200ResponseBodyApplicationJson = LocalizationType
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_localization_type_oapg(
        self,
...
class GetLocalizationType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_localization_type(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_localization_type(
        ...
        return self._get_localization_type_oapg(
