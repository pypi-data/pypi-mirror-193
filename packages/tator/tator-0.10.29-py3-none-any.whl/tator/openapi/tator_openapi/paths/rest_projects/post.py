...
from tator_openapi.model.project_spec import ProjectSpec
...
# body param
SchemaForRequestBodyApplicationJson = ProjectSpec


request_body_project_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_spec.serialize(body, content_type)
