...
from tator_openapi.model.file_spec import FileSpec
...
# body param
SchemaForRequestBodyApplicationJson = FileSpec


request_body_file_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_file_spec.serialize(body, content_type)
