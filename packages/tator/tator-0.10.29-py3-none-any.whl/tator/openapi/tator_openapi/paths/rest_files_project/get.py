...
from tator_openapi.model.file import File

from . import path

# Query params
MetaSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'meta': typing.Union[MetaSchema, decimal.Decimal, int, ],
...
request_query_meta = api_client.QueryParameter(
    name="meta",
...
class GetFileList(BaseApi):
    ...
    def get_file_list(
        ...
        return self._get_file_list_oapg(
