...
from tator_openapi.model.favorite_update import FavoriteUpdate
...
# body param
SchemaForRequestBodyApplicationJson = FavoriteUpdate


request_body_favorite_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_favorite_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_favorite_update.serialize(body, content_type)
