...
from tator_openapi.model.favorite import Favorite
...
SchemaFor200ResponseBodyApplicationJson = Favorite
...
class GetFavorite(BaseApi):
    ...
    def get_favorite(
        ...
        return self._get_favorite_oapg(
