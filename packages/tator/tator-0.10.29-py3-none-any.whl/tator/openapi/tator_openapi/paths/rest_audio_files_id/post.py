...
# body param
SchemaForRequestBodyApplicationJson = AudioDefinition


request_body_audio_definition = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_audio_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_audio_definition.serialize(body, content_type)
...
class CreateAudioFile(BaseApi):
    ...
    def create_audio_file(
        ...
        return self._create_audio_file_oapg(
            body=body,
