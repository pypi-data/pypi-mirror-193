...
from tator_openapi.model.media_type_spec import MediaTypeSpec
...
# body param
SchemaForRequestBodyApplicationJson = MediaTypeSpec


request_body_media_type_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_media_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_media_type_spec.serialize(body, content_type)
...
class CreateMediaType(BaseApi):
    ...
    def create_media_type(
        ...
        return self._create_media_type_oapg(
            body=body,
