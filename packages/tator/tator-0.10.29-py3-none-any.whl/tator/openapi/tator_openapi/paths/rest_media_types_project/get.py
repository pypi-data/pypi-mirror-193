...
from tator_openapi.model.media_type import MediaType
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MediaType']:
            return MediaType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['MediaType'], typing.List['MediaType']],
    ...
    def __getitem__(self, i: int) -> 'MediaType':
...
class GetMediaTypeList(BaseApi):
    ...
    def get_media_type_list(
        ...
        return self._get_media_type_list_oapg(
