...
from tator_openapi.model.media_next import MediaNext
...
SchemaFor200ResponseBodyApplicationJson = MediaNext
...
class GetMediaNext(BaseApi):
    ...
    def get_media_next(
        ...
        return self._get_media_next_oapg(
