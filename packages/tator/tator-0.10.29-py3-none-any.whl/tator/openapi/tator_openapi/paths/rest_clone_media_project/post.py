...
from tator_openapi.model.clone_media_spec import CloneMediaSpec
...
# body param
SchemaForRequestBodyApplicationJson = CloneMediaSpec


request_body_clone_media_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _clone_media_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_clone_media_spec.serialize(body, content_type)
...
class CloneMediaList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def clone_media_list(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def clone_media_list(
        ...
        return self._clone_media_list_oapg(
            body=body,
