...
from tator_openapi.model.leaf_type import LeafType
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LeafType']:
            return LeafType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LeafType'], typing.List['LeafType']],
    ...
    def __getitem__(self, i: int) -> 'LeafType':
...
class GetLeafTypeList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_leaf_type_list(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_leaf_type_list(
        ...
        return self._get_leaf_type_list_oapg(
