...
from tator_openapi.model.leaf_type_spec import LeafTypeSpec
...
# body param
SchemaForRequestBodyApplicationJson = LeafTypeSpec


request_body_leaf_type_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_leaf_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_leaf_type_spec.serialize(body, content_type)
...
class CreateLeafType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_leaf_type(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_leaf_type(
        ...
        return self._create_leaf_type_oapg(
            body=body,
