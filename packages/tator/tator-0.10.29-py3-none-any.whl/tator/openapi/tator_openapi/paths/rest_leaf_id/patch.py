...
from tator_openapi.model.leaf_update import LeafUpdate
...
# body param
SchemaForRequestBodyApplicationJson = LeafUpdate


request_body_leaf_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_leaf_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_leaf_update.serialize(body, content_type)
