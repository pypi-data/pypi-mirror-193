...
from tator_openapi.model.media_prev import MediaPrev
...
SchemaFor200ResponseBodyApplicationJson = MediaPrev
...
class GetMediaPrev(BaseApi):
    ...
    def get_media_prev(
        ...
        return self._get_media_prev_oapg(
