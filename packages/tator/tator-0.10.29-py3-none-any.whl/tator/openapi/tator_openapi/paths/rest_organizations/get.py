...
from tator_openapi.model.organization import Organization
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_list_oapg(
        self,
...
class GetOrganizationList(BaseApi):
    ...
    def get_organization_list(
        ...
        return self._get_organization_list_oapg(
