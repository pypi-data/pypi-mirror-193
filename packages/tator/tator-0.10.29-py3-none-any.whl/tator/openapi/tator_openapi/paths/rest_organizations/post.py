...
from tator_openapi.model.organization_spec import OrganizationSpec
...
# body param
SchemaForRequestBodyApplicationJson = OrganizationSpec


request_body_organization_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_organization_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_spec.serialize(body, content_type)
