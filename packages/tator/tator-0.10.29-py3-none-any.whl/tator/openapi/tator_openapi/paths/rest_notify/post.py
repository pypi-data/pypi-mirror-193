...
from tator_openapi.model.notify_spec import NotifySpec
from tator_openapi.model.bad_request_response import BadRequestResponse

from . import path

# body param
SchemaForRequestBodyApplicationJson = NotifySpec


request_body_notify_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _notify_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_notify_spec.serialize(body, content_type)
