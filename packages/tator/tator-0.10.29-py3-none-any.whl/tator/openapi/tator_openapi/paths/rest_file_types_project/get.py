...
from tator_openapi.model.file_type import FileType
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FileType']:
            return FileType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['FileType'], typing.List['FileType']],
    ...
    def __getitem__(self, i: int) -> 'FileType':
...
class GetFileTypeList(BaseApi):
    ...
    def get_file_type_list(
        ...
        return self._get_file_type_list_oapg(
