...
from tator_openapi.model.file_type_spec import FileTypeSpec
...
# body param
SchemaForRequestBodyApplicationJson = FileTypeSpec


request_body_file_type_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_file_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_file_type_spec.serialize(body, content_type)
...
class CreateFileType(BaseApi):
    ...
    def create_file_type(
        ...
        return self._create_file_type_oapg(
            body=body,
