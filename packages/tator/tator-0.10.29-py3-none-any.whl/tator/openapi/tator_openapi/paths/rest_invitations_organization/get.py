...
from tator_openapi.model.invitation import Invitation
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Invitation']:
            return Invitation

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Invitation'], typing.List['Invitation']],
    ...
    def __getitem__(self, i: int) -> 'Invitation':
...
class GetInvitationList(BaseApi):
    ...
    def get_invitation_list(
        ...
        return self._get_invitation_list_oapg(
