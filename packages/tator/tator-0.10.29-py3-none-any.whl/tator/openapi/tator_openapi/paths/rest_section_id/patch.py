...
from tator_openapi.model.section_update import SectionUpdate
...
# body param
SchemaForRequestBodyApplicationJson = SectionUpdate


request_body_section_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_section_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_section_update.serialize(body, content_type)
