...
from tator_openapi.model.video_clip import VideoClip
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'frameRanges': typing.Union[FrameRangesSchema, list, tuple, ],
    }
)
...
request_query_frame_ranges = api_client.QueryParameter(
    name="frameRanges",
    style=api_client.ParameterStyle.FORM,
    schema=FrameRangesSchema,
    required=True,
)
...
SchemaFor200ResponseBodyApplicationJson = VideoClip
