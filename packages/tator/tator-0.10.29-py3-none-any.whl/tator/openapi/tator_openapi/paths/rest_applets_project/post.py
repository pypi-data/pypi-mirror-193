...
from tator_openapi.model.applet_spec import AppletSpec
...
# body param
SchemaForRequestBodyApplicationJson = AppletSpec


request_body_applet_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _register_applet_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_applet_spec.serialize(body, content_type)
...
class RegisterApplet(BaseApi):
    ...
    def register_applet(
        ...
        return self._register_applet_oapg(
            body=body,
