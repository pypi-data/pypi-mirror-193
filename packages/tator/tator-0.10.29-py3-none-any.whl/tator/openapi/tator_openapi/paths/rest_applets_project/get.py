...
from tator_openapi.model.applet import Applet
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Applet']:
            return Applet

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Applet'], typing.List['Applet']],
    ...
    def __getitem__(self, i: int) -> 'Applet':
...
class GetAppletList(BaseApi):
    ...
    def get_applet_list(
        ...
        return self._get_applet_list_oapg(
