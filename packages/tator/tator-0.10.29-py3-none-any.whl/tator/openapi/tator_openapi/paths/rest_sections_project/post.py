...
from tator_openapi.model.section_spec import SectionSpec
...
# body param
SchemaForRequestBodyApplicationJson = SectionSpec


request_body_section_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_section_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_section_spec.serialize(body, content_type)
...
class CreateSection(BaseApi):
    ...
    def create_section(
        ...
        return self._create_section_oapg(
            body=body,
