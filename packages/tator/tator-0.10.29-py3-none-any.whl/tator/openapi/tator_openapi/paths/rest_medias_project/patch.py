...
from tator_openapi.model.media_bulk_update import MediaBulkUpdate
...
# body param
SchemaForRequestBodyApplicationJson = MediaBulkUpdate


request_body_media_bulk_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_media_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_media_bulk_update.serialize(body, content_type)
...
class UpdateMediaList(BaseApi):
    ...
    def update_media_list(
        ...
        return self._update_media_list_oapg(
            body=body,
