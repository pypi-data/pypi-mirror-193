...
from tator_openapi.model.media_spec import MediaSpec
...
# body param
SchemaForRequestBodyApplicationJson = MediaSpec


request_body_media_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_media_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_media_spec.serialize(body, content_type)
...
class CreateMedia(BaseApi):
    ...
    def create_media(
        ...
        return self._create_media_oapg(
            body=body,
