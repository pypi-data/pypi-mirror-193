...
from tator_openapi.model.media_id_query import MediaIdQuery
...
# body param
SchemaForRequestBodyApplicationJson = MediaIdQuery


request_body_media_id_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_media_list_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_media_id_query.serialize(body, content_type)
...
class DeleteMediaList(BaseApi):
    ...
    def delete_media_list(
        ...
        return self._delete_media_list_oapg(
            body=body,
