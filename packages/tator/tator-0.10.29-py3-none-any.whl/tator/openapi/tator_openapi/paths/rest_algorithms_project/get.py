...
from tator_openapi.model.algorithm import Algorithm
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Algorithm']:
            return Algorithm

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Algorithm'], typing.List['Algorithm']],
    ...
    def __getitem__(self, i: int) -> 'Algorithm':
...
class GetAlgorithmList(BaseApi):
    ...
    def get_algorithm_list(
        ...
        return self._get_algorithm_list_oapg(
