...
from tator_openapi.model.algorithm_spec import AlgorithmSpec
...
# body param
SchemaForRequestBodyApplicationJson = AlgorithmSpec


request_body_algorithm_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _register_algorithm_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_algorithm_spec.serialize(body, content_type)
...
class RegisterAlgorithm(BaseApi):
    ...
    def register_algorithm(
        ...
        return self._register_algorithm_oapg(
            body=body,
