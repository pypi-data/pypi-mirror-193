...
from tator_openapi.model.membership import Membership
...
class GetMembershipList(BaseApi):
    ...
    def get_membership_list(
        ...
        return self._get_membership_list_oapg(
