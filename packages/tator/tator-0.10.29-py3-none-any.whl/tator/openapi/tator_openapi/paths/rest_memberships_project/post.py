...
from tator_openapi.model.membership_spec import MembershipSpec
...
# body param
SchemaForRequestBodyApplicationJson = MembershipSpec


request_body_membership_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_membership_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_membership_spec.serialize(body, content_type)
