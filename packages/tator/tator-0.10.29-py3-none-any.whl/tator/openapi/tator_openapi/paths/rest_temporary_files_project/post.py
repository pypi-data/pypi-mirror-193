...
from tator_openapi.model.temporary_file_spec import TemporaryFileSpec
...
# body param
SchemaForRequestBodyApplicationJson = TemporaryFileSpec


request_body_temporary_file_spec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_temporary_file_oapg(
        self,
    ...
    def _create_temporary_file_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_temporary_file_spec.serialize(body, content_type)
...
class CreateTemporaryFile(BaseApi):
    ...
    def create_temporary_file(
        ...
        return self._create_temporary_file_oapg(
            body=body,
