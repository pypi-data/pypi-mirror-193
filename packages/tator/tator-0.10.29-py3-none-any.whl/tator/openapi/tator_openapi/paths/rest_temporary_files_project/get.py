...
# Query params
ExpiredSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'expired': typing.Union[ExpiredSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_expired = api_client.QueryParameter(
    name="expired",
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TemporaryFile']:
            return TemporaryFile

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TemporaryFile'], typing.List['TemporaryFile']],
    ...
    def __getitem__(self, i: int) -> 'TemporaryFile':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_temporary_file_list_oapg(
        self,
...
class GetTemporaryFileList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_temporary_file_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_temporary_file_list(
        ...
        return self._get_temporary_file_list_oapg(
