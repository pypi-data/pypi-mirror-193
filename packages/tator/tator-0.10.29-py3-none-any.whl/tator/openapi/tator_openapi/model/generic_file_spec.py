...
class GenericFileSpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "upload_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "upload_url", ], str]):
