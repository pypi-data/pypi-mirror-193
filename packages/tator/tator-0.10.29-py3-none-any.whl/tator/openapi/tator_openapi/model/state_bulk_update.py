...
class StateBulkUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attributes", "float_array", "ids", "localization_ids", "media_ids", "media_query", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attributes", "float_array", "ids", "localization_ids", "media_ids", "media_query", ], str]):
        return super().get_item_oapg(name)
