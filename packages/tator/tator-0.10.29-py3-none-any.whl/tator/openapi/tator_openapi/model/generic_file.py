...
class GenericFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "project", "upload_url", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "project", "upload_url", "url", ], str]):
