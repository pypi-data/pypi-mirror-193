...
class LeafType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute_types", "description", "dtype", "id", "name", "project", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute_types", "description", "dtype", "id", "name", "project", ], str]):
