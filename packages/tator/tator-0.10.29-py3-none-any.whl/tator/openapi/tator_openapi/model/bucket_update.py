...
class BucketUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_key", "archive_sc", "endpoint_url", "gcs_key_info", "live_sc", "name", "region", "secret_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_key", "archive_sc", "endpoint_url", "gcs_key_info", "live_sc", "name", "region", "secret_key", ], str]):
