...
class MembershipUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["default_version", "permission", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["default_version", "permission", ], str]):
