...
class LocalizationIdQuery(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["float_array", "ids", "media_ids", "media_query", "state_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["float_array", "ids", "media_ids", "media_query", "state_ids", ], str]):
