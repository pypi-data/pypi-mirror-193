...
class InvitationUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["permission", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["permission", "status", ], str]):
