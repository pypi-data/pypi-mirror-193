...
class Bucket(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_key", "archive_sc", "endpoint_url", "gcs_key_info", "id", "live_sc", "name", "organization", "region", "secret_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_key", "archive_sc", "endpoint_url", "gcs_key_info", "id", "live_sc", "name", "organization", "region", "secret_key", ], str]):
