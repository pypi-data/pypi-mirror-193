...
class LeafTypeSpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute_types", "description", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute_types", "description", "name", ], str]):
