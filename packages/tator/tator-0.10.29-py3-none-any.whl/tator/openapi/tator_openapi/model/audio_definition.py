...
class AudioDefinition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["codec", "path", "bit_rate", "codec_description", "codec_mime", "host", "http_auth", "size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["codec", "path", "bit_rate", "codec_description", "codec_mime", "host", "http_auth", "size", ], str]):
