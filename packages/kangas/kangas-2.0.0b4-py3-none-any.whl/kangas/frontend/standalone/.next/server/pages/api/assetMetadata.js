...
const handler = async (req, res)=>{
    ...
    const result = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].apiUrl */ .Z.apiUrl}asset-metadata?${query.toString()}`, {
        next: {
            revalidate: 10000
        }
    });
...
var __webpack_exports__ = (__webpack_exec__(63671));
