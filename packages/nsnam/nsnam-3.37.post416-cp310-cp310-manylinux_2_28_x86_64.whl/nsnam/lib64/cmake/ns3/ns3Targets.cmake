...
set_target_properties(ns3::libconfig-store PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/usr/local/include;/usr/local;/usr/include/freetype2;/usr/include/glib-2.0;/usr/lib64/glib-2.0/include;/usr/include/gdk-pixbuf-2.0;/usr/include/gtk-3.0;/usr/include/cairo;/usr/include;/usr/include/pango-1.0;/usr/include/harfbuzz;/usr/include/atk-1.0;/usr/include/libxml2;/opt/_internal/cpython-3.10.9/include/python3.10"
  INTERFACE_LINK_LIBRARIES "-Wl,--no-as-needed;ns3::libcore;ns3::libnetwork;-lpthread;/usr/lib64/libxml2.so;/usr/lib64/libfreetype.so;/usr/lib64/libglib-2.0.so;/usr/lib64/libgthread-2.0.so;/usr/lib64/libgobject-2.0.so;/usr/lib64/libgio-2.0.so;/usr/lib64/libgdk_pixbuf-2.0.so;/usr/lib64/libgdk-3.so;/usr/lib64/libgtk-3.so;/usr/lib64/libcairo.so;/usr/lib64/libpango-1.0.so;/usr/lib64/libatk-1.0.so;-Wl,--as-needed"
)
