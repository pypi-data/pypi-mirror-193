...
from .const import (
    DEFAULT_CLIENT_ID,
    DEFAULT_CLIENT_SECRET, GUEST_USERNAME, GUEST_PASSWORD
)
...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--client_id", required=False, help="OAuth credentials client_id (Optional.)",
                        default=DEFAULT_CLIENT_ID)
    parser.add_argument("--client_secret", required=False, help="OAuth credentials client_secret (Optional.)",
    ...
    parser.add_argument('id',
                        nargs="?",
                        help='meter ID, if not specified, information about all meters will be shown')
    ...
    parser.add_argument("--user",
                        nargs="?",
                        dest='user_id',
                        help="show info about user, if user_id not specified, information about current user will be shown")
...
async def cli() -> None:
    ...
    _LOGGER.setLevel(LOG_LEVELS.get(args.verbose))
