...
class TaipitApi:
    ...
    async def async_request(self, method: str, url: str, **kwargs) -> Union[dict[str, Any], list[dict[str, Any]]]:
        """Make async request to api endpoint"""
        return await self._auth.request(method, f"{self._api_url}/{url}", **kwargs)
