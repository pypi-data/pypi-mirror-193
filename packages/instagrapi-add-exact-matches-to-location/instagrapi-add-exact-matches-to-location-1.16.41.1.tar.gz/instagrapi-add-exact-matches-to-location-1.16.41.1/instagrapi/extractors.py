...
def extract_location(data):
    ...
    if isinstance(address_json, str):
        ...
        if isinstance(address, dict) and address:
            ...
            data["exact_country_match"] = address.get("exact_country_match")
            data["exact_region_match"] = address.get("exact_region_match")
            data["exact_city_match"] = address.get("exact_city_match")
