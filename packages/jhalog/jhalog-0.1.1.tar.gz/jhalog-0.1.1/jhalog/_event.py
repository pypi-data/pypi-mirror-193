...
class LogEvent(MutableMapping[str, Any]):
    ...
    @client_id.setter
    def client_id(self, value: Any) -> None:
        """Set client ID.

        Args:
            value: Value.
        """
        self._dict["client_id"] = value
    ...
    @client_ip.setter
    def client_ip(self, value: IPv4Address | IPv6Address | str) -> None:
        """Set client IP.
        ...
        Args:
            value: Value.
        """
        if self._logger.ip_addresses_allowed:
            self._dict["client_ip"] = str(value)
    ...
    @client_jti.setter
    def client_jti(self, value: str) -> None:
        """Set client JTI.

        Args:
            value: Value.
        """
        self._dict["client_jti"] = value
    ...
    def client_user_agent(self, value: str) -> None:
        """Set client user agent.

        Args:
            value: Value.
        """
        self._dict["client_user_agent"] = value
    ...
    @error_detail.setter
    def error_detail(self, value: Any) -> None:
        """Set error detail.

        Args:
            value: Value.
        """
        self._dict["error_detail"] = value
    ...
    def request_id(self) -> str:
        ...
        try:
            ...
            self._dict["request_id"] = b64encode(urandom(12)).decode()
            return self._dict["request_id"]
    ...
    def server_version(self, value: str) -> None:
        ...
        Args:
            value: Value.
        """
        self._dict["server_version"] = value
    ...
    def status_code(self, value: int) -> None:
        ...
        if 100 <= value < 400:
            ...
            self._dict["level"] = "warning"
        elif 500 <= value < 600:
            self._dict["level"] = "error"
        else:
            raise ValueError(f"Invalid HTTP status code: {value}")

    def status_code_from_exception(self, exception: Exception) -> tuple[int, str]:
