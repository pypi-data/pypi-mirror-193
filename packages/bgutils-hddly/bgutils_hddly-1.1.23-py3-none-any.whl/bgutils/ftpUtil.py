...
class ftpUtil:
    ...
    def putfile_project(self, local_path, prj_id, stud_id, no_file,fdesc):
        # # 要传输文件的路径
        # filepath = "./myname.jpg"
        # # 上传后的传输文件的文件名
        ...
        try:
            ...
            # item['stud'] = stud
            self.__mutil.sftp_file_ins(local_path, self.__url_head +pid +'/'+ remote_file, stud,fdesc,fsize,duration,ftype,pid)
        except Exception as ex:
