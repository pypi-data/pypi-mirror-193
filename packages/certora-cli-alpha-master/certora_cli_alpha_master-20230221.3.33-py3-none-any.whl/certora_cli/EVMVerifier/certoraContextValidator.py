...
class CertoraContextValidator:
    ...
    def validate(self) -> None:
        ...
        self.validate_array_of_strings("files", Vf.validate_input_file)
        self.validate_array_of_strings("verify", Vf.validate_verify_arg)
        self.validate_array_of_strings("assert_contracts", Vf.validate_assert_contract)
        self.validate_array_of_strings("bytecode_jsons", Vf.validate_json_file)
        self.validate_a_single_string("bytecode_spec", Vf.validate_readable_file)
        self.validate_a_single_string("solc", Vf.validate_exec_file)
        self.validate_array_of_strings("solc_args", None)
        self.validate_dictionary("solc_map", Vf.validate_solc_map)
        self.validate_dictionary("optimize_map", Vf.validate_optimize_map)
        self.validate_a_single_string("path", Vf.validate_dir)
        self.validate_a_single_string("optimize", Vf.validate_non_negative_integer)
        self.validate_a_single_string("loop_iter", Vf.validate_non_negative_integer)
        self.validate_a_single_string("hashing_length_bound", Vf.validate_positive_integer)
        self.validate_a_single_string("packages_path", Vf.validate_dir)
        self.validate_array_of_strings("packages", Vf.validate_packages)
        self.validate_boolean("optimistic_loop")
        self.validate_boolean("optimistic_hashing")
        self.validate_a_single_string("method", Vf.validate_method)
        self.validate_a_single_string("cache", lambda val: str(val))
        self.validate_a_single_string("smt_timeout", Vf.validate_positive_integer)
        self.validate_array_of_strings("link", Vf.validate_link_arg)
        self.validate_array_of_strings("address", Vf.validate_address)
        self.validate_array_of_strings("structLink", Vf.validate_struct_link)
        self.validate_array_of_strings("prototype", Vf.validate_prototype_arg)
        ...
        self.validate_a_single_string("rule_sanity", Vf.validate_sanity_value)
        self.validate_a_single_string("multi_example", Vf.validate_multi_example_value)
        self.validate_a_single_string("dynamic_bound", Vf.validate_non_negative_integer)
        ...
        self.validate_a_single_string("jar", Vf.validate_jar)
        self.validate_array_of_strings("java_args", Vf.validate_java_args)
        ...
        self.validate_a_single_string("build_dir", Vf.validate_build_dir)
        ...
        self.validate_a_single_string("expected_file", Vf.validate_optional_readable_file)
        self.validate_a_single_string("queue_wait_minutes", Vf.validate_non_negative_integer)
        self.validate_a_single_string("max_poll_minutes", Vf.validate_non_negative_integer)
        self.validate_a_single_string("log_query_frequency_seconds", Vf.validate_non_negative_integer)
        self.validate_a_single_string("max_attempts_to_fetch_output", Vf.validate_non_negative_integer)
        self.validate_a_single_string("delay_fetch_output_seconds", Vf.validate_non_negative_integer)
        ...
        self.validate_a_single_string("max_graph_depth", Vf.validate_non_negative_integer)
        self.validate_a_single_string("tool_output", Vf.validate_tool_output_path)
        self.validate_a_single_string("internal_funcs", Vf.validate_json_file)
        self.validate_boolean("coinbaseMode")  # --coinbaseMode  ??? used
        self.validate_a_single_string("get_conf", Vf.validate_conf_file)
    ...
    def validate_dictionary(self, key: str, validate_func: Optional[Callable[[str], Dict[str, str]]]) -> None:
        ...
        if not isinstance(value, Dict):
            raise Util.CertoraUserInputError(f"value of {key} {value} is not a Dictionary")
    ...
    def validate_array_of_strings(self, key: str, validate_func: Optional[Callable[[str], str]]) -> None:
        ...
        if not isinstance(value, List):
            raise Util.CertoraUserInputError(f"value of {key} {value} is not a list")
        for f in value:
            if validate_func is None:
                if not isinstance(f, str):
                    raise Util.CertoraUserInputError(f"value in {key} {f} is not a string")
            else:
                validate_func(f)
    ...
    def validate_boolean(self, key: str) -> None:
        ...
        if value is not None and value not in [True, False]:
            raise Util.CertoraUserInputError(f"value of {key} must be a boolean (true or false)")
    ...
    def validate_settings(self) -> None:
        ...
        if getattr(self.context, "settings", None) is None:
            return
        self.validate_array_of_strings("settings", Vf.validate_settings_arg)
...
def warn_validate_file_args(files: List[str]) -> Tuple[Set[str], Set[str], Dict[str, str], Dict[str, Set[str]]]:
    ...
    @raise Util.CertoraUserInputError in an illegal case (see above)
    """
...
def check_contract_name_arg_inputs(context: CertoraContext) -> None:
    ...
    @raise Util.CertoraUserInputError if a contract name argument was expected, but not given.
    """
...
def check_mode_of_operation(context: CertoraContext) -> None:
    ...
    @raise an Util.CertoraUserInputError when:
...
def check_solc_solc_map(context: CertoraContext) -> None:
    ...
    3. If --solc_map is used and we are not in .conf file Util.Mode:
