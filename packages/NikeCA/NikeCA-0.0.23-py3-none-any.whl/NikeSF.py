...
class Snowflake(_SnowflakeData.SnowflakeData):
    ...
    def search_schema(self, username=None, warehouse=None, database=None, role=None, sample_table: bool = False,
                      sample_val: bool = False, table_sample: dict = None, dtypes_conv=None, db=None, schema=None,
                      table=None, column_name=None, col_and_or='and', get_ex_val=False, like_flag=True) -> pd.DataFrame:
